...
```text
I make $3,000 a month. Make me a budget so I can save money.
```

### ✅ After (Result)

```text
### 💰 Your Tailored $3,000 Monthly Budget Plan

**1. Cash Flow Summary**
- **Net Income:** $3,000
- **Fixed Expenses:** -$1,300 (Rent, Utilities, Insurance, Subs)
- **Savings Goal (Pay Yourself First):** -$800
- **👉 Remaining Variable Budget:** $900

**2. Variable Expense Allocation (Total: $900)**

| Category | Budget | Ratio | Actionable Tip |
| :--- | :--- | :--- | :--- |
| **Food & Groceries** | $450 | 50% | Limit takeout to twice a month; meal prep lunches. |
| **Transportation** | $150 | 17% | Rely on public transit; limit rideshares to emergencies. |
| **Personal & Leisure** | $150 | 17% | Implement a 48-hour cooling-off period before buying non-essentials. |
| **Emergency/Buffer** | $150 | 16% | Keep this in a separate checking account for unexpected costs. |

**3. 💡 Specific Saving Tips to Stay on Track:**
1. **The Subscription Audit:** You're spending $50/month on subs. Cancel any service you haven't used in the last 14 days. You can always resubscribe later.
2. **Cash Envelope System for Leisure:** Withdraw your $150 Personal & Leisure budget in cash at the start of the month. When it's gone, it's gone.
3. **Automate the $800:** Set up an automatic transfer to move your $800 savings into a separate, hard-to-access account the morning after payday.
```
