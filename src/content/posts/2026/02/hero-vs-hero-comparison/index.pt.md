...
> **Contexto (Context):**
>
> - Objetivo: Quero comparar `[Figura A]` e `[Figura B]` para entender profundamente seus estilos de liderança e seus papéis em seus respectivos contextos temporais.
>
> **Tarefa (Task):**
>
> 1. **Tabela de Comparação**: Organize informações sobre o nascimento, contexto da época, principais conquistas, o fim de suas vidas e as palavras-chave que definem sua liderança em uma tabela Markdown.
> 2. **Semelhanças e Diferenças**: Analise as 2 maiores semelhanças e os 2 pontos de contraste mais decisivos entre as duas figuras.
> 3. **Conversa Virtual**: Se os dois se encontrassem hoje em um café, sobre o que conversariam? Escreva um roteiro curto e envolvente.
>
...
### ❌ Antes (Pesquisa Tradicional e Isolada)

```text
- Pesquisar Almirante Yi Sun-sin: Herói naval coreano, criador do Navio Tartaruga, Batalha de Myeongnyang...
- Pesquisar Horatio Nelson: Almirante britânico, herói da Batalha de Trafalgar...
(Os fatos estão completamente soltos e não há conexão profunda entre eles.)
```
...
| Item | Yi Sun-sin (Coreia - Dinastia Joseon) | Horatio Nelson (Reino Unido) |
| :--- | :--- | :--- |
| **Principais Batalhas Navais** | Myeongnyang, Hansando, Noryang | Batalha do Nilo, Trafalgar |
| **Fim da Vida** | Morto em combate durante a Batalha de Noryang | Morto em combate durante a Batalha de Trafalgar |
| **Citação Famosa** | "Não informem os inimigos da minha morte." | "Graças a Deus, cumpri meu dever." |

**[Análise de Semelhanças]**
1. Salvação Nacional em Crise: Ambos foram gênios navais que salvaram suas respectivas nações da aniquilação total contra frotas numericamente muito superiores.
2. Sacrifício Final: Os dois líderes terminaram suas vidas sendo atingidos por balas inimigas exatamente no momento de suas vitórias mais decisivas, solidificando seus legados imortais.

**[Análise de Diferenças]**
1. Apoio Político e Estrutural: Enquanto Nelson operava com o apoio incondicional do Império Britânico e aclamação popular, Yi Sun-sin lutou sob extrema desconfiança, controle opressivo do Rei Seonjo e falta crônica de recursos.

**[Conversa Virtual]**
Nelson: "General Yi, defender o estreito contra 133 navios japoneses usando apenas 13... Nem mesmo a gloriosa Marinha Real Britânica ousaria esperar por tal milagre. Qual foi o seu segredo?"
Yi Sun-sin: "Eu apenas transformei o pavor de meus homens em coragem através da disciplina e do uso implacável das marés. Mas ouvi dizer que o senhor, Almirante, também liderou na linha de frente mesmo após perder um braço e a visão de um olho. O verdadeiro milagre sempre foi a vontade humana."
```
