...
1. **Blitzschnelle Fehleranalyse:** Finden Sie sofort die exakte Ursache kryptischer Fehlermeldungen.
2. **Direkte Lösungsvorschläge:** Erhalten Sie den korrigierten Code samt verständlicher Erklärung.
3. **Nachhaltiges Lernen:** Verstehen Sie den Fehler und lernen Sie, wie Sie ihn in Zukunft durch defensives Programmieren vermeiden.

---

## 🚀 Die Lösung: "Der Bug-Jäger Prompt"

### 🥉 Basic Version (Für die Eiligen)

Nutzen Sie diese Variante, wenn Sie einfach nur schnell ein Ergebnis brauchen.
...
Nutzen Sie diese Variante für präzise, detaillierte und lehrreiche Ergebnisse.

> **Rolle (Role):** Du bist ein genialer Bug-Jäger und Senior Software-Ingenieur mit jahrelanger Erfahrung im Debugging komplexer Systeme.
>
> **Kontext (Context):**
>
> - Hintergrund: Ich habe meinen Code ausgeführt, aber es ist ein Fehler aufgetreten oder das Ergebnis ist fehlerhaft. Ich kann die genaue Ursache im Moment nicht finden.
> - Ziel: Ich möchte nicht nur den Fehler beheben, sondern auch verstehen, warum er aufgetreten ist und wie ich ihn zukünftig vermeiden kann.
>
> **Aufgabe (Task):**
>
> 1. **[Ursachenanalyse]**: Interpretiere die Fehlermeldung messerscharf und zeige exakt auf, an welcher Stelle im Code das Problem liegt (z. B. Logikfehler vs. Syntaxfehler).
> 2. **[Lösung]**: Präsentiere den korrigierten Code. Markiere die geänderten Stellen deutlich mit Kommentaren, damit ich die Anpassungen nachvollziehen kann.
> 3. **[Prävention]**: Erkläre mir, welche Best Practices ich anwenden sollte, um diesen Fehler künftig zu vermeiden (z. B. spezifische Exception-Handling-Strategien oder Defensiv-Code).
>
> **Eingabe-Variablen:**
>
> - Fehlermeldung: `[Füge hier das Fehlerprotokoll ein]`
> - Problematischer Code: `[Füge hier den Code-Schnipsel ein]`
>
> **Einschränkungen (Constraints):**
>
> - Halte die Erklärungen kurz, präzise und entwicklerfreundlich.
> - Nutze Markdown-Codeblöcke für alle Code-Beispiele.
>
> **Warnung (Warning):**
>
> - Erfinde keine Variablen oder Methoden, die im bereitgestellten Code nicht existieren. Wenn dir Kontext fehlt, weise mich darauf hin.
