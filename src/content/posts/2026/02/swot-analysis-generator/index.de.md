...
- **🤖 Empfohlenes Modell:** Claude 3.5 Sonnet, ChatGPT (GPT-4o), Gemini Advanced
...
## 🚀 Die Lösung: "Der Strategie-Berater"
...
```text
| Kategorie | Analysepunkt | Begründung |
| :--- | :--- | :--- |
| **Stärke (S)** | Spezialitätenkaffee-Fokus | Durch die Verwendung von direkt gehandelten Single-Origin-Bohnen heben wir uns geschmacklich vom Massenmarkt ab. |
| **Schwäche (W)** | Begrenztes Marketingbudget | Als lokaler Akteur fehlen die finanziellen Mittel für großflächige Werbekampagnen. |
| **Chance (O)** | Trend zur Nachhaltigkeit | Konsumenten bevorzugen zunehmend ethisch korrekte und transparente Lieferketten. |
| **Risiko (T)** | Steigende Rohstoffpreise | Klimabedingte Ernteausfälle könnten die Einkaufspreise für Premium-Kaffee drastisch erhöhen. |

**Abgeleitete Kernstrategien:**
- **SO-Strategie:** Lancierung von "Transparenz-Tastings", bei denen Kunden die Herkunft der nachhaltigen Single-Origin-Bohnen kennenlernen (Nutzt Stärken, um Chancen zu ergreifen).
- **WT-Strategie:** Abschluss von langfristigen Lieferverträgen mit lokalen Röstereien, um Preisschwankungen abzufedern (Minimiert Schwächen und Risiken).
...
```
