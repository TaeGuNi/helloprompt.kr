...
- **🤖 Empfohlene Modelle:** Alle konversationsbasierten KI-Modelle (ChatGPT, Claude, Gemini etc.)
...
> **Kontext (Context):**
>
> - Hintergrund: Ich muss jeden Morgen ein Daily Standup-Update in unserem Team-Chat (z. B. Slack/Teams) posten.
> - Ziel: Meine unstrukturierten Gedanken und Arbeitsnotizen sollen in ein professionelles, leicht lesbares und präzises Update umgewandelt werden.
>
> **Aufgabe (Task):**
>
> 1. Analysiere den Text, den ich dir unten im Bereich `[Meine Notizen]` zur Verfügung stelle.
> 2. Kategorisiere die Informationen strikt in drei Bereiche:
>    - 🗓️ **Gestern erledigt:** Was wurde abgeschlossen oder bearbeitet?
>    - 🎯 **Heute geplant:** Was steht heute auf der Agenda?
>    - 🚧 **Blocker / Issues:** Gibt es Hindernisse oder wird Hilfe benötigt? (Falls keine vorhanden sind, schreibe "Keine Blocker").
> 3. Formuliere die Sätze aktiv, prägnant und professionell. Entferne unwichtige Details, behalte aber den wesentlichen Kern bei. `[Meine Notizen]` ist der Bereich, den ich ausfüllen werde.
>
> **Einschränkungen (Constraints):**
>
> - Verwende Aufzählungszeichen (Bulletpoints) für eine bessere Lesbarkeit.
> - Halte den Tonfall professionell, aber teamfreundlich.
>
> **Warnung (Warning):**
>
...
🗓️ **Gestern erledigt:**
- Teilnahme am Kickoff-Meeting für die neue Kampagne.
- Erstellung der ersten Entwürfe (Drafts) für die Ad-Copy-Texte.

🎯 **Heute geplant:**
- Abstimmung mit dem Design-Team bezüglich der Kampagnen-Grafiken.

🚧 **Blocker / Issues:**
- Fehlender Zugriff auf das Analytics-Tool (IT-Support hat noch nicht geantwortet). Ohne Zugang verzögert sich der morgige Bericht.
```
