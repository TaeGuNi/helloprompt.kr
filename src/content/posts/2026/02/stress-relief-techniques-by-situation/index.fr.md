...
## 🚀 La solution : "Le Prompt Anti-Stress 119"

### 🥉 Version Basique (Urgence)
...
> **Contexte (Context) :**
>
> - Ma situation actuelle : Je me sens extrêmement stressé et au bord de la crise.
> - La cause : `[Les directives contradictoires et injustes de mon supérieur]`
> - Mon émotion dominante : `[De la colère mêlée à un profond sentiment d'injustice]`
> - Mon environnement : Je suis actuellement `[en open space au bureau]`, je ne peux donc ni crier ni m'isoler.
>
> **Tâche (Task) :**
>
> 1. Propose-moi **3 techniques d'urgence pour gérer la colère** applicables discrètement à mon poste de travail (ex: techniques de respiration spécifiques, acupression, etc.).
> 2. Recommande-moi 2 activités de "sas de décompression" à réaliser après le travail pour changer radicalement d'humeur (exclure l'alcool ou la malbouffe).
> 3. Fournis-moi un recadrage cognitif (conseil psychologique) pour m'aider à observer cette situation avec plus de rationalité et de détachement.
>
> **Contraintes (Constraints) :**
>
> - BANNISSEZ les conseils toxiques ou évidents ("sois patient", "pense positivement", "relativise").
> - Ne proposez QUE des méthodes pratiques, discrètes et scientifiquement fondées.
>
> **Format :**
>
> - Présente tes réponses sous forme de liste à puces claire et concise, avec un ton empathique mais direct.
...
```text
Prompt : Que faire quand on est en colère au travail ?
...
```text
[Kit de Survie Émotionnelle - Spécial Bureau]

1. Respiration 4-7-8 (Discrète et redoutable) : Inspirez par le nez pendant 4 secondes, retenez l'air 7 secondes, expirez lentement par la bouche pendant 8 secondes. Cela force l'activation de votre système nerveux parasympathique et bride mécaniquement votre rythme cardiaque.
2. Acupression du point Hegu (LI4) : Massez fermement le creux charnu entre votre pouce et votre index pendant une minute. Ce signal de pression détourne temporairement les ressources de traitement de la douleur émotionnelle de votre cerveau.
3. Brain Dump (Vidage de charge) : Ouvrez un bloc-notes non sauvegardé sur votre ordinateur. Tapez absolument tout ce que vous avez sur le cœur de manière frénétique. Une fois terminé, appuyez sur CTRL+A puis Supprimer. Le soulagement neuro-moteur est immédiat et ne laisse aucune trace.
```
