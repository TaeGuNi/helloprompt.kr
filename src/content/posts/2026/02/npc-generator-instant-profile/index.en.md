...
1. Simply input the basic profession or role of the needed NPC.
2. The AI instantly generates their name, defining physical trait, speaking tone, and a unique **'Small Habit'**.
3. It seamlessly adds a hidden **'Secret'** or **'Desire'** to give the character instant narrative depth and potential quest hooks.

---

## 🚀 The Solution: "10-Second NPC Factory"
...
> **Context:**
>
> - Background: The players have suddenly engaged in conversation with an unplanned passerby or a specific background character.
> - Goal: I need to seamlessly roleplay this character impromptu without breaking immersion.
>
> **Task:**
>
> 1. Quickly generate a highly actable **Profile** for this NPC.
>    - **Name:** (Memorable and fitting the setting)
>    - **Appearance:** (One striking visual feature. e.g., A bright red nose, a missing earlobe)
>    - **Tone/Personality:** (Clear acting directions. e.g., Trails off at the end of sentences, quick-tempered and loud)
>    - **Quirk/Habit:** (A physical action to perform during the conversation. e.g., Constantly flipping a coin, scratching their neck)
> 2. Add one **Hidden Secret** or **Immediate Dilemma** this NPC is dealing with, which could serve as a potential quest hook.
>
> **Constraints:**
>
> - Keep it concise. Format the output using easily scannable bullet points.
> - The descriptions must be intuitive and immediately actionable for a Game Master.
> - Do not invent overly complex lore; keep it grounded.
>
> **Variables:**
>
> - `[Job/Role]`: `[Insert Job/Role here, e.g., Suspicious peddler, Cowardly guard]`
> - `[Race/Gender]`: `[Insert Race/Gender here, e.g., Dwarf Female, Elf Male]`
...
```text
- **Name:** Brog
- **Appearance:** A thick, braided beard that's visibly singed in places. A severe, jagged burn scar runs up his right forearm.
- **Tone:** Blunt, loud, and incredibly impatient. Habitually ends his sentences with, "So, are ya buying or what?!"
- **Habit:** Rhythmically taps his heavy hammer against the side of his anvil while talking to you.
- **Secret:** He actually possesses the lost skill to forge legendary mythril weapons, but he accidentally caused his son's death with one of his own creations in the past. Now, he swears to only make simple farming tools and horseshoes.
```
