...
title: "🎵 Une touche de sensibilité à la Olivia Dean : Le prompt magique qui redonne vie aux textes sans âme"
author: "Jay"
date: "2026-03-01"
...
- **🤖 Modèles recommandés :** Toutes les IA conversationnelles (Claude 3.5 Sonnet, ChatGPT, Gemini, etc.)
- ⭐ **Difficulté :** ⭐⭐☆☆☆
- ⚡️ **Efficacité :** ⭐⭐⭐⭐⭐
- 🚀 **Utilité :** ⭐⭐⭐⭐⭐
...
## 🚀 La solution : "Le concepteur-rédacteur acoustique 100 % authentique"

### 🥉 Version basique (Basic Version)

Idéale pour obtenir des résultats percutants en un minimum de temps.

> **Rôle :** Tu es un concepteur-rédacteur expert en écriture émotionnelle et sincère.
> **Tâche :** Rédige un texte promotionnel destiné aux réseaux sociaux pour `[Nom de la marque/Nom du produit]`. Attention : bannis tous les superlatifs publicitaires exagérés et adopte un ton simple et naturel, comme si tu t'adressais à un ami proche.
...
> **Tâche :**
> 
> 1. En te basant sur la valeur fondamentale fournie, rédige une histoire de marque qui s'intègre naturellement dans le quotidien du client. Décline-la en 3 versions : une pour Instagram, une pour une newsletter, et une pour l'introduction d'un article de blog.
> 2. Les variables `[Nom de la marque]`, `[Produit/Service]` et `[Valeur fondamentale]` seront fournies ci-dessous.
> 3. N'utilise sous aucun prétexte les expressions clichées typiques de l'IA (« innovant », « l'expérience ultime », « la meilleure solution », « nous vous offrons », etc.).
>
> **Contraintes :**
> 
> - Sépare clairement chaque version à l'aide de listes à puces (en incluant des émojis).
> - N'utilise absolument aucun format de tableau.
> - Imagine-toi en train de jouer dans la rue, accompagné seulement d'une guitare acoustique : élimine toute rhétorique flamboyante tout en maintenant une tonalité captivante du début à la fin.
>
> **Avertissement :**
> 
> - N'invente aucune information contraire aux faits (Prévention des hallucinations).
> - La nature du produit ne doit pas être occultée par un excès de sentimentalisme. Veille à souligner clairement les avantages concrets pour le client.
...
### ✅ Après (En précisant l'idée d'un "thermos au design un peu brut mais qui conserve parfaitement la chaleur" dans la version Pro)
