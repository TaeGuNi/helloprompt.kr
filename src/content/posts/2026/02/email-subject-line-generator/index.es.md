...
description: "Evita la bandeja de spam y dispara tus conversiones. Descubre cómo redactar asuntos de correo irresistibles que tus clientes no podrán ignorar."
tags:
  [
...
> **Contexto (Context):**
>
> - Tipo de correo: `[Ej. Lanzamiento de producto, Newsletter semanal, Alerta de carrito abandonado]`
> - Objetivo principal: Lograr que el destinatario abra el correo de inmediato y lea la oferta central.
>
> **Solicitud (Task):**
>
...
>
> - El asunto no debe superar los 40 caracteres para garantizar su legibilidad en pantallas móviles.
> - Prohibido usar palabras que activen los filtros de spam (ej. "Gratis", "Promoción", "Descuento", "Oferta", "$$$"). Transmite estos conceptos de forma creativa e indirecta.
> - Formato de salida: Muestra los resultados en una tabla Markdown con las siguientes columnas: [Estrategia | Asunto | Texto de Vista Previa].
>
> **Advertencia (Warning):**
>
> - Huye del tono puramente comercial o publicitario. El mensaje debe sentirse orgánico y cercano, como si lo enviara un colega de confianza.
