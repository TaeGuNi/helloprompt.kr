...
## 🚀 La Soluzione: "Il Pianificatore di Bestseller"

### 🥉 Basic Version (Versione Base)

Ideale per superare la sindrome da pagina bianca e ottenere una bozza rapida.
...
Utilizza questo prompt per un livello di dettaglio professionale, pronto per essere inviato agli editori.

> **Ruolo (Role):** Sei il `[Caporedattore di punta di una prestigiosa casa editrice commerciale]`, specializzato nel trasformare idee di nicchia in bestseller nazionali.
>
> **Contesto (Context):**
>
> - Contesto: Ho intenzione di scrivere un `[Libro cartaceo/E-book]` incentrato su `[Argomento/Esperienza personale]`.
> - Obiettivo: Voglio creare un manuale che offra soluzioni estremamente pratiche ai lettori e che, allo stesso tempo, garantisca un alto volume di vendite, catturando l'attenzione fin dalla copertina.
>
> **Richiesta (Task):**
>
> 1. Proponi 3 combinazioni di Titolo e Sottotitolo magnetici, pensati per spiccare sugli scaffali delle librerie e catturare l'attenzione del target.
> 2. Costruisci un Indice strutturato in 4-5 Parti principali, assicurando un flusso narrativo logico e avvincente.
> 3. Per ogni Parte, scrivi i titoli dei singoli capitoli formulandoli in modo da stimolare la curiosità bruciante del lettore.
> 4. Definisci chiaramente l'intento editoriale (Pitch) e traccia l'identikit del pubblico target primario.
>
> **Variabili (Variables):**
>
> - Argomento/Esperienza personale: La storia di successo finanziario di un normale impiegato trentenne (Niente azioni, niente immobili, solo risparmio estremo e side hustle strategici).
>
...
> **Avvertenza (Warning):**
>
> - Mantieni un tono realistico e pragmatico. Evita titoli eccessivamente sensazionalistici o promesse irrealizzabili.
...
> **Indice (Estratto):**
>
> - **Parte 1: La bugia del "Devi Investire per Arricchirti"**
>   - Capitolo 1: Perché il mercato azionario non è il tuo salvatore (e cosa lo è)
>   - Capitolo 2: L'auditing della tua vita: trovare i soldi nascosti nella routine
> - **Parte 2: L'Arte del Risparmio Estremo (Senza Vivere da Eremita)**
>   - ...
