...
## 🚀 La Solution : "Le Gestionnaire de Risques"
...
Utilisez ce prompt détaillé pour un plan financier personnalisé et directement applicable. Copiez-collez le texte ci-dessous et remplissez les variables entre crochets.

> **Rôle (Role) :** Tu es un conseiller financier expert en gestion des risques et en finances personnelles.
>
> **Contexte (Context) :**
>
...
> **Tâche (Task) :**
>
> 1. En tenant compte de la stabilité de mon statut professionnel, indique-moi **combien de mois de dépenses fixes** je dois absolument sécuriser.
> 2. Calcule le **Montant Cible de mon Fonds d'Urgence**.
> 3. Recommande-moi des **types de supports financiers spécifiques** (livrets réglementés, comptes à terme flexibles, etc.) pour stocker cet argent, en maximisant la sécurité et la liquidité.
> 4. Sachant que mon fonds d'urgence actuel est de `[0 €]`, propose-moi un plan d'épargne mensuel réaliste pour atteindre cet objectif, avec une date de complétion estimée.
>
> **Contraintes (Constraints) :**
>
> - Sois plus conservateur (prévois une marge plus large) pour un profil freelance/indépendant que pour un salarié en CDI.
> - Condition sine qua non : cet argent doit être retirable instantanément ou sous 24h, sans pénalité.
> - Présente le résultat final sous forme de points clairs et de listes à puces pour une lecture optimale.
>
> **Avertissement (Warning) :**
>
> - Ne me propose pas de produits financiers bloqués (comme l'assurance-vie à long terme ou la bourse) pour ce fonds spécifique. Reste strictement sur de l'épargne de précaution liquide.
...
```text
### 🛡️ Votre Stratégie de Fonds d'Urgence Personnalisée (Profil Freelance)

**1. Horizon de couverture recommandé : Minimum 6 mois**
En tant que designer freelance, vos revenus sont par nature irréguliers. Contrairement à un salarié en CDI (qui peut se contenter de 3 mois), vous avez besoin d'un double filet de sécurité pour pallier d'éventuels retards de paiement, baisses d'activité ou problèmes de santé.

**2. Montant Cible du Fonds d'Urgence**
- Dépenses incompressibles : 2 000 € / mois
- Durée de couverture : 6 mois
- **Capital total à sécuriser : 12 000 €**

**3. Supports d'épargne recommandés (Liquidité maximale)**
Pour stocker ces 12 000 €, voici les options idéales (accessibles et sans risque) :
- **Livret A / LDDS :** Parfait pour une disponibilité immédiate et sans impôts (taux réglementé).
- **Livrets bancaires boostés (Comptes à vue rémunérés) :** Si vos plafonds sont atteints, optez pour des livrets bancaires classiques offrant un accès en 24h.
*Ne placez jamais cet argent sur un PEA ou une assurance-vie avec frais de rachat bloquants.*

**4. Votre Plan d'Accumulation Réaliste**
Puisque votre solde de départ est de 0 €, voici une stratégie pour atteindre l'objectif sans vous asphyxier :
- **Épargne agressive (Les 3 premiers mois) :** Mettez de côté 1 000 €/mois si possible, pour atteindre rapidement un premier palier de 3 000 € (1,5 mois de survie).
- **Épargne de croisière :** Une fois le palier de 3 000 € atteint, vous pouvez épargner 500 € par mois.
- **Date cible :** À raison de 500 € à 1 000 € par mois, votre fonds sera complet d'ici **12 à 18 mois**.
```
