...
- **🤖 Modelo Recomendado:** ChatGPT-4o (Rápido & Dinâmico) ou Claude 3.5 Sonnet
...
## 🚀 A Solução: "Gerador de Shorts Virais"
...
> **Situação (Context):**
>
> - Tema: `[Top 3 Achados Incríveis da Ikea]`
> - Objetivo: Criar um roteiro de vídeo curto altamente engajador, pronto para gravação.
>
> **Tarefa (Task):**
>
> Escreva um roteiro de Shorts com exatamente 59 segundos sobre o tema acima. Siga rigorosamente esta estrutura:
>
> 1. **Hook (0~3s):** Um impacto visual ou verbal que impeça o usuário de rolar a tela. (Uma pergunta instigante, uma ação inesperada ou um fato chocante).
> 2. **Body (4~50s):** A entrega do conteúdo em si. O ritmo deve ser acelerado e dinâmico. (Corte qualquer introdução desnecessária, vá direto ao ponto).
> 3. **CTA (51~59s):** Uma chamada à ação clara (Inscrição, Curtida ou Comentário).
>
> **Restrições (Constraints):**
>
> - O formato de saída deve ser obrigatoriamente uma tabela Markdown com as seguintes colunas: | Tempo | Visual (Ação/Câmera) | Áudio (O que será falado) |.
> - Apenas forneça a tabela diretamente, sem avisos prévios.
> - `[Variáveis]` devem ser indicadas com colchetes para que eu possa preencher depois.
>
> **Tom de Voz (Tone):**
>
> - Casual, alta energia, ritmo acelerado, como se estivesse contando um segredo para o seu melhor amigo.
...
_(Sem impacto visual e com introdução lenta)_
"Olá a todos! Hoje vou apresentar para vocês alguns itens muito bons que encontrei na Ikea. O primeiro deles é..." (O espectador já rolou para o próximo vídeo 👋)

### ✅ Depois (Com o Prompt Pro)

**(0~3s) Hook**

- **Visual:** O criador amassa agressivamente um recibo antigo e joga no chão, olhando fixamente para a câmera.
- **Áudio:** "Você ainda gasta dinheiro à toa na Ikea? Todo funcionário usa esses 3 itens secretos. Compre só isso e me agradeça depois!"
