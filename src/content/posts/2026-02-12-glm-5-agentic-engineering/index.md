...
# (Updated) (Updated) (Updated) 📝 GLM-5: 에이전트 엔지니어링의 서막
...
## (Updated) (Updated) (Updated) 🚀 주요 특징

### (Updated) (Updated) (Updated) 1. Agentic Capabilities (에이전트 능력)

기존 모델들이 사용자의 지시에 따라 코드를 짜는 '수동적' 역할에 머물렀다면, GLM-5는 스스로 문제를 정의하고 해결책을 설계하는 '능동적' 에이전트 능력을 대폭 강화했습니다.

### (Updated) (Updated) (Updated) 2. Vibe Coding
