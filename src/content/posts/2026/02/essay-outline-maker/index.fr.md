...
1. **Structuration immédiate :** Génère un plan logique (Introduction, Développement, Conclusion) à partir d'un simple sujet.
2. **Guidage pas-à-pas :** Propose des arguments clés et des exemples concrets pour nourrir chaque paragraphe de votre texte.
3. **Accroches percutantes :** Vous fournit une phrase d'ouverture captivante (Hook) et une conclusion mémorable pour marquer les esprits.

---

## 🚀 La Solution : « L'Architecte de Plan »
...
> **Contexte (Context) :**
>
> - Sujet : Je dois rédiger une dissertation/un rapport/un article sur `[Sujet, ex : L'IA remplacera-t-elle les emplois humains ?]`.
> - Mon point de vue : Mon argument central est que `[Argument Central, ex : L'IA détruira certains emplois mais créera de nouvelles opportunités uniques]`.
> - Problème : J'ai du mal à organiser mes idées pour rendre mon texte fluide, logique et persuasif.
>
> **Tâche (Task) :**
>
> 1. **[Création du Plan]** : Conçois une structure classique et efficace : Introduction, Développement (en 3 parties thématiques ou dialectiques), Conclusion.
> 2. **[Guide par Paragraphe]** : Pour chaque partie, fournis les mots-clés essentiels, les arguments à développer et le type d'exemples à utiliser.
> 3. **[Accroche & Clôture]** : Rédige une première phrase d'introduction (une accroche ou "Hook" irrésistible pour capter l'attention) et la dernière phrase de la conclusion (une ouverture ou réflexion finale marquante).
>
> **Contraintes (Constraints) :**
>
> - Le fil conducteur (la transition entre les paragraphes) doit être parfaitement naturel et logique.
> - Intègre obligatoirement l'anticipation d'un contre-argument (antithèse) dans le développement pour renforcer ma crédibilité.
> - Le ton doit être professionnel, clair et engageant.
>
> **Attention (Warning) :**
>
> - Ne rédige pas le texte à ma place, fournis uniquement le plan détaillé et les guides de rédaction.
...
### ❌ Avant (Flux de Pensée Chaotique)

```text
L'IA est dangereuse. Mais elle est aussi très pratique. Est-ce que nos emplois vont disparaître ? Peut-être pas tous. De toute façon, il faut bien apprendre à s'en servir si on ne veut pas être dépassé. (Brouillon, sans structure claire).
```
...
1. **Introduction**
   - Contexte : Le parallèle entre la Révolution Industrielle (mouvement des Luddites cassant les métiers à tisser) et la peur actuelle de l'IA.
   - Problématique : L'IA signe-t-elle la fin du travail humain ou le début d'une nouvelle ère de collaboration ?

2. **Développement 1 (La Menace - Thèse)**
   - Argument : L'automatisation inéluctable des tâches répétitives et administratives.
   - Exemples : Traitement de données massif, service client de premier niveau.

3. **Développement 2 (L'Irrémplaçable - Antithèse)**
   - Argument : Les limites de l'IA face aux compétences intrinsèquement humaines.
   - Mots-clés : Intelligence émotionnelle, créativité divergente, jugement éthique, empathie profonde.

4. **Développement 3 (L'Opportunité - Synthèse)**
   - Argument : L'émergence de nouveaux métiers hybrides et la valorisation de la compétence "Centaure" (Humain + IA).
   - Exemples : Ingénieur de prompt, éthicien de l'IA, stratège assisté par algorithme.

5. **Conclusion**
   - Bilan : L'IA est un outil, pas un rival. La vraie compétition n'est pas "Humain vs IA", mais "Humain vs Humain utilisant l'IA".

**[Accroche - Hook]**
"Dans 10 ans, votre patron sera-t-il un algorithme froid, ou une personne qui a appris à maîtriser les algorithmes ?"

**[Réflexion Finale - Clôture]**
"Pour ceux qui craignent le changement, l'IA est une menace foudroyante ; mais pour ceux qui décident de la dompter, elle deviendra la paire d'ailes qui élèvera leur carrière vers de nouveaux sommets."
```
