...
## 🚀 A Solução: "Simulador de Negociação Salarial"
...
> **Context (Contexto):**
>
> - Perfil do funcionário: Sou um profissional com `[Anos]` anos de experiência na área de `[Sua Área]`.
> - Momento: Reunião anual de avaliação de desempenho e negociação salarial.
>
> **Minhas Cartas (Desempenho Comprovado):**
>
> 1. `[Ex: Atingi 120% da meta de vendas no último trimestre]`
> 2. `[Ex: Liderei a implementação do novo sistema que economizou 50h/mês da equipe]`
>
> **Objetivo:**
> Aumentar meu salário atual de `[Salário Atual]` para `[Salário Desejado]`.
>
> **Task (Regras do Jogo):**
>
> 1. Você deve iniciar a negociação. (ex: "Vi seus resultados, mas o cenário econômico da empresa este ano exige cautela...")
> 2. Quando eu apresentar meus argumentos, você deve tentar refutá-los de forma lógica e apontar possíveis falhas ou fatores externos. (ex: "Esse aumento de vendas não foi impulsionado pela tendência do mercado em vez do seu esforço individual?")
> 3. Após 5 trocas de mensagens, encerre a simulação, avalie o resultado final (Sucesso/Parcial/Falha) e forneça um feedback brutalmente honesto sobre minhas habilidades de negociação e a força da minha argumentação.
>
> **Constraints (Restrições):**
>
> - Não seja facilmente convencido. Faça-me suar para conseguir cada porcentagem.
> - Suas respostas devem ser realistas e usar o jargão corporativo padrão do setor de Recursos Humanos.
...
### ❌ Before (Apelo à Emoção)

```text
Eu: "Eu trabalhei muito duro este ano e fiz muitas horas extras. Por favor, me dê um aumento. As coisas estão muito caras ultimamente e eu quero me mudar."
RH (IA): "Compreendo o seu esforço, todos na equipe trabalharam muito. No entanto, devido à política da empresa e ao orçamento restrito deste trimestre, não podemos oferecer um aumento salarial neste momento." (Fim da negociação)
```

### ✅ After (Dados & Lógica)

```text
Eu: "Como você pode ver nos relatórios, superei a meta de vendas em 20%, gerando um lucro adicional de R$ 500.000 para a empresa. Considerando a média salarial do mercado para o meu nível de entrega atual, um reajuste de 15% é um investimento seguro e proporcional para a retenção deste resultado."
RH (IA): "Seus números são de fato impressionantes e reconhecemos isso. No entanto, 15% está acima do nosso teto orçamentário para o seu cargo. O mercado está aquecido, mas considerando sua contribuição direta e nosso limite, posso aprovar um reajuste imediato de 10% aliado a um bônus por performance atrelado às metas do próximo semestre."
```
