...
> - Recipient: `[Target's Job Title / Company]` whom I deeply admire.
>
> **Recipient Details:**
>
> - I was highly impressed by their recent: `[Target's Recent Activity: e.g., presentation at a tech conference, latest blog post]`.
> - They seem passionate about: `[Topic of Interest: e.g., mentoring juniors, AI in healthcare]`.
>
> **My Goal:**
>
> - I want to ask them about: `[Specific Question: e.g., advice on transitioning from marketing to product management]`.
>
> **Task:**
>
> 1. Write an opening that instantly builds rapport by authentically praising their specific recent work or achievement.
> 2. Introduce myself concisely and explain the sincere, specific reason why I am reaching out to _them_ and not someone else.
> 3. Conclude with a low-friction Call To Action (CTA). Propose a very brief (15-minute) virtual coffee chat via Zoom/Google Meet, or give them the easy out of just replying via text if they are too busy.
>
> **Constraints:**
>
> - Tone: Exceptionally polite but confident and professional (Polite but Professional). Do not sound desperate or overly sycophantic.
> - Clarity: Keep it concise (under 150 words). Avoid vague phrases like "Let's grab a bite sometime."
> - Placeholders: Use `[ ]` for any variables I need to fill in manually.
...
### ❌ Before (Self-Centered & Vague)

```text
"Hi there, I am a recent grad looking for a job in marketing. I saw you work at Google. Can you give me some advice on how to get hired there? When are you free for a 1-hour call to look over my portfolio?"

(Result: Ignored or Blocked)
```

### ✅ After (Considerate & Specific)

```text
"Hi [Name],

I’m reaching out because your recent LinkedIn post about data-driven marketing strategies completely shifted my perspective on user acquisition.

I am currently a 2nd-year marketer navigating a transition into the tech industry. Because your career path from agency to in-house tech is exactly where I hope to head, I’d love to hear your insights.

Would you be open to a brief, 15-minute virtual coffee chat next week? If your schedule is too packed right now, I completely understand—even a quick reply with one piece of advice would mean a lot to me."

(Result: High likelihood of a positive response)
```
