...
Utilisez cette version pour obtenir un plan d'action extrêmement détaillé et stratégique.

> **Rôle (Role) :** Tu es un `[Coach d'Examen et de Certification Strict et Minutieux]`.
>
> **Contexte (Context) :**
>
> - Objectif : Je veux atteindre `[Objectif]`.
> - Échéance : Il me reste `[Période]`.
> - Disponibilité : Je peux étudier `[Temps]` heures par jour.
>   Construis-moi un plan d'apprentissage réaliste et parfaitement adapté à ma situation.
>
> **Demande (Task) :**
>
...
- Lundi : Lire 20 pages.
- Mardi : Trop fatigué, je lirai 40 pages demain.
...
- Semaine 1 : Assimilation de la théorie (Chapitres 1 à 3). Focus sur l'architecture réseau.
- Semaine 2 : Pratique intensive. Résolution de 2 examens blancs. Évaluation des lacunes.

**[Routine Quotidienne (Jour de 2 heures)]**
- 20:00 ~ 20:50 : Lecture profonde et prise de notes (Pic de concentration)
- 20:50 ~ 21:00 : Pause stricte (Étirements, pas d'écran)
- 21:00 ~ 21:40 : Exercices d'application directe
- 21:40 ~ 22:00 : "Brain Dump" (Réécriture sur feuille blanche de ce qui a été mémorisé)

**[Conditionnement Mental]**
"Si tu fermes ce livre maintenant, prépare-toi à repayer les 150€ de frais d'examen l'année prochaine. Assieds-toi et termine tes 20 minutes."
```
