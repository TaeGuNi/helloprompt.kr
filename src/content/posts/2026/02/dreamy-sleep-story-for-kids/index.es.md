...
> - Objetivo: Crear una historia inmersiva titulada "El Viaje en el Tren de las Nubes" que le ayude a quedarse dormido plácidamente en menos de 10 minutos.
>
> **Tarea (Task):**
>
...
> 2. Utiliza descripciones sensoriales lánguidas, suaves y acogedoras (colores pastel, el sonido de una brisa suave, textura de algodón, temperatura cálida).
> 3. Escribe el guion para que un padre lo lea en voz alta, dirigiéndose directamente al niño en segunda persona ("tú").
>
> **Restricciones (Constraints):**
>
> - Formato: Utiliza abundantes puntos suspensivos (...) y comas (,) para forzar al lector a hacer pausas largas y hablar a un ritmo muy lento.
> - Tono: Extremadamente monótono, relajante y susurrado. Cero sobresaltos.
> - Contenido: Está estrictamente prohibido incluir villanos, conflictos, ruidos fuertes o cualquier elemento que genere tensión o estado de alerta.
