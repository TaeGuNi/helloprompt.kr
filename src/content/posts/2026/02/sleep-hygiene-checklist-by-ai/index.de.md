...
## 🚀 Lösung: Der persönliche "Schlaf-Architekt"

### 🥉 Basic Version (Für den schnellen Überblick)

Nutzen Sie diesen Prompt, wenn Sie sofortige, pragmatische Tipps ohne tiefgehende Analyse benötigen.
...
> **Rolle (Role):** Du bist ein renommierter Schlafmediziner und Experte für evidenzbasierte Raumgestaltung und Chronobiologie.
>
> **Kontext (Context):**
>
...
### ❌ Before (Gewöhnliche Anfrage)

```text
Input: "Sag mir, wie man besser schläft. Ich bin abends oft am Handy und trainiere spät."

Output: "Um besser zu schlafen, solltest du weniger am Handy sein, da das Licht schlecht ist. Trinke abends warme Milch oder Kamillentee und versuche, dich vor dem Schlafen zu entspannen. Mache auch keinen anstrengenden Sport mehr am späten Abend." (Zu generisch, keine echte Handlungsanweisung)
```

### ✅ After (Ergebnis mit Pro-Prompt)

```text
[TOP 3 Gravierendste Störfaktoren & Aktionspunkte]

1. Melatonin-Unterdrückung durch Blaulicht (Smartphone): Das blaue Lichtspektrum signalisiert der inneren Uhr, dass es Tag ist, was die Ausschüttung des Schlafhormons Melatonin drastisch hemmt.
   -> Aktionspunkt: Verbanne das Smartphone aus dem Schlafzimmer. Nutze einen analogen Wecker. Wenn du lesen möchtest, nutze ein physisches Buch unter einer warmweißen Leselampe (< 2700 Kelvin).

2. Erhöhte Körperkerntemperatur durch spätes Training: Für den Eintritt in den Tiefschlaf muss die Körperkerntemperatur um etwa 1 Grad sinken. Intensives Training hält Temperatur und Cortisolspiegel bis tief in die Nacht künstlich hoch.
   -> Aktionspunkt: Verlege das Workout auf mindestens 3-4 Stunden vor dem Zubettgehen. Etabliere ab 21 Uhr eine "Cool-Down-Routine" mit sanftem Stretching, um den Parasympathikus zu aktivieren.

3. Lichtverschmutzung (Keine Verdunkelung & Standby-Lichter): Selbst minimale Lichtquellen durchdringen die geschlossenen Augenlider und stören die Architektur der REM- und Tiefschlafphasen.
   -> Aktionspunkt: Besorge dir eine hochwertige, konturierte 3D-Schlafmaske (um Druck auf die Augen zu vermeiden). Klebe sämtliche Standby-LEDs im Raum (TV, Ladekabel) mit Dimming-Tape ab.
```
