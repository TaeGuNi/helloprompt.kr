...
## 🚀 A Solução: "Shadowing Coach Prompt"
...
```text
Fala: "What are you talking about?"
Pronúncia: Uót! Ar! Iu! Tó-kin! A-báut! (Leitura mecânica e pausada, dando ênfase a todas as palavras 🤖)
Emoção: Leitura seca de livro didático.
```

### ✅ Depois (Com Coaching da IA)

```text
Fala: "What are you talking about?"
Linking e Entonação: "uá-râ-iu tó-quin-a-báut?" (o "what" e o "are" se conectam suavemente 🇺🇸)
Direção de Atuação: Franze levemente a testa e solte a palavra 'talking' com força, como se estivesse incrédulo com o absurdo que a outra pessoa está dizendo.
```
