...
Utilize esta estrutura para alcançar qualidade de estúdio e controle minucioso sobre os detalhes e a atmosfera da imagem.

> **Papel (Role):** Você é um Diretor de Arte experiente especializado em ilustrações botânicas e arquitetônicas.
>
> **Contexto (Context):**
>
...
> **Solicitação (Task):**
>
> 1. Gere um prompt de geração de imagem detalhado utilizando a estrutura abaixo.
> 2. Preencha as partes entre colchetes `[ ]` com detalhes específicos da cena desejada.
>
> **Estrutura do Prompt a ser gerada:**
>
> - **Subject:** `[Descreva o tema principal, ex: Um canto aconchegante de um café em Paris, com cadeiras e mesas na calçada, e uma bicicleta]`
...
> - **Parameters (Midjourney):** --ar `[Proporção, ex: 4:3]` --v 6.0 --stylize 250
>
...
> **Aviso (Warning):**
>
> - Não inclua elementos hiper-realistas ou renderizações em 3D. A essência deve ser estritamente ilustrativa e analógica.
