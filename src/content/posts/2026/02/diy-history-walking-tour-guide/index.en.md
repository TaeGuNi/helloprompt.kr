...
Deploy this prompt when you want a highly detailed, professional-grade itinerary infused with rich, immersive historical storytelling.
...
1. **Role Playing:** Assigning the AI the hyper-specific persona of a "master Storytelling Tour Planner" forces it to adopt an engaging, narrative-driven tone. Without this, the model defaults to spitting out a sterile, encyclopedic list of dry facts. We want a storyteller, not a textbook.
2. **Context & Logistics Constraint:** By explicitly restricting the route to exactly 3km and 3 hours, we act as an anchor. This prevents the AI from hallucinating an unrealistic, sprawling itinerary that looks great on paper but would be physically exhausting and practically impossible to complete in a single half-day.
3. **Google Maps Compatibility:** Specifically requesting the original, local-language names is a crucial logistical safety net. It averts the deeply frustrating experience of trying to search for an awkwardly translated monument name on a foreign map application, saving you from getting lost in translation.
...
_(Result: A generic, exhausting checklist featuring Buckingham Palace, the London Eye, and Big Ben, lacking any logical walking path or cohesive thematic connection. It's a recipe for sore feet and tourist burnout.)_
...
>
> _(Result: A cohesive, 2.5km thematic journey complete with engaging trivia about the Victorian era and Holmes' enduring legacy at each specific stop, perfectly paced and featuring a strategically timed coffee break.)_
