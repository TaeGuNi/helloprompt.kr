...
## 🚀 The Solution: "The Master Pitch Outline"
...
```text
User: Make an outline for a presentation about our Q3 sales drop.
AI:
Slide 1: Introduction to Q3
Slide 2: Why Sales Dropped
Slide 3: Competitor Analysis
Slide 4: What We Can Do Next
...
```text
Slide 1: The Q3 Reality Check
- Key Message: We face a temporary setback, but the path to recovery is clear.
- Talking Points: Acknowledge the 15% drop; state the goal of today's meeting (securing the Q4 campaign budget).
- Visual Suggestion: A stark, simple metric highlighting the 15% dip, juxtaposed with a bold "Recovery Plan" arrow pointing upward.

Slide 2: The Competitor Squeeze (Problem)
- Key Message: Aggressive pricing from NewCo eroded our market share in the mid-tier segment.
- Talking Points: NewCo launched in August; our mid-tier customer churn spiked by 8%.
- Visual Suggestion: Stacked bar chart comparing our market share vs. NewCo over the last 3 months.
...
```
