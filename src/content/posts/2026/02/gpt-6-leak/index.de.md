...
## 🚀 Lösung: Der "Long-Horizon Planning" Prompt
...
Maximale Detailtiefe für komplexe, unternehmenskritische Vorhaben. Dieser Prompt emuliert die tiefgreifende Planung, die für die nächste Modellgeneration erwartet wird.

> **Rolle (Role):** Du bist ein Chief Strategy Officer (CSO) mit herausragender Expertise in "Long-Horizon Planning" und Systemdenken.
>
> **Kontext (Context):**
>
> - Hintergrund: Wir planen `[Beschreibung des Vorhabens, z. B. die Markteinführung eines neuen B2B-SaaS-Produkts]`.
> - Ziel: Ein wasserdichter, mehrstufiger Strategieplan für die nächsten `[Anzahl, z. B. 18]` Monate, der unvorhergesehene Marktveränderungen proaktiv antizipiert.
>
> **Aufgabe (Task):**
>
> 1. Erstelle eine detaillierte Roadmap, aufgeteilt in Quartale.
> 2. Identifiziere für jeden Meilenstein die versteckten Abhängigkeiten (Second-Order Effects).
> 3. Entwickle proaktive Ausweichpläne (Contingency Plans) für die 3 größten identifizierten Risiken.
>
> **Einschränkungen (Constraints):**
>
> - Denke in Systemen: Jede Aktion muss als Ursache für eine zukünftige Wirkung betrachtet werden.
> - Formatiere die finale Roadmap übersichtlich in einer Markdown-Tabelle (mit den Spalten: Quartal, Meilenstein, Abhängigkeiten, Risiko, Ausweichplan).
>
> **Warnung (Warning):**
>
> - Vermeide oberflächliche Floskeln. Wenn Daten zur Markteinschätzung fehlen, weise explizit auf diese Wissenslücken hin. Keine Halluzinationen von Markttrends erzeugen.
...
```markdown
| Quartal | Meilenstein        | Abhängigkeiten (Second-Order)            | Größtes Risiko                       | Ausweichplan (Contingency)                                                                   |
| :------ | :----------------- | :--------------------------------------- | :----------------------------------- | :------------------------------------------------------------------------------------------- |
| **Q1**  | Beta-Release       | API-Fertigstellung durch Backend-Team    | Verzögerung bei der API-Integration  | Reduzierung des Beta-Feature-Sets auf Kernfunktionen, um Zeitplan zu halten.                 |
