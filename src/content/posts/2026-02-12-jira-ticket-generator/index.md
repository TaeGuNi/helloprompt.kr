...
# (Updated) (Updated) 🎫 Jira 티켓 자동 생성: 기획서만 넣으면 개발 티켓 10개가 뚝딱
...
## (Updated) (Updated) 🚀 해결책: "Backlog Generator Prompt"

### (Updated) (Updated) 🥉 Basic Version (단순 리스트)
...
### (Updated) (Updated) ❌ Before (통짜 티켓)

티켓명: "장바구니 기능 개발"
설명: "기획서 참고하세요."
(개발자: "뭘 하라는 거야? 어디서부터 해?")

### (Updated) (Updated) ✅ After (구조화된 티켓)
