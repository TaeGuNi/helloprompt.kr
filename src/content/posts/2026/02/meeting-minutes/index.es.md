...
## 🚀 La Solución: "El Asistente de Actas Perfecto"
...
> **Contexto (Context):**
>
> - Acabamos de finalizar una reunión sobre `[Tema de la reunión]`.
> - Te proporcionaré la transcripción cruda generada automáticamente, la cual puede contener errores de reconocimiento de voz, pausas o diálogos cruzados.
>
> **Tarea (Task):**
>
> Analiza la transcripción y redacta un acta de reunión profesional estructurada de la siguiente manera:
>
> 1. **Resumen Ejecutivo:** Un párrafo (máximo 3 líneas) con el objetivo principal y la conclusión general de la reunión.
> 2. **Decisiones Clave:** Lista en viñetas de los acuerdos definitivos tomados.
> 3. **Plan de Acción (Next Steps):** Formato claro indicando `[Qué hacer]` - `[Quién es el responsable]` - `[Fecha límite]`. Si falta algún dato, indícalo como "Por definir".
> 4. **Temas Pendientes (Parking Lot):** Ideas o problemas mencionados que se pospusieron para futuras reuniones.
>
> **Restricciones (Constraints):**
>
> - El tono debe ser estrictamente profesional, corporativo y objetivo.
> - Ignora la charla informal ("small talk"), saludos, pausas y despedidas.
> - Utiliza formato Markdown para estructurar el documento (negritas, listas, encabezados).
>
> **Advertencia (Warning):**
>
> - Limítate estrictamente a la información presente en la transcripción. NO inventes acuerdos, fechas ni responsables si no se mencionan explícitamente.
>
> **Transcripción:**
>
> `[Pega la transcripción aquí]`
...
### ❌ Antes (Transcripción cruda de Teams)

```text
Juan: Hola, me escuchan? Bueno, eh, sobre el proyecto Alpha, creo que el diseño está bien pero falta el logo.
María: Sí, el logo. Yo hablé con la agencia ayer. Dijeron que para el viernes lo tienen listo.
Juan: Perfecto. Ah, y Carlos, tú tienes que revisar el presupuesto del servidor, ¿no?
Carlos: Sí, ando en eso. ¿Para cuándo lo necesitan exactamente?
Juan: Pues idealmente para el miércoles. Ah, me avisan que ya llegó el almuerzo a la oficina.
María: Vale, entonces yo hago seguimiento a la agencia y Carlos ve lo del servidor.
```

### ✅ Después (Acta generada)

```markdown
### Resumen Ejecutivo

Se revisó el estado actual del Proyecto Alpha, logrando alinear los próximos pasos para la entrega de activos de diseño y la aprobación de la infraestructura técnica.

### Decisiones Clave

- El diseño actual del Proyecto Alpha está aprobado, a la espera únicamente de la integración del logotipo final.

### Plan de Acción (Next Steps)

- **Seguimiento con la agencia para la entrega del logo** - María - Viernes.
- **Revisión del presupuesto del servidor** - Carlos - Miércoles.

### Temas Pendientes (Parking Lot)
...
Deja de ser el "tomador de notas" oficial de tu equipo. Con este flujo de trabajo, puedes centrar toda tu atención y energía en aportar valor estratégico durante la reunión, sabiendo que la tediosa gestión administrativa está completamente cubierta por tu asistente de IA.

¡Recupera tu tiempo y sal a tu hora! 🍷
