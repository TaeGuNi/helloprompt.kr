...
## 🚀 La Soluzione: "Generatore di Incipit (Hook)"
...
> **Dettagli dell'Opera:**
>
> - Genere: `[es. Fantasy Romantico, Apocalisse Zombie, Thriller Noir]`
> - Protagonista: `[es. Assassino in pensione, Antagonista reincarnata]`
> - Evento Centrale: `[es. Il protagonista si sveglia al proprio funerale]`
>
> **Richiesta (Task):**
>
...
> 5. Atmosfera/Setting: Una descrizione immersiva e travolgente.
>    (Usa la tua creatività per le restanti 5 frasi)
>
> **Vincoli (Constraints):**
>
...
- **Q: Questo prompt funziona bene anche con la versione gratuita di ChatGPT?**
  - A: Assolutamente sì. Tuttavia, modelli più avanzati come GPT-4 o Claude 3.5 Sonnet tendono a produrre metafore meno scontate e stili di scrittura più raffinati.

- **Q: Posso usarlo per scrivere l'incipit di un saggio o di un testo non-fiction?**
  - A: Certo! Ti basterà modificare i "Dettagli dell'Opera" inserendo l'argomento centrale del tuo saggio e chiedendo tecniche di hook adatte alla saggistica (es. statistica scioccante, aneddoto storico provocatorio).
...
"Il protagonista è morto ed è tornato in vita."

### ✅ Dopo (Risultato dell'IA)

1. **[Dichiarazione Scioccante]** "Il mio funerale si è rivelato una festa decisamente più grandiosa di quanto mi aspettassi."
2. **[In Media Res]** "Prendere a calci il coperchio di una bara dall'interno richiede molta più forza muscolare di quanto si possa immaginare."
3. **[Mistero]** "Chi ha detto che la morte è la fine? Quella era un'evidente, banale frode."
