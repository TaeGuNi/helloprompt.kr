...
## 🚀 La Solution : Le Prompt "Ninja du Bien-être"

### 🥉 Version Basique

Pour un soulagement immédiat sans entrer dans les détails.
...
Pour une routine ultra-personnalisée et parfaitement camouflée.

> **Rôle (Role) :** Tu es un kinésithérapeute expert en ergonomie de bureau et un maître du camouflage en entreprise.
>
> **Contexte (Context) :**
>
> - Situation : Je suis actuellement à mon poste de travail dans un open space très fréquenté.
> - Problème : J'ai des tensions sévères au niveau de `[la nuque et l'épaule droite]`. Se lever ou faire des mouvements amples attirerait immédiatement l'attention.
>
> **Tâche (Task) :**
>
...
> **Requête :** "Donne-moi des étirements pour le bureau."

```text
(Résultat de l'IA)
Tenez-vous debout, les pieds écartés de la largeur des épaules. Levez les bras au ciel et penchez-vous lentement vers la gauche, puis vers la droite, en respirant profondément...
(Résultat : Tout l'open space vous regarde bizarrement).
```
...
```text
(Résultat de l'IA)
[Routine d'Étirement Furtif : Le Penseur]

1. L'Alibi de la Réflexion Profonde (Étirement cervical) :
   - L'action : Placez le bout de vos doigts sur votre front comme si vous souteniez votre tête. En réalité, poussez légèrement votre tête contre vos doigts tout en résistant avec votre cou (contraction isométrique). Maintenez 5 secondes.
   - L'Alibi : Vous avez l'air d'un professionnel très concentré en train d'analyser un tableau de bord complexe. Personne ne se doute que vous musclez vos cervicales.

2. Le Tiroir Imaginaire (Étirement des poignets) :
   - L'action : Sous le bureau, pressez fermement vos deux paumes l'une contre l'autre, doigts pointés vers le bas, tout en gardant les épaules basses.
   - L'Alibi : Mouvement totalement invisible sous la table.
```
