...
1. As palavras-chave `Bokeh` e `Blurry background` são os gatilhos definitivos para ativar o efeito.
2. Especifique configurações reais de lentes fotográficas no prompt, como `Shallow depth of field` ou `f/1.2 aperture`.
3. Cenários noturnos ou repletos de luzes neon (como metrópoles chuvosas) geram os resultados estéticos mais impressionantes.
...
Ideal para quando você precisa de um resultado rápido e direto ao ponto na sua rotina acelerada.

> **Papel:** Você é um `[Especialista em Fotografia de Retrato]`.
> **Solicitação:** Gere uma imagem focada em `[Assunto Principal]`, aplicando um desfoque intenso no fundo para criar um efeito bokeh altamente pronunciado.

### 🥇 Versão Pro (Pro Version)

Ideal para diretores de arte e criadores que exigem controle absoluto sobre a estética, a volumetria da iluminação e a qualidade cinematográfica da composição final.

> **Papel (Role):** Você é um diretor de fotografia premiado em Hollywood, especializado em retratos noturnos e iluminação cinematográfica.
>
> **Situação (Context):**
>
> - Cenário de fundo: `[Ruas chuvosas de uma metrópole à noite]`
> - Objetivo principal: `[Destacar o protagonista com foco absoluto e texturas hiper-realistas, transformando o cenário de fundo em esferas de luz abstratas e desfocadas]`
>
> **Solicitação (Task):**
>
> 1. Adapte as variáveis no prompt de imagem abaixo e gere o resultado final de altíssima fidelidade.
> 2. Substitua o `[Assunto Principal]` e o `[Cenário de Fundo]` de acordo com a necessidade específica do seu projeto.
>
> **Prompt de Imagem (Copie e cole):**
> **Subject:** `[Retrato em close-up de um músico de jazz tocando saxofone]` em uma `[rua chuvosa e iluminada por neon à noite]`.
...
>
> - Mantenha estritamente as especificações da lente da câmera (`f/1.2 aperture`) e a profundidade de campo (`shallow depth of field`).
>
> **Aviso (Warning):**
>
...
- **Q: Esse prompt mantém a consistência se eu usá-lo no DALL-E 3 (via ChatGPT)?**
...
_(Resultado: Uma imagem desastrosamente plana e visualmente poluída. Letreiros de lojas, carros distantes e vitrines ao fundo aparecem quase tão nítidos quanto o protagonista, gerando uma tremenda confusão visual que rouba toda a atenção do espectador.)_

### ✅ Depois (Resultado Pro)

Usando o prompt de engenharia avançada com `Bokeh background`, `f/1.2 aperture` e `Cinematic mood`.

_(Resultado: Um retrato noturno dramático e emocionalmente envolvente. O músico exibe texturas incrivelmente detalhadas na pele e no instrumento, enquanto as intensas luzes neon da cidade ao fundo se dissolvem em círculos mágicos, suaves e coloridos. O impacto visual e o isolamento do sujeito são absolutos!)_

---

## 🎯 Conclusão

A estética premium e o nível de produção de uma fotografia profissional de Hollywood estão, agora, literalmente a um prompt de distância. Ao dominar a ciência por trás do efeito Bokeh e da profundidade de campo, qualquer imagem que você gerar por IA deixará de ser apenas um "gráfico legal" para adquirir um peso artístico profundo e uma ressonância emocional inigualável.

Agora é a sua vez de assumir a direção de fotografia e criar obras-primas irretocáveis. Encerre o expediente mais cedo! 🍷
