...
description: "Magische Worte für Eltern: So entschärfen Sie kindliche Wutanfälle empathisch und hochwirksam in Rekordzeit. Erfahren Sie mehr über die praktische Anwendung von KI-Prompts."
...
- **🤖 Empfohlenes Modell:** ChatGPT (Plus), Claude 3, Gemini Advanced
...
## 🚀 Lösung: Der "Erziehungs-Kompass" Prompt
...
Nutzen Sie diesen detaillierten Prompt, wenn Sie maßgeschneiderte Skripte für spezifische, wiederkehrende Konfliktsituationen benötigen.

> **Rolle (Role):** Du bist ein renommierter Kinderpsychologe (ähnlich wie Jesper Juul oder Dr. Oh Eun-young), der auf bedürfnisorientierte Erziehung und Emotionscoaching spezialisiert ist.
>
> **Kontext (Context):**
>
> - Situation: Mein Kind (Alter: `[Alter des Kindes]`) wirft sich im Supermarkt auf den Boden und schreit ohrenbetäubend, weil es `[Gegenstand der Begierde, z.B. Gummibärchen]` haben möchte.
> - Vorgeschichte: Wir hatten vor dem Einkaufen klar vereinbart, dass wir heute keine Süßigkeiten kaufen.
>
> **Aufgabe (Task):**
>
> 1. Formuliere einen "Türöffner-Satz" (Empathie/Mirroring), der dem Kind sofort signalisiert: "Ich sehe und verstehe deinen Frust".
> 2. Entwickle ein kurzes Gesprächsskript. Dieses muss liebevoll, aber absolut konsequent an der Abmachung festhalten (Nein bleibt Nein).
> 3. Biete eine attraktive, aber realistische Alternative an, um das Kind aus der Frustrationsspirale zu holen (z.B. eine gemeinsame Aktivität zu Hause).
>
> **Einschränkungen (Constraints):**
>
> - Vermeide strikt toxische, beschämende oder befehlende Phrasen wie "Hör auf zu weinen", "Sei nicht so trotzig" oder "Du blamierst uns".
> - Das Skript muss der psychologischen Reihenfolge folgen: 1. Emotion validieren -> 2. Sanfte Grenze setzen -> 3. Alternative/Lösung vorschlagen.
> - Halte die Sätze kurz und kindgerecht.
...
- **Q: Kann ich den Prompt auch für ältere Kinder (z.B. 10 Jahre alt) verwenden?**
...
### ✅ After (KI-generiertes, empathisches Skript)

```text
1. Empathie: "Oh wow, ich sehe, du bist gerade richtig wütend und traurig. Du wolltest diese Gummibärchen unbedingt haben, nicht wahr? Sie sehen auch wirklich lecker aus."
2. Grenze: "Aber weißt du noch, was wir vor dem Einkaufen besprochen haben? Heute ist unser 'Nur-Gucken-Tag' für Süßigkeiten."
3. Alternative: "Komm, wir suchen schnell die Äpfel für unser Picknick nachher. Sollen wir zu Hause zusammen einen großen Apfel in kleine Stücke schneiden und mit Zimt bestreuen?"
```
