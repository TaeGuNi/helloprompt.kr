...
>
> 1. Dívida A: Saldo `[R$ 3.000]` / Taxa de Juros `[14% ao mês]` (Cartão de Crédito)
> 2. Dívida B: Saldo `[R$ 50.000]` / Taxa de Juros `[2% ao mês]` (Financiamento de Veículo)
> 3. Dívida C: Saldo `[R$ 10.000]` / Taxa de Juros `[5% ao mês]` (Empréstimo Pessoal)
>
> **Tarefa (Task):**
>
...
Devido à taxa de juros predatória do seu Cartão de Crédito (14% ao mês), esses juros se transformarão em uma bola de neve incontrolável se não forem contidos. Recomendo fortemente focar na liquidação dessa dívida primeiro para **"Minimizar o Custo Efetivo Total"**, priorizando a razão matemática sobre o conforto psicológico.

**2. Ordem de Prioridade de Pagamento**
1. 🥇 **Dívida A (Cartão de Crédito):** Saldo R$ 3.000 / Taxa 14% a.m. (Máxima Urgência!)
2. 🥈 **Dívida C (Empréstimo Pessoal):** Saldo R$ 10.000 / Taxa 5% a.m.
3. 🥉 **Dívida B (Financiamento):** Saldo R$ 50.000 / Taxa 2% a.m.

**3. Simulação (Considerando o aporte extra de R$ 1.500 mensais)**
- **Ação Imediata:** Se você direcionar os R$ 1.500 mensais exclusivamente para a Dívida A (R$ 3.000), ignorando novos gastos no cartão, a dívida será **totalmente liquidada em pouco mais de 2 meses**.
- **Próximos Passos:** Ao se livrar da Dívida A em 2 meses, o estresse financeiro diminuirá drasticamente e seu score de crédito tenderá a subir. A partir do 3º mês, redirecione esses R$ 1.500 para atacar a Dívida C.
```
