...
## 🚀 A Solução: "Gerador de Manchetes Magnéticas para Redes Sociais"
...
> **Situação (Context):**
>
> - Formato: Planejo postar `[Card News / Carrossel Informativo]` no Instagram.
> - Objetivo: Preciso de um texto altamente persuasivo que faça as pessoas pararem de rolar o feed imediatamente.
>
> **Solicitação (Task):**
>
> 1. Recomende 5 manchetes para a capa que utilizem gatilhos mentais fortes (estimulando curiosidade, urgência/medo de perder algo ou destacando um benefício claro) focados no meu público-alvo.
> 2. Explique brevemente o porquê de cada manchete ser eficaz sob a ótica da psicologia de marketing e copywriting.
> 3. Escreva um esboço de roteiro estruturado em 4 etapas (Problema -> Empatia -> Solução -> Chamada para Ação/CTA) para compor os slides seguintes do carrossel.
>
> **Tópico e Público-Alvo (Variables):**
>
> - Tópico: `[Alongamento para correção de "pescoço de tartaruga" e dores cervicais]`
> - Público: `[Trabalhadores de escritório que passam mais de 8 horas no computador]`
>
> **Restrições (Constraints):**
>
> - Formate a resposta de forma clara usando tópicos e listas em Markdown.
> - O tom de voz deve ser empático, autoritário e direto ao ponto.
...
```text
Estou fazendo um post de carrossel ensinando alongamento de pescoço para quem trabalha em escritório. Me dê um título.
```

### ✅ Depois (Resultado com a Versão Pro)

```text
Manchete 1: "Seu pescoço estala ao final do expediente? Você está envelhecendo sua coluna em 10 anos." (Gatilho: Medo/Urgência)

Manchete 2: "O alongamento de 3 minutos que alivia a tensão instantaneamente sem sair da cadeira." (Gatilho: Benefício Prático)

Esboço do Carrossel (4 Etapas):
- Slide 1 (Problema): "Dor de cabeça tensional às 17h? A culpa é da altura do seu monitor."
- Slide 2 (Empatia): "Nós sabemos que é quase impossível não projetar o pescoço para a frente quando o prazo da entrega está acabando."
- Slide 3 (Solução): "Arraste para o lado e aprenda a 'Técnica do Queixo Duplo' para reverter essa sobrecarga agora mesmo."
- Slide 4 (CTA): "Salve este post para lembrar de fazer amanhã no meio do expediente!"
```
