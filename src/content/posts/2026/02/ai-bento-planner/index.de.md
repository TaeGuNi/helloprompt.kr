...
## 🚀 Die Lösung: "Der 10-Minuten Bento-Architekt"

### 🥉 Basic Version (Für den schnellen Hunger)

Nutze diesen Prompt, wenn du es besonders eilig hast und nur eine grobe Rezeptidee brauchst.
...
Dieser Prompt liefert dir detaillierte Anweisungen, strukturiert die Zubereitung und gibt dir entscheidende Tipps zum Anrichten für unterwegs.

> **Rolle (Role):** Du bist ein professioneller Ernährungsberater und japanischer Bento-Meister.
>
> **Kontext (Context):**
>
> - Hintergrund: Ich bin ein vielbeschäftigter Büroangestellter und habe morgens extrem wenig Zeit zum Kochen.
> - Ziel: Ich möchte aus meinen vorhandenen Kühlschrank-Resten eine gesunde, ausgewogene und optisch ansprechende Lunchbox (Bento) zubereiten.
>
> **Aufgabe (Task):**
>
> 1. Analysiere meine Zutatenliste: `[Liste deiner Zutaten, z.B. 2 Eier, halbe Zucchini, etwas Reis von gestern, Sojasauce]`
> 2. Kreiere ein Rezept, das strengstens unter 10 Minuten Zubereitungszeit bleibt.
> 3. Achte auf eine gute Balance aus Proteinen, Kohlenhydraten und Gemüse.
> 4. Gib konkrete Tipps, wie die Zutaten in der Box platziert werden sollten, damit sie bis zum Mittagessen frisch bleiben und nicht durchweichen.
>
> **Einschränkungen (Constraints):**
>
> - Formatiere die Ausgabe als übersichtliche Markdown-Tabelle für die Zutaten und eine nummerierte Schritt-für-Schritt-Anleitung für die Zubereitung.
> - Füge absolut keine frischen Zutaten hinzu, die ich nicht aufgelistet habe (außer Basis-Gewürze wie Salz, Pfeffer, Speiseöl).
>
> **Warnung (Warning):**
>
> - Schlage keine Rezepte vor, die langes Backen, Marinieren oder Kochen erfordern. Wenn die Zutaten nicht für ein 10-Minuten-Gericht reichen, sag mir direkt, was ich mit minimalem Aufwand noch dazukaufen muss.
...
```text
🍱 Dein 10-Minuten Bento: Schnelle Zucchini-Ei-Rolle auf gebratenem Soja-Reis

Zutaten:
| Zutat | Menge |
|---|---|
| Reis (vom Vortag) | 1 Portion |
| Eier | 2 Stück |
| Zucchini | 1/2 Stück |
| Sojasauce (Basis) | 1 EL |

Schritt-für-Schritt:
1. Vorbereitung (2 Min): Zucchini grob raspeln. Eier in einer Schüssel verquirlen und die Zucchiniraspeln untermischen.
2. Reis (3 Min): Den kalten Reis in einer Pfanne mit etwas Öl und der Sojasauce scharf anbraten. Aus der Pfanne nehmen und abkühlen lassen.
3. Omelett (4 Min): Die Ei-Zucchini-Masse in die Pfanne geben, als dünnes Omelett braten, in der Pfanne aufrollen und in mundgerechte Scheiben schneiden.
4. Bento-Tipp (1 Min): Drücke den gebratenen Reis auf der einen Seite deiner Lunchbox fest an. Lege die Ei-Rollen auf die andere Seite. WICHTIG: Komplett auskühlen lassen, bevor du den Deckel schließt, sonst weicht das Kondenswasser alles auf!
```
