...
## (Updated) 1. 아키텍처의 핵심: 액터 모델 (The Actor Model) {#the-actor-model}
...
## (Updated) 2. 데이터베이스의 진화: Cassandra에서 ScyllaDB로 {#updated}
...
## (Updated) 3. Rust와 데이터 서비스: Thundering Herd 문제 해결 {#updated}
...
## (Updated) 4. 하드웨어의 한계 극복: Super-Disk {#updated}
...
## (Updated) 5. 클라이언트 및 기타 최적화 {#updated}
