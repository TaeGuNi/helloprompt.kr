...
category: " "
description: "Transformez instantanément vos transcriptions de réunions chaotiques en résumés clairs et plans d'action structurés grâce à ce prompt IA ultra-efficace."
...
Même avec un outil de transcription performant comme Whisper, extraire l'essentiel d'une conversation souvent décousue demeure une véritable corvée chronophage. Ce prompt va droit au but : il isole avec une précision chirurgicale les **décisions clés** et les **prochaines étapes (Action Items)** à partir d'un bloc de texte brut. Vous n'avez plus qu'à copier-coller le résultat.
