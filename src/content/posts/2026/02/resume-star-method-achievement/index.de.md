...
> **Aufgabe (Task):**
>
> 1. Analysiere die von mir eingegebene Erfahrung und strukturiere sie streng nach dem **STAR-Framework** um.
> 2. Lege den Fokus massiv auf das **Result (Ergebnis)**. Integriere Zahlen (%, absolute Mengen, eingesparte Zeit, Umsatzsteigerung). Falls meine Eingabe keine genauen Zahlen enthält, schlage realistische, branchenübliche Platzhalter oder schätzbare Indikatoren vor.
> 3. Formuliere aus der Analyse exakt **3 wirkungsvolle Ein-Satz-Bulletpoints** (Action Statements), die ich sofort per Copy & Paste in meinen Lebenslauf übernehmen kann.
>
> **Meine Erfahrung (Input):**
> `[Fügen Sie hier Ihre Erfahrung als Text ein. z. B.: Ich habe im Marketingteam eine Instagram-Kampagne betreut. Wir hatten mehr Follower als vorher und der Chef war zufrieden.]`
>
> **Einschränkungen (Constraints):**
>
> - Entferne strikt alle passiven und vagen Ausdrücke wie 'hart gearbeitet', 'zuständig für', 'beigetragen'.
> - Beginne jeden Bulletpoint mit einem starken, aktiven Handlungsverb (z. B. Geleitet, Erreicht, Verbessert, Implementiert).
> - Gliedere deine Antwort klar in zwei Abschnitte: `[STAR-Analyse]` und `[Empfohlene Bulletpoints]`.
>
> **Warnung (Warning):**
>
> - Erfinde keine Fakten. Wenn Informationen für das 'Result' fehlen, weise mich darauf hin, anstatt unrealistische Zahlen zu halluzinieren.
...
```text
Ich habe ein Instagram-Event im Marketingteam geplant und durchgeführt.
Viele Leute haben teilgenommen und die Followerzahl ist gestiegen, wofür mich der Teamleiter gelobt hat.
```
