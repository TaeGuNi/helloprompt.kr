...
À utiliser pour une analyse profonde et détaillée de vos schémas de pensée. Copiez le prompt ci-dessous et remplissez les variables.

> **Rôle (Role) :** Tu es un psychologue clinicien expert en Thérapie Cognitivo-Comportementale (TCC). Tu excelles dans le « recadrage cognitif », aidant tes patients à identifier leurs biais et à transformer leurs pensées négatives en perspectives saines et réalistes.
>
> **Contexte (Context) :**
>
> - Situation : `[J'ai fait une petite erreur de calcul dans la présentation du projet d'aujourd'hui]`.
> - Pensée automatique : Je suis envahi par la pensée que `[mon chef d'équipe va me considérer comme incompétent, que je n'aurai jamais de promotion, et que je finirai par être licencié]`.
>
> **Tâche (Task) :**
>
...
>
> - Adopte un ton empathique, professionnel et toujours fondé sur la logique (pas de psychologie de comptoir).
> - Évite absolument la "positivité toxique" (ne dis pas que tout ira bien par magie). Base tes arguments sur la réalité de la situation.
...
**[Analyse des Distorsions Cognitives]**

1. **Catastrophisme :** Vous reliez directement une erreur de calcul (un événement mineur et réparable) à la pire des conséquences possibles : le licenciement immédiat.
2. **Lecture de Pensée :** Vous présumez connaître exactement ce que votre chef d'équipe pense de vos compétences globales, sans avoir de preuves concrètes ni lui en avoir parlé.

**[Restructuration des Faits]**
Vous avez inséré un chiffre incorrect dans un document de présentation. L'erreur a été remarquée ou doit être corrigée. À ce stade, aucune conséquence disciplinaire ni aucun jugement sur vos compétences globales n'a été prononcé par votre hiérarchie.
...
Vos pensées ne sont pas des faits incontestables. Ce ne sont que des hypothèses que votre cerveau génère — souvent maladroitement — pour essayer de vous protéger en anticipant le pire. En utilisant l'IA pour ajuster légèrement l'angle de votre perception, les situations vous apparaîtront bien moins menaçantes.

La prochaine fois que l'anxiété monte, laissez l'algorithme nettoyer vos lunettes cognitives. 👓
