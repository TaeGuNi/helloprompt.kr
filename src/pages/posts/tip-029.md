  ...
  return (
    <div className="max-w-sm rounded overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white">
      ...
      <div className="px-6 pt-4 pb-4 flex justify-between items-center">
        ...
        <button className="text-gray-400 hover:text-red-500 transition-colors" aria-label="찜하기">
          <Heart size={24} />
        </button>
      </div>
    </div>
...
**Q. 디자인이 너무 촌스러워요.**
A. *"Apple 스타일의 미니멀한 디자인으로 해줘"* 또는 *"토스(Toss) 앱처럼 깔끔하고 모던하게 해줘"* 라고 레퍼런스를 언급하세요.

**Q. 인터랙션(동작)이 없어요.**
A. *"버튼을 클릭했을 때 하트 색이 채워지는 토글 기능을 추가해줘"* 라고 상태 관리(useState) 로직을 요청하세요.
