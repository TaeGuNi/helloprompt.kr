...
description: "A transparent and secure guide detailing how Hello Prompt collects and processes your personal data."
date: "2026-02-09"
...
To ensure a seamless and secure browsing experience, the Site automatically collects only the following baseline metrics.

> **Collected Items:** `[Cookies]`, `[IP Address]`, `[Browser & Device Specifications]`, `[Access Timestamps & Session History]`
> **Collection Method:** Automatically gathered via standard analytics tools (e.g., Google Analytics) upon your visit.

### 🥇 Purpose of Data Usage (Pro)

The data we collect is utilized exclusively to elevate service quality, fortify security protocols, and guarantee uninterrupted operations.

> **Role:** The Site operates as an uncompromising and `[Secure Data Controller]`.
>
> **Context:**
>
> - Background: `[Optimizing the overall user experience while maintaining robust, global server stability]`
> - Goal: `[Delivering high-quality AI prompts to our users with maximum speed and uncompromising security]`
>
> **Task:**
>
...
> **Constraints:**
>
> - All logged data must be either strictly anonymized or permanently purged immediately following statistical analysis (Maximum retention period: 3 months).
>
> **Warning:**
>
> - Under no circumstances will sensitive personal data (e.g., names, direct contact information) be collected without explicit user consent, nor will any data ever be sold to third-party data brokers.
...
- **Q: How can I opt out of personalized advertisements and tracking cookies?**
...
Please be aware that if you navigate to external websites via outgoing links featured on Hello Prompt, the privacy frameworks of those respective platforms operate entirely independent of our Site. We advise you to exercise standard caution and review their individual policies.

If you have any further inquiries regarding your personal data, or if you wish to formally request data deletion, please reach out to our dedicated privacy channel below. We guarantee a prompt, transparent, and accommodating response.

- **Contact:** Hello Prompt Privacy Protection Team
- **Email:** `support@helloprompt.kr`

Now, dive back into your creative AI journey within a truly transparent and secure digital environment! 🚀
