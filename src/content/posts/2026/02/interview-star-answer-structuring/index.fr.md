...
À utiliser pour obtenir un script prêt à être prononcé, parfaitement calibré et hautement persuasif.

> **Rôle (Role) :** Tu es un coach expert en communication et un consultant en recrutement chevronné.
>
> **Contexte (Context) :**
>
...
> `[Collez ici vos notes en vrac, même si elles sont totalement désorganisées]`
>
> **Tâche (Task) :**
>
> 1. Restructure mon récit en appliquant rigoureusement la **méthode STAR**.
>    - **S (Situation) :** Pose le contexte en une seule phrase claire.
>    - **T (Tâche) :** Définis le défi à relever ou l'objectif à atteindre en une phrase.
>    - **A (Action) :** Décris les mesures _spécifiques_ que j'ai prises. Détaille cette partie sur 2 à 3 phrases.
>    - **R (Résultat) :** Mets en évidence l'impact quantitatif ou la leçon qualitative que j'en ai tirée, en une phrase percutante.
> 2. Transforme cette structure en un **script naturel et taillé pour l'oral**, prêt à être prononcé face à un recruteur.
>
> **Contraintes (Constraints) :**
>
> - La longueur totale du discours doit correspondre à **45 secondes - 1 minute** de temps de parole.
> - Réduis au strict minimum les détails inutiles de la Situation (S) pour te concentrer pleinement sur l'Action (A). Alloue plus de 50 % du discours à l'Action.
>
> **Attention (Warning) :**
>
> - N'invente absolument aucun fait, chiffre ou compétence qui ne figure pas dans mon récit initial. S'il manque des éléments pour construire un bon « STAR », signale-le-moi au lieu d'halluciner des informations.
...
```text
« C'était lors d'un projet de groupe pendant mes études... Un des membres de l'équipe a complètement disparu sans prévenir, du coup c'était super dur parce qu'on était très en retard. J'ai pensé à le dire au prof, mais je me suis finalement dit que j'allais juste faire sa partie. J'ai fait pas mal de nuits blanches et on a quand même eu une bonne note à la fin. C'était vraiment épuisant mais je suis fier de l'avoir fait. »
(Problème : Le récit est centré sur l'émotion et la fatigue ; la réflexion stratégique et le rôle exact du candidat sont flous).
```

### ✅ Après (La structure STAR)

```text
(Situation) « Lors d'un projet de groupe décisif, nous nous sommes retrouvés à trois pour abattre la charge de travail de quatre personnes suite à l'abandon soudain d'un de nos membres. »
(Tâche) « À seulement une semaine de la date limite, notre objectif était de livrer un produit totalement fonctionnel sans pour autant sacrifier la qualité. »
(Action) « Plutôt que de céder à la panique, j'ai proposé de redéfinir nos priorités en nous concentrant exclusivement sur les fonctionnalités clés. J'ai ensuite pris l'initiative de gérer la configuration complète du serveur, que j'ai finalisée en trois jours tout en épaulant mes coéquipiers sur leurs propres tâches. »
(Résultat) « Grâce à cette réorganisation expresse, nous avons livré le projet dans les délais, décroché la note maximale (A+), et j'ai surtout appris à gérer les priorités sous une forte pression. »
```
