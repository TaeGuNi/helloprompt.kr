...
Úsala cuando necesites una calidad detallada y literaria.

> **Rol (Role):** Eres un autor superventas experto en atrapar a los lectores en los primeros 3 segundos.
>
> **Contexto (Context):**
>
> - Fondo: Estoy planeando escribir una novela, pero la introducción me resulta demasiado plana.
> - Objetivo: Necesito una primera frase impactante que despierte una curiosidad inmensa en los lectores.
>
...
> **Solicitud (Task):**
>
> Redacta **10 Primeras Frases** utilizando las siguientes técnicas narrativas:
>
> 1. **In Media Res (En medio de la acción):** Comienza directamente con la acción sin explicaciones previas.
> 2. **Misterio/Pregunta:** Lanza una incógnita al lector o induce una fuerte curiosidad.
> 3. **Voz Única del Personaje:** Un monólogo interno que revele la personalidad o el estado mental del protagonista.
> 4. **Declaración Impactante:** Un comentario audaz que desafíe el sentido común o las expectativas.
> 5. **Atmósfera Envolvente:** Una descripción breve pero abrumadora del entorno.
>    _(Puedes usar otras técnicas literarias libres para las 5 opciones restantes)_
>
> **Restricciones (Constraints):**
>
> - Las oraciones deben ser extremadamente concisas e impactantes.
> - Prohibido el uso de descripciones climáticas cliché (ej. "Era un día oscuro y tormentoso" o "Era un día soleado").
...
```text
1. [Declaración Impactante] "Mi funeral resultó ser una fiesta mucho más animada de lo que hubiera imaginado."
2. [In Media Res] "Patear la tapa de un ataúd desde dentro requiere una fuerza muscular que definitivamente no tenía."
3. [Misterio] "¿Quién fue el idiota que dijo que la muerte era el descanso eterno? Claramente, me estafaron."
```
