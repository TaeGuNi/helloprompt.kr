...
> **Kontext (Context):**
>
> - Hintergrund: `[Ein wichtiger Kunde hat eine unrealistische Deadline für das aktuelle Projekt gefordert.]`
> - Ziel: `[Die Forderung höflich, aber bestimmt ablehnen und einen realistischen Alternativplan vorschlagen, ohne die Kundenbeziehung zu gefährden.]`
>
> **Aufgabe (Task):**
>
> 1. Verfasse eine professionelle Geschäfts-E-Mail auf Deutsch.
> 2. Zeige Verständnis für die Situation des Empfängers.
> 3. Formuliere die `[Absage/Verschiebung/Forderung]` klar, aber äußerst diplomatisch.
> 4. Biete eine konstruktive Alternative oder Lösung an.
> 5. Lass `[Platzhalter]` in Klammern, damit ich Namen und Daten selbst ausfüllen kann.
>
> **Einschränkungen (Constraints):**
>
> - Der Ton muss formell, professionell und lösungsorientiert sein.
> - Vermeide emotionale oder rechtfertigende Sprache.
> - Halte die E-Mail prägnant (maximal 150 Wörter).
>
> **Warnung (Warning):**
>
> - Erfinde keine Fakten oder Versprechungen, die nicht im Kontext erwähnt wurden.
...
### ❌ Vorher (Gedanklicher Entwurf)

```text
Hallo Thomas,
wir können die Deadline nächste Woche unmöglich einhalten. Das ist viel zu kurzfristig und mein Team ist ohnehin schon überlastet. Wir brauchen mindestens zwei Wochen länger. Sag mir, ob das okay ist.
Gruß
```
...
vielen Dank für die Zusendung der aktualisierten Anforderungen. Ich schätze das Vertrauen in unser Team sehr.

Nach einer sorgfältigen Prüfung unserer aktuellen Kapazitäten müssen wir Ihnen jedoch mitteilen, dass die vorgeschlagene Deadline in der nächsten Woche leider nicht realisierbar ist, ohne die Qualität unserer Arbeit zu beeinträchtigen.

Um Ihnen das bestmögliche Ergebnis liefern zu können, schlage ich stattdessen [Datum in zwei Wochen] als neuen Liefertermin vor. Dieser Zeitrahmen ermöglicht es uns, alle Details mit der gewohnten Sorgfalt umzusetzen.

Bitte lassen Sie mich wissen, ob dieser alternative Zeitplan für Sie praktikabel ist.
