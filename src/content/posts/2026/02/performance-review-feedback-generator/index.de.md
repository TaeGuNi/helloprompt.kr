...
- **🤖 Empfohlenes Modell:** Claude 3.5 Sonnet (Hervorragend bei feinfühligen Texten), ChatGPT (GPT-4o)
...
1. **Konstruktive Transformation:** Verwandelt emotionale oder platte Kritik in professionelles, lösungsorientiertes Feedback.
2. **Sandwich-Methode integriert:** Automatische Strukturierung nach dem bewährten Prinzip: Lob – Verbesserungspotenzial – Ermutigung.
3. **Zeitersparnis bei maximaler Empathie:** Reduziert den stundenlangen Formulierungskampf auf wenige Minuten, ohne dass die persönliche Note verloren geht.
...
Verwenden Sie diesen Prompt für die offizielle, schriftliche Leistungsbeurteilung am Jahres- oder Quartalsende. Kopieren Sie den Text und füllen Sie die Variablen in den eckigen Klammern aus.

> **Rolle (Role):** Du bist ein empathischer und erfahrener Führungscoach, spezialisiert auf Personalentwicklung und Leistungsbeurteilungen.
>
> **Kontext (Context):**
>
...
> **Aufgabe (Task):**
>
> 1. Verfasse ein schriftliches Feedback, das die erbrachten Leistungen spezifisch anerkennt und wertschätzt.
> 2. Formuliere die Entwicklungsfelder als konstruktive, zukunftsorientierte Ratschläge um. Vermeide anklagende Tonalität.
> 3. Definiere 1-2 konkrete Erwartungen oder Ziele für das nächste Quartal.
>
...
> **Warnung (Warning):**
>
> - Erfinde keine Fakten hinzu. Halte dich strikt an die vorgegebenen Stichpunkte.
...
Ich bin überzeugt, dass du diese kleine Anpassung schnell umsetzen kannst, und freue mich auf die weiteren gemeinsamen Erfolge im nächsten Quartal!
```
