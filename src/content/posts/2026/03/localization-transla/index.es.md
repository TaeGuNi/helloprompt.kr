...
> **Tarea:**
>
> 1. Localiza y traduce el "Texto original" para que resulte lo más atractivo y persuasivo posible para tu público objetivo.
> 2. Si es necesario, desmantela y reconstruye por completo la estructura de las oraciones. Tu prioridad absoluta es transmitir la intención y el mensaje.
> 3. Sustituye cualquier tabú cultural, expresión incómoda o concepto que no resuene por una alternativa perfectamente adaptada al mercado local.
...
> **Advertencias:**
>
> - No toleraré el abuso de la voz pasiva ni las estructuras rígidas típicas de las traducciones automáticas. El resultado final debe parecer escrito desde cero por un nativo.
...
(Análisis: La gramática es impecable, pero suena rígido, robótico y huele a kilómetro al típico mensaje comercial de traductor automático).
```

### ✅ Después (Resultado)

```text
(Resultado usando el Prompt Pro - Objetivo: Startup tecnológica en un mercado hispanohablante)
Traducción: 
...
- Se sustituyó "la eficiencia aumentará drásticamente" por el verbo de acción "Multiplica", mucho más contundente y habitual en el ecosistema SaaS.
- En lugar de la frase corporativa "mejorar el equilibrio...", se localizó hacia un beneficio emocional y tangible: "devuélveles sus fines de semana".
- Se acortó la longitud de la frase y se exprimió la voz activa ("Empieza", "comprueba") para lograr un CTA (Call to Action) cien veces más persuasivo y orientado a la conversión.
```
