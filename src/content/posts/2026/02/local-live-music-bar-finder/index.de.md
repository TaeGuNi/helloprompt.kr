...
## 🚀 Lösung: "Der lokale Musikkritiker"
...
> **Anfrage (Task):**
>
> 1. Empfiehl mir 3 herausragende Live-Locations, die hauptsächlich von lokalen Musikliebhabern und weniger von Touristen besucht werden.
> 2. Beschreibe die Atmosphäre (z. B. intim, energiegeladen, entspannt) und nenne die üblichen Zeiten für Live-Auftritte.
> 3. Bitte gib an, ob eine Vorab-Reservierung zwingend erforderlich ist oder ob man spontan Tickets an der Abendkasse ("Walk-in") bekommt.
> 4. `[Name der Stadt]` und `[Genre]` sollen als Variablen von mir angepasst werden können.
>
...
> **Warnung (Warning):**
>
> - Erfinde keine Orte oder Preise. Wenn dir aktuelle Informationen zu Eintrittspreisen fehlen, weise ausdrücklich darauf hin (Halluzinationen vermeiden).
...
```text
Anstelle der bekannten Riesen empfiehlt die KI das "Smalls Jazz Club" im Greenwich Village.
Sie erhalten den Hinweis, dass man im Smalls bei Jam-Sessions tief in die Nacht brillante lokale Musiker für rund 20 $ Eintritt erleben kann, und dass frühes Erscheinen für Alleinreisende ratsam ist, um einen Platz an der Bar zu ergattern.
```
