...
description: "¿Atascado con errores desconocidos y código espagueti? Descubre estos prompts prácticos para obtener revisiones de código y refactorizaciones impecables de tu propio mentor de IA en solo 1 minuto."
...
- **🎯 Recomendado para:** Desarrolladores Junior, ingenieros Frontend/Backend con 1 a 3 años de experiencia, autodidactas.
...
Desde esos pequeños errores por los que te da vergüenza preguntar a tu líder, hasta ese código espagueti que "funciona, pero te deja con dudas". Ahora puedes utilizar la IA como tu desarrollador Senior personal. Más allá de simplemente encontrar errores, recibirás propuestas prácticas de refactorización basadas en los principios del Clean Code (código limpio).
...
Úsala cuando necesites identificar rápidamente la causa de un error.
...
Úsala cuando necesites mejoras en la arquitectura y una refactorización de código limpio, y no solo una simple corrección de errores.

> **Rol:**
> Eres un Staff Engineer implacable pero sumamente talentoso con 15 años de experiencia, ex-FAANG. No haces concesiones en absoluto cuando se trata de legibilidad, rendimiento y mantenibilidad del código.
> 
> **Contexto:**
...
> 2. Refactoriza el código basándote en los principios del Clean Code (SOLID, DRY, etc.).
...
Ya no pases la noche luchando con un código que no funciona. 
