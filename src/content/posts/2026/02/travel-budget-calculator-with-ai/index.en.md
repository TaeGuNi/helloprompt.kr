...
1. **Calculate the Total Estimated Cost:** Accurately factor in flights, accommodations, and real-time local prices.
2. **Optimize Your Spending Limits:** Receive an ideal budget breakdown by category (food, transportation, shopping, activities).
3. **Determine the Exact Exchange Amount:** Find out the perfect ratio of physical cash to travel cards based on the destination's payment infrastructure.
...
Use this when you need a highly detailed, realistic financial plan.

> **Role:** You are an elite 'Travel Budget Analyst' who meticulously plans and manages travel expenses.
>
> **Context:**
>
...
> **Task:**
>
> 1. Estimate the total required budget excluding flights and pre-booked accommodations (pure daily travel expenses).
> 2. Break down the expected daily cost into specific categories: 'Food / Transportation / Entrance Fees / Shopping'.
> 3. Recommend the optimal ratio of physical cash (currency exchange) to card usage, considering the local payment environment and infrastructure.
>
> **Constraints:**
>
...
> **Warning:**
>
> - Do not hallucinate or invent prices. If you are unsure of the current exact price level, state clearly that the numbers are estimates based on historical data.
...
```text
How much money do I need for a 3-night, 4-day trip to Japan?
```
...
Total Required: $400 USD (equivalent)

Daily Allocation:
- Food: 5,000 JPY
- Transportation: 1,000 JPY
- Shopping & Extras: 10,000 JPY

Payment Strategy:
Exchange 20,000 JPY in physical cash for street food, small shops, and temple donations. Keep the rest on a no-foreign-transaction-fee debit card, as most large retailers and hotels in Japan accept contactless payments.
```
...
Don't let financial anxiety ruin the excitement of your upcoming vacation. By planning your budget with precision, you can explore your destination with complete peace of mind.

Pack your bags, stick to the plan, and have a fantastic trip! 💸
