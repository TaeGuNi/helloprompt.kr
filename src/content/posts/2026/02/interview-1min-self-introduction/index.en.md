...
1. Select two of your most impactful core competencies that align with the role.
2. Distill the experiences that prove these strengths into concise, one-line statements.
3. Structure your script to conclude with a clear, actionable vision of how you will contribute to the company.

---

## 🚀 The Solution: "Elevator Pitch Generator"
...
- **Q: The generated script feels a bit too formal for my industry (e.g., a startup). How can I fix this?**
  - A: You can simply add a line to the **Constraints** section: _"Adopt a conversational, energetic, and slightly informal tone suitable for a dynamic tech startup environment."_ The AI will adjust the vocabulary accordingly.

- **Q: Can I use this for a 3-minute introduction?**
  - A: Yes, but you shouldn't just ask the AI to "make it 3 minutes." For longer intros, you need more substance. Add a `[Strength 3]` and include a new instruction in the **Task** section: _"Elaborate on one specific project where I applied these strengths to overcome a major challenge."_

---

## 🧬 Prompt Anatomy (Why it works?)

1. **Role Playing:** By combining "executive coach" and "ad copywriter," the AI understands it needs to sell you as a premium brand, not just generate a generic list of skills.
2. **Strict Constraints:** Explicitly banning clichés (like "I'm a sponge") prevents the AI from falling into the trap of terrible, outdated interview advice.
3. **Time Formatting:** Asking for a specific speaking duration (45-50 seconds) ensures the output isn't a massive wall of text that you have to brutally edit down later.
...
```text
"Hello! I am a sponge-like applicant, John Doe.
Just like a sponge absorbs water, I am ready to learn anything you teach me.
Ever since I was young, I was taught to listen carefully and work hard..."
```

_(Result: Too long, boring, and highly forgettable. The interviewer has already stopped listening.)_

### ✅ After (The Impact)

```text
"A marketer who translates raw data into customer desires—that is who I am.
I bring two core strengths to this role.
First, my ability to connect analytical insights directly to sales, honed through three years of optimizing e-commerce funnels.
Second, my fluency in global business etiquette, developed by managing direct communications with our North American enterprise clients.
I plan to leverage these competencies to drive a 10% increase in your international market retention rate within my first year.
Thank you."
```
...
The 1-minute self-introduction is not the time to regurgitate your life story. It is an exclusive invitation that says, **"I have exactly what you need; would you like to hear more?"**

Create the most attractive invitation possible, and walk into that interview with confidence. 💌
