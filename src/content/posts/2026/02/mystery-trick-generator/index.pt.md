...
## 🚀 A Solução: "O Arquivo Secreto do Detetive"
...
Utilize esta versão para obter uma trama detalhada, coesa e pronta para ser desenvolvida em um roteiro ou livro.

> **Papel (Role):** Você é um escritor de mistério experiente e mestre em tramas complexas, combinando a brilhante dedução de Agatha Christie com os truques físicos e psicológicos de Keigo Higashino.
>
> **Contexto (Context):**
>
> - Estou escrevendo um autêntico romance de mistério. Preciso de um truque de crime engenhoso e inédito que os leitores não consigam prever de forma alguma.
> - **Cenário:** `[Ex: Uma cabana em uma montanha isolada pela neve, quarto de hotel no 5º andar trancado por dentro]`
> - **Vítima:** `[Ex: Um agiota implacável que colecionava inimigos]`
> - **Suspeitos:** `[Ex: A governanta endividada, um ex-sócio com sede de vingança, o sobrinho de olho na herança]`
>
> **Tarefa (Task):**
>
> 1. Designe o **Culpado** e crie um **Truque de Crime** detalhado que pareça absolutamente impossível à primeira vista. (Explore dispositivos físicos, manipulação de tempo, reações químicas inusitadas ou pontos cegos psicológicos).
> 2. Desenvolva o **Álibi Perfeito** que o culpado preparou meticulosamente para escapar de suspeitas.
> 3. Revele a **Pista Decisiva** (o pequeno erro ou contradição) que permitirá ao detetive quebrar o álibi e provar a culpa.
>
> **Restrições (Constraints):**
>
> - Proíba estritamente reviravoltas clichês, como "eram gêmeos", "foi suicídio acidental" ou "a vítima fingiu a própria morte".
> - O truque deve ser 100% explicável cientificamente, logicamente viável e não depender de pura sorte.
...
```text
Me recomende um truque de assassinato em um quarto fechado.
```

_(A IA geralmente responde com o clichê exausto: "O assassino esfaqueou a vítima com um pedaço de gelo, que depois derreteu e não deixou a arma do crime.")_

### ✅ Depois (Resultado com o Prompt Pro)

```text
- Culpado: A Governanta.
- Truque (Como?): Não houve uso de chaves de gelo. O método foi a "Expansão Térmica". A vítima foi morta fora do quarto, e colocada lá dentro depois. A governanta afrouxou os parafusos da moldura da janela um dia antes. Após colocar o corpo, ela ligou o aquecedor do quarto no máximo pelo lado de fora (usando um painel inteligente). O calor extremo expandiu a madeira e a estrutura da janela, travando-a de forma tão firme que parecia selada por dentro, criando a ilusão de um quarto perfeitamente fechado.
- Álibi: Ela estava preparando o jantar na cozinha do 1º andar no horário estimado da morte, gravada nas câmeras com testemunhas. (Ela manipulou a rigidez cadavérica com a temperatura extrema do quarto para alterar a hora estimada da morte).
- Pista Decisiva: O quarto estava escaldante, mas a vítima usava um suéter grosso. Além disso, estranhamente, as bordas da janela eram as únicas partes do quarto sem condensação, devido ao afrouxamento prévio.
```
