...
## 🚀 La Solución: "Creador de Historia Interactivo"
...
> **Contexto (Context):**
>
> - Fondo: Quiero experimentar en primera persona el evento `[Evento Histórico Específico]`.
> - Objetivo: Dirigir una simulación interactiva que funcione como un juego de aventuras basado en texto.
>
> **Tarea (Task):**
>
> 1. **[Apertura]**: Comienza con una descripción inmersiva y vívida del contexto histórico, mi posición social, mi rol y la crisis o situación actual.
> 2. **[Opciones]**: En cada encrucijada crítica, preséntame 3 opciones (A, B, C).
>    - Una opción debe corresponder a la decisión real que se tomó en la historia.
>    - Las otras dos deben ser alternativas históricamente plausibles.
> 3. **[Resultado]**: Tras mi elección, narra las consecuencias inmediatas y el efecto dominó en el entorno, para luego avanzar a la siguiente situación crítica.
> 4. **[Final]**: Una vez concluida la simulación, proporciona un análisis comparativo entre mis decisiones y los hechos reales (Hechos Históricos).
>
> **Restricciones (Constraints):**
>
> - Limita cada respuesta a 3 o 4 oraciones para mantener un ritmo dinámico y evitar textos excesivamente largos.
> - Utiliza siempre la segunda persona del singular ("Tú eres...", "Tú decides...") para maximizar la inmersión.
> - Mantén el rigor histórico y el tono de la época tanto como sea posible en las descripciones.
> - Si no tienes información precisa sobre un detalle, indícalo o improvisa de forma coherente con la época sin distorsionar los grandes hitos.
>
> **Variables a completar:**
>
> - `[Evento Histórico Específico]`: Ej. La Revolución Francesa, el cruce de los Andes por San Martín, o la Batalla de Myeongnyang.
...
### ❌ Antes (Estilo Libro de Texto)

```text
En la Batalla de Myeongnyang, el Almirante Yi Sun-sin derrotó a una inmensa flota japonesa de 133 barcos con tan solo 13 embarcaciones, aprovechando estratégicamente las fuertes corrientes del estrecho de Uldolmok.
```

### ✅ Después (Experiencia de Juego con el Prompt)

```text
[Situación]
Eres el Comandante Yi Sun-sin. La brisa marina es fría y la tensión es palpable. Apenas te quedan 13 barcos. A lo lejos, en el horizonte, la colosal flota japonesa de más de 100 naves avanza implacablemente hacia ti. Escuchas los murmullos de terror entre tus subordinados. El destino de la nación pende de un hilo.

[Opciones]
A. "¡Aquellos que buscan vivir morirán, y los que buscan morir vivirán!" Ordenas a todas tus fuerzas avanzar hacia el estrecho para aprovechar la corriente.
B. Ordenas una retirada táctica inmediata hacia tierra firme para librar una guerra de guerrillas.
C. Decides esperar a que caiga la noche para emboscar sus barcos de suministro bajo el amparo de la oscuridad.

(Elección del Usuario: B)

[Resultado]
Abandonas las naves y guías a tus hombres hacia las montañas. La pequeña flota de Joseon es capturada sin resistencia. Sin oposición en el mar, las fuerzas japonesas aseguran el Mar del Oeste y establecen una línea de suministro directa y masiva hacia la capital, Hanyang. Las defensas terrestres colapsan bajo el peso de los refuerzos enemigos... *(Final Trágico)*

[Análisis Histórico]
El verdadero Almirante Yi Sun-sin eligió la opción A. A pesar de la abrumadora inferioridad numérica, logró una victoria milagrosa utilizando el estrecho de Uldolmok. Tu elección (B) refleja la estrategia conservadora que muchos en la corte deseaban en ese momento, pero como hemos visto, habría llevado a la rápida caída de Joseon.
```
