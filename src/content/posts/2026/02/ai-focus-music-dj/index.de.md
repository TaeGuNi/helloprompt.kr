...
> **Aufgabe (Task):**
>
> 1. Erstelle eine strukturierte, 90-minütige Playlist (passend zu einem Deep-Work-Block).
> 2. Unterteile die Session in drei Phasen: "Warm-up" (10 Min.), "Deep Flow" (70 Min.) und "Cool-down" (10 Min.).
> 3. Empfehle spezifische Künstler, Alben oder Suchbegriffe für jede Phase.
> 4. Erkläre kurz, _warum_ diese Art von Musik akustisch und neurologisch für meine Aufgabe geeignet ist (z. B. BPM, Frequenzen).
>
> **Einschränkungen (Constraints):**
>
> - Vermeide Musik mit Texten (Vocals), da diese das Sprachzentrum im Gehirn ablenken.
> - Gib die Ergebnisse als übersichtliche Markdown-Tabelle aus.
>
> **Warnung (Warning):**
>
> - Erfinde keine fiktiven Künstler oder Alben (keine Halluzinationen). Empfiehl nur reale, auffindbare Musik oder etablierte Suchbegriffe.
...
```text
Ich muss arbeiten. Gib mir Musiktipps.
```

_(Die KI liefert eine unstrukturierte Liste von Beethoven-Symphonien und "Lo-Fi Beats to Relax/Study to", ohne Rücksicht auf die Art der Arbeit oder die Tagesform.)_

### ✅ After (Mit dem Pro-Prompt)

```text
| Phase | Dauer | Empfehlung (Künstler/Suchbegriff) | Warum es funktioniert (Neurologie) |
| :--- | :--- | :--- | :--- |
| **Warm-up** | 10 Min | Marconi Union - "Weightless" | 60 BPM senken aktiv den Herzschlag und signalisieren dem Gehirn den Übergang zur Ruhe. |
| **Deep Flow** | 70 Min | Jon Hopkins - "Singularity" | Kontinuierliche elektronische Rhythmen (100-120 BPM) fördern Theta-Wellen, optimal für komplexe Architekturen. |
| **Cool-down** | 10 Min | Brian Eno - "Music for Airports" | Strukturlose Ambient-Klänge lösen den mentalen Tunnelblick und bereiten auf die Pause vor. |
```
