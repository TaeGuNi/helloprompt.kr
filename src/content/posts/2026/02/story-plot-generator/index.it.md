...
## 🚀 La Soluzione: "Generatore di Trame per Web Novel"
...
```text
(Schermo vuoto)
"Voglio scrivere una storia su un impiegato che si reincarna in un mondo magico, ma non so da dove iniziare, non ho idee per il sistema magico e non so chi sia il vero cattivo..."
```

### ✅ Dopo (Risultato dell'IA)

```text
**Logline:** Un contabile aziendale esaurito si reincarna nell'amministratore finanziario del regno del Re dei Demoni. Ora deve bilanciare il budget dell'esercito oscuro per evitare la bancarotta totale, cercando di non farsi uccidere dagli "Eroi" invasori o dai suoi stessi spietati dipendenti.

**Arco 1: L'Audit Infernale**
- Colpo di scena: Il Re dei Demoni è in realtà un pacifista incompreso che sta nascondendo un enorme debito ereditato dalle generazioni precedenti.
- Cliffhanger: Gli eroi arrivano alle porte del castello non per combattere una guerra epica, ma per condurre un'ispezione fiscale a sorpresa per conto degli dei.
...
```
