...
1. **La palabra clave es la reina:** Incluir `Steampunk` en tu prompt hace el 80% del trabajo estilístico por ti.
...
3. **Atmósfera y paleta de colores:** Utiliza términos como `Sepia`, `Bronze` y `Warm cinematic lighting` (iluminación cálida cinematográfica) para clavar ese inconfundible tono clásico.
...
Úsala cuando busques una calidad cinematográfica con un nivel de detalle milimétrico. Es ideal para portadas o *concept art* profesional.
...
*(Resultado: Una auténtica obra maestra mecánica de tonos cálidos, repleta de engranajes giratorios, tuberías de cobre y envuelta en una iluminación cinematográfica entre nubes de vapor).*
