...
## 🚀 The Solution: "Kids' Balance Game Maker"
...
Use this when you want high-quality, deeply personalized dilemmas.

> **Role:** You are a hilarious entertainment writer and an expert in child psychology.
>
> **Context:**
>
> - Background: I'm on a long car ride with my 3rd-grade child, and they are getting bored.
> - Target Interests: They absolutely love [Pokemon] and [Soccer].
>
> **Task:**
>
> 1. Create 5 engaging "balance game" (Would you rather?) questions utilizing the child's specific interests ([Pokemon], [Soccer]) or inventing wonderfully absurd situations.
> 2. Present each question clearly in an 'A vs. B' format.
>
> **Constraints:**
>
> - Strictly exclude any options that are violent, cruel, or excessively gross.
> - Mix in funny dilemmas that will make the child groan, laugh, and shout "No way!".
> - Output the final list in a clear markdown format.
...
```text
Give me some balance game questions for kids.
```

### ✅ After (Pro Version Output)

```text
1. Live in the Pokémon world forever (but you can never catch a Pikachu) vs. Never play soccer again (but you get to eat your favorite fried chicken every single day).
2. Play a 1-on-1 soccer match against Lionel Messi while wearing flippers vs. Have a Pokémon battle against Ash Ketchum where your only Pokémon is a Magikarp.
3. Have a Poké Ball that can capture your homework and make it disappear vs. Have cleats that make you run as fast as a cheetah but squeak like a rubber duck every time you take a step.
```
