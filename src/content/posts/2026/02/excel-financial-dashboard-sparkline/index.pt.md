...
## 🚀 A Solução: O "Mestre Visual do Excel"
...
Utilize este prompt quando buscar um nível de detalhamento impecável e resultados profissionais.

> **Papel (Role):** Você é um `[Especialista Sênior em Visualização de Dados Financeiros e BI]`.
>
> **Contexto (Context):**
>
> - Cenário atual: Estou elaborando o relatório mensal de desempenho de vendas da minha equipe no Excel. Os dados de faturamento de Janeiro a Dezembro estão alocados no intervalo `[B2:M2]`.
> - Objetivo: Em vez de entregar uma tabela de números fria e difícil de ler, desejo criar um painel visual de alto impacto que permita à diretoria identificar tendências anuais e taxas de sucesso em segundos.
>
> **Tarefa (Task):**
>
> 1. Explique passo a passo, de forma didática, como inserir um **'Minigráfico (Sparkline)'** na célula `[N2]` para ilustrar a tendência de vendas dos 12 meses como um gráfico de linha.
> 2. Detalhe como transformar a coluna de 'Taxa de Realização da Meta (%)' em um elemento visual atrativo aplicando **'Formatação Condicional (Barra de Dados)'**.
> 3. Forneça uma dica avançada sobre a configuração de **'Conjunto de Ícones'** para que setas vermelhas automáticas alertem sobre quedas em relação ao mês anterior e setas verdes celebrem aumentos.
>
> **Restrições (Constraints):**
>
> - Forneça a localização exata de cada ferramenta no menu Ribbon do Excel (ex: aba Inserir > Minigráficos).
> - Estruture as explicações em uma ordem lógica de cliques, pensando em um usuário de nível intermediário.
> - Utilize listas e formatação em negrito para facilitar a leitura.
>
> **Aviso (Warning):**
>
> - Descreva apenas os atalhos e caminhos de menu reais do Microsoft Excel 365. Não invente menus inexistentes.
...
```text
Diga-me como deixar a tabela do Excel mais bonita e fácil de ler.
```

### ✅ After (Resultado)

```text
### 📊 Guia Rápido: Painel Visual Executivo no Excel

**1. Minigráfico de Tendência (Sparkline)**
- **Caminho:** Vá até a aba [Inserir] ➔ Grupo [Minigráficos] ➔ Clique em [Linha].
- **Configuração:** Selecione o intervalo de vendas (B2:M2) para 'Intervalo de Dados' e indique a célula N2 como 'Intervalo de Locais' ➔ Pressione [OK].
- **Efeito:** A evolução anual das suas vendas será exibida elegantemente como uma linha dentro da própria célula!

**2. Gráficos em Células (Barras de Dados)**
- **Caminho:** Selecione a coluna de Taxa de Realização ➔ Aba [Página Inicial] ➔ [Formatação Condicional] ➔ [Barras de Dados] ➔ Escolha a cor (ex: Preenchimento Sólido Azul).
- **Efeito:** Uma célula com 100% ficará totalmente preenchida de azul; uma com 50% ficará preenchida até a metade. Identifique o desempenho com um simples olhar.

**3. Alertas Automáticos (Conjunto de Ícones)**
- **Caminho:** Selecione a coluna de 'Variação vs Mês Anterior' ➔ Aba [Página Inicial] ➔ [Formatação Condicional] ➔ [Conjuntos de Ícones] ➔ Escolha [Direcional (3 Setas Coloridas)].
- **Efeito:** Uma seta vermelha 🔻 aparecerá automaticamente para quedas percentuais, permitindo a identificação instantânea de gargalos operacionais.
```
