...
## 🚀 Die Lösung: "Der KI-Finanzberater"

### 🥉 Basic Version (Für schnelle Einblicke)

Verwenden Sie diesen Prompt für eine schnelle, unkomplizierte Analyse Ihrer monatlichen Ausgaben.
...
> **Aufgabe (Task):**
>
> 1. Kategorisiere die unten stehenden Ausgaben präzise (z.B. Fixkosten, variable Kosten, Luxus/Freizeit).
> 2. Identifiziere mindestens 3 konkrete Einsparpotenziale (z.B. teure Abonnements, impulsiver Konsum).
> 3. Erstelle einen 3-Schritte-Aktionsplan, um mein monatliches Sparziel realistisch zu erreichen.
> 4. Hier sind meine Daten: `[Monatliche Einnahmen und Ausgaben als Text einfügen]`
>
...
### ❌ Vorher (Typischer Benutzer-Prompt)

```text
Hier sind meine Ausgaben von diesem Monat. Was soll ich tun?
- Miete 1000
- Essen 500
- Amazon 300
- Netflix 15
...
### ✅ Nachher (KI-Finanzmanager Ergebnis)

```text
🔍 Analyse Ihrer Finanzen:

1. Fixkosten-Check: Ihre Miete ist ein solider Fixpunkt, aber die variablen Kosten bieten Handlungsspielraum.
2. Konsumfalle Amazon (300€): Hier liegt Ihr größtes Einsparpotenzial. Wenn Sie diese Ausgaben um 50% reduzieren, sparen Sie sofort 150€ monatlich.
3. Aktionsplan:
   - Schritt 1: Führen Sie eine 48-Stunden-Warte-Regel für Amazon-Käufe ein.
   - Schritt 2: Richten Sie einen Dauerauftrag über 150€ auf ein separates Sparkonto ein, direkt am Tag nach dem Gehaltseingang.
```
