...
> **Ruolo (Role):** Sei un esperto di logistica urbana e un navigatore GPS avanzato con accesso in tempo reale ai dati sul traffico.
>
> **Contesto (Context):**
>
> - Partenza: `[Il tuo indirizzo o quartiere]`
> - Destinazione: `[Indirizzo dell'ufficio o destinazione]`
> - Orario di arrivo desiderato: `[Es. 08:45 AM]`
> - Mezzo di trasporto: `[Auto / Mezzi pubblici / Bici]`
>
> **Richiesta (Task):**
>
> 1. Analizza le condizioni attuali e previste del traffico per il mio percorso.
> 2. Suggerisci l'orario esatto in cui devo uscire di casa per arrivare in orario con un margine di sicurezza di 10 minuti.
> 3. Fornisci un "Percorso A" (il più veloce) e un "Percorso B" (alternativa in caso di incidenti o blocchi improvvisi).
> 4. Se ci sono condizioni meteo avverse (es. pioggia, neve), calcola il tempo extra necessario.
>
> **Vincoli (Constraints):**
>
> - Organizza la risposta utilizzando elenchi puntati per facilitare la lettura veloce sul telefono.
> - Sii conciso. Non ho tempo di leggere testi lunghi la mattina.
>
> **Avvertenze (Warning):**
>
> - Basati solo su dati logici e realistici. Se non hai accesso a dati in tempo reale, usa i modelli di traffico storico per questo orario. Non inventare percorsi inesistenti.
...
### ❌ Prima (Ricerca classica o navigatore base)

```text
Google Maps: "Traffico intenso sulla A4. Tempo stimato: 55 minuti."
(Nessuna strategia, solo una constatazione del problema).
```

### ✅ Dopo (Risultato del Prompt Pro)

```text
Ecco la tua strategia di viaggio per arrivare entro le 08:45:

🚗 Orario di partenza ottimale: 07:35 AM (incluso margine di sicurezza di 10 min)

🛣️ Percorso A (Principale):
- Via Viale Europa -> Autostrada A4 (Uscita Centro).
- Traffico: Rallentamenti previsti tra i km 12 e 15 a causa di lavori in corso.

🗺️ Percorso B (Alternativa di emergenza):
- Strada Statale 11 -> Tangenziale Est.
- Nota: Più lungo di 5 km, ma attualmente scorrevole. Usalo se l'Autostrada A4 segnala incidenti sulla rampa d'accesso.

🌧️ Meteo: Pioggia leggera prevista. Ho aggiunto 8 minuti extra al tuo tempo di percorrenza. Guida con prudenza!
```
...
Non lasciare che il traffico detti il tuo umore per il resto della giornata. Delega la logistica all'intelligenza artificiale, riprendi il controllo del tuo tempo e goditi una colazione più rilassata.
