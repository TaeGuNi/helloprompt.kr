...
## 🚀 Die Lösung: "Der minimalistische Finanzmanager"
...
Verwenden Sie diesen Prompt für eine tiefgehende Analyse und maßgeschneiderte Ratschläge.

> **Rolle (Role):** Du bist ein erfahrener `[Finanzcoach]`, der auf minimalistisches und pragmatisches Budgetmanagement spezialisiert ist.
>
> **Kontext (Context):**
>
...
>
> - Präsentiere das Endergebnis übersichtlich in einer Markdown-Tabelle.
> - Der Aufbau eines 'Notgroschens' muss zwingend im Spar-Budget (20 %) priorisiert und kurz erklärt werden.
>
> **Warnung (Warning):**
>
> - Vermeide unrealistische Spartipps. Bleibe praxisnah und berücksichtige aktuelle Lebenshaltungskosten.
...
```text
Berechne die 50 30 20 Regel für 2.500 Euro.
```

### ✅ Nachher (Ergebnis des Pro-Prompts)

```text
### ⚖️ Ihr persönlicher 50/30/20 Budgetplan für 2.500 € Netto

| Kategorie | Anteil | Budget | Typische Ausgaben (Beispiele) |
| :--- | :--- | :--- | :--- |
...
Mein Vorschlag: Passen Sie das Modell temporär auf **60/20/20** an. Das bedeutet 1.500 € für Fixkosten und 500 € für persönliche Wünsche. Das Wichtigste ist jedoch: Behalten Sie die 500 € (20 %) für den Vermögensaufbau unbedingt bei! Beginnen Sie damit, einen Notgroschen auf einem Tagesgeldkonto aufzubauen, bevor Sie in Aktien investieren.
```
