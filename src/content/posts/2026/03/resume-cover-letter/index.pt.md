...
> **Contexto (Context):**
>
> - Cenário: Sou um profissional com `[Anos de Experiência]` anos de atuação, buscando uma transição para o cargo de `[Cargo Desejado]`.
> - Objetivo: Analisar minuciosamente a `[Descrição da Vaga (JD)]` fornecida e redigir uma carta de apresentação altamente estratégica que conecte os requisitos da empresa às minhas `[Experiências Principais]`, com o intuito de convencer o recrutador.
>
> **Tarefa (Task):**
>
