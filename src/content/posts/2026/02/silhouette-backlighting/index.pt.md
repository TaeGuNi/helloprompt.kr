...
- **🤖 Modelo recomendado:** Todos os modelos (Midjourney, DALL-E 3, Stable Diffusion)
...
> **Contexto (Context):**
>
> - Fundo: `[Cenário de fundo luminoso, ex: lua vermelha gigante, pôr do sol urbano]`
> - Sujeito: `[Personagem ou objeto em foco, ex: samurai solitário, árvore retorcida]`
>
> **Solicitação (Task):**
>
> 1. Gere um prompt em inglês otimizado para `[Midjourney / DALL-E 3]`.
> 2. O sujeito principal deve ser renderizado como uma silhueta absolutamente preta (`dark silhouette`), sem detalhes internos visíveis.
> 3. Aplique uma luz de fundo extrema (`strong backlighting`, `rim light`) para destacar os contornos da silhueta contra o fundo brilhante.
> 4. Use um estilo visual `[Estilo, ex: arte minimalista, estilo graphic novel]`.
>
> **Restrições (Constraints):**
>
> - Não inclua texturas ou detalhes faciais no sujeito. O foco deve ser 100% na forma geométrica.
> - Mantenha um alto contraste (`high contrast`) e cores vibrantes apenas no fundo.
