...
## 🚀 La Solución: "Generador de Reseñas de Patinaje al Estilo NBC"
...
>
> - La longitud del texto debe ser de aproximadamente 1000 caracteres.
> - Divide claramente el texto en 4 o 5 párrafos y utiliza emojis apropiados al principio y al final de cada uno.
> - Nunca utilices el formato de tabla (Table); en su lugar, organiza los puntos clave del resumen utilizando una lista de viñetas (Bullet List).
>
...
```text
Hoy un atleta estadounidense quedó en primer lugar en el patinaje libre de patinaje artístico.
Saltó muy bien sin caerse y la música fue triste y conmovedora.
Escribe un artículo para publicar en mi blog.
```

### ✅ Después (Resultado)

```text
🥇 ¡Unos abrumadores 4 minutos dominando el hielo a la perfección! 🇺🇸
Hoy, el estadio contuvo la respiración desde el instante en que se posicionó en el centro de la pista.
Cuando comenzó la majestuosa melodía y aterrizó el primer elemento, un triple axel, ligero como una pluma, ¡todos supimos instintivamente de quién sería la medalla de oro!
✨ Momentos estelares que no te puedes perder:
- Una altura y un tiempo de suspensión en los saltos verdaderamente milagrosos, desafiando por completo la gravedad.
- Una secuencia de pasos lírica y elegante que se fusionó en un solo latido con la música.
- El spin Biellmann final que transformó las gradas en un inmenso mar de lágrimas.
Esto superó los límites de una simple competencia deportiva; fue una grandiosa obra de arte plasmada sobre el hielo. Es un inmenso honor compartir con ustedes este momento en el que se escribe un nuevo capítulo en la historia del patinaje artístico.
#nbcolympics #figureskating #patinajeartistico #highlights #medalladeoro
```
