...
1. Jogue todo o texto desorganizado do seu currículo para a IA.
2. Converta-o para um formato Markdown altamente legível (usando Cabeçalhos, Tópicos e Negrito).
3. Cole diretamente no Notion ou em qualquer editor Markdown para uso e formatação imediatos.
...
> **Situação (Context):**
>
> - Fundo: Quero organizar e estruturar de forma impecável o conteúdo de um currículo que escrevi de maneira rascunhada em um bloco de notas.
> - Objetivo: Obter um texto em Markdown perfeitamente alinhado, pronto para ser colado no Notion ou convertido para PDF.
>
> **Tarefa (Task):**
>
> 1. Converta o texto fornecido abaixo em um **formato Markdown** rigorosamente estruturado.
> 2. Use `[Cabeçalhos (#, ##)]` para as seções principais, `[Negrito (**)]` para destacar os períodos e os cargos, e `[Tópicos (-)]` para listar as responsabilidades e conquistas.
> 3. Insira uma linha separadora (`---`) entre as seções para maximizar a legibilidade.
> 4. Padronize todas as datas para o formato `AAAA.MM` e alinhe-as à direita (ou posicione-as ao final da linha, se o alinhamento não for possível).
>
> **Texto de Entrada:**
> `[Cole o conteúdo desordenado do seu currículo aqui]`
>
> **Restrições (Constraints):**
>
> - Não invente nem adicione informações criativas. Mantenha os fatos originais. Limite-se a corrigir erros de digitação, gramática e a polir frases que soem estranhas ou pouco profissionais.
> - Utilize Emojis de forma adequada e profissional apenas nos títulos das seções (ex: 💼 Experiência Profissional, 🎓 Formação Acadêmica, 🛠️ Habilidades).
...
### ❌ Antes (Rascunho no Bloco de Notas)
...
**ABC Marketing** | Vice-Diretor | 2020.01 - 2023.12

- **Gestão de Canais de Redes Sociais:** Alcançou a marca de 10.000 seguidores (Principal responsável)
- **Execução de Anúncios:** Planejamento, operação e otimização de campanhas de marketing online

---

## 🎓 Formação Acadêmica

**Universidade da Coreia** | Bacharelado em Administração de Empresas | 2015.03 - 2019.02

---

## 🛠 Habilidades

- **Ferramentas:** Adobe Photoshop, Microsoft Excel, Microsoft PowerPoint
```
