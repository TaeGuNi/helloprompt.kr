...
> - Problème : Il fait extrêmement chaud, je dois donc optimiser ma tenue tout en respectant scrupuleusement les règles du lieu sacré.
>
> **Tâche (Task) :**
>
> 1. Détaille précisément le code vestimentaire exigé (haut, bas, chaussures, couvre-chef). Si les règles diffèrent selon le genre, explique-les séparément.
> 2. Indique si des articles de dépannage (sarongs, foulards, jupes longues) peuvent être loués ou empruntés à l'entrée, et précise leur coût approximatif.
> 3. Énonce les règles spécifiques concernant les accessoires : taille maximale autorisée pour les sacs à dos, port de chapeaux ou de lunettes de soleil à l'intérieur.
> 4. Dresse la liste des zones où la photographie est strictement interdite ou soumise à autorisation, ainsi que les comportements à éviter absolument.
>
> **Contraintes (Constraints) :**
>
> - Fournis uniquement des informations vérifiées et actualisées.
> - Si le lieu n'impose pas de règles strictes mais émet des recommandations culturelles, précise-le clairement.
> - Structure ta réponse avec des puces (bullet points) pour une lecture optimale sur mobile.
> - Si tu as un doute sur une information, mentionne-le de manière explicite.
...
> "Comment dois-je m'habiller pour visiter le Grand Palais à Bangkok ?"
