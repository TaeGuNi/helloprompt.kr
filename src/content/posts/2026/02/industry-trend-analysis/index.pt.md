...
- **🤖 Modelo recomendado:** Qualquer IA com acesso à internet (ChatGPT Plus, Perplexity, Gemini Advanced)
...
## 🚀 A Solução: "Navegador de Indústrias do Futuro"
...
> **Contexto (Context):**
>
> - Cenário: Estou planejando um investimento de longo prazo no setor de `[Inteligência Artificial Generativa / Robótica / Baterias Secundárias]`.
> - Objetivo: Preciso compreender as tendências macroeconômicas atuais e as projeções de crescimento deste mercado para os próximos 5 anos.
>
> **Solicitação (Task):**
>
...
>
> - Baseie sua análise estritamente nas informações e relatórios de mercado mais recentes (últimos 6 meses).
> - Seja específico: cite nomes exatos de tecnologias e de empresas reais. Evite jargões vazios e generalizações.
> - A saída final deve ser formatada estruturalmente usando as tags de Markdown apropriadas (H2, H3, tabelas, bullet points).
>
> **Aviso (Warning):**
>
> - Se não tiver acesso a dados recentes ou dados numéricos confiáveis sobre um determinado ponto, declare explicitamente que "não possui informações suficientes". Sob nenhuma hipótese invente (alucine) dados financeiros ou nomes de empresas.
...
```text
Como é a perspectiva da indústria de robôs? Recomende algumas ações relacionadas a isso para eu investir.
```

### ✅ Depois (Resultado Estruturado via Pro Version)

```text
### 🤖 Análise Estratégica Setorial: Indústria de Robótica e Robôs Humanoides

**1. Motores de Crescimento Chave (Growth Drivers)**
- **Déficit Demográfico e Inflação Salarial:** Escassez crítica e progressiva de força de trabalho manual em países desenvolvidos, empurrando a adoção industrial forçada.
- **Convergência Robótica-IA:** A fusão de Modelos de Fundação (LLMs/VLM) avançados atuando como "cérebros" em hardwares de mobilidade otimizados.
- **Queda no CapEx de Componentes:** Redução drástica de custo em componentes essenciais de precisão (atuadores elétricos, sensores LiDAR, chips de IA periférica).

**2. Cadeia de Valor e Ações de Destaque**

| Segmento da Cadeia | Papel / Função | Destaques Globais (Tickers) | Relevância Local (Brasil/EUA) |
| :--- | :--- | :--- | :--- |
| **Cérebro (Software/IA)** | Cognição, Visão, Lógica | Nvidia (NVDA), Microsoft (MSFT) | Locaweb (LWSA3 - Datacenters) |
| **Atuadores (Hardware de Base)** | Motores de Passo, Juntas | Harmonic Drive (6324.T), Yaskawa | WEG (WEGE3 - Motores Elétricos) |
| **Montadoras (Produto Final)** | Integração e Vendas B2B | Tesla (TSLA), Boston Dynamics | Embraer (EMBR3 - via Eve/Tech) |

**3. 🚨 Risco Crítico de Mercado**
- **Regulação Rigorosa e "Imposto sobre Robôs":** À medida que a automação avança, há um risco severo de intervenção estatal visando taxar a automação para suprir a perda de recolhimento previdenciário da força de trabalho humana deslocada, além de normas extremas de segurança de hardware.
```
