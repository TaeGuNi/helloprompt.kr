...
## 🚀 Solución: "Arquitecto de Presentaciones"
...
> **Contexto (Context):**
>
> - Fondo: `[Breve descripción de la situación actual o el problema a resolver]`
> - Objetivo: `[El objetivo principal de esta presentación, e.g., Conseguir aprobación de presupuesto, Informar sobre resultados trimestrales]`
> - Audiencia: `[Quién verá la presentación, e.g., Junta directiva, Clientes potenciales, Equipo interno]`
> - Duración/Número de diapositivas: `[Ej. 10 minutos o 15 diapositivas]`
>
> **Tarea (Task):**
>
...
>
> - Evita la jerga innecesaria a menos que sea apropiada para la audiencia especificada.
> - Mantén el texto de cada diapositiva conciso (aplica la regla de no más de 6 líneas por diapositiva en el concepto).
> - Presenta el resultado final estrictamente en formato de tabla Markdown.
>
> **Advertencia (Warning):**
>
> - No inventes datos estadísticos. Si se necesitan ejemplos numéricos, usa marcadores de posición claros como "[Insertar dato sobre X]".
...
```text
Necesito hacer un PPT sobre nuestra nueva campaña de marketing para el próximo trimestre. Serán como 10 slides. Dame ideas sobre qué poner.
```
