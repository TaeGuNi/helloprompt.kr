...
- **🤖 Modèle recommandé :** Midjourney (v6.0+), DALL-E 3, Stable Diffusion
...
## 🚀 La Solution : Prompt "Conduite Rétro"
...
Utilisez ce prompt détaillé, particulièrement optimisé pour Midjourney ou Stable Diffusion, afin d'obtenir une qualité de production et un contrôle total sur l'esthétique. Copiez-le tel quel ou modifiez les variables entre crochets.

> **Sujet (Subject) :**
>
> `[a DeLorean sports car]` driving on an endless digital highway towards a giant sunset.
>
> **Fond (Background) :**
>
> Neon grid landscape, silhouette of palm trees, retro futuristic city skyline.
>
> **Style et Ambiance (Style & Mood) :**
>
> Synthwave art style, retrowave, 80s vibe, vibrant purple and orange gradient, lo-fi aesthetic, VHS glitch effect.
>
> **Paramètres (Parameters - Midjourney) :**
>
