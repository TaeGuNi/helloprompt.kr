...
- **🤖 Recommended Model:** Apple Intelligence 2.0 (Siri on iPhone 17 / A19 Pro)
...
## 🚀 The Solution: "The Siri 2.0 Cross-App Workflow Prompt"
...
> **Task:**
>
> 1. Read this current email thread and extract the key action items assigned to me.
> 2. Create individual tasks in the Reminders app for each action item, setting the due dates based on the email context.
> 3. Draft a polite reply confirming I am on it, and briefly summarizing the timeline.
>
> **Constraints:**
>
> - Keep the email draft concise and professional.
> - Do not send the email automatically; open the draft so I can review it first.
> - If any deadlines are ambiguous, set the Reminder for this Friday at 5 PM.
