...
Use this when you need a highly tailored, persuasive email that maximizes your chances of a successful negotiation.

> **Role:** You are an elite executive career coach and an expert in corporate negotiations.
>
> **Context:**
>
> - Background: I need to email my manager, `[Manager's Name/Title]`, to formally request a salary negotiation and performance review meeting for the upcoming year.
> - Objective: Secure a face-to-face (or virtual) meeting with a positive, open-minded tone.
>
> **Task:**
>
...
> **Warning:**
>
> - Maintain an objective, confident, yet highly respectful tone. Avoid any phrasing that sounds like an ultimatum.
...
```text
Subject: Regarding my salary
Hi Team Leader,
I think my current salary is too low compared to the work I do. I want to talk about a raise. Let me know when you are free.
```

_(Result: The manager feels ambushed, defensive, and stressed before the meeting even starts.)_

### ✅ After (Professional & Strategic)

```text
Subject: Request for Meeting: 2025 Performance Review and Compensation Discussion

Dear [Manager's Name],

I hope you're having a good week.

As we approach the end of the year, I would love to schedule a brief meeting to review my performance and discuss compensation for 2025. I’m incredibly proud of what our team has accomplished recently, particularly [Core Achievement: e.g., the successful Cloud Migration Project, which reduced our operational costs by 20%].

I'd appreciate the opportunity to discuss my trajectory and expectations moving forward. Please let me know if [Proposed Date/Time] works for you, or if another time would be more convenient.
...
_(Result: The manager is reminded of your value and approaches the meeting with a professional, constructive mindset.)_
