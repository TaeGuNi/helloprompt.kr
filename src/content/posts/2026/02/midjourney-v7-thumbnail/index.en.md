...
## 🚀 The Solution: "Thumbnail Cheat Code"

### 🥉 Basic Version

Perfect for a trendy, clean, Notion-esque aesthetic. Use this when you need a high-quality asset fast.
...
> **Context:**
>
> - Background: I need to create a highly engaging thumbnail for a blog post about `[Investment Tips]`.
> - Goal: To generate prompts that result in click-inducing, professional-grade artwork.
>
> **Task:**
>
> 1. Write 3 'Eye-catching' Midjourney prompts in English based on the topic.
> 2. Ensure one prompt utilizes a clean 3D isometric style, and another uses a modern digital illustration style.
> 3. Use the following structure for the Midjourney output: `[Subject] + [Art Style] + [Color Palette] + [Lighting] + [Parameters]`
>
> **Constraints:**
>
> - Output the prompts clearly using markdown code blocks.
> - Ensure all parameters, like `--ar 16:9` and `--v 7.0`, are included at the end of each prompt.
>
> **Warning:**
>
> - Do not include any instructions for generating text within the image. Focus purely on the visual composition.
