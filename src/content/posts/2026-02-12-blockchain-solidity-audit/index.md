...
# (Updated) (Updated) (Updated) ⛓️ 블록체인 스마트 컨트랙트: Solidity 코드 생성 및 감사 (Audit) {#audit}
...
## (Updated) (Updated) (Updated) 🚀 해결책: "Smart Contract Developer Prompt"

### (Updated) (Updated) (Updated) 🥉 Basic Version (ERC-20 토큰 생성) {#erc-20}
...
### (Updated) (Updated) (Updated) 🥇 Pro Version (보안 감사 및 가스비 최적화)
...
### (Updated) (Updated) (Updated) ❌ Before (그냥 짬)

`balances[msg.sender] -= amount;` (순서 잘못 써서 돈 무한 복사 버그 발생 💸)

### (Updated) (Updated) (Updated) ✅ After (AI 감사) {#ai}
