...
## 🚀 La Solution : "Le Révélateur de Profil d'Investisseur"
...
> **Contexte (Context) :**
>
> - Objectif : Je veux découvrir ma véritable tolérance au risque avant de structurer mon portefeuille.
> - Méthode : Ne me donne pas un questionnaire QCM classique. Plonge-moi dans des situations de crise financière concrètes (Scénarios) pour tester mon sang-froid.
>
> **Tâche (Task) :**
>
> 1. Pose-moi, une par une, **3 questions basées sur des situations de crise** réalistes (ex. : "Votre portefeuille vient de perdre 50 % de sa valeur suite à l'annonce d'une nouvelle pandémie mondiale. Que faites-vous ?").
> 2. Après avoir analysé mes réponses, détermine mon **profil de risque (Risk Tolerance)** parmi les suivants : 'Sécuritaire / Modéré / Équilibré / Dynamique / Agressif'.
> 3. Recommande-moi une **allocation d'actifs idéale (Actions : Obligations : Liquidités)** qui correspond parfaitement à mon profil psychologique.
>
> **Contraintes (Constraints) :**
>
> - Pose les questions de manière **interactive**, l'une après l'autre. Attends ma réponse avant de passer à la question suivante.
> - Ton analyse finale doit être présentée sous forme de liste à puces claire et argumentée.
>
...
```text
### 🧠 Résultat de votre Diagnostic : Profil [Dynamique] (Growth Investor)

**1. Base de l'Analyse**
- Face à une chute brutale de 20 % du marché, vous avez choisi de considérer cela comme une "opportunité de soldes" et de réinvestir massivement.
- Vous tolérez une volatilité importante si cela vous permet de battre l'inflation sur le long terme. Vous préférez le risque de perte temporaire au risque d'érosion de votre pouvoir d'achat.

**2. Allocation d'Actifs Recommandée (60 : 30 : 10)**
- 📈 **Actions (60 %) :** Moteur de croissance (ETF S&P 500, MSCI World).
- 🛡️ **Obligations (30 %) :** Amortisseurs de volatilité (Fonds euros, obligations d'État).
- 💰 **Liquidités (10 %) :** Trésorerie stratégique pour saisir les opportunités lors des baisses de marché.

**3. Conseil en Psychologie Financière**
Vous avez une forte tolérance à la volatilité, mais attention au biais d'excès de confiance (Overconfidence). Rappelez-vous toujours de conserver votre poche de liquidités et de ne pas investir l'argent dont vous pourriez avoir besoin à court terme.
```
