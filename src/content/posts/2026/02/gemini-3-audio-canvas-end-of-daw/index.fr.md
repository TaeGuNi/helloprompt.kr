...
## 🚀 La Solution : "Prompt de contrôle précis Audio Canvas"
...
> **Contexte (Context) :**
>
> - Arrière-plan : `[Objectif du contenu, ex: Musique de fond pour un vlog YouTube, parfaite pour regarder la pluie par la fenêtre]`
> - Objectif : `[Ambiance du résultat final, ex: Un beat calme, émotionnel et achevé]`
>
> **Tâche (Task) :**
>
...
>
> - **BPM :** `[ex: 80-85]`
> - **Tonalité (Key) :** `[ex: Do Majeur ou La Mineur]`
...
>
> - Refuse les demandes de mixage sur des bandes de fréquences physiquement impossibles ou toute imitation de la voix d'un artiste spécifique protégé par des droits d'auteur, et propose une alternative. (Prévention des hallucinations et des violations de droits d'auteur)
...
```text
[Commande supplémentaire après avoir soumis le prompt de la Version Pro]
