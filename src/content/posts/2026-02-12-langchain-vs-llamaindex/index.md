...
# (Updated) ⛓️ LangChain vs LlamaIndex: 도대체 뭘 써야 할까? {#updated}
...
## (Updated) 🚀 해결책: "Framework Selector Prompt" {#updated}

### (Updated) 🥉 Basic Version (특징 비교) {#updated}
...
### (Updated) 🥇 Pro Version (아키텍처 설계 조언) {#updated}
...
### (Updated) ❌ Before (무조건 랭체인) {#updated}

"랭체인이 짱이래." -> PDF 10만 개 로드하다가 메모리 터지고, 검색 정확도 떨어짐. 🤯

### (Updated) ✅ After (적재적소) {#updated}
