...
## 🚀 Die Lösung: "Der KI-Datenanalyst"
...
Nutzen Sie diesen Prompt für tiefgehende Analysen und professionelle Berichte mit hoher Detailgenauigkeit.

> **Rolle (Role):** Du bist ein Senior Data Scientist und strategischer Unternehmensberater.
>
> **Kontext (Context):**
>
> - Hintergrund: Das Folgende sind die `[Datentyp, z.B. Verkaufsdaten]` unseres Unternehmens aus dem letzten Monat.
> - Ziel: Versteckte Muster erkennen und umsetzbare Geschäftsstrategien ableiten.
> - Daten: `[Fügen Sie hier Ihre Rohdaten oder CSV-Werte ein]`
>
> **Aufgabe (Task):**
>
> 1. Identifiziere die 3 auffälligsten Muster, Trends oder Ausreißer (Anomalien) in diesen Daten.
> 2. Interpretiere die geschäftliche Bedeutung jedes gefundenen Musters. Warum ist das passiert?
> 3. Schlage basierend auf diesen Erkenntnissen konkrete Verbesserungsmaßnahmen oder neue Geschäftsmöglichkeiten vor.
>
> **Einschränkungen (Constraints):**
>
> - Jede Behauptung muss durch konkrete Zahlen aus den Daten belegt werden.
> - Vermeide übermäßig komplexe Statistik-Fachbegriffe. Erkläre alles in klarer, überzeugender Geschäftssprache.
> - Strukturiere die Antwort übersichtlich mit Aufzählungspunkten und Fettdruck für wichtige Kennzahlen.
>
> **Warnung (Warning):**
>
> - Wenn die Daten nicht ausreichen, um eine sichere Schlussfolgerung zu ziehen, weise ausdrücklich darauf hin. Erfinde keine Fakten.
...
```text
Hier sind unsere Verkaufsdaten von Januar bis Dezember. Analysiere das mal.
```

### ✅ After (Ergebnis)

```text
📊 Analyse der Verkaufsdaten (Jan - Dez)

1. Saisonale Umsatzspitze im Sommer (Muster):
- Die Verkaufszahlen stiegen im Juli und August um 32 % im Vergleich zum Jahresdurchschnitt.
- Geschäftliche Bedeutung: Unsere Produkte haben eine starke saisonale Relevanz, die wir bisher nicht voll ausschöpfen.
- Maßnahme: Verdreifachung des Marketingbudgets für Sommerkampagnen bereits ab Mitte Juni, um den Trend frühzeitig mitzunehmen.

2. Rückgang der Wiederkaufrate (Ausreißer):
- Trotz hoher Neukundenakquise im November fiel die Wiederkaufrate im Dezember um 5,4 %.
- Geschäftliche Bedeutung: Das Onboarding oder das Produkterlebnis nach dem Erstkauf ist nicht überzeugend genug.
- Maßnahme: Initiierung einer automatisierten Follow-up-E-Mail-Kampagne 14 Tage nach dem Kauf, gekoppelt mit einem 10%-Rabattcode.
```
