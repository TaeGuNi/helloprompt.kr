...
- **🤖 Angewandte Technologien:** Google Analytics, Google AdSense (Cookie-basierte personalisierte Analysen)
...
> **Aufgabe (Task):**
>
> 1. **Statistische Analyse:** Traffic-Analyse und Verbesserung der Inhaltsqualität mithilfe von Google Analytics.
> 2. **Personalisierte Werbung:** Schaltung relevanter und nützlicher Anzeigen über Google AdSense (zur Monetarisierung).
> 3. **Sicherheitsmaßnahmen:** Blockierung bösartiger Bot-Zugriffe und Abwehr von abnormalem Traffic (z. B. DDoS-Angriffe).
>
> **Einschränkungen (Constraints):**
>
> - Alle gesammelten Protokolldaten müssen nach der statistischen Analyse unverzüglich anonymisiert oder gelöscht werden. (Maximale Aufbewahrungsfrist: 3 Monate)
>
> **Warnung (Warning):**
>
...
- **Zuständig:** Datenschutz-Team von Hello Prompt
- **E-Mail:** `support@helloprompt.kr`

Setze deine kreative Reise durch die Welt der KI-Prompts in einer transparenten und sicheren Internetumgebung fort! 🚀
