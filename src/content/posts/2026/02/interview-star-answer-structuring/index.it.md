...
- **Q: Posso usare questo prompt anche per scrivere le esperienze sul CV?**
  - A: Assolutamente sì! Basta aggiungere nei Vincoli del prompt: _"Trasforma il risultato in un elenco puntato adatto a un curriculum, iniziando con un verbo d'azione forte"_.
- **Q: Cosa faccio se l'episodio non ha un "Risultato" positivo o quantificabile?**
  - A: Non preoccuparti. Se non ci sono numeri (es. "+20% di vendite"), chiedi all'IA di concentrarsi sulla _lezione appresa_ (es. "Ho imparato a gestire le priorità sotto pressione"). L'autoconsapevolezza vale quanto un successo numerico.
