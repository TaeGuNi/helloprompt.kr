...
## (Updated) (Updated) (Updated) (Updated) (Updated) 🎯 Target Audience (누구를 위한 글인가)

- **크리에이터 & 유튜버:** 저작권 걱정 없는 맞춤형 BGM이 필요한 분.
- **뮤지션 & 프로듀서:** AI 도구가 자신의 직업에 미칠 영향이 궁금한 전문가.
- **프롬프트 엔지니어:** 텍스트-오디오(Text-to-Audio) 제어 기술을 익히고 싶은 분.

## (Updated) (Updated) (Updated) (Updated) (Updated) 💡 Intent (이 글의 목적)
...
## (Updated) (Updated) (Updated) (Updated) (Updated) 🛠 Pragmatic Utility (실전 활용성)
...
### (Updated) (Updated) (Updated) (Updated) (Updated) 1. 인페인팅 & 아웃페인팅 (In-painting & Out-painting)

이미지 생성 AI에서 쓰던 용어 그대로입니다. 트랙의 특정 구간(예: 1분 20초~1분 30초)을 드래그한 뒤 프롬프트를 입력하면, 그 부분만 수정됩니다.

"드럼 비트를 걷어내고, 몽환적인 신디사이저 패드로 채워줘."

### (Updated) (Updated) (Updated) (Updated) (Updated) 2. 스템 분리 및 리믹스 (Stem Separation)

업로드한 오디오 파일에서 보컬, 베이스, 드럼, 기타를 자동으로 분리합니다. 그리고 각 레이어에 대해 별도의 효과를 주문할 수 있습니다.

### (Updated) (Updated) (Updated) (Updated) (Updated) 3. Prompt Craftsmanship (프롬프트 장인정신)
...
## (Updated) (Updated) (Updated) (Updated) (Updated) 4. Human Touch: Writer's Insight (작성자 코멘트)
...
## (Updated) (Updated) (Updated) (Updated) (Updated) 5. Integrity & Ethics (윤리 및 저작권)
