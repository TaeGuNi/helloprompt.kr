...
## 🚀 La solution : "Le Prompt du Docteur Burn-out"
...
Utilisez cette version pour une analyse structurée et des solutions concrètes.

> **Rôle (Role) :** Tu es un `[psychologue expert]` avec plus de 10 ans d'expérience dans le suivi de la santé mentale des professionnels de la tech.
>
> **Contexte (Context) :**
>
> - Contexte : Je suis un `[développeur back-end]` avec `[5]` ans d'expérience. Récemment, je suis mentalement et physiquement épuisé à cause de `[heures supplémentaires fréquentes et de délais de projet irréalistes]`.
> - Symptômes : Même quand je code, je ne ressens plus aucun sentiment d'accomplissement, et discuter avec mes collègues sur la messagerie me demande un effort surhumain. Le week-end, je reste couché sans rien faire.
>
> **Tâche (Task) :**
>
> 1. **Analyse approfondie :** Analyse mes symptômes en te basant sur les 3 dimensions du MBI (Maslach Burnout Inventory), l'échelle de référence du burn-out en psychologie : l'épuisement émotionnel, la dépersonnalisation et la perte d'accomplissement personnel.
> 2. **Diagnostic objectif :** Évalue mon niveau de risque actuel de burn-out sur une échelle de 1 à 10.
> 3. **Prescription sur mesure (Prescription) :** Évite les conseils irréalistes comme "Reposez-vous à tout prix". Propose-moi plutôt 3 "routines de récupération sur mesure pour développeur", sous forme de plan d'action concret que je peux mettre en pratique dès demain en arrivant au bureau ou juste après le travail.
>
> **Contraintes (Constraints) :**
>
> - Évite tout sentimentalisme ou réconfort artificiel. Garde un ton analytique, pragmatique et professionnel.
> - Ajoute une courte clause de non-responsabilité à la fin pour rappeler que cela ne remplace en aucun cas un diagnostic médical professionnel.
...
1.  **Application d'un cadre scientifique (MBI) :** Au lieu de demander un simple diagnostic, nous avons imposé à l'IA d'utiliser des critères psychologiques précis : l'épuisement émotionnel, la dépersonnalisation et la perte d'accomplissement. Ainsi, l'IA produit une analyse logique et multidimensionnelle plutôt que des banalités réconfortantes.
2.  **Contraintes réalistes (Constraints) :** En tenant compte de la réalité et de la personnalité des développeurs, nous avons bloqué d'emblée les conseils impossibles à suivre comme "Prenez des vacances illimitées", pour exiger un plan de "micro-actions" immédiatement applicables, maximisant ainsi l'utilité du prompt.

---

## 📊 Preuve : Avant & Après

### ❌ Avant (Mode d'auto-exploitation)

```text
Moi : "Ah, je n'ai vraiment pas envie d'écrire une seule ligne de code ces jours-ci. Je n'arrive plus à me concentrer. Je dois être devenu paresseux. Je vais boire un autre Red Bull et me forcer à coder. Pourquoi les autres y arrivent et pas moi ?"

(Résultat : Manque de sommeil -> Baisse supplémentaire de la concentration -> Haine de soi exacerbée et aggravation du burn-out 📉)
```

### ✅ Après (Mode d'acceptation de soi et de récupération)

```text
IA : "D'après l'analyse, votre risque actuel de burn-out est de 8.5/10. L''épuisement émotionnel' est particulièrement critique.
Il ne s'agit pas de paresse, mais d'un mécanisme de défense de votre cerveau pour éviter une surcharge du système. Vous n'avez aucune raison de vous culpabiliser.

Micro-routines à mettre en pratique immédiatement :
1. Regrouper la vérification des notifications Slack une fois par heure.
2. Marcher pendant 15 minutes en rentrant du travail sans écouteurs, en prêtant attention aux bruits environnants..."

(Résultat : Allègement de la culpabilité infondée, début de changements de comportement minimes et récupération mentale progressive 🧘)
```
...
Même le serveur le plus performant plantera si son disque et son CPU sont surchargés par un afflux de trafic. À plus forte raison, le cerveau humain, doté d'émotions complexes, ne peut y échapper.
