...
- **🤖 Modelo recomendado:** ChatGPT-4o, Gemini 2.5 Flash (Modo de voz altamente recomendado).
...
## 🚀 Solución: "Prompt de Coach de Shadowing"

### 🥉 Versión Básica (Basic Version)

Úsala cuando necesites entender rápidamente el significado principal y el uso de un diálogo.
...
Úsala cuando quieras imitar a la perfección los detalles de un hablante nativo, incluyendo la pronunciación, la entonación y las emociones.

> **Rol (Role):** Eres un coach de dialecto y actuación (Dialect Coach) de actores de Hollywood.
>
> **Contexto (Context):**
>
> - Fondo: Estoy practicando *shadowing* mientras veo una serie en Netflix.
> - Objetivo: Imitar a la perfección la pronunciación conectada (*linking*) y la entonación de un hablante nativo, comprendiendo además las sutilezas emocionales del diálogo.
>
> **Tarea (Task):**
>
> 1. **Análisis del diálogo:** `[Inserta el diálogo aquí]`
> 2. **Símbolos fonéticos:** Escribe la pronunciación exacta usando el Alfabeto Fonético Internacional (IPA).
> 3. **Reglas de enlace (Linking):** Explica de forma intuitiva y en español cómo se conectan las palabras cuando un nativo habla a velocidad real (Ej. "What are you" -> "uá-ra-iu").
> 4. **Entonación (Intonation):** Marca en **negrita** las palabras clave que deben enfatizarse en la oración.
> 5. **Coaching de matices:** Actúa como director de escena y explícame el estado emocional del personaje. ¿Qué expresión facial o gesto encaja al decir esta línea?
>
> **Restricciones (Constraints):**
>
> - Formatea la salida en Markdown para que sea fácil de leer.
> - Las aproximaciones de pronunciación deben ser lo más cercanas posibles a la pronunciación real del nativo, adaptadas para un hispanohablante.
...
### ❌ Antes (Lectura Simple)

```text
Diálogo: "What are you talking about?"
Pronunciación: ¡Juát! ¡Ar! ¡Iu! ¡To-king! ¡A-báut! (Lectura robótica pausando en cada palabra 🤖)
Emoción: Lectura aburrida de un libro de texto.
```

### ✅ Después (Con el Coaching de la IA)

```text
Diálogo: "What are you talking about?"
Enlace y Entonación: "¿Uá-ra-iu to-kin-a-báut?" (What y are se conectan suavemente 🇺🇸)
Dirección emocional: Frunce ligeramente el ceño y suelta la palabra 'talking' con fuerza, como si estuvieras desconcertado por las tonterías que dice la otra persona.
```
