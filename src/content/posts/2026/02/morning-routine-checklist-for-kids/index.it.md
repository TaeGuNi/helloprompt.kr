...
1. **Gamification:** Trasforma gli ordini mattutini in entusiasmanti missioni di gioco.
2. **Autonomia:** Sviluppa le capacità di gestione del tempo fin dalla tenera età.
3. **Pace Mentale:** Inizia la giornata con energia positiva, eliminando le urla e lo stress.

---

## 🚀 Soluzione: Prompt "Manager della Routine Mattutina"

### 🥉 Basic Version (Versione Rapida)

Ideale per ottenere subito un piano semplice e funzionale.
...
Per creare una vera e propria avventura su misura e di altissima qualità. Copia il **PROMPT** qui sotto e personalizza le variabili tra parentesi quadre.

> **Ruolo (Role):** Sei un esperto life coach specializzato in psicologia infantile e gamification.
>
> **Contesto (Context):**
>
> - Background: Mio figlio di `[7]` anni impiega troppo tempo per vestirsi e prepararsi al mattino, distraendosi continuamente.
> - Obiettivo: Voglio creare una tabella della routine mattutina strutturata come un gioco, affinché possa completare i compiti con entusiasmo e in autonomia.
>
> **Compito (Task):**
>
> 1. Suddividi la routine in 4 fasi principali (Risveglio -> Igiene personale -> Vestizione -> Preparazione dello zaino) e rinominale come vere e proprie "Missioni Segrete" o "Sfide Eroiche".
> 2. Associa a ogni missione completata entro 5 minuti una 'formula magica di successo' o un elogio specifico e gratificante.
>
> **Vincoli (Constraints):**
>
> - Scrivi le istruzioni sotto forma di 'Sfida' interattiva, evitando il tono imperativo o autoritario.
> - Usa nomi di missioni creativi, divertenti e adatti all'immaginario di un bambino (es. "L'Eroe dello Spazzolino Scintillante").
> - Presenta il risultato finale formattato in una tabella Markdown chiara e pronta per essere stampata.
>
> **Avvertenze (Warning):**
>
> - Mantieni un linguaggio semplice, positivo ed estremamente incoraggiante. Non includere punizioni, ma concentrati sui rinforzi positivi.
...
```text
| 🛡️ Missione Eroica | ⏱️ Tempo | ✨ Formula di Successo (Premio Verbale) |
| :--- | :--- | :--- |
| **1. Fuga dal Regno dei Sogni** (Alzarsi e rifare il letto) | 5 Min | "Incredibile salto dimensionale, Eroe!" |
| **2. Sconfitta dei Mostri della Carie** (Lavare viso e denti) | 5 Min | "Scudo di menta attivato! Sorriso accecante!" |
| **3. Armatura del Giorno** (Vestirsi da soli) | 5 Min | "Armatura equipaggiata alla perfezione!" |
| **4. Rifornimento Tattico** (Preparare lo zaino) | 5 Min | "Equipaggiamento pronto per la grande avventura!" |
```
