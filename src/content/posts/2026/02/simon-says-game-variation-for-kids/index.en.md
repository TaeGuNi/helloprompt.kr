...
description: "Improve your child's concentration and physical control with whimsical, AI-generated missions. Learn how to use AI prompts effectively with practical examples and expert tips."
...
## 🚀 Solution: "AI Brain Development Play Planner"
...
> **Context:**
>
> - Background: I am going to play 'Simon Says' in the `[Location, e.g., living room]` with my `[Age, e.g., 5 and 7]`-year-old children.
> - Goal: To improve their auditory attention and working memory while expending physical energy.
>
> **Task:**
>
> 1. Create 3 missions for each difficulty level (Easy/Normal/Hard), providing a total of 9 missions.
> 2. For the 'Hard' level, incorporate multi-step instructions (e.g., doing two actions simultaneously or in a specific sequence).
>
> **Constraints:**
>
> - All actions must be safe to perform indoors within the `[Location]`.
> - Incorporate highly engaging and imaginative elements, such as `[Theme, e.g., animal impressions or space adventures]`.
> - Format the output as a clear Markdown list.
>
> **Warning:**
>
> - Do not include any actions that require heavy jumping or running to prevent indoor accidents and noise complaints.
...
```text
Give me some Simon Says commands.
```

### ✅ After (Pro Prompt Output)

```text
**Hard Difficulty (Ages 5-7):**
1. "Simon says: Pretend you are a flamingo! Stand on one leg, tuck your hands under your armpits like wings, and count to five out loud!"
2. "Simon says: Turn into a spinning top! Spin around twice in a circle, then immediately freeze like a statue and don't blink!"
3. "Simon says: Be a sneaky ninja! Tiptoe quietly to the nearest wall, touch it with both hands, and sneak back to your spot without making a sound!"
```
