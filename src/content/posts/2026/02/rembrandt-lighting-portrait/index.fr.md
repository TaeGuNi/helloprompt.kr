...
- **🤖 Modèles recommandés :** Tous les modèles d'IA (Midjourney, Stable Diffusion, DALL-E)
...
## 🚀 La Solution : « Le Prompt de Portrait Rembrandt »
...
>
> **Éclairage (Lighting) :** Rembrandt lighting, dramatic side lighting, deep shadows, chiaroscuro, subtle light triangle on the shadow side cheek.
>
> **Style et Ambiance (Style & Mood) :** Oil painting texture, classic art style, photorealistic masterpiece, 8k resolution, sharp focus.
>
> **Paramètres (Midjourney) :** --ar 4:5 --v 6.0 --style raw
...
```text
Face of an old man, Rembrandt lighting, chiaroscuro, dramatic side lighting.
```

_(Résultat : Un portrait artistique saisissant. Un côté du visage est plongé dans une ombre mystérieuse, la lumière caresse la joue opposée en formant un triangle parfait, révélant la profondeur et l'histoire de chaque ride.)_
