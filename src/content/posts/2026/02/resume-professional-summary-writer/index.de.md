...
- **🤖 Empfohlenes Modell:** GPT-4, Claude 3.5 Sonnet, Gemini Advanced
...
> **Rolle (Role):** Du bist ein hochkarätiger Experte für Personal Branding und ein erfahrener Executive Recruiter.
>
> **Kontext (Context):**
>
> - Ziel: Ich möchte eine aussagekräftige **Professional Summary** für den Kopfbereich meines Lebenslaufs verfassen.
> - Hintergrund: Ich habe `[N]` Jahre Berufserfahrung als `[Aktuelle Berufsbezeichnung]`.
>
...
```text
Hallo, mein Name ist Max Mustermann. Ich habe 5 Jahre Erfahrung im Marketing gesammelt.
Ich kann mit verschiedenen Tools umgehen, bin sehr teamfähig und kommunikationsstark.
Wenn Sie mir die Chance geben, werde ich hart für Ihr Unternehmen arbeiten und mich schnell einarbeiten.
```

### ✅ Nachher (KI-optimiert, Fokus auf messbare Erfolge)

```text
Datengetriebener Performance-Marketer mit 5 Jahren Erfahrung in der Skalierung digitaler Geschäftsmodelle.
Erfolgreiche Verwaltung eines Jahresbudgets von über 1 Mio. Euro und nachweisliche Steigerung des ROAS um 200 % im B2C-Segment.
Experte für präzise Kundensegmentierung mittels SQL und Python; treibt nachhaltiges Unternehmenswachstum durch fundierte, datenbasierte Entscheidungen voran.
```
