...
> _"¿Estás cansado de mirar el clima y seguir sin saber qué ponerte? Deja que la IA analice la temperatura, humedad y viento para armar tu outfit perfecto."_

Todas las mañanas, la misma batalla: miras por la ventana, revisas la aplicación del clima, ves "15°C con probabilidad de lluvia", y aún así, no tienes idea de si necesitas un abrigo grueso o si bastará con una chaqueta ligera. Peor aún, te vistes y a mitad del día te das cuenta de que la humedad arruinó tu elección.

Con este prompt, convertirás a la IA en tu estilista personal. Ya no tendrás que adivinar; recibirás recomendaciones precisas de qué prendas usar, cómo combinarlas y qué accesorios llevar según las condiciones climáticas exactas de tu ciudad, garantizando que siempre estés cómodo y a la moda.
...
2. **Contexto de estilo:** Especifica tu código de vestimenta (casual, oficina, cita) y tus preferencias.
...
Úsala para obtener combinaciones detalladas, consejos de capas de ropa (layering) y recomendaciones de texturas basadas en variables climáticas sutiles como el viento y la humedad.
...
> 2. Basado en mi código de vestimenta `[Ej: Business Casual, Streetwear, Deportivo]` y mi género `[Ej: Hombre, Mujer, Neutro]`, propón un outfit completo.
...
2. **Justificación del Estilo ("Por qué"):** Al pedirle a la IA que explique por qué eligió cada prenda (ej. "Lino porque es transpirable para la alta humedad"), aprendes inconscientemente sobre reglas de moda y clima.
