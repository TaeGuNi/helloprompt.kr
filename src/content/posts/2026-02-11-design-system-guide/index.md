...
# (Updated) (Updated) (Updated) 🎨 디자인 시스템 구축: 디자이너와 개발자가 안 싸우는 법
...
## (Updated) (Updated) (Updated) 🚀 해결책: "Design Token Prompt"

### (Updated) (Updated) (Updated) 🥉 Basic Version (이름 짓기)
...
### (Updated) (Updated) (Updated) 🥇 Pro Version (코드 자동 생성)
...
### (Updated) (Updated) (Updated) ❌ Before (하드코딩)

`background-color: #3b82f6;` (색상 바꿀 때 파일 100개 수정 😱)

### (Updated) (Updated) (Updated) ✅ After (디자인 토큰)
