...
## 🚀 La Solution : « Le Rédacteur de CV Natif »
...
Utilisez cette version pour un rendu détaillé, percutant et prêt à être envoyé.

> **Rôle (Role) :** Tu es un `[recruteur Senior de la Silicon Valley et expert en rédaction de CV anglophones]`.
>
> **Contexte (Context) :**
>
...
> **Demande (Task) :**
>
> 1. Commence chaque puce par un **Verbe d'Action puissant** (ex: Led, Orchestrated, Spearheaded).
> 2. Omets systématiquement les pronoms personnels ('I', 'My').
> 3. Mets en **Gras** les chiffres clés, les pourcentages et les résultats concrets.
> 4. Reformule les expressions maladroites en utilisant le jargon professionnel naturel des locuteurs natifs.
> 5. Traduis le `[Texte du CV]` fourni ci-dessous en respectant ces critères.
>
> **Contraintes (Constraints) :**
>
> - Le texte doit être totalement exempt d'erreurs grammaticales et orthographiques.
> - Respecte scrupuleusement la concordance des temps (Passé pour les expériences terminées, Présent pour le poste actuel).
> - Présente le résultat sous forme de liste à puces (bullet points) claire et lisible.
>
> **Texte du CV (Input) :**
>
...
### ❌ Avant (Style Traduction Littérale / Konglish)
...
### ✅ Après (Style CV Anglophone Natif)

```text
• **Spearheaded** a comprehensive new sales strategy as Team Lead, successfully driving a **20% increase** in annual revenue.
• **Optimized** client acquisition processes, which directly enhanced overall team productivity.
```
