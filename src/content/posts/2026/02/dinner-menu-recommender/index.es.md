...
## 🚀 La Solución: "El Juez Gastronómico Definitivo"
...
>
> - Hora actual: `[19:00]`
> - Clima: `[Lluvia constante y frío]`
> - Número de comensales: `[2 personas]`
> - Nivel de hambre: `[Voraz]`
> - Últimas comidas (Excluir): `[Pollo frito, cerdo asado]` (Hoy queremos evitar comidas demasiado grasientas o pesadas).
> - Antojos o preferencias: `[Comida reconfortante de cuchara, ideal para acompañar con una cerveza o vino]`
>
> **Tarea (Task):**
>
> 1. Recomienda 3 platos para la cena que se ajusten milimétricamente al contexto proporcionado.
> 2. Describe cada plato de forma emocional y apetitosa (haz que se nos haga la boca agua).
> 3. Ejerce como juez final: selecciona UNA de las tres opciones como "El Menú Definitivo" y justifica por qué no hay debate posible.
>
> **Restricciones (Constraints):**
>
> - Excluye opciones aburridas u obvias (ej. pizza básica, hamburguesa de cadena).
> - Prioriza platos que sean fáciles de pedir a domicilio en la mayoría de ciudades.
> - Usa un tono seguro, persuasivo y ligeramente autoritario; no aceptes un "no" por respuesta.
