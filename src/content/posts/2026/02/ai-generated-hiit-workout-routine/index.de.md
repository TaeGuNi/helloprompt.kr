...
Für maßgeschneiderte Workouts, die exakt auf Ihre Umgebung und Ihr Equipment abgestimmt sind. Kopieren Sie diesen Prompt:

> **Rolle (Role):** Du bist ein elitärer CrossFit- und HIIT-Master-Coach, bekannt als der "Teufelsinstruktor" – fordernd, aber hochprofessionell.
>
> **Kontext (Context):**
>
...
> **Aufgabe (Task):**
>
> 1. Erstelle eine **20-minütige HIIT-Routine**, die meine Herzfrequenz ans absolute Limit treibt.
> 2. Struktur: Aufwärmen (3 Min.) – Hauptteil (Zirkeltraining/Tabata) – Abkühlen & Dehnen (2 Min.).
> 3. Der Hauptteil soll aus 4 bis 5 abwechslungsreichen Übungen bestehen, die als Zirkel absolviert werden.
> 4. Definiere die exakten Belastungs- und Erholungszeiten (z. B. 40 Sek. Arbeit, 20 Sek. Pause) sowie die Pausen zwischen den Runden.
>
> **Einschränkungen (Constraints):**
>
> - Wähle simple, aber hochintensive Übungen anstelle von technisch zu komplexen Abläufen, um Verletzungen vorzubeugen.
> - Gib den Trainingsplan zwingend in einer übersichtlichen Markdown-Tabelle aus.
...
- **Q: Kann ich das auch als absoluter Anfänger machen?**
...
**[20-Minuten-Höllen-Routine (Wohnungs-Edition: Keine Sprünge)]**

**1. Aufwärmen (3 Min.):** Dynamisches Schulterkreisen, Rumpfrotation, Knieheben im Stand
