...
## 🚀 Die Lösung: "Skill Gap Analyzer"

### 🥉 Basic Version (Für den schnellen Überblick)

Nutzen Sie diese Variante, wenn Sie sofort ein grobes Feedback benötigen.
...
Nutzen Sie diese Variante für maximale Präzision und handlungsorientierte Ergebnisse.

> **Rolle (Role):** Du bist ein erfahrener Karriere-Coach und anspruchsvoller Recruiter.
>
> **Kontext (Context):**
>
> - Hintergrund: Ich möchte mich auf die unten stehende **[Ziel-Stellenbeschreibung]** bewerben.
> - Ziel: Ich möchte eine objektive Einschätzung meiner Erfolgschancen auf Basis meines **[Aktuellen Lebenslaufs]** erhalten und genau wissen, welche Qualifikationen mir noch fehlen.
>
> **Aufgabe (Task):**
>
> 1. **Matching-Analyse:** Erstelle eine strukturierte Übersicht. Stelle darin die Anforderungen der Stellenbeschreibung meinen vorhandenen Qualifikationen (Match) und den fehlenden Kompetenzen (Gap) gegenüber.
> 2. **Strategie zur Überbrückung von Lücken:** Entwickle konkrete Vorschläge, wie ich meine bisherigen Erfahrungen neu interpretieren und präsentieren kann, um die fehlenden Anforderungen (Gaps) auszugleichen. Schlage alternativ kurzfristige Maßnahmen vor, mit denen ich diese Lücken schließen kann.
> 3. **Erfolgswahrscheinlichkeit:** Bewerte meine Chancen auf eine Einladung zum Vorstellungsgespräch realistisch auf einer Skala von 0 bis 100 Punkten und begründe deine Einschätzung ausführlich.
>
> **Daten (Input):**
>
...
>
> - Liefere eine eiskalte, objektive Faktenanalyse statt netter Floskeln oder falschem Trost.
> - Formuliere die Ergebnisse in klar strukturierten, sofort umsetzbaren Handlungsempfehlungen.
...
### ❌ Vorher (Vage Sorgen ohne Plan)

```text
"Puh, die suchen jemanden mit fließendem Business-Englisch. Mein Schulenglisch ist etwas eingerostet und ich habe kein TOEFL-Zertifikat... da falle ich bestimmt sofort durch. Ich bewerbe mich einfach auf gut Glück und hoffe, dass es niemandem auffällt." (Keine Vorbereitung)
```

### ✅ Nachher (Strategische Argumentation dank KI)

```text
[Auszug aus der KI-Analyse]
• Identifizierte Lücke (Gap): Fließendes Business-Englisch wird ausdrücklich gefordert. Es fehlen offizielle Zertifikate.
• Überbrückungsstrategie: Obwohl ein formeller Sprachtest fehlt, betonen Sie im Anschreiben Ihre praktische Erfahrung. Verweisen Sie konkret auf das erfolgreiche Krisenmanagement mit dem internationalen Zulieferer im letzten Jahr, bei dem Sie die gesamte Kommunikation auf Englisch geleitet haben. Das demonstriert angewandte Sprachpraxis anstelle von reiner Theorie.
• Erfolgswahrscheinlichkeit: 75/100 Punkte. Die fachliche Eignung ist extrem hoch, das Risiko liegt im sprachlichen Bereich. Bereiten Sie sich darauf vor, einen Teil des Interviews auf Englisch zu führen.
```
