...
> **Context:**
>
> - Background: I urgently need to burn body fat and improve my cardiovascular health.
> - Constraints: I have exactly `[20 minutes]` to work out. I will be exercising at `[Home/Gym/Park]`, and I have access to `[Bodyweight only / Dumbbells / Kettlebells]`. Floor noise `[is not an issue / is a major concern, so absolutely NO jumping]`.
>
> **Task:**
>
> 1. Design a brutal but safe **20-minute HIIT routine** guaranteed to spike my heart rate.
> 2. Structure the workout as follows: Warm-up (3 mins) → Main Circuit (15 mins) → Cool-down & Mobility (2 mins).
> 3. For the main circuit, create 4 to 5 distinct movements designed to be performed in a continuous loop.
> 4. Clearly define the work-to-rest ratio (e.g., 40 seconds work, 20 seconds rest) for each round.
>
> **Constraints:**
>
> - Prioritize simple, high-intensity foundational movements over overly complex acrobatics.
> - Format the output as a clean Markdown table including the order, movement name, and a quick form tip.
>
> **Warning:**
>
> - Ensure the routine strictly adheres to my equipment and floor noise constraints. Do not include burpees or jump squats if I specified no jumping.
...
- **Q: Can I use this prompt if I have injuries (e.g., bad knees)?**
...
**[The 20-Minute Silent Burner (No Floor Noise Version)]**
