...
## 🚀 La Solución: "Analizador de Teorías Paralelas"

### 🥉 Versión Básica (Basic Version)

Ideal para obtener una comparativa rápida y sin complicaciones.
...
Utiliza esta versión para un análisis profundo, estructurado y de alta calidad académica.

> **Rol (Role):** Eres un historiador comparativo experto y analista de perfiles psicológicos e históricos.
>
> **Contexto (Context):**
>
> - Objetivo: Quiero comparar a `[Persona A]` y a `[Persona B]` para comprender profundamente sus estilos de liderazgo, sus circunstancias históricas y el impacto que tuvieron en sus respectivas épocas.
>
> **Solicitud (Task):**
>
> 1. **Tabla de Comparación:** Crea una tabla en formato Markdown que contraste su época, origen, principales logros, finales (cómo murieron o terminaron sus carreras) y palabras clave de su liderazgo.
> 2. **Similitudes y Diferencias:** Analiza y explica las 2 similitudes más grandes y las 2 diferencias más decisivas entre ambas figuras.
> 3. **Conversación Virtual:** Escribe un guion corto e imaginario de una conversación entre ambos en una cafetería moderna. Refleja fielmente sus personalidades, filosofías y tonos de voz.
>
> **Restricciones (Constraints):**
>
> - Mantén una perspectiva estrictamente neutral, objetiva y libre de sesgos históricos o culturales.
> - La conversación ficticia debe ser creíble y basarse en hechos reales o ideologías documentadas de cada personaje.
>
> **Variables (Input):**
>
> - Persona A: `[Ej: Yi Sun-sin / Steve Jobs]`
> - Persona B: `[Ej: Horacio Nelson / Thomas Edison]`
...
### ❌ Antes (Búsqueda Individual Convencional)

```text
Búsqueda 1: Yi Sun-sin -> Almirante coreano, inventó el Barco Tortuga, ganó la batalla de Myeongnyang, murió en la batalla de Noryang...
Búsqueda 2: Horacio Nelson -> Almirante británico, ganó la batalla de Trafalgar, perdió un ojo y un brazo, murió en combate...
(Datos aislados, sin una narrativa que los conecte).
```
...
| Categoría | Yi Sun-sin (Dinastía Joseon) | Horacio Nelson (Imperio Británico) |
| :--- | :--- | :--- |
| Principales Batallas | Hansando, Myeongnyang, Noryang | Nilo, Copenhague, Trafalgar |
| Estilo de Liderazgo | Estratégico, meticuloso, estoico | Audaz, carismático, toma de riesgos |
| Final | Muerto en combate (Noryang, 1598) | Muerto en combate (Trafalgar, 1805) |
| Cita Famosa | "No hagáis saber mi muerte a los enemigos." | "Inglaterra espera que cada hombre cumpla con su deber." |

[Similitudes]
1. Salvadores de la Patria: Ambos fueron almirantes que salvaron a sus respectivos países de una invasión inminente por mar.
2. Sacrificio Final: Ambos perdieron la vida en el clímax de su mayor victoria, convirtiéndose en mártires nacionales.

[Diferencias]
1. Respaldo del Estado: Nelson fue apoyado por su gobierno, mientras que Yi Sun-sin fue degradado por su propio rey a pesar de su lealtad.
2. Enfoque Táctico: Nelson prefería el combate cerrado y agresivo. Yi Sun-sin era un maestro de las formaciones y la artillería a distancia.

[Conversación Virtual]
Nelson: "Almirante Yi, he leído sobre Myeongnyang. Detener a 133 barcos con solo 13... ni siquiera la Royal Navy podría soñar con un milagro así. ¿Cuál fue su secreto?"
Yi Sun-sin: "El terror es natural, Lord Nelson. Mi único secreto fue encontrar la manera de convertir ese miedo paralizante en un coraje inquebrantable para mis hombres."
```
