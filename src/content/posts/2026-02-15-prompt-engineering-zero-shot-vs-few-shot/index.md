...
# (Updated) (Updated) 제로 샷(Zero Shot) vs 퓨 샷(Few Shot) 프롬프팅 {#zero-shot}

## (Updated) (Updated) 소개 (Introduction) {#introduction}
...
### (Updated) (Updated) 제로 샷(Zero Shot) 프롬프팅 {#zero-shot}
...
### (Updated) (Updated) 퓨 샷(Few Shot) 프롬프팅 {#few-shot}
...
### (Updated) (Updated) 결정적인 차이 {#updated}
