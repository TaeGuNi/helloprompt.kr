...
> - **Problema:** Rischio di **Cache Stampede**. Nel momento esatto in cui scade il TTL delle informazioni sull'evento, decine di migliaia di richieste simultanee genereranno un Cache Miss, abbattendosi sul DB e causandone il collasso immediato.
> 
> **Task (Richiesta):**
> 
...
> 3. **Strategia Circuit Breaker:** Progetta un meccanismo per cui, in caso di guasto totale del cluster Redis, il sistema attivi un fallback o una Graceful Degradation per sopravvivere senza andare in crash.
> 
> **Vincoli (Constraints):**
> 
