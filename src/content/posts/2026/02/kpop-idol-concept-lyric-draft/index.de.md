...
## 🚀 Die Lösung: "Der KI-Creative-Director"
...
>
> - **Gruppenname/Art:** `[z.B.: Luminous / 5-köpfige Girlgroup]`
> - **Mitglieder-Vibe:** `[z.B.: Mystisches, verträumtes Visual mit starken Tanzfähigkeiten]`
> - **Kern-Schlüsselwörter:** `[z.B.: Zeitreise, Retro-Futurismus, Girl Crush]`
>
...
"Schreibe ein Konzept für eine Girlgroup, die durch die Zeit reist."

### ✅ Nachher (Ergebnis mit dem Pro-Prompt)

```text
- Albumname: <REWIND: 1999_ERROR>
- Visuelles Konzept: Ein Mix & Match aus dem späten 20. Jahrhundert (Y2K-Vibe mit klobigen Kopfhörern und Baggy-Pants) gepaart mit futuristischen Hologramm-Accessoires und Neondekorationen.
- Universum (Lore): Die Mitglieder stammen aus der Zukunft, sind aber aufgrund einer Fehlfunktion ihrer Zeitmaschine im Jahr 1999 gestrandet. Sie versuchen verzweifelt, eine Nachricht an ihr zukünftiges Selbst zu senden, doch durch Risse in der Raumzeit wird nur ein verzerrtes Rauschen (Glitch) übertragen. *Easter Egg:* Die Tracklänge des Intros beträgt exakt 19 Sekunden.
- Songtext (Hook):
  "Glitch Mode, die Zeit bricht (Crack!) /
  Spule zurück, back to you / (Oh-eh-oh) /
  Mein Signal verblasst, reaching out in the dark /
  Connection lost, es wird gefährlich!"
```
