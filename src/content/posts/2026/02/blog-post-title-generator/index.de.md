...
> **Kontext (Context):**
>
> - Hintergrund: Ich habe einen detaillierten Blogpost über `[Thema/Keyword]` geschrieben.
> - Ziel: Ich benötige Titel, die aus der Masse herausstechen und die Klickrate (CTR) in den Suchergebnissen und sozialen Medien drastisch erhöhen.
>
> **Aufgabe (Task):**
>
> 1. Analysiere den Kerninhalt: `[Kurze Zusammenfassung des Inhalts]`
> 2. Berücksichtige die Zielgruppe: `[Wer soll diesen Beitrag lesen?]`
> 3. Generiere jeweils 2 Titel für die folgenden 5 psychologischen Typen (insgesamt 10 Titel):
>    - Typ A: Neugier wecken (Unerwartete Fragen, Geheimnisse)
>    - Typ B: Konkrete Methoden/Zahlen (Listen-Formate, Schritt-für-Schritt)
>    - Typ C: Verlustaversion/FOMO (Fehler vermeiden, Warnungen)
>    - Typ D: Autorität/Insider-Wissen (Experten-Geheimnisse enthüllt)
>    - Typ E: Schnelle & einfache Lösung (Geringer Aufwand, hoher Ertrag)
>
> **Einschränkungen (Constraints):**
>
> - Halte die Titel bei etwa 50 bis maximal 60 Zeichen, damit sie auf mobilen Geräten und in den Google-SERPs nicht abgeschnitten werden.
> - Platziere das wichtigste Keyword (`[Thema/Keyword]`) so weit vorne wie möglich.
> - Vermeide billiges Clickbaiting. Die Titel müssen attraktiv sein, aber zwingend das Versprechen des Inhalts halten.
> - Formatiere die Ausgabe als übersichtliche Markdown-Liste.
...
```text
- Typ A (Neugier): Der wahre Grund, warum Ihr Englisch seit 10 Jahren stagniert
- Typ B (Methoden): 3 tägliche Routinen, um fließend wie ein Muttersprachler zu sprechen
- Typ C (Verlust): Lernen Sie keine Vokabeln auswendig (Das ist reine Zeitverschwendung)
- Typ D (Autorität): Die geheime Shadowing-Methode der Top-Dolmetscher enthüllt
- Typ E (Einfachheit): Die einfachste Methode, um Ihr Hörverständnis mit Netflix zu trainieren
```
