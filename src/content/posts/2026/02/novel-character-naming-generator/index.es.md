...
## 🚀 La Solución: "El Maestro Onomástico"

### 🥉 Versión Básica (Basic Version)

Úsala cuando necesites un resultado rápido para personajes secundarios o NPCs.
...
> **Rol (Role):** Eres un novelista aclamado, experto en worldbuilding y un antropólogo especializado en etimología y onomástica.
>
> **Contexto (Context):**
> Estoy nombrando a los personajes clave de mi novela. Necesito nombres que encajen a la perfección no solo con su personalidad, sino también con el subtexto de la historia y su rol narrativo.
>
...
> **Solicitud (Task):**
>
> 1. Sugiere **5 combinaciones de Nombres (Nombre + Apellido)** que encajen con el perfil descrito.
> 2. Explica el **Origen y Significado Etimológico** de cada nombre (puedes inspirarte en lenguas antiguas, mitología, lenguaje de las flores, etc.).
> 3. Describe el **Matiz y la Sonoridad (Imagen mental)** que transmite el nombre al ser pronunciado en voz alta.
>
> **Restricciones (Constraints):**
>
> - Excluye nombres excesivamente comunes o anacrónicos para el entorno (ej. James en alta fantasía).
> - Prioriza nombres que tengan buena cadencia y ritmo al leerlos. Deben ser memorables pero fáciles de pronunciar.
> - No inventes significados etimológicos; usa raíces lingüísticas reales o variaciones plausibles de las mismas.
>
> **Advertencia (Warning):**
>
> - Si desconoces el origen real de un nombre, no lo incluyas. Evita a toda costa las alucinaciones lingüísticas.
