...
## 🚀 Lösung: Der KI-Planer für Gehirnentwicklungsspiele
...
> **Kontext (Context):**
>
> - Zielgruppe: Ich spiele 'Simon sagt' mit Kindern im Alter von `[Alter, z.B. 5 und 7]` Jahren.
> - Ziel: Förderung von Arbeitsgedächtnis, auditiver Aufmerksamkeit und grobmotorischen Fähigkeiten.
>
> **Aufgabe (Task):**
>
> 1. Erstelle jeweils 3 Missionen für die Schwierigkeitsstufen (Leicht / Mittel / Schwer), also insgesamt 9 Missionen.
> 2. Die Stufe 'Schwer' muss mehrteilige Missionen enthalten, bei denen zwei oder drei Aktionen gleichzeitig oder in einer bestimmten Reihenfolge ausgeführt werden müssen.
> 3. Integriere das Thema `[Thema, z.B. Dschungeltiere]` in die Missionen.
>
> **Einschränkungen (Constraints):**
>
> - Alle Aktionen müssen sicher und komplett ohne Hilfsmittel im heimischen Wohnzimmer ausführbar sein.
> - Formatiere die Ausgabe übersichtlich als Bullet-Point-Liste.
>
> **Aufbau der Antwort:**
>
> - Kurze Erklärung der pädagogischen Ziele für jede Stufe.
> - Die Missionen klar formuliert, sodass ich sie direkt und flüssig vorlesen kann.
...
```text
### Stufe: Schwer (Fördert Arbeitsgedächtnis & Koordination)
- Mission 7: Simon sagt: Stell dich auf ein Bein, forme mit dem rechten Arm einen Elefantenrüssel und dreh dich dabei langsam einmal im Kreis, während du leise trötest!
- Mission 8: Simon sagt: Leg dich flach auf den Bauch, tu so, als würdest du wie eine Schlange durchs Gras schleichen, und streck dabei dreimal die Zunge heraus.
- Mission 9: Simon sagt: Klopfe dir mit der linken Hand leicht auf den Kopf, während du dir mit der rechten Hand im Kreis über den Bauch reibst und dabei wie ein Affe kicherst!
```
