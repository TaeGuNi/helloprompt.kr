...
category: "자기계발"
description: "Un prompt conçu pour créer une routine matinale optimale, parfaitement adaptée à votre biorythme et à vos objectifs."
...
Utilisez cette version si vous avez simplement besoin d'une structure immédiate pour bien démarrer votre journée.

> **Rôle :** Tu es un coach expert en productivité et en bien-être.
> **Requête :** Conçois-moi une routine matinale de 60 minutes incluant des étirements légers, un moment de calme et la préparation de ma journée de travail.

### 🥇 Version Pro (Pour des résultats optimisés et sur mesure)

Utilisez cette version pour obtenir une routine parfaitement adaptée à votre style de vie, avec un niveau de détail approfondi.
...
>
> - Présente le planning sous forme de tableau Markdown clair et lisible.
> - Sois réaliste : n'inclus pas d'objectifs inatteignables ni de changements de mode de vie trop brutaux.
> - Garde un ton motivant mais scientifique, fermement ancré dans la réalité.
>
> **Avertissement (Warning) :**
>
> - Ne propose aucun supplément médical ou diététique spécifique ; concentre-toi uniquement sur les habitudes comportementales.
...
- **Q : Dois-je utiliser ce prompt tous les jours ?**
  - R : Non, une seule fois suffit pour établir votre plan de base. Vous pouvez le réutiliser pour ajuster la routine si votre emploi du temps ou vos objectifs changent radicalement (lors d'un changement de poste, par exemple).

- **Q : Que faire si le planning généré est encore trop chargé ?**
  - R : Demandez simplement à l'IA de l'alléger en lui répondant : « C'est trop intense pour un début. Réduis la durée totale de 30 % en ne gardant que l'essentiel. »

- **Q : Est-ce que cela fonctionne avec la version gratuite de ChatGPT ?**
  - R : Absolument ! Les versions gratuites (comme GPT-3.5 ou Claude 3 Haiku) sont parfaitement capables de structurer ce type d'emploi du temps. Les modèles avancés (comme GPT-4) offriront simplement des justifications scientifiques un peu plus pointues.
