...
## 🚀 Die Lösung: "Der KI-Zutaten-Ersatz-Guide"
...
> **Kontext (Context):**
>
> - Szenario: Ich bereite gerade `[Gericht, z. B. cremige Pasta]` zu.
> - Problem: Mir fehlt eine wichtige Zutat: `[Fehlende Zutat, z. B. Sahne]`. Ich kann jetzt nicht einkaufen gehen.
> - Meine Vorräte: In meiner Küche habe ich aktuell `[Vorhandene Zutaten, z. B. Milch, Scheibenkäse, Butter, Eier, griechischer Joghurt]`.
>
> **Aufgabe (Task):**
>
> 1. Schlage mir 3 optimale Alternativen vor, um die `[Fehlende Zutat]` perfekt zu ersetzen, indem du ausschließlich meine vorhandenen Vorräte nutzt.
> 2. Gib für jede Alternative das exakte **Mischverhältnis** und die **Zubereitungsmethode** an (z. B. "100 ml Milch mit 10 g Butter bei schwacher Hitze schmelzen").
> 3. Erkläre, wie sich der Einsatz dieser Alternative auf Geschmack, Textur und Aroma im Vergleich zum Originalrezept auswirkt.
>
> **Einschränkungen (Constraints):**
>
> - Formatiere deine Antwort übersichtlich als Markdown.
> - Vermeide exotische oder schwer erhältliche Zutaten. Nutze strikt nur das, was in einem durchschnittlichen Haushalt zu finden ist oder was ich dir als Vorrat genannt habe.
>
> **Warnhinweise (Warning):**
>
> - Falls eine Kombination das Risiko birgt, dass die Textur gerinnt, sich trennt oder das Gericht verdirbt, musst du zwingend vorab darauf hinweisen und Tipps zur Vermeidung geben.
...
### ❌ Vorher (Eine einfache Frage)

```text
Frage: Ich mache Rahm-Pasta, habe aber keine Sahne. Was tun?
Ergebnis: Versuchen Sie, stattdessen Milch zu verwenden. Sie können Milch und Butter mischen oder Käse hinzufügen, um einen ähnlichen Geschmack zu erzielen. (Keine Mengenangaben, keine Anleitung – man ist genauso ratlos wie vorher)
```

### ✅ Nachher (Mit der Pro Version)

```text
Hier sind 3 perfekte Alternativen für Sahne, basierend auf Ihren Vorräten:

1. Milch + Butter (Der klassische Ersatz)
- Verhältnis: 3 Teile Milch : 1 Teil Butter (z. B. 150 ml Milch, 50 g Butter)
- Zubereitung: Butter bei schwacher Hitze schmelzen, langsam die Milch einrühren. Nicht kochen, nur sanft erwärmen!
- Geschmackliche Auswirkung: Kommt der Reichhaltigkeit von Sahne am nächsten. Da es etwas flüssiger ist, sollten Sie etwas weniger Nudelwasser verwenden.

2. Milch + Scheibenkäse (Wenn es cremig und dickflüssig werden soll)
- Verhältnis: 200 ml Milch + 2 Scheiben Käse
- Zubereitung: Die Milch leicht erhitzen, den Käse in Stücken hineinzupfen und rühren, bis die Soße andickt.
- Geschmackliche Auswirkung: Der Käse bringt eine intensive, herzhafte Umami-Note mit. Vorsicht beim Salzen, da der Käse bereits viel eigenes Salz enthält!
```
