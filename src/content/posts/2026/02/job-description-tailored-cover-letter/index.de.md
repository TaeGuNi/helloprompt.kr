...
> _"Kopierte Standard-Anschreiben werden von Personalern in Sekunden aussortiert. Aber wer hat schon die Zeit, für jede Bewerbung das Rad neu zu erfinden?"_

Das perfekte Anschreiben erzählt genau die **Geschichte, die das Unternehmen hören möchte**. Überlassen Sie es der KI, die verborgenen Kernkompetenzen aus der Stellenbeschreibung (JD - Job Description) herauszufiltern und nahtlos mit Ihren persönlichen Erfahrungen zu verknüpfen.

---

## ⚡️ 3-Zeilen-Zusammenfassung (TL;DR)

1. Extrahieren Sie die entscheidenden Schlüsselkompetenzen direkt aus der Stellenanzeige.
2. Gleichen Sie Ihren Lebenslauf und Ihre Erfahrungen präzise mit diesen Anforderungen ab.
3. Formulieren Sie eine überzeugende Motivation und klare Ziele, die exakt auf die Unternehmenskultur zugeschnitten sind.

---

## 🚀 Die Lösung: "JD-Mirroring Anschreiben-Generator"
...
>    `[Fügen Sie hier die Anforderungen und Qualifikationen aus der JD ein]`
> 2. **Meine Erfahrungen:**
>    `[Fassen Sie hier 2-3 relevante berufliche Stationen oder Projekte kurz zusammen]`
>
> **Aufgabe (Task):**
>
> 1. Identifiziere zunächst die 3 wichtigsten Schlüsselkompetenzen aus der Stellenbeschreibung.
> 2. Verfasse auf Basis meiner Erfahrungen den Abschnitt **'Motivation und Eignung'** (ca. 150-200 Wörter), der genau diese Schlüsselkompetenzen belegt.
> 3. Der Tonfall muss selbstbewusst, professionell, authentisch und höflich sein.
>
> **Einschränkungen (Constraints):**
>
> - Formuliere ergebnisorientiert und nenne konkrete Handlungen anstelle von abstrakten Floskeln (wie "ich arbeite hart", "ich gebe mein Bestes").
> - Nutze eine deduktive Struktur (die wichtigste Aussage/das Ergebnis steht am Anfang).
>
> **Achtung (Warning):**
>
> - Erfinde keine Fakten oder Erfahrungen, die nicht in meinen Eingabedaten stehen. (Keine Halluzinationen)
...
### ❌ Vorher (Standard-Anschreiben)

```text
Ich habe mich schon seit meiner Schulzeit sehr für Marketing interessiert und verfolge die Entwicklung Ihres Unternehmens mit großer Begeisterung. Ich bin hoch motiviert, stets lernbereit und werde als Teil Ihres Teams immer mein Bestes geben.
```
...
Die konsequente Ausrichtung von [Unternehmensname] auf datengestütztes Marketing deckt sich exakt mit meiner fachlichen Expertise. In meiner vorherigen Position konnte ich durch den gezielten Einsatz von GA4 die Absprungrate unserer Landingpages nachweislich um 15 % senken. Diese analytische Herangehensweise möchte ich nun nutzen, um Ihre Performance-Marketing-Ziele aktiv voranzutreiben.
```
