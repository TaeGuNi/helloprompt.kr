...
## 🚀 A Solução: "Crítico Musical Local"
...
> **Contexto (Context):**
>
> - Cenário: Estou viajando por `[Nome da Cidade]` e quero assistir a uma apresentação ao vivo autêntica esta noite.
> - Objetivo: Encontrar o melhor local para o meu gênero favorito, que é `[Gênero: Jazz/Rock/Acústico/Eletrônica, etc.]`.
>
> **Tarefa (Task):**
>
...
>
> - Exclua terminantemente áreas com problemas conhecidos de segurança pública.
> - Priorize estabelecimentos que sejam confortáveis para quem viaja sozinho (ex: lugares com assentos no balcão do bar).
> - Forneça uma estimativa de custo médio (valor da entrada + uma bebida).
> - Organize a saída em um formato de fácil leitura (use bullet points e negrito).
>
> **Aviso (Warning):**
>
> - Não invente informações sobre locais que fecharam ou que não existem. Se não tiver certeza, avise e sugira que o usuário verifique no Google Maps. (Evite alucinações).
...
```text
Recomende bares de jazz em Nova York.
```

_(O resultado geralmente lista o Blue Note, Village Vanguard ou Birdland — lugares lendários, porém caríssimos, lotados de turistas, onde a bebida é superfaturada e que exigem reservas com semanas de antecedência.)_

### ✅ After (Resultado com o Prompt Pro)

```text
1. Smalls Jazz Club (Greenwich Village)
   - Atmosfera: Intimista, crua e totalmente focada nos músicos locais. É famoso por suas autênticas jam sessions que rolam soltas até a madrugada.
   - Ideal para Viajantes Solitários: Sente-se no balcão do bar; a proximidade com o palco e a facilidade de conversar com outros amantes de jazz é imbatível.
   - Custo Médio: Entrada em torno de $20-$25. As bebidas têm preços justos para os padrões de Nova York.
   - Reserva: Não é estritamente necessária, mas chegue cedo (pelo menos 30 min antes) para pegar os ingressos diretamente na porta e garantir seu lugar.

2. Tomi Jazz (Midtown)
   - Atmosfera: Um verdadeiro tesouro escondido num subsolo! Tem uma vibe incrivelmente descontraída e acolhedora, combinando comfort food japonesa com jazz instrumental excelente.
   - Ideal para Viajantes Solitários: O longo balcão de madeira é super amigável para quem vai sozinho.
   - Custo Médio: Cerca de $10 de cover + mínimo obrigatório de $15 em comida/bebida.
   - Reserva: Eles não aceitam reservas (apenas walk-in). Dica: evite horários de pico ou esteja preparado para colocar o nome na lista e esperar um pouco.
```
