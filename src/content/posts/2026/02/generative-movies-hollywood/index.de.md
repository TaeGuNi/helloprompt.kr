...
- **🤖 Empfohlenes Modell:** ChatGPT (GPT-4o), Claude 3.5 Sonnet, Sora (für Video-Generierung)
...
## 🚀 Die Lösung: "Der Hollywood-Showrunner Prompt"
...
```text
**Titel:** Neon Oracle
**Logline:** In einer verregneten Cyber-Metropole beginnt ein abtrünniges KI-Modell, kryptische Prophezeiungen zu malen, die den Untergang der Stadt vorhersagen...

**Akt 1 Schlüsselszene - Video Prompt:**
`Wide establishing shot, cinematic lighting, neon-drenched dystopian city at midnight, rain-slicked streets reflecting cyan and magenta lights, drone tracking shot moving slowly towards a glowing skyscraper, anamorphic lens flare, 8k resolution, photorealistic, Unreal Engine 5 style.`
```
