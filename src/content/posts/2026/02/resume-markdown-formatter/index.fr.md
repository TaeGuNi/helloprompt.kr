...
1. **Brouillon brut :** Soumettez le texte de votre CV, même totalement désorganisé, à l'IA.
2. **Structuration automatique :** L'IA le convertit en un format Markdown hautement lisible (Titres, puces, gras).
3. **Déploiement immédiat :** Collez le résultat dans Notion ou votre éditeur Markdown préféré pour une utilisation instantanée.

---

## 🚀 La Solution : « Formateur de CV Propre »

### 🥉 Version Basique (Basic Version)

Utilisez cette version pour obtenir un résultat rapide sans instructions complexes.
...
Utilisez cette version pour garantir un niveau de détail professionnel et une structure irréprochable.

> **Rôle (Role) :** Tu es un recruteur expert et un maître de la mise en page de documents en Markdown.
>
> **Contexte (Context) :**
>
> - Contexte : J'ai rédigé le contenu de mon CV de manière brute dans un bloc-notes.
> - Objectif : Je veux l'organiser avec une structure claire et professionnelle pour le rendre immédiatement exploitable.
>
> **Tâche (Task) :**
>
> 1. Convertis le texte fourni ci-dessous en un **format Markdown** rigoureusement structuré.
> 2. Utilise les balises d'en-tête (`#`, `##`) pour les sections principales, le gras (`**`) pour les noms d'entreprises, les postes et les dates, et les puces (`-`) pour détailler les missions et les réalisations.
> 3. Insère une ligne de séparation (`---`) entre chaque grande section pour aérer la lecture.
> 4. Uniformise toutes les dates au format `AAAA.MM` et place-les judicieusement.
>
> **Texte d'Entrée (Input) :**
> `[Collez ici le contenu brut de votre CV]`
>
> **Contraintes (Constraints) :**
>
> - Ne crée pas et n'invente aucune fausse information (pas d'hallucination). Conserve fidèlement mes expériences.
> - Contente-toi de corriger les fautes d'orthographe, d'améliorer la syntaxe des phrases maladroites et de reformuler légèrement pour plus d'impact professionnel.
> - Utilise des Emojis de manière subtile et appropriée uniquement dans les titres de section (ex : 💼 Expérience Professionnelle, 🎓 Formation).
>
> **Avertissement (Warning) :**
>
> - Si une information n'a pas de sens ou est manquante, ne la devine pas. Laisse l'espace vide ou demande une clarification.
...
### ❌ Avant (Brouillon brut)

```text
Expérience
A travaillé comme assistant chez ABC Marketing de 2020 à 2023. A principalement géré les réseaux sociaux et géré des pubs. La réalisation est d'atteindre 10k abonnés.
L'éducation est diplômé de l'Administration des Affaires de l'Université de Paris (2015-2019).
...
**ABC Marketing** | Assistant de direction | **2020.01 - 2023.12**

- **Gestion des Réseaux Sociaux :** Animation des communautés et croissance de l'audience jusqu'à atteindre les 10 000 abonnés.
- **Gestion Publicitaire :** Planification, exécution et suivi de campagnes publicitaires numériques.

---

## 🎓 Formation

**Université de Paris** | Licence en Administration des Affaires | **2015.09 - 2019.06**

---

## 🛠 Compétences Techniques

- **Logiciels & Outils :** Adobe Photoshop, Microsoft Excel, Microsoft PowerPoint
```
