...
Úsala cuando necesites un esquema rápido sin demasiados detalles.
...
Úsala cuando necesites un plan detallado, estructurado y de alta calidad para un objetivo importante.

> **Rol (Role):** Eres un coordinador académico y preparador de exámenes sumamente estricto, realista y meticuloso. Eres experto en psicología del aprendizaje y gestión del tiempo.
>
> **Situación (Context):**
>
> - Objetivo: Quiero lograr `[Objetivo]`.
> - Tiempo: Me quedan `[Período]`, y dispongo de `[Tiempo]` horas al día para estudiar.
>
> **Tarea (Task):**
> Crea un plan de estudio realista y perfectamente adaptado a mi situación. Debes incluir:
>
> 1. **[Hoja de Ruta Semanal]**: Divide todo el período en semanas y establece un hito (milestone) claro para cada una.
> 2. **[Rutina Diaria]**: Elabora un horario detallado sobre cómo distribuir mi tiempo de estudio diario (incluyendo pausas estratégicas, como la técnica Pomodoro).
> 3. **[Puntos de Control]**: Define métodos de verificación intermedios (exámenes de prueba, autoevaluaciones) para comprobar mi progreso real.
> 4. **[Preparación Mental]**: Dame un consejo crudo, directo y "punzante" que deba leer cada vez que me sienta perezoso o quiera procrastinar.
>
> **Restricciones (Constraints):**
>
> - El plan no debe ser utópico; debe ser 100% realista y alcanzable para un humano que se cansa.
> - Debes designar obligatoriamente un día a la semana como día de descanso absoluto (Cheat Day).
> - Presenta el resultado con una estructura clara y fácil de leer, usando listas y viñetas.
>
> **Mi Información (Variables):**
>
> - Objetivo: `[ej.: Aprobar el examen de certificación PMP en 3 meses]`
> - Tiempo Disponible: `[ej.: 2 horas después del trabajo entre semana, 5 horas los sábados, domingos libres]`
> - Nivel Actual: `[ej.: Principiante, sin base técnica previa]`
...
- **Q: ¿Qué hago si me atraso en el plan que me dio la IA?**
...
- **Semana 1:** Lectura de la Asignatura 1 (Diseño de Software). Objetivo: Familiarizarse con la terminología básica.
- **Semana 2:** Lectura de la Asignatura 2 (Desarrollo). Objetivo: Resolver 1 examen de prueba completo (y aceptar la frustración inicial).
...
> _"Si cierras el libro ahora para ir a ver series, tendrás que volver a pagar la costosa tarifa de este examen el año que viene. ¿De verdad quieres tirar ese dinero a la basura en lugar de irte de viaje para celebrarlo?"_
