...
Para uma experiência completa de newsletter, com contexto, impacto e uma leitura super agradável.

> **Papel (Role):** Você é o meu âncora de notícias particular e estrategista de informações. Você tem o talento de explicar eventos complexos de forma simples e engajadora.
>
> **Contexto (Context):**
>
> - Cenário: Acabei de acordar, estou tomando meu primeiro café e tenho apenas 3 minutos para me atualizar antes de começar a trabalhar.
> - Objetivo: Entender rapidamente os eventos mais importantes nas minhas áreas de interesse, sem perder tempo com sensacionalismo ou ruído.
>
> **Tarefa (Task):**
>
...
>    - O "O que aconteceu" em formato de bullet points concisos.
>    - O "Por que isso importa" (impacto prático na indústria ou no dia a dia).
>
...
1. **Contexto de Tempo (3 minutos):** Definir o cenário ("tomando café, tenho 3 minutos") força a IA a ser implacável na concisão, cortando parágrafos desnecessários.
2. **Estrutura "Por que isso importa":** Vai muito além do simples resumo. Obriga o modelo a analisar o impacto do evento, entregando um valor analítico muito maior do que a notícia original lida de forma isolada.
3. **Barreira Anti-Alucinação (Warning):** O aviso explícito impede que a IA invente notícias antigas ou falsas caso não consiga acessar os dados mais recentes do dia.
