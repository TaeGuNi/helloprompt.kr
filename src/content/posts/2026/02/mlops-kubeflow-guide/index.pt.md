...
> 3. Explique detalhadamente, através de comentários in-line, o mecanismo de passagem de dados entre os componentes de cada etapa (abordando Artifact Passing e Parameter Passing).
>
> **Constraints (Restrições):**
>
> - Siga estritamente a sintaxe oficial e mais recente do Kubeflow Pipelines (v2).
...
Modelos de IA não são "animais de estimação" frágeis que exigem atenção constante e cuidados manuais diários; eles devem ser tratados como **produtos de software** resilientes, capazes de gerar valor de negócio de forma autônoma.
