...
> **Contesto (Context):**
>
> - Background: Il testo che ti fornirò è la trascrizione letterale di una riunione. Il contenuto è lungo, frammentato e ricco di digressioni fuori tema.
> - Obiettivo: Trasformare questa trascrizione caotica in un verbale limpido, strutturato e immediatamente utilizzabile dal team per mettersi all'opera.
>
> **Richiesta (Task):**
>
> 1. Organizza il contenuto suddividendolo in 4 sezioni: Ordine del Giorno, Punti Chiave Discussi, Decisioni Prese e Piani d'Azione (Action Items).
> 2. Riformula il linguaggio colloquiale, adottando uno stile di scrittura formale, conciso e altamente professionale.
> 3. Per ogni singola voce nella sezione "Piani d'Azione", indica chiaramente la Persona Responsabile (Assignee) e la Scadenza (Deadline), qualora siano state menzionate durante la riunione.
>
> **Vincoli (Constraints):**
>
