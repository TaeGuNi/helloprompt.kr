...
> 
> **Contexto (Context):**
> - Antecedentes: Actualmente estamos desarrollando o gestionando `[Descripción de tu producto/servicio]`.
> - Competidores objetivo: `[Competidor A]`, `[Competidor B]`, `[Competidor C]`
> - Objetivo: Comprender el posicionamiento actual en el mercado de nuestros principales competidores para extraer nuestra propia estrategia de diferenciación (Action Items).
> 
> **Tarea (Task):**
...
> - El formato de salida debe estar estructurado en viñetas Markdown (incluyendo emojis) para garantizar una lectura ágil.
> - El análisis debe incluir obligatoriamente, como mínimo, 1 caso real o artículo de prensa publicado en los últimos 6 meses.
> - Prohibido dar consejos vagos o genéricos (ej. "Debemos fortalecer el marketing"). Propón planes de acción ultra-específicos.
> 
> **Advertencia (Warning):**
> - Jamás inventes cifras, datos o información que no pueda ser contrastada a través de búsquedas web. Si desconoces un dato, indica claramente "Datos no verificables". (Tolerancia cero a las alucinaciones).
...
- **Segmentación Específica:** Al incluir la `[Descripción de tu producto/servicio]` en el Contexto, obligamos a la IA a cambiar su punto de enfoque para realizar un análisis significativo **desde la perspectiva única de nuestra empresa**, huyendo de resúmenes genéricos y predecibles.
- **Enfoque Obligatorio en Hechos:** Al especificar en las restricciones *"incluir obligatoriamente al menos 1 caso real de los últimos 6 meses"*, minimizamos drásticamente las alucinaciones y catapultamos la credibilidad del informe.
- **Orientado a la Acción (Action-Oriented):** No se estanca en el diagnóstico pasivo del análisis SWOT, sino que lo vincula de forma proactiva a propuestas estratégicas, resolviendo la eterna preocupación de cualquier profesional: "Vale, y ahora, ¿qué hacemos?".
...
*(Resultado: La típica historia de manual que todo el mundo ya sabe, datos obsoletos de 2021, y ni una sola pista sobre lo que debería hacer nuestra propia app).*

### ✅ Después (Resultado)
- **Tendencias del mercado:** Intensificación brutal de la competencia por las suscripciones de envío gratuito (reciente guerra de envíos ilimitados a coste cero), fortalecimiento de las funciones de comunidad hiperlocal, etc.
- **SWOT de la competencia (ej. Uber Eats):** 
  - 🟢 Fortalezas: Sólida integración cruzada con el ecosistema global de su marca matriz.
  - 🔴 Debilidades: Escasez relativa de datos y reseñas hiperlocales, así como falta de restaurantes especializados en raciones individuales.
- **Nuestra propuesta de estrategia de diferenciación:** "Como aplicación de delivery emergente, debemos evitar a toda costa la guerra de precios en los envíos y atacar un segmento nicho mediante un 'sistema gamificado de recompensas por reseñas y la especialización en micro-empaquetado para hogares unipersonales'." *(Ofrece insights precisos, viables y listos para ejecutar).*

---

## 🎯 Conclusión
El análisis de la competencia es solo el punto de partida de la planificación, jamás el destino final. Invierte los 3 días que te acabas de ahorrar gracias a este prompt en salir a hablar directamente con tus clientes y perfeccionar tu producto. 

¡Ahora sí, ya puedes salir de la oficina a tu hora! 🍷
