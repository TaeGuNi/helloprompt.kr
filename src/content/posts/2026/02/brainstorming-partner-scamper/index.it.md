...
## 🚀 La Soluzione: "Banca delle Idee Inesauribile"
...
Usala quando cerchi idee strutturate, dettagliate e pronte per essere trasformate in progetti o presentazioni reali. Copia il contenuto del prompt qui sotto e incollalo nell'IA.

> **Ruolo (Role):** Sei un Consulente di Innovazione e Creatività di fama mondiale.
>
> **Contesto (Context):**
>
...
> **Compito (Task):**
>
> 1. Applica rigorosamente la tecnica SCAMPER (Sostituire, Combinare, Adattare, Modificare, Mettere ad altro uso, Eliminare, Invertire) per generare almeno un'idea innovativa per ciascuna delle 7 prospettive.
> 2. Proponi 3 idee "folli" e di rottura, prendendo ispirazione da casi di successo in settori completamente non correlati (es. industria aerospaziale, biologia, moda, ecc.).
> 3. Per il momento ignora i vincoli di budget o di fattibilità tecnica: l'obiettivo è la pura divergenza creativa.
>
> **Vincoli (Constraints):**
>
> - Formatta l'output in modo chiaro utilizzando elenchi puntati.
> - Descrivi ogni idea con un titolo accattivante e una breve spiegazione di 2-3 righe.
>
> **Attenzione (Warning):**
>
...
```text
Dammi alcune nuove idee di design per delle tazze da caffè.
```
...
```text
💡 Prospettive SCAMPER:
1. (Combinare) "Sip & Sound": Una tazza termica con un modulo speaker Bluetooth ultra-sottile e removibile integrato nella base, perfetto per podcast mattutini.
2. (Eliminare) "Zero Gravity Cup": Una tazza senza il classico fondo piatto, progettata per incastrarsi esclusivamente su apposite basi magnetiche da scrivania o da auto, eliminando definitivamente il rischio di rovesciamento.
3. (Mettere ad altro uso) "Sprout Cup": Una tazza biodegradabile al 100% che, una volta logorata, può essere piantata nel terreno fungendo da vaso e fertilizzante per dei semi già incastonati nel materiale esterno.

🔥 Idee di Rottura (Cross-Sector):
- Ispirazione Automotive (Sospensioni): Un thermos con un sistema di "sospensioni liquide" interne per mantenere il livello del caffè perfettamente in piano anche mentre si corre per non perdere il treno.
```
