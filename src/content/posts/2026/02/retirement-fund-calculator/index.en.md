...
1. Calculate the total asset size (Retirement Fund) required after you retire.
2. Determine your actual funding shortfall by factoring in your expected national or corporate pension payouts.
3. Reverse-engineer the exact monthly investment amount needed to achieve your financial goal.

---

## 🚀 The Solution: "Future Planner" Prompt
...
Use this when you need a detailed, customized financial roadmap with actionable steps.

> **Role:** You are a top-tier Certified Financial Planner (CFP) specializing in retirement strategies and wealth management.
>
> **Context:**
>
...
> **Task:**
>
> 1. Factor in inflation to calculate the **Future Value of my desired Monthly Living Expenses** when I reach age 60.
> 2. Excluding expected pension payouts, calculate the **Total Necessary Retirement Fund** I must build myself.
> 3. To reach this target fund, calculate **exactly how much I need to save and invest every month** starting from today.
>
> **Constraints:**
>
> - Break down the calculation process step-by-step in a clear markdown format.
> - Provide the final breakdown in a Markdown table.
>
> **Warning:**
>
> - Do not hallucinate financial formulas. If a calculation is mathematically unfeasible, state it clearly and suggest realistic alternatives (e.g., delaying retirement or adjusting the monthly savings rate).
...
1.  **Role Assignment:** By designating the AI as a "Certified Financial Planner," we elevate its output from generic advice to structured, professional financial modeling.
2.  **Clear Assumptions:** Hardcoding variables like inflation (2%) and realistic returns (7% pre-retirement, 4% post-retirement) prevents the AI from making wild guesses and ensures the math is grounded in reality.
3.  **Actionable Outputs:** Reversing the calculation to find the _monthly savings required_ gives the user an immediate, actionable takeaway rather than just a daunting final target number.
...
```text
How much do I need to retire? I want to spend 3 million KRW monthly.
```

### ✅ After (Result)

```text
### 👴 35-Year-Old's Retirement Simulation (Target Age: 60)

**1. Future Living Expense Calculation**
- Current Target: 3 Million KRW/month ➡️ **Required at Age 60: 4.92 Million KRW/month** (Assuming 2% annual inflation)

**2. Total Necessary Retirement Fund**
- Shortfall (Excluding National Pension) from age 60 to 90 (30 years)
- **Target Asset Size Required: Approximately 1.25 Billion KRW**

**3. The Solution: How much do you need to save monthly?**
- Assuming current assets are 0, investing for 25 years with a 7% annual return
- **👉 You need to invest approximately 1.55 Million KRW every month starting today.**

**💡 Expert Advice:**
If investing 1.55 Million KRW monthly is currently unfeasible, consider delaying your retirement to age 65 or increasing your initial lump-sum investment. Time is your greatest asset in compound interest.
```
