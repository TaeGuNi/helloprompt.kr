...
## 🚀 La Soluzione: "Architetto di Schema di Saggio"

### 🥉 Basic Version (Versione Base)

Usala quando hai fretta e ti serve solo una traccia rapida per iniziare.
...
> **Contesto (Context):**
>
> - Devo scrivere un saggio/rapporto su `[Argomento, es: L'impatto dell'IA sul mercato del lavoro]`.
> - La mia tesi centrale è `[Argomento Centrale, es: L'IA non sostituirà gli umani, ma gli umani che usano l'IA sostituiranno quelli che non la usano]`, ma non so come strutturare il testo per renderlo logico e persuasivo.
>
> **Compito (Task):**
>
> 1. **[Creazione Schema]**: Progetta uno schema standard dettagliato diviso in Introduzione, Corpo (minimo 3 sezioni) e Conclusione.
> 2. **[Guida per Paragrafo]**: Per ogni paragrafo, fornisci parole chiave concrete, suggerisci quali argomentazioni sviluppare e quali esempi o dati di supporto includere.
> 3. **[Gancio & Chiusura]**: Suggerisci la prima frase dell'introduzione (un "Gancio" magnetico per catturare il lettore) e l'ultima frase della conclusione (un commento ad alto impatto emotivo o logico).
>
> **Vincoli (Constraints):**
>
> - Il flusso logico tra i paragrafi deve essere fluido e naturale.
> - Includi almeno un paragrafo nel Corpo dedicato a un contro-argomento (confutazione delle opinioni opposte) per rafforzare la tesi.
> - Non scrivere l'intero saggio, limitati a fornire la struttura e i punti chiave.
>
> **Attenzione (Warning):**
>
> - Assicurati che lo schema sia fattibile e basato su argomentazioni realistiche. Non inventare dati o statistiche inesistenti.
...
- **Corpo 1 (La Crisi Inevitabile):**
  - _Focus:_ Automazione delle mansioni ripetitive.
...
- **Conclusione:**
  ...
  - _Chiusura:_ "Per chi teme il cambiamento, l'IA sarà un disastro imminente; ma per chi impara a cavalcarlo, si trasformerà in ali."
