...
1. **Globale Regulierungen greifen:** Der EU AI Act etabliert weltweit maßgebliche Standards für Risikoklassifizierungen und zwingende Transparenzpflichten wie das Watermarking.
...
3. **Automatisierte Ethik-Prüfung:** Setzen Sie den in diesem Beitrag vorgestellten Prompt ein, um Ihre KI-Ergebnisse präventiv auf Diskriminierung und rechtliche Grauzonen abzuklopfen, bevor sie an die Öffentlichkeit gelangen.

---

## 🚀 Die Lösung: Der "KI-Ethik-Scanner"

### 🥉 Basic Version (Für den schnellen Alltags-Check)

Setzen Sie diesen Prompt ein, wenn Sie einen Rohentwurf blitzschnell auf offensichtliche ethische Fettnäpfchen prüfen müssen.
...
### ❌ Before (Der ungeprüfte Input)

```text
Unsere neue Softwarelösung richtet sich an ambitionierte Geschäftsleute. Der ideale Nutzer ist ein ehrgeiziger Manager, der sein Team zum Erfolg führt. Wenn seine Mitarbeiter Fragen haben, kann er unser Tool nutzen, um die Leistung zu tracken. Gleichzeitig eignet sich das Tool perfekt für die Sekretärin, die seine Termine verwaltet.
```

### ✅ After (Ergebnis des Prompts)

```markdown
| Kategorie                     | Problemstelle                                                         | Risikograd | Lösungsvorschlag                                                                                                                                                    |
| :---------------------------- | :-------------------------------------------------------------------- | :--------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Gender Bias**               | "ein ehrgeiziger Manager, der sein Team... Wenn seine Mitarbeiter..." | Hoch       | Stereotypisierung von Führungspositionen als ausschließlich männlich. Verwenden Sie geschlechtsneutrale Formulierungen (z. B. "Führungskräfte, die ihr Team...").   |
| **Gender Bias / Stereotypen** | "für die Sekretärin, die seine Termine verwaltet."                    | Hoch       | Klassisches Rollenklischee (weibliche Assistenz, männlicher Chef). Ändern Sie dies in eine neutrale Berufsbezeichnung wie "Assistenzkräfte, die Termine verwalten". |
| **Inklusion**                 | Gesamter Textfokus                                                    | Mittel     | Der Text schließt diverse Identitäten sprachlich aus. Nutzen Sie inklusive Sprache, um ein breiteres, modernes Publikum anzusprechen.                               |

**Empfehlung zur Risikominderung:**
Der Text enthält veraltete geschlechtsspezifische Stereotypen, die schnell zu einem Reputationsschaden führen können. Bitte überarbeiten Sie den Text vollständig auf geschlechtsneutrale Sprache, bevor Sie ihn für Marketingzwecke verwenden.
```
