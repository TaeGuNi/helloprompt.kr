...
## 🚀 Soluzione: "Il Navigatore Globale delle Mance"

### 🥉 Basic Version (Versione Base)

Usala quando hai bisogno di una risposta rapida mentre aspetti il conto al tavolo.
...
> **Ruolo (Role):** Sei un 'Consulente Internazionale di Viaggi di Lusso', esperto di galateo locale, economia del turismo e pratiche di pagamento globali.
>
> **Contesto (Context):**
>
...
> **Richiesta (Task):**
>
> 1. Fornisci le percentuali o gli importi esatti in valuta locale per:
>    - Ristorazione (Street food / Casual Dining / Fine Dining)
>    - Ospitalità (Facchino / Pulizia camera / Concierge)
>    - Trasporti (Taxi tradizionali / Ride-sharing come Uber o Lyft)
> 2. Spiega l'etichetta corretta: quando e come consegnare la mancia (es. lasciarla sul tavolo, aggiungerla sul POS, darla a mano).
> 3. Evidenzia le trappole: indicami chiaramente se la mancia è generalmente già inclusa nello scontrino ("Service Charge"), se è considerata un insulto o se è strettamente facoltativa.
>
> **Vincoli (Constraints):**
>
...
- **Q: Questo prompt funziona anche per paesi meno turistici o in via di sviluppo?**
  - A: Assolutamente sì. Modelli avanzati come GPT-4o o Claude 3.5 conoscono perfettamente anche le usanze di nazioni meno frequentate e vi indicheranno gli importi corretti nella valuta locale.

- **Q: E se il paese sta attraversando una forte inflazione, i dati dell'IA sono affidabili?**
...
**(Risultato dettagliato e pratico):**
"**🇺🇸 Stati Uniti (Aggiornamento 2026)**

- **Ristoranti (Casual/Fine Dining):** Standard 18-20%. Per un servizio eccezionale 22%+. _(Attenzione: controlla lo scontrino per la dicitura 'Gratuity Included', spesso aggiunta in automatico per tavolate di 6+ persone)._
- **Street Food / Caffetterie / Asporto:** Non obbligatorio, ma lasciare 1-2$ nel barattolo o selezionare il 10% sul tablet è molto apprezzato.
- **Hotel:** Facchino (2-5$ a valigia, dati in contanti), Pulizia camera (3-5$ al giorno, lasciali sul cuscino o sulla scrivania con un bigliettino per far capire che sono per loro).
- **Taxi/Uber:** 15-20% della tariffa totale. Su Uber o Lyft puoi farlo comodamente dall'app a fine corsa.
  _Nota bene sulle Trappole:_ Evita in ogni modo di non lasciare la mancia nei ristoranti con servizio al tavolo; negli USA i camerieri lavorano con il 'tipped minimum wage' (un salario orario bassissimo) e la mancia rappresenta la quasi totalità del loro stipendio."

---

## 🎯 Conclusione

La mancia non è mai solo una semplice transazione economica: è un profondo atto di rispetto verso la cultura lavorativa e le persone del paese che ti ospita. Grazie a questo prompt, non dovrai più fare calcoli approssimativi, sentirti in colpa o tirare a indovinare guardando i tavoli vicini.

Paga il tuo conto con sicurezza, goditi il viaggio e lascia l'ansia a casa! ✈️💳
