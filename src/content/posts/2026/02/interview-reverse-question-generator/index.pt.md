...
Use esta versão quando precisar apenas de um resultado rápido antes de entrar na sala de entrevista.
...
> **Papel (Role):** Você é um estrategista e coach de carreira sênior com vasta experiência em recrutamento executivo.
>
> **Contexto (Context):**
>
...
> **Tarefa (Task):**
>
> 1. Elabore 2 perguntas excepcionais para cada uma das categorias abaixo:
>    - **Foco na Função:** Perguntas aprofundadas sobre os desafios reais e as expectativas para este cargo nos primeiros 90 dias.
>    - **Visão e Cultura da Empresa:** Perguntas estratégicas sobre a direção, o crescimento da empresa ou a cultura da equipe.
>    - **Pessoal (Entrevistador):** Perguntas que gerem empatia, abordando a experiência, os desafios ou a visão pessoal do próprio entrevistador na empresa (para usar quando o clima da conversa estiver favorável).
>
> **Restrições (Constraints):**
>
> - NÃO inclua perguntas triviais ou focadas apenas em benefícios (ex: "Tem muita hora extra?", "Qual é o salário?", "Como é o refeitório?").
> - A intenção oculta de cada pergunta deve transmitir proatividade, pensamento analítico e paixão genuína pelo desafio.
> - Estruture as perguntas de forma que comecem com uma breve introdução ou observação construtiva (ex: "Em minhas pesquisas recentes sobre a empresa, notei que...", "Considerando o cenário atual do mercado...").
>
> **Aviso (Warning):**
>
...
### ❌ Antes (Sem preparo / Foco exclusivo em si mesmo)

```text
"Vocês costumam pagar hora extra?"
"Como funciona a política de vale-refeição?"
"Não tenho dúvidas, foi tudo muito bem explicado. Obrigado." (O pior cenário possível)
```

### ✅ Depois (Profissionalismo, Estratégia e Empatia)

```text
"Lendo as notícias recentes do setor, vi que a empresa está expandindo suas operações para a área de tecnologia em nuvem. Considerando os desafios dessa expansão, qual seria o papel direto desta posição para apoiar o sucesso desse novo projeto?"

"Sei que você está na empresa há alguns anos e provavelmente viu muita coisa mudar por aqui. Pessoalmente, qual foi o projeto ou o momento que mais lhe trouxe satisfação e orgulho de trabalhar nesta equipe?"
```
