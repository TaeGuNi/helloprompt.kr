...
1. **Bannissez la requête « Traduis ça » :** Au lieu d'un basique « Traduis de l'anglais vers le français », attribuez à l'IA un persona d'expert natif du pays ciblé.
...
3. **Ajoutez un bouclier anti-mot-à-mot :** Imposez une règle stricte : « N'hésite pas à restructurer entièrement les phrases tant que le message de fond est préservé. »
...
> **Rôle :** Tu es un concepteur-rédacteur (copywriter) expert cumulant plus de 10 ans d'expérience en `[Pays cible, par ex. : France]`.
> **Tâche :** Traduis le texte suivant en `[Langue cible, par ex. : Français]`. Cependant, fuis absolument la traduction littérale. Adapte le texte de manière idiomatique en employant les expressions naturelles et le vocabulaire que les locaux utilisent au quotidien.
> 
> **Texte original :**
...
> **Rôle (Role) :** 
> Tu es un expert chevronné en `[Secteur d'activité, par ex. : Marketing B2B SaaS]` et un locuteur natif maîtrisant les moindres rouages du marché en `[Pays cible, par ex. : France]`.
>
> **Contexte (Context) :**
>
> - Langue source : `[Langue source, par ex. : Anglais]`
> - Langue cible : `[Langue cible, par ex. : Français de France]`
> - Public cible : `[Public visé, par ex. : Décideurs et CTO d'entreprises tech à Station F]`
> - Ton et style : `[Ton souhaité, par ex. : Professionnel, percutant, moderne et sans jargon inutile]`
> - Objectif du document : `[Objectif du document, par ex. : Séquence d'e-mails à froid (Cold Emailing) pour un lancement de produit]`
>
> **Tâche (Task) :**
>
...
Soyons francs : si vous vous contentez de taper « Traduis ça en français », vous exploitez à peine 10 % du potentiel de l'IA. Sur le terrain, qu'il s'agisse de déployer un site web multilingue ou de lancer une campagne d'e-mails à l'international, une traduction littérale est le tueur numéro un de votre crédibilité.

En concevant ce prompt, j'ai été frappé par la métamorphose du texte dès l'instant où l'on ajoute la clause libératrice : « n'hésite pas à déconstruire la structure des phrases ». Essayer de calquer la grammaire d'une langue source (souvent verbeuse ou omettant des sujets) vers le français mène au désastre. C'est en accordant cette liberté créative à l'IA — tout en la bridant via un persona strict — que l'on transcende les limites des traducteurs classiques. Vous lui dites en somme : **« Tu es un copywriter d'élite, fais ce qu'il faut pour que ça convertisse. »**
...
Entrée : "[Phrase promotionnelle asiatique typique]"
...
Une localisation maîtrisée donne instantanément à vos clients internationaux le sentiment que votre produit a été conçu spécialement pour eux, en respectant leur propre culture.
...
Déployez vos campagnes à l'international et quittez le bureau à l'heure ! 🍷
