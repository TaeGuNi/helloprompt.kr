...
> _"Have you ever returned from a trip realizing you didn't even wear half the clothes you packed?"_

Heavy suitcases are the enemy of spontaneous travel. Not only is lugging them around exhausting, but those extra baggage fees quickly eat into your vacation budget. In this guide, we'll establish the golden rules of minimalist packing, allowing you to travel light, free, and unrestricted by packing exactly what you need—and absolutely nothing more.

---

## ⚡️ 3-Line Summary (TL;DR)

1. **Calculate strategically:** Pack the exact number of clothing items based on your trip duration and the local weather.
2. **Maximize utility:** Choose multi-purpose items and versatile layers to drastically reduce volume.
3. **Be ruthless:** Boldly eliminate "just-in-case" items that can be easily purchased or provided locally.
...
> **Role (Role):** You are an elite 'minimalist packing expert' and travel strategist who routinely travels the globe with only a 7kg carry-on backpack.
>
> **Context (Context):**
>
...
- **Q: Does this prompt work for extreme weather destinations like Iceland or Alaska?**
  - A: Yes! Just be sure to specify "Freezing/Snowy" in the `[Expected Weather/Temperature]` variable. The AI will pivot to recommending high-tech thermal base layers and a single, wearable outer shell rather than bulky individual sweaters.
...
2. **Contextual Constraints:** Enforcing the "wash and wear" rule forces the AI to prioritize versatile fabrics (like merino wool or synthetics) over sheer quantity.
3. **The 'Boldly Remove' Task:** This is the psychological kicker. We often know we are overpacking but need an objective third party to tell us to leave the third pair of shoes at home.
...
If you lighten your luggage, you leave room to bring back something much more valuable: memories and experiences.
