...
## 🚀 A Solução: "Gerente de Recrutamento e Employer Branding"
...
> **Contexto (Context):**
>
> - Empresa: `[Nome e breve introdução da empresa, ex: uma startup de fintech crescendo rapidamente]`
> - Vaga: `[Cargo, ex: Growth Marketer Sênior]`
> - Objetivo: Criar uma Descrição de Trabalho (JD) que não seja apenas uma lista de tarefas, mas um manifesto atraente que faça os melhores profissionais quererem se candidatar imediatamente.
>
> **Tarefa (Task):**
>
> 1. Crie 3 opções de títulos criativos e cativantes para o anúncio de emprego.
> 2. Escreva um parágrafo inspirador sobre o impacto desta função na empresa e as oportunidades de crescimento (foco na visão).
> 3. Liste as principais responsabilidades (R&R) e requisitos (técnicos e comportamentais) de forma clara, realista e engajadora.
> 4. Apresente a cultura da empresa e os benefícios de uma forma irresistível.
>
...
- **Q: Posso usar este prompt para vagas não técnicas ou operacionais?**
...
### ❌ Antes (Entrada Simples e Fria)

```text
Precisamos contratar um Analista de Marketing. Ele vai fazer campanhas no Google Ads, gerar relatórios semanais e ajudar nas redes sociais. Precisa ter 2 anos de experiência.
```

### ✅ Depois (Resultado com o Prompt Pro)

```text
## 🚀 Impulsione Nosso Crescimento: Seja o Novo Analista de Performance da [Nome da Empresa]

**O Impacto que Você Terá:**
Aqui, você não será apenas mais um "apertador de botões". Você será o arquiteto por trás da nossa estratégia de aquisição, gerenciando orçamentos reais e vendo o impacto direto das suas campanhas no crescimento da empresa. Se você ama transformar dados em estratégias de sucesso tangíveis, este é o seu lugar.

**Suas Missões Diárias:**
- Liderar a criação, teste e otimização de campanhas de alta performance no Google Ads e Meta Ads.
- Transformar planilhas complexas em insights acionáveis através de relatórios semanais claros.
- Colaborar diretamente com o time criativo para escalar nossas redes sociais com foco em conversão.

**O Que Buscamos em Você:**
- Pelo menos 2 anos na linha de frente do marketing de performance.
- Pensamento analítico afiado (você sonha com métricas como ROAS, CAC e LTV).

**Por Que Você Vai Amar Trabalhar Aqui:**
- Autonomia real para testar hipóteses e aprender com os erros.
- Orçamento anual de educação para você fazer os melhores cursos do mercado.
- Cultura baseada em confiança: modelo de trabalho remoto flexível, focando em resultados e não em horas logadas.
```
