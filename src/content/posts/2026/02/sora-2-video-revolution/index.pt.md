...
- **🤖 Modelo Recomendado:** OpenAI Sora 2.0
...
## 🚀 Solução: "O Diretor Cinematográfico de Bolso"
...
> **Contexto (Context):**
>
> - Cenário: `[Descrição hiperdetalhada do ambiente, ex: Uma metrópole cyberpunk chuvosa em Tóquio, à noite, iluminada por letreiros neon]`
> - Clima/Atmosfera: `[Sentimento e iluminação, ex: Estética noir, melancólico, com reflexos nítidos nas poças d'água]`
>
> **Tarefa (Task):**
>
> 1. Gere um vídeo narrativo de `[Duração, ex: 15 segundos]` em resolução 4K a 60fps.
> 2. Posicione a câmera inicial em `[Ângulo de câmera, ex: Close-up extremo no rosto do protagonista]`.
> 3. Execute o seguinte movimento de câmera: `[Movimento, ex: Dolly out lento e contínuo, revelando a grandiosidade da cidade ao fundo]`.
> 4. Sincronize o áudio integrado para incluir: `[Efeitos sonoros, ex: Som de chuva pesada batendo no asfalto e sirenes distantes]`.
>
> **Restrições (Constraints):**
>
> - Mantenha a consistência absoluta dos traços faciais e das roupas do personagem durante toda a duração do vídeo.
> - O estilo visual deve ser fotorrealista, simulando uma gravação feita com uma lente anamórfica de 35mm.
>
> **Aviso (Warning):**
>
> - Não inclua elementos que violem direitos autorais, logotipos reais ou rostos de celebridades. Evite o efeito "uncanny valley" (vale da estranheza), focando em microexpressões humanas perfeitamente naturais.
