...
Úsala cuando te enfrentes a una resistencia severa y necesites un enfoque altamente empático y estructurado.

> **Rol (Role):** Eres un psicólogo infantil experto en motivación intrínseca y coaching de aprendizaje.
>
> **Contexto (Context):**
>
> - Situación: Mi hijo pospone constantemente su tarea de matemáticas diciendo que "es muy difícil" y solo quiere ver YouTube.
> - Objetivo: Lograr que se siente en el escritorio por su cuenta y comience a trabajar, sin generar una discusión.
>
> **Tarea (Task):**
>
> 1. En lugar de la típica orden "Ve a hacer tu tarea", proporcióname 3 "preguntas de coaching" específicas que validen sus emociones y alivien la presión.
> 2. Diseña un enfoque conversacional que reduzca la barrera psicológica inicial mediante una "micrometa" (por ejemplo, proponerle resolver solo 1 ejercicio o leer el primer párrafo juntos).
>
> **Restricciones (Constraints):**
>
> - El tono debe ser 100% empático, cálido y libre de cualquier matiz de sarcasmo, frustración o manipulación.
> - La primera frase de cada opción DEBE validar explícitamente la dificultad o frustración que siente el niño.
>
> **Precaución (Warning):**
>
> - No uses frases cliché de crianza autoritaria. Mantén el enfoque en la colaboración y el respeto mutuo. No inventes castigos.
...
- **Q: ¿Qué hago si mi hijo responde con un rotundo "NO" incluso a las micrometas?**
  - A: Retrocede un paso. Pídele a la IA: _"Mi hijo rechazó la micrometa y dijo 'no quiero hacer nada'. ¿Cómo valido esta frustración extrema sin ceder en el límite de que la tarea debe hacerse hoy?"_. La clave es mantener la calma, validar la emoción y no engancharse en una lucha de poder.

- **Q: ¿Necesito la versión de pago de ChatGPT o Claude para obtener buenas respuestas?**
  - A: No. La empatía lingüística es una de las fortalezas centrales de casi cualquier modelo de lenguaje moderno (incluso en versiones gratuitas como ChatGPT 3.5 o Gemini Flash). El modelo entenderá perfectamente el rol de "psicólogo infantil" sin costo adicional.
...
La hora de la tarea no tiene por qué ser una batalla diaria de voluntades que agote a toda la familia. Con las palabras adecuadas y un enfoque basado en la empatía, puedes convertirte en el mayor aliado de tu hijo frente a sus desafíos académicos.

¡Guarda este prompt y transforma la frustración en un momento de crecimiento conjunto y conexión! 👨‍👩‍👧‍👦
