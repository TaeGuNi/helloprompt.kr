...
title: "💌 Cold Email Prompt for Recruiting Celebs That Even Nick Jonas Would Accept"
author: "Jay"
date: "2026-03-01"
...
- **🤖 Recommended Model:** Claude 3.5 Sonnet (Exceptional at contextual nuance and business correspondence)

- ⭐ **Difficulty:** ⭐⭐⭐☆☆
- ⚡️ **Effectiveness:** ⭐⭐⭐⭐⭐
- 🚀 **Utility:** ⭐⭐⭐⭐☆

> _"The agencies representing mega-celebrities with millions of followers receive thousands of boilerplate sponsorship requests every single day. Is your pitch heading straight to the trash bin in under a second?"_
...
## 🚀 Solution: "VIP Celeb Recruitment Cold Email Generator"
...
> **Context:**
>
> - Target Celeb: `[Nick Jonas]`
> - Celeb's Recent Activities: `[Recently starring in a Broadway musical and preparing for a highly anticipated solo album]`
> - Our Brand: `[Sustainable, eco-friendly premium lifestyle brand 'EcoVibe']`
> - Proposal Details: `[Appointment as our 2026 Global Ambassador and co-designing a limited-edition capsule collection]`
> - Benefits Offered: `[Industry-leading guarantee, full production sponsorship for the upcoming album, and a percentage of profits donated to a foundation of the celebrity's choice]`
>
> **Task:**
>
...
> 6. Leave the variables indicated by `[ ]` intact, or populate them with contextual examples so the user can easily adapt them.
>
> **Constraints:**
>
> - Maintain a concise length; structure the email into 3 to 4 short paragraphs optimized for mobile readability.
> - Strictly avoid amateur, sycophantic phrasing (e.g., "We are your biggest fans!!!"). Maintain an unwavering, professional business tone and manner throughout.
> - Format the output cleanly: use a list for the 3 subject options, followed by the body of the email. (Do not use Markdown tables).
>
> **Warning:**
>
> - Do not invent non-existent celebrity scandals or fabricate facts in the context. (Strictly prevent hallucinations).

---

## 💡 Author's Insight

This prompt perfectly distills the cold email psychology utilized by the highest echelons of global PR agencies. 

The core strategy isn't to endlessly profess **"how much we love your work,"** but rather to unequivocally prove **"how we can serve as a strategic lever for your next major business move."** This is exactly why the `[Celeb's Recent Activities]` variable is the linchpin of the Pro version. To motivate the agency of a mega-celebrity like Nick Jonas—who is already at the pinnacle of their career—you must provide a compelling 'justification' (e.g., funding a charitable initiative, sponsoring a passion project) that transcends mere financial compensation, perfectly timed with their current trajectory.

If you've ever hesitated to pitch international celebrities or tier-one global influencers due to a lack of native-level, sophisticated business etiquette, this prompt is your ultimate safety net. When paired with Claude 3.5 Sonnet, we've consistently verified its ability to output natural, elegant English correspondence that commands respect even from the most seasoned Hollywood representatives.
...
- **Q: Will this prompt work on the free version of ChatGPT?**
  - A: It will function at a baseline level. However, to perfectly capture the subtle nuances and executive 'tone and manner' required for elite business emails, the output from premium models (like Claude 3.5 Sonnet or GPT-4o) is overwhelmingly superior and far more professional.
...
```text
Subject: Hello Nick Jonas! This is a sponsorship proposal from EcoVibe.

Hello Nick Jonas! We are a perfume brand called EcoVibe.
We are huge fans of Nick Jonas!!! We recently launched a new perfume, could you be our model?
We can give you a lot of money. Please be sure to contact us!!!
```
