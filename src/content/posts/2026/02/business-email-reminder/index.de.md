...
## 🚀 Die Lösung: "Der diplomatische Follow-up-Bot"
...
> **Kontext (Context):**
>
> - Hintergrund: Ich habe vor 3 Tagen eine E-Mail gesendet und dringend Daten von einem Geschäftspartner für das Projekt `[Projektname]` angefordert, aber bisher keine Antwort erhalten.
> - Ziel: Ich muss höflich, aber sehr bestimmt um ein Statusupdate bitten, ohne dass der Partner sich angegriffen oder unter Druck gesetzt fühlt.
>
> **Anfrage (Task):**
>
> 1. Verfasse einen E-Mail-Entwurf, der klar um eine Rückmeldung bittet.
> 2. Zeige aufrichtiges Verständnis dafür, dass der Partner möglicherweise gerade sehr beschäftigt ist.
> 3. Erinnere freundlich an die bestehende Frist (`[Datum der Frist]`) und die Wichtigkeit der Daten für die nächsten gemeinsamen Schritte.
> 4. Verwende Platzhalter wie `[Name des Partners]`, `[Projektname]` und `[Datum der Frist]`, die ich später flexibel ausfüllen kann.
>
> **Einschränkungen (Constraints):**
>
> - Vermeide jegliche passiv-aggressive oder emotionale Formulierungen (z.B. "Wie bereits in meiner letzten Mail erwähnt...").
> - Halte den Tonfall äußerst professionell, respektvoll und lösungsorientiert.
> - Strukturiere die E-Mail übersichtlich in Betreff und Fließtext.
...
### ❌ Before (Menschlicher Frust-Entwurf)

```text
Hallo [Name],

ich habe noch keine Antwort auf meine Mail von Dienstag bekommen. Ich brauche die Daten jetzt wirklich dringend, sonst können wir im Projekt nicht weitermachen. Bitte schicken Sie mir diese bis heute Nachmittag.
```

### ✅ After (KI-generierter diplomatischer Entwurf)

```text
Betreff: Kurze Nachfrage: Benötigte Materialien für [Projektname]

Sehr geehrte(r) [Name des Partners],

ich hoffe, Sie haben eine erfolgreiche Woche. Ich weiß, dass Sie derzeit sicher viele Themen auf dem Schreibtisch haben.

Ich melde mich heute kurz bei Ihnen, um nach dem aktuellen Stand der Daten für unser Projekt [Projektname] zu fragen. Da wir diese Informationen dringend für die nächsten Planungsschritte bis zum [Datum der Frist] benötigen, wäre ich Ihnen für ein kurzes Update sehr dankbar.

Falls Sie noch weitere Details oder Unterstützung von meiner Seite benötigen, lassen Sie es mich gerne wissen.

Vielen Dank im Voraus für Ihre Mühe und beste Grüße,
```
