...
Use esta versão para obter um calendário altamente personalizado, estruturado e com temas que evoluem gradativamente.

> **Papel (Role):** Você é um treinador de escrita experiente e curador de conteúdo especializado.
>
> **Contexto (Context):**
>
> - Cenário: Quero construir o hábito sólido de escrever todos os dias, mas costumo desistir por falta de ideias.
> - Objetivo: Preciso de um calendário de tópicos estimulantes para 30 dias, que me mantenha motivado sem me sobrecarregar.
>
...
A verdadeira mágica deste prompt está na diretriz de "progressão de dificuldade" e nas "perguntas específicas". Quando comecei a escrever online, meu maior erro foi tentar produzir "ensaios profundos" logo no Dia 1. Isso gera esgotamento rápido. Ao instruir a IA a começar com perguntas simples ("O que está na sua mesa agora?") e evoluir gradativamente, você constrói o "músculo da escrita" sem perceber. Recomendo usar o Claude 3.5 Sonnet ou ChatGPT-4o para este prompt, pois eles tendem a gerar perguntas mais empáticas e menos robóticas.

---

## 🙋 Perguntas Frequentes (FAQ)

- **Q: E se eu não gostar dos tópicos gerados para alguns dias?**
  - A: Você pode pedir à IA para regenerar dias específicos na mesma conversa. Por exemplo: _"Substitua os tópicos dos Dias 12 e 15 por opções mais focadas em [Novo Tema]"_.

- **Q: Preciso publicar tudo o que eu escrever na internet?**
  - A: De forma alguma! O objetivo principal é criar o hábito. Muitas pessoas usam este calendário apenas para diários pessoais (journaling) matinais ou para organizar os próprios pensamentos.

- **Q: Posso adaptar este calendário para roteiros de vídeos curtos (Reels/TikTok)?**
  - A: Sim. Basta alterar o **Propósito da Escrita** para _"Roteiros para vídeos curtos no TikTok"_ e a IA adaptará os ganchos, a linguagem e a estrutura dos tópicos sugeridos.
