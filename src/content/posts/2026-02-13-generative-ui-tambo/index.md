...
## (Updated) 제너레이티브 UI란 무엇인가요? {#updated}
...
## (Updated) Tambo SDK로 시작하기 {#updated}
...
### (Updated) 3. Tambo 레지스트리 설정 {#updated}
...
### (Updated) 4. AI 응답에서 UI 렌더링 {#updated}
