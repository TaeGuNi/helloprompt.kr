...
## 🚀 The Solution: "One-Day City Tour Planner"
...
Use this when you want a meticulously crafted, highly personalized travel experience.
...
> **Constraints:**
>
> - Clearly specify the exact mode of transportation between each location (e.g., walking, subway, bus) and the estimated transit time.
> - Provide the output strictly in a 'Time-stamped Itinerary' format.
> - Append exactly one indoor alternative plan at the bottom of the itinerary in case of rain.
>
> **Warning:**
>
> - Do not hallucinate or invent non-existent places. Only recommend real, currently operating locations. If unsure about a location's status, choose a well-known alternative.
...
```text
Plan a one-day trip to Tokyo.
```

_(Result: A chaotic list of Tokyo's top 10 attractions scattered across the city, requiring 4 hours of transit and offering no sense of pacing or actual logistics.)_

### ✅ After (Result)

```text
**Tokyo 1-Day Itinerary: Shibuya & Harajuku Focus (10:00 AM - 8:00 PM)**

- **10:00 AM:** Arrive at Harajuku Station. Walk to Meiji Shrine (15 min walk).
- **11:30 AM:** Explore Takeshita Street.
- **12:30 PM (Lunch):** 'Afuri Harajuku' (Authentic Yuzu Ramen, 10 min walk).
- **2:00 PM:** Transit to Shibuya (Fukutoshin Line, 5 mins).
- **2:15 PM:** Experience Shibuya Crossing & Hachiko Statue.
- **3:00 PM (Cafe Break):** 'Miyashita Park - Sequence Cafe' (Rooftop views, 8 min walk).
- **4:30 PM:** Shopping at Shibuya PARCO.
- **6:30 PM (Dinner):** 'Katsumidori Seibu Shibuya' (High-quality conveyor belt sushi).

**🌧️ Rainy Day Alternative:**
If it rains, skip Meiji Shrine and head directly to 'Shibuya Scramble Square' for indoor shopping, dining, and the enclosed 'Shibuya Sky' observation deck.
```
