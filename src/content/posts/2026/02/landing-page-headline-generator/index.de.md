...
- **🤖 Empfohlenes Modell:** Claude 3.5 Sonnet (für kreatives Copywriting), ChatGPT-4o
...
## 🚀 Die Lösung: "Hero Copy Generator"

### 🥉 Basic Version (Schnellstart)

Verwenden Sie diesen Prompt, wenn Sie sofort eine solide Textgrundlage ohne viel Kontext benötigen.
...
> **Rolle (Role):** Du bist ein Senior Conversion Copywriter und UX-Writer. Deine Spezialität ist es, komplexe Produkte in unwiderstehliche, glasklare Botschaften zu übersetzen, die den Leser in unter 3 Sekunden fesseln.
>
> **Kontext (Context):**
>
...
> **Aufgabe (Task):**
>
> 1. Analysiere das Produkt und die Zielgruppe.
> 2. Generiere 3 völlig unterschiedliche Hero-Copy-Varianten, basierend auf bewährten Copywriting-Formeln (z.B. PAS - Problem/Agitation/Solution, Nutzen-getrieben, Neugierde-weckend).
> 3. Jede Variante muss zwingend aus diesen 3 Elementen bestehen:
>    - **Headline (H1):** Ein kraftvoller, nutzenorientierter Satz, der sofort ins Auge springt.
>    - **Subheadline (H2):** Vertrauensbildende, logische Ergänzung, die Zweifel ausräumt.
>    - **CTA-Button:** Handlungsgetriebener Text (kein langweiliges "Hier klicken").
>
> **Einschränkungen (Constraints):**
>
> - Die Headline darf maximal 12 Wörter lang sein.
> - Die Subheadline darf maximal 2 Sätze lang sein.
> - Vermeide leere Floskeln ("innovativ", "branchenführend", "bahnbrechend").
> - Verwende konkrete Zahlen, Zeiten oder garantierte Ergebnisse ("In 3 Tagen", "Spare 10 Stunden").
...
### ❌ Vorher (Typischer Anfänger-Text)

```text
Überschrift: Unser Buchhaltungsprogramm ist einfach und schnell.
Unterüberschrift: Bitte nutzen Sie unsere Software für Ihre Firma. Sie ist innovativ und führend auf dem Markt.
CTA: Hier klicken
```
...
```text
[Variante 1: Der Problemlöser]

Headline: Excel-Chaos in der Buchhaltung? So sparen Sie monatlich 10 Stunden.
Subheadline: Fotografieren Sie Belege einfach ab. Unsere KI kategorisiert alles automatisch und synchronisiert centgenau mit Ihrem Steuerberater.
CTA: Jetzt 14 Tage gratis testen


[Variante 2: Der Nutzen-Fokus]

Headline: Erledigen Sie Ihre Firmensteuer bei einer Tasse Kaffee.
Subheadline: Keine Zettelwirtschaft, keine Fristversäumnisse. Die erste Buchhaltungssoftware, die Ihnen wirklich den Rücken für Ihr Kerngeschäft freihält.
CTA: Zuverlässig Steuern sparen
```
