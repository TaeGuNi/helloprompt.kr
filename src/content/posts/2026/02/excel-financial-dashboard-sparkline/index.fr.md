...
```text
Dis-moi comment rendre mon tableau Excel plus joli.
```

### ✅ Après (Résultat)

```text
### 📊 Compétences de Tableau de Bord Financier : Maîtrisées en 1 Minute

**1. Le mini-graphique intégré, 'Sparkline'**
- **Chemin :** Onglet [Insertion] ➔ Groupe [Graphiques sparkline] ➔ Clic sur [Courbes]
- **Réglage :** Sélectionnez les ventes de Jan~Déc (B2:M2) pour la 'Plage de données' ➔ Cliquez sur OK
- **Effet :** La tendance de vos ventes annuelles s'affiche instantanément sous forme de courbe élégante dans la cellule N2 !

**2. Les chiffres transformés en graphiques, 'Barre de données'**
- **Chemin :** Sélectionnez la colonne Taux de Réalisation ➔ Onglet [Accueil] ➔ [Mise en forme conditionnelle] ➔ [Barres de données] ➔ Sélectionnez le remplissage de votre choix (ex: Bleu)
- **Effet :** Une réalisation à 100 % remplit la cellule, 50 % la remplit à moitié. Les performances sautent immédiatement aux yeux.

**3. Les alertes automatiques, 'Jeu d'icônes'**
- **Chemin :** Sélectionnez la colonne de Croissance vs Mois Précédent ➔ [Mise en forme conditionnelle] ➔ [Jeux d'icônes] ➔ [Directionnel (Flèches)]
- **Effet :** 🔻 Une flèche rouge apparaît automatiquement pour les valeurs négatives, permettant de repérer les anomalies et les baisses de performance en une fraction de seconde.
```
