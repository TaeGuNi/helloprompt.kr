...
## 🚀 The Solution: "The Heartfelt Messenger"

### 🥉 Basic Version (Quick Draft)

Use this when you need a fast, straightforward template to build upon.
...
Use this when you need absolute precision, emotional nuance, and a tailored delivery.

> **Role (Persona):** You are an elite psychological counselor and a master ghostwriter who understands complex human dynamics and emotional subtleties.
>
> **Context:**
>
> - Background: I need to send a critical message to `[Recipient: e.g., a friend of 10 years]`.
> - Goal: My true intentions must be conveyed clearly, without causing unnecessary hurt or misunderstanding.
>
> **Letter Details:**
>
> - **Purpose:** `[e.g., Politely refusing a request to borrow money]`
> - **My Current Emotion/Attitude:** `[e.g., Apologetic, empathetic, but setting a firm boundary]`
> - **Key Information to Include:** `[e.g., I am currently paying off my own loans and cannot spare any cash]`
>
> **Task:**
>
> 1. Draft a **natural, sincere, and emotionally intelligent letter** incorporating the details above.
> 2. Ensure the recipient feels respected, but leave no room for ambiguity regarding my stance.
> 3. Provide two distinct variations: **Version 1 (Soft & Empathetic Tone)** and **Version 2 (Direct & Firm Tone)**.
>
> **Constraints:**
>
> - The language must sound human and conversational, avoiding robotic or overly formal "AI-speak."
> - Do not invent any excuses or details that I haven't explicitly provided.
>
> **Warning:**
>
> - Maintain the exact emotional boundary I requested. Do not make promises or open negotiations if the purpose is a definitive refusal.
