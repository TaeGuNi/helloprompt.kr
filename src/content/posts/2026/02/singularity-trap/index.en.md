...
- **🤖 Recommended Models:** All conversational AIs (Claude 3.5 Sonnet, GPT-4o, Gemini 1.5 Pro)
...
1. **The Singularity as a Sales Pitch:** The narrative of impending AGI is often used to justify massive investments in compute power rather than solving immediate user problems.
2. **The Disconnect:** There is a growing gap between what AI companies promise (autonomous, omniscient agents) and what they actually deliver (incremental improvements in pattern matching).
3. **Consumer Exhaustion:** Users globally are starting to reject the hype, demanding practical utility over philosophical speculation.

---

## 🚀 The Solution: "The Hype-Cutter"
...
### 🥇 Pro Version (Deep Deconstruction)

Use this for deep-dive analysis of whitepapers, keynote speeches, or investment pitches to uncover the underlying business motives.

> **Role (Role):** You are an elite technology analyst and investigative tech journalist with 15 years of experience debunking Silicon Valley hype cycles. You deeply understand the economics of AI, GPU supply chains, and venture capital mechanics.
>
> **Context (Context):**
>
...
The "Singularity Trap" isn't just an annoyance; it's a massive misallocation of capital and attention. As professionals in the tech space, we are constantly bombarded with narratives designed to create urgency and fear. I created the "Hype-Cutter" prompt because I realized I was spending hours trying to manually decipher whether a new model release was actually a breakthrough or just a minor parameter tweak wrapped in exceptional copywriting.
...
- **Q: Won't an AI be biased towards defending AI progress?**
  - A: Not if you strictly define its persona. By explicitly assigning it the role of a "skeptical investigative journalist" and demanding focus on verifiable facts vs. financial motives, you bypass its default "helpful AI" persona and force it to be critical.

- **Q: Can I use this for non-AI tech hype (like Web3 or Metaverse)?**
  - A: Absolutely. Just change the context keywords in the Pro Prompt from "AGI/Singularity" to "Decentralization" or "Spatial Computing." The mechanism of deconstructing marketing spin remains exactly the same.
...
### ❌ Before (Raw Input - Fictional Press Release)

```text
"Today, we are thrilled to announce OmniMind v7. This is not just a model; it is the dawn of a new era. OmniMind v7 exhibits sparks of true consciousness and brings us to the very edge of the Singularity. To run this revolutionary intelligence, we are partnering with leading hardware providers to build a $50 billion compute cluster. The future is here, and you must adopt it or be left behind."
```

### ✅ After (AI Output using Pro Prompt)

```text
### 1. Fact vs. Fiction
*   **Verifiable Claims:** The company has released a new model (OmniMind v7) and is building a $50 billion compute cluster in partnership with hardware providers.
*   **Marketing Fiction/Hype:** "Sparks of true consciousness," "dawn of a new era," "edge of the Singularity." There is zero technical evidence provided to support these philosophical claims.

### 2. The "GPU Motive"
The narrative heavily utilizes the fear of being "left behind" (FOMO) and the philosophical allure of the "Singularity" to justify an astronomical $50 billion capital expenditure on hardware. This press release reads primarily as a signal to investors to fund infrastructure, using abstract AGI promises as the collateral.

### 3. The Goalposts
The terms "sparks of true consciousness" and "Singularity" are undefined and entirely unmeasurable, allowing the company to claim victory without hitting any specific, verifiable technical benchmarks.

### 4. The Verdict
This announcement is a massive infrastructure spending plan disguised as a scientific breakthrough. The company is leveraging the emotional weight of AGI to secure funding for compute clusters, rather than demonstrating a tangible leap in actual AI capabilities. Proceed with extreme financial skepticism.
```
