...
1. Definisci l'aspetto del personaggio (colori, dettagli distintivi, ecc.) in modo inequivocabile utilizzando istruzioni testuali chiare.
2. Richiedi all'IA una **"Grid View (Vista a griglia)"** contenente più espressioni nella stessa immagine, anziché generare un'immagine alla volta, per massimizzare la coerenza.
3. Utilizza il risultato generato dall'IA come base (Tracer) per ricalcare i contorni su un iPad, aggiungi del testo empatico e invia il lavoro per la revisione.

---

## 🚀 La Soluzione: "Emoticon Factory Prompt"

### 🥉 Versione Base (Basic Version)

Ideale per stabilire il design generale e il "tone and manner" del tuo personaggio.

> **Ruolo:** Sei un character designer esperto con 10 anni di esperienza nella creazione di sticker per app di messaggistica.
...
Perfetta per estrarre le espressioni chiave e mantenere una coerenza assoluta per un intero set di 24 sticker.

> **Ruolo (Role):** Sei un character designer veterano che ha lanciato con grande successo decine di set di sticker sugli store ufficiali.
> 
> **Contesto (Context):**
> 
> - Background: Non possiedo alcuna abilità nel disegno, ma desidero ideare un set di sticker basato su situazioni lavorative reali, capace di generare forte empatia tra gli impiegati.
> - Obiettivo: Mantenendo una perfetta coerenza visiva della 'papera col germoglio' creata in precedenza, voglio generare 4 espressioni fondamentali, che fungeranno da base per il set completo di 24 sticker necessario per la valutazione.
> 
> **Compito (Task):**
> 
> Conservando fedelmente l'aspetto del personaggio (corpo giallo, germoglio sulla testa), disegna un set di sticker che rappresenti le 4 emozioni seguenti. È assolutamente fondamentale che tu mi mostri le 4 immagini all'interno di un'unica **Vista a griglia (Grid View)** suddivisa.
> 
> 1. **Gioia (Fine turno):** Occhi a mezzaluna per la felicità assoluta, mentre fa un salto di gioia lanciando dei documenti in aria.
> 2. **Tristezza (Straordinari):** Occhiaie profonde che scendono fino al mento, fronte abbandonata sulla tastiera e l'anima che sembra letteralmente abbandonare il corpo.
> 3. **Rabbia (Perdita di controllo):** Il germoglio sulla testa brucia di un rosso fuoco mentre ribalta la scrivania con furore.
> 4. **Rifiuto (Categorico):** Espressione totalmente impassibile, mentre incrocia le sue due piccole ali formando una X in modo deciso.
> 
> **Vincoli (Constraints):**
> 
> - [Stile]: Stile di illustrazione 2D semplificato, tipico e ottimizzato per le app di messaggistica.
> - [Spessore linea]: Usa rigorosamente **linee esterne marcate (Thick Outline)** affinché il disegno risulti ben visibile anche sui piccoli schermi degli smartphone.
> - [Sfondo]: Lo sfondo deve essere di un bianco puro (Solid White) per facilitare enormemente la futura rimozione dello sfondo (scontorno).
> - [Testo]: NON includere assolutamente alcun testo (parole o lettere) all'interno dell'immagine. (Il copywriting verrà aggiunto in seguito utilizzando Photoshop).
...
- **Q: Posso inviare direttamente le immagini create dall'IA per farle approvare sugli store?**
...
1.  **Sfruttamento della Grid View:** Chiedendo all'IA di generare immagini singole separate, il sistema applicherà un nuovo Seed (valore di partenza) per ciascuna, introducendo inevitabili micro-variazioni nel design del personaggio. Ordinando invece di "disegnare in una vista a griglia condivisa", l'IA opera all'interno dello stesso contesto spaziale e logico, innalzando esponenzialmente il tasso di coerenza visiva (Consistency).
2.  **Controllo rigoroso dei dettagli:** Imponendo parametri stringenti come "Thick Outline (linea esterna spessa)" e "Solid White Background (sfondo bianco puro)", si semplifica in modo clamoroso la successiva e inevitabile fase di post-produzione su Photoshop (come lo scontorno), rendendo inoltre le immagini nativamente ottimizzate per la visualizzazione su smartphone.
...
Ottieni istantaneamente un set di 4 espressioni chiave del personaggio, caratterizzato da linee pulite e proporzioni perfette, paragonabile al lavoro di un illustratore professionista! Utilizzando queste immagini come base da ricalcare sul tablet, e aggiungendo infine il giusto testo, sarai in grado di pianificare e abbozzare un intero set professionale di 24 sticker in un solo weekend di lavoro.
