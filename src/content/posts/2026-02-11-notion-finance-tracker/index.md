...
# (Updated) 💸 Notion 가계부 템플릿: 돈이 모이는 자동화 시스템 {#updated}
...
## (Updated) 🚀 해결책: "Notion Formula Architect" {#updated}

### (Updated) 🥉 Basic Version (수식 생성) {#updated}
...
### (Updated) ❌ Before (카드 명세서) {#updated}

"아... 지난달에 배달 음식 50만 원 썼네? 미쳤다." (이미 늦음 💸)

### (Updated) ✅ After (노션 가계부) {#updated}
