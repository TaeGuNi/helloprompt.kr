...
Es geht hierbei nicht nur darum, das Review-Verfahren auszulagern. Es ist der intelligenteste Weg, die wertvolle Zeit deiner Kollegen zu sparen und deinen eigenen Stolz (sowie deine Performance-Bewertung) als Entwickler zu wahren.
...
> 
> **Aufgabe (Task):**
> Bitte reviewe den von mir bereitgestellten Code-Snippet. Unterteile deine Antwort in die folgenden 4 Abschnitte im Markdown-Format:
> 
...
1. **Persona-Design (Role):** Indem der KI die Rolle eines "Senior Staff Engineers mit 10 Jahren Erfahrung" zugewiesen wird, heben wir die Tiefe und den analytischen Blickwinkel des Reviews sofort auf ein architektonisches Niveau an.
