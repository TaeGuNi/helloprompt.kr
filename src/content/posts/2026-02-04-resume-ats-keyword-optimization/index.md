...
# (Updated) (Updated) 📝 ATS(채용 솔루션) 광탈 방지! 이력서 키워드 최적화 프롬프트 {#updated}
...
## (Updated) (Updated) 🚀 해결책: "ATS 해킹 프롬프트" {#updated}
...
### (Updated) (Updated) ❌ Before (키워드 불일치) {#updated}
...
### (Updated) (Updated) ✅ After (JD 키워드: GA4, Cross-functional Team) {#jd-ga4-cross-functional-team}
