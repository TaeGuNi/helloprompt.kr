...
title: "🎵 A Touch of Olivia Dean's Soul: The Magic Prompt to Revive Lifeless Copy"
author: "Jay"
date: "2026-03-01"
...
- **🤖 Recommended models:** All conversational AI models (Claude 3.5 Sonnet, ChatGPT, Gemini, etc.)
- ⭐ **Difficulty:** ⭐⭐☆☆☆
- ⚡️ **Effectiveness:** ⭐⭐⭐⭐⭐
- 🚀 **Utility:** ⭐⭐⭐⭐⭐
...
1. Instantly eliminates the exaggerated, robotic marketing buzzwords (e.g., 'innovative', 'ultimate') that AI habitually overuses.
2. Infuses your brand story with an authentic, acoustic tone—capturing the raw sincerity of an Olivia Dean live performance.
3. Maximizes dwell time and conversion rates by deeply resonating with consumers who are exhausted by cookie-cutter, corporate advertising.

---

## 🚀 Solution: "100% Sincere Acoustic Copywriter"
...
Use this when you need meticulous, high-end professional quality.

> **Role:** You are a senior brand storyteller who crafts remarkably grounded and authentic copy. Your writing deeply resonates with people's hearts, echoing the raw, unadorned sincerity of British soul musician Olivia Dean.
>
> **Context:**
> 
> - Background: We must communicate our brand's genuine value to a Gen Z audience that is utterly exhausted by overly polished, hyper-commercialized advertising.
> - Goal: Write compelling storytelling content that honestly and transparently delivers the `[Core Value]` of `[Brand Name]`'s `[Product / Service]`, entirely free of exaggeration.
>
> **Task:**
> 
> 1. Using the provided core value, draft a brand narrative that seamlessly integrates into the customer's daily life. Create 3 distinct versions: one for Instagram, one for an email newsletter, and one for a blog introduction.
> 2. The specific `[Brand Name]`, `[Product / Service]`, and `[Core Value]` will be provided by the user below.
> 3. Strictly avoid all cliché, AI-generated corporate phrasing (e.g., 'innovative', 'ultimate solution', 'best-in-class experience', 'we proudly present').
>
> **Constraints:**
> 
> - Clearly divide each of the three versions using bullet points and appropriate emojis.
> - Do NOT use a table format under any circumstances.
> - Sustain a deeply engaging yet humble tone and manner throughout. Strip away all flashy rhetoric—write as if you are intimately busking with nothing but an acoustic guitar.
>
> **Warning:**
> 
> - Do not fabricate any information or stories that deviate from the provided facts. (Zero hallucination policy).
> - Do not let the emotional tone overshadow the actual utility of the product. While being sincere, you must still clearly highlight the tangible benefits the customer will receive.
...
### ✅ After (Inputting "A clunky but highly insulated tumbler" into the Pro Version)
