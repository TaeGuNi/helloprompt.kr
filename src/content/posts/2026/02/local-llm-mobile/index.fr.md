...
```text
Réunion strat Q3.
Marc dit qu'on doit couper le budget marketing de 150k€. Sarah n'est pas d'accord, elle veut tout réallouer sur des campagnes TikTok.
Décision finale : on coupe 50k€ et on met 100k€ sur des influenceurs.
Faut absolument que Paul prépare les contrats d'ici vendredi.
Ah, et le projet Alpha est reporté à novembre car on manque gravement de dev.
```

### ✅ Après (Généré hors ligne en 3 secondes)

```markdown
### Résumé Exécutif

La réunion de stratégie du troisième trimestre s'est principalement concentrée sur l'optimisation des dépenses marketing et la mise à jour du calendrier des projets en cours. Un consensus stratégique a été trouvé pour réallouer une proportion significative du budget vers le marketing d'influence, tout en actant le report du Projet Alpha en raison de contraintes liées aux ressources techniques actuelles.

### Décisions Clés

- Réduction budgétaire partielle du budget marketing global.
- Réallocation majeure des fonds restants vers des campagnes ciblées d'influenceurs (ex: TikTok).
- Report officiel de la livraison du Projet Alpha au mois de novembre.

### Plan d'Action

- [ ] **Paul** : Rédiger et finaliser les contrats de partenariat influenceurs d'ici ce vendredi.
- [ ] **Équipe technique / RH** : (Point à clarifier) Évaluer précisément les besoins en recrutement de développeurs pour relancer le Projet Alpha.
```
