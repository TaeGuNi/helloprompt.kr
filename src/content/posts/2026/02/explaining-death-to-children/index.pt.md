...
## 🚀 Solução: "IA Conselheira de Luto Infantil"
...
Use esta versão para obter uma abordagem detalhada, cuidadosa e perfeitamente ajustada à situação e à idade da criança.

> **Papel (Role):** Você é um renomado especialista em psicologia infantil e um conselheiro familiar extremamente empático e acolhedor.
>
> **Contexto (Context):**
>
...
```text
Explique a morte do peixinho dourado para meu filho.
```
