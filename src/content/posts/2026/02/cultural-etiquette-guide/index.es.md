...
Úsala cuando estés a punto de aterrizar y necesites reglas de supervivencia rápidas.
...
> **Contexto (Context):**
>
> - Destino: Viajo a `[Dubái, Emiratos Árabes Unidos]` la próxima semana.
> - Situación: Estoy preocupado porque es mi primera vez visitando una cultura islámica y no quiero cometer errores graves.
>
> **Tarea (Task):**
>
...
>
> - No uses frases genéricas y obvias como "debes ser respetuoso". Dame pautas de acción sumamente específicas (ej. "No comas ni saludes usando la mano izquierda").
> - Marca en **negrita y con el emoji 🚨** aquellas acciones que puedan acarrear problemas legales, multas o arrestos por su incumplimiento.
>
> **Advertencia (Warning):**
>
...
```text
"Dime precauciones para mi viaje a Dubái."
```

_(Resultado: Un texto genérico sobre el clima caluroso, beber agua, y ser "respetuoso con la religión", sin ejemplos claros de qué significa eso en la práctica)._

### ✅ Después (Resultado con el Prompt Pro)

```text
🚨 Tabúes Absolutos:
- Muestras públicas de afecto: Abrazarse apasionadamente o besarse en público es ilegal y puede resultar en arresto.
- Uso de la mano izquierda: Considerada impura. Nunca ofrezcas cosas, comas ni saludes usando tu mano izquierda.
- Fotografía sin permiso: 🚨 Es un delito penado por la ley fotografiar a mujeres musulmanas, instalaciones militares o edificios gubernamentales.

💰 Propinas:
- En restaurantes, suele estar incluido un cargo por servicio del 10%, pero es costumbre dejar un 10-15% extra en efectivo para el mesero si el servicio fue bueno.
```
