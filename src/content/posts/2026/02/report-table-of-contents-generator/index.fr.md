...
>
> - Sois extrêmement concis et percutant. Supprime tout jargon inutile.
> - Le format de sortie doit être structuré de manière claire en Markdown.
>
> **Attention (Warning) :**
>
> - Si les informations fournies dans le contexte sont insuffisantes pour créer un plan solide et argumenté, pose-moi 3 questions clés avant de générer le résultat. Ne devine pas les éléments critiques.
...
- **Q : Que faire si le plan généré ne correspond pas au style de mon entreprise ?**
  - A : Ajoutez le style de votre entreprise directement dans la section "Contraintes". Par exemple : "Utilise le ton analytique, direct et factuel typique de la culture d'écriture d'Amazon (style 6-pager)."
...
_(L'IA produit souvent une liste basique et sans âme : 1. Introduction, 2. Marché, 3. Produit, 4. Conclusion... Très ennuyeux et sans réel impact stratégique.)_

### ✅ Après (Résultat avec le Prompt Pro)

```text
**Titre recommandé :** Stratégie de Lancement Sécurisé : Repousser pour mieux Régner (Application Q3)

**1. Résumé Exécutif (Conclusion d'abord)**
*Synthèse : Un report d'un mois garantit la sécurité des données utilisateurs sans impacter l'objectif de revenus annuel.*
- Mots-clés : Risque sécuritaire, Tolérance zéro, Impact financier mitigé.

**2. Situation Actuelle & Complication**
*Synthèse : Bien que le développement soit achevé à 95%, le dernier test de pénétration révèle des failles critiques.*
- Mots-clés : Audit externe, Faille d'authentification, RGPD.

**3. Analyse de l'Impact (Pourquoi repousser ?)**
*Synthèse : Un lancement précipité exposerait l'entreprise à une perte de confiance irréversible de la part des premiers utilisateurs.*
- Mots-clés : Réputation de la marque, Churn précoce, Coûts de remédiation.

**4. Plan d'Action & Calendrier Révisé**
*Synthèse : Mobilisation de l'équipe cybersécurité pour un patch intensif en 3 semaines et un lancement début Q4.*
- Mots-clés : Sprint de sécurité, Nouveau rétroplanning, Allocation des ressources.
```
