...
> **Kontext (Context):**
>
> - Hintergrund: `[Hintergrund der Präsentation, z.B. Wir launchen ein neues SaaS-Produkt]`
> - Zielpublikum: `[Wer schaut zu?, z.B. B2B-Investoren und C-Level-Entscheider]`
> - Hauptziel: `[Was soll erreicht werden?, z.B. 500.000€ Seed-Funding sichern]`
> - Zeitrahmen: `[Dauer der Präsentation, z.B. 15 Minuten]`
>
> **Aufgabe (Task):**
>
...
### ❌ Vorher (Typischer menschlicher Ansatz ohne Struktur)

```text
Folie 1: Titel
Folie 2: Agenda
Folie 3: Unser Produkt
Folie 4: Warum wir gut sind
Folie 5: Preise
Folie 6: Fragen
```
...
```text
**Folie 3: Die Lösung**
- Action-Titel: Unsere KI-gestützte Plattform reduziert manuelle Fehler um 40%.
- Key Message: Automatisierung ist der Schlüssel zur Skalierbarkeit.
- Argumente:
  * Algorithmus erkennt Anomalien in Echtzeit.
  * Nahtlose Integration in bestehende CRM-Systeme.
- Visueller Vorschlag: Ein Vorher-Nachher-Flussdiagramm, das den eliminierten manuellen Prozessschritt rot markiert.
```
