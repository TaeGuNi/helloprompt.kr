...
# (Updated) ⌨️ Vim 단축키 마스터: 마우스 없이 코딩하는 법 {#updated}
...
## (Updated) 🚀 해결책: "Vim Tutor Prompt" {#updated}

### (Updated) 🥉 Basic Version (생존 키트) {#updated}
...
### (Updated) 🥇 Pro Version (매크로 & 레지스터) {#updated}
