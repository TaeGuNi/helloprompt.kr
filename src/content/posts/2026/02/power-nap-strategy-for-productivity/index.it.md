...
1. **Tempismo Perfetto:** Impara a impostare un timer strategico di 20 minuti (Power Nap) per evitare di entrare nella fase di sonno profondo.
2. **Il Trucco del 'Coffee Nap':** Unisci l'effetto stimolante della caffeina ai benefici rigeneranti del pisolino per un'iniezione di energia esplosiva.
3. **Risveglio Istantaneo:** Applica tecniche specifiche per azzerare la sensazione di intontimento e tornare immediatamente operativo e concentrato.
...
Usala quando ti servono istruzioni rapide e dirette.

> **Ruolo:** Sei un esperto scienziato del sonno e consulente di produttività.
>
> **Richiesta:** Ho una forte sonnolenza post-pranzo. Spiegami in modo semplice e veloce la tecnica del 'Coffee Nap' per riposare esattamente 20 minuti e svegliarmi carico di energia.
...
> **Contesto (Context):**
>
> - Stato attuale: Ho appena terminato di pranzare e sto accusando un drastico calo di energie. Attualmente sono le `[13:30]`.
> - Obiettivo: Ho una riunione cruciale alle `[14:00]`, pertanto la mia mente deve essere estremamente lucida, reattiva e priva di nebbia cognitiva (brain fog).
>
> **Richiesta (Task):**
>
> 1. Definisci la **durata esatta del pisolino (in minuti)** più strategica per la mia specifica situazione.
...
> 4. Suggeriscimi uno **stretching di 1 minuto** o un'azione fisica immediata per riattivare il cervello non appena in piedi.
>
> **Vincoli (Constraints):**
>
> - Il tempo di sonno effettivo non deve mai superare i 25 minuti, al fine di evitare l'inerzia del sonno.
> - Spiega brevemente ma con rigore scientifico perché questa tecnica è efficace (cita i recettori dell'adenosina).
>
> **Avvertenze (Warning):**
>
> - Sii conciso e focalizzati su passaggi immediatamente azionabili. Evita inutili discorsi motivazionali.
...
1. 13:35 (Iniezione di Caffeina): Bevi rapidamente un caffè espresso o un cold brew. (Fallo subito: la caffeina impiegherà circa 20 minuti per bloccare i recettori dell'adenosina).
...
3. 13:58 (Risveglio Sincronizzato): Al suono della sveglia, alzati immediatamente. L'effetto della caffeina sta raggiungendo il suo picco di massima efficacia proprio ora.
4. 14:00 (Attivazione): Sciacquati il viso con acqua fredda ed esegui 10 allungamenti verso l'alto (stretching della colonna vertebrale). Il tuo cervello è stato riavviato ed è pronto per la riunione.
```
