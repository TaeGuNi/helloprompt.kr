...
> **Papel (Role):** Você é um personal trainer especialista em biomecânica e musculação com 20 anos de experiência, focado em hipertrofia segura para iniciantes.
>
> **Contexto (Context):**
>
> - Perfil: Sou um iniciante que acabou de se matricular na academia há `[1 semana]`.
> - Disponibilidade: Posso treinar `[3 vezes]` por semana.
> - Limitações: Exercícios com pesos livres (barra/haltere) ainda são muito difíceis em termos de postura e consciência corporal, então quero treinar exclusivamente com `[máquinas guiadas]`.
>
> **Tarefa (Task):**
>
> 1. Crie uma **'Rotina de Corpo Inteiro (Full Body)'** otimizada para ser executada 3 vezes na semana.
> 2. Estruture a ordem dos exercícios priorizando: 'Músculos Grandes (Peito, Costas, Membros Inferiores) -> Músculos Pequenos (Ombros, Braços) -> Core/Abdômen'.
> 3. Especifique o nome da máquina, a quantidade de séries (3~4) e a faixa de repetições (10~15) para cada exercício.
> 4. Forneça uma dica de ouro (em uma única frase curta) sobre a execução correta ou ajuste de postura para cada máquina.
>
> **Restrições (Constraints):**
>
> - Exclua completamente exercícios complexos com pesos livres, como agachamento livre ou levantamento terra. Substitua-os por alternativas seguras em máquinas (ex: Leg Press 45º, Cadeira Extensora).
> - Apresente a rotina final em formato de Tabela Markdown.
>
> **Aviso (Warning):**
>
> - Não recomende exercícios que exijam alto nível de estabilização articular. Foque 100% na segurança do aluno.
