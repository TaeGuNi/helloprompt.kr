...
# (Updated) (Updated) (Updated) 🎯 백 마디 설명보다 강력한 "예시"의 힘 {#updated}
...
## (Updated) (Updated) (Updated) 🚀 해결책: "입력과 출력 쌍(Pair) 보여주기" {#pair}
...
### (Updated) (Updated) (Updated) ❌ Before (설명만 했을 때) {#updated}
...
### (Updated) (Updated) (Updated) ✅ After (퓨샷 예시를 줬을 때) {#updated}
