...
## 🚀 La Soluzione: "Il Tutor Matematico Passo-Passo"
...
> **Contesto (Context):**
>
> - Background: Mi sono bloccato durante la risoluzione di un problema di matematica. Non voglio solo la soluzione finale, ma ho bisogno di comprendere a fondo l'intero processo logico.
> - Obiettivo: Poiché le mie basi sono un po' fragili, devi spiegarmi ogni concetto con estrema semplicità, come se stessi parlando a un principiante assoluto.
>
> **Richiesta (Task):**
>
> 1. Definisci chiaramente i **Concetti Chiave / Formule** indispensabili per affrontare il problema.
> 2. Scomponi la risoluzione in **Passaggi Logici Sequenziali** (Passo 1, Passo 2, ecc.).
> 3. Ogni volta che applichi una trasformazione o manipoli un'equazione, specifica esplicitamente tra parentesi **quale teorema, principio o regola matematica è stata utilizzata** (es. _"Applicando il Teorema di Pitagora"_, _"Elevando al quadrato entrambi i membri"_, ecc.).
> 4. Concludi sempre con un processo di **Verifica (Controllo)** per dimostrare matematicamente l'esattezza del risultato.
>
> **Vincoli (Constraints):**
>
> - Utilizza rigorosamente la formattazione LaTeX per rendere le formule e le equazioni perfettamente leggibili.
> - Evita assolutamente espressioni del tipo "Come è ovvio che sia" o "Chiaramente". (Se per me fosse ovvio, non te lo starei chiedendo!).
>
> **Problema:**
> `[Inserisci qui il problema di matematica che desideri risolvere]`
...
- **Q: Posso usarlo per problemi di geometria o fisica?**
...
### ❌ Before (Richiesta Standard)

D: "Risolvi x^2 - 5x + 6 = 0"
R: "Le soluzioni sono x = 2 e x = 3." _(Punto e basta. Utilità: zero)._

### ✅ After (Risultato con il Prompt Pro)

**[Concetti Chiave]**
Per risolvere questa equazione di secondo grado, utilizzeremo il metodo della 'Fattorizzazione' (o scomposizione del trinomio). L'obiettivo è trasformare l'equazione in un prodotto di due binomi.

**[Processo di Soluzione]**

**Passo 1: Ricerca dei fattori**
Dobbiamo trovare due numeri magici la cui somma sia pari al coefficiente del termine di primo grado (-5) e il cui prodotto sia pari al termine noto (+6).

- Prodotto desiderato: +6
- Somma desiderata: -5

Analizziamo i possibili fattori di 6:

- 2 × 3 = 6 (Ma 2 + 3 = +5. _Non va bene_)
- (-2) × (-3) = 6 (E la somma (-2) + (-3) fa esattamente -5! _Trovati!_)
  I nostri due numeri sono -2 e -3.

**Passo 2: Riscrivere l'equazione fattorizzata**
Sostituiamo i numeri trovati per comporre i due binomi:
$$(x - 2)(x - 3) = 0$$ _(Applicazione della scomposizione del trinomio particolare)_

**Passo 3: Applicazione della legge di annullamento del prodotto**
Affinché la moltiplicazione di due espressioni dia come risultato 0, è sufficiente che almeno una delle due sia pari a 0.
...
- Per $$x = 2$$: $$(2)^2 - 5(2) + 6 = 4 - 10 + 6 = 0$$ _(Corretto!)_
- Per $$x = 3$$: $$(3)^2 - 5(3) + 6 = 9 - 15 + 6 = 0$$ _(Corretto!)_
