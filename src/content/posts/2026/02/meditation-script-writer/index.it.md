...
## 🚀 La Soluzione: "Il Tuo Guru Personale di Mindfulness"
...
> **Contesto (Context):**
>
> - Stato emotivo: `[Nervoso, con il battito accelerato 10 minuti prima di una presentazione importante]`
> - Luogo attuale: `[Bagno dell'ufficio]`
> - Obiettivo: `[Calmare i nervi e ritrovare un senso di profonda sicurezza e lucidità]`
>
> **Richiesta (Task):**
>
> 1. Scrivi uno script di meditazione guidata intitolato 'Sollievo dalla Tensione e Ricarica di Fiducia', della durata di circa `[3 minuti]`.
> 2. **Introduzione:** Usa tecniche di respirazione specifiche (es. box breathing o 4-7-8) per ancorarmi al momento presente.
> 3. **Sviluppo:** Guidami in una visualizzazione vivida e potente in cui concludo la presentazione con un successo straordinario.
> 4. **Conclusione:** Accompagnami a riaprire gli occhi sentendomi energico, calmo e padrone della situazione.
>
> **Vincoli (Constraints):**
>
> - Inserisci chiare indicazioni di ritmo tra le frasi, come `(Inspira profondamente dal naso per 4 secondi...)` o `(Pausa di 3 secondi...)`.
> - Mantieni le frasi brevi e ritmate per favorire il rilassamento.
> - La lunghezza totale del testo, se letto a voce alta con le pause, deve essere esattamente di 3 minuti.
>
> **Attenzione (Warning):**
>
> - Evita qualsiasi tono giudicante. Le tue parole devono trasmettere assoluta accettazione e sicurezza.
...
_(Risultato: "Chiudi dolcemente gli occhi. Senti il pavimento solido sotto le tue scarpe, qui, in questa stanza. (Pausa di 2 secondi...). Inspira profondamente dal naso, immaginando di portare dentro aria fresca e limpida... 1... 2... 3... 4... (Trattieni il respiro per 2 secondi...). Ora espira lentamente dalla bocca, lasciando andare tutta la tensione accumulata nelle spalle... 1... 2... 3... 4... 5... 6...")_
