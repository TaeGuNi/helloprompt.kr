...
- **🤖 Modèle recommandé :** Tous les générateurs d'images IA (Midjourney, DALL-E 3, Stable Diffusion)
...
## 🚀 La Solution : « Le Prompt d'Hôtel Symétrique »

### 🥉 Version de Base (Simple et Rapide)

Idéal pour obtenir un résultat immédiat sans réglages complexes.
...
> **Contexte (Context) :**
>
> - **Sujet :** Le grand hall majestueux d'un hôtel vintage aux tons roses.
> - **Objectif :** Créer une image d'une symétrie absolue pour une affiche de film.
>
> **Instructions (Task) :**
>
> 1. Rédige un prompt détaillé en anglais pour générer l'image.
> 2. Assure-toi d'inclure les éléments spatiaux : `receptionist standing exactly in the middle`, `perfectly symmetrical composition`, `centered shot`, `mirror image balance`, `front view`.
> 3. Ajoute les éléments de style : `Wes Anderson style`, `pastel colors`, `whimsical`, `flat lighting`, `highly detailed`, `8k`.
>
> **Contraintes (Constraints) :**
>
> - Le prompt final doit être fourni sous forme de bloc de texte clair.
> - Ajoute les paramètres Midjourney suivants à la toute fin : `--ar 16:9 --v 6.0 --style raw --chaos 0`
