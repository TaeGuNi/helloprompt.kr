...
>
> **Contexto:**
> - Fondo: Estoy en movimiento y no puedo mirar la pantalla por mucho tiempo.
> - Objetivo: Quiero un resumen auditivo claro de los mensajes e información importante que me he perdido.
>
> **Tarea:**
> 1. Busca todos los mensajes o correos electrónicos sobre `[Tema de interés]` enviados por `[Nombre del remitente]` durante la última semana.
> 2. Extrae y preséntame los 3 puntos más importantes de esa información.
> 3. Al finalizar el resumen, verifica si tengo algún evento en el calendario relacionado con este tema.
>
> **Restricciones:**
> - El formato de salida debe ser un resumen verbal claro y conciso, como si estuvieras dándome un *briefing* ejecutivo.
>
> **Advertencia:**
> - Si no encuentras información relevante, no inventes nada. Simplemente responde: "No se ha encontrado información al respecto".
...
### ❌ Antes (Método tradicional de Siri)

```text
Yo: "Oye Siri, busca el podcast sobre café que me envió Greg la semana pasada."
Siri: "Esto es lo que he encontrado en la web sobre 'el podcast sobre café que me envió Greg la semana pasada'." (Abre resultados genéricos de búsqueda de Safari)
```

### ✅ Después (Con Apple Intelligence 2.0)

```text
Yo: "Oye Siri, busca el podcast sobre café que me envió Greg la semana pasada y resúmelo en puntos clave."
Siri: "Revisando tus mensajes, el podcast que te recomendó Greg es 'El futuro del café de especialidad'.
Los puntos clave son: 
1. El cambio en la tendencia de acidez del grano colombiano. 
2. La popularización de las máquinas tostadoras caseras.
¿Quieres que guarde esta información en Notas o que te programe un recordatorio para escucharlo?"
```
