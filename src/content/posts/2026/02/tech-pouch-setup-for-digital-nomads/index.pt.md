...
## 🚀 A Solução: "Curador de Setup Tecnológico"
...
> **Tarefa (Task):**
>
> 1. Monte um kit leve e poderoso de 'carregador multipontas (GaN)' e cabos capazes de carregar todos os meus dispositivos simultaneamente.
> 2. Explique como posso criar uma configuração de dois monitores de forma portátil em um Airbnb ou café (ex: usando um tablet como tela estendida).
> 3. Verifique o padrão de tomada e a voltagem do país de destino e recomende o adaptador internacional correto.
>
> **Restrições (Constraints):**
>
> - Minimize o peso e o volume total na mochila. Priorize itens compactos.
> - Inclua um plano de contingência para internet (eSIM, roteador portátil 5G, tethering seguro).
> - Baseie as recomendações em especificações técnicas vitais (ex: Power Delivery acima de 100W, portas Thunderbolt 4) e não apenas em marcas famosas.
> - Formate a saída como uma lista de verificação (checklist) em Markdown e organize por categorias (Energia, Ergonomia, Conectividade).
...
1. Energia (GaN & Cabos):
   ...
   - Cabo trançado PD de 100W de 2 metros (essencial para cafés com tomadas distantes).

2. Ergonomia & Monitor Duplo:
   - Use seu iPad como segunda tela nativamente via 'Sidecar' da Apple.
   - Suporte de alumínio dobrável (estilo Roost Stand) para elevar a tela na altura dos olhos.
