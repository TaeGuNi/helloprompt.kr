...
1. **Zielgerichtete Namensgebung:** Füttern Sie die KI mit den Kernfunktionen und Ihrer Zielgruppe für maßgeschneiderte Vorschläge.
2. **Kreative Vielfalt:** Entdecken Sie ein breites Spektrum an Benennungsstilen – von intuitiv bis hin zu metaphorisch und abstrakt.
3. **Strategische Auswahl:** Erhalten Sie nicht nur Namen, sondern auch fundierte Begründungen und assoziierte Bilder, um die bestmögliche Wahl zu treffen.

---

## 🚀 Die Lösung: "Der Namensfindungs-Maestro"

### 🥉 Basic Version (Grundlagen)

Verwenden Sie dies, wenn Sie schnelle, erste Inspirationen benötigen.
...
Verwenden Sie dies für detaillierte, marktreife und strategisch fundierte Namensvorschläge.

> **Rolle (Role):** Du bist ein `[Professioneller Berater für Markenbenennung]` mit über 20 Jahren Erfahrung in der Entwicklung international erfolgreicher Marken. Du bist ein Meister im kreativen Wortspiel und in der Erschaffung trendiger, einprägsamer Wortkombinationen.
>
> **Kontext (Context):**
>
> - Hintergrund: Ich bringe ein neues `[Produkt/Dienstleistung]` auf den Markt.
> - Ziel: Ich brauche einen extrem starken, unverwechselbaren Namen, der sich sofort in den Köpfen der Kunden verankert.
>
> **Aufgabe (Task):**
>
> 1. Analysiere das Produkt: `[Kernfunktionen und Alleinstellungsmerkmale des Produkts]`
> 2. Berücksichtige die Zielgruppe: `[Hauptzielgruppe und deren Bedürfnisse]`
> 3. Reflektiere den Markenton: `[Gewünschte Markenpersönlichkeit (z.B. luxuriös, nahbar, innovativ, hip)]`
> 4. Entwickle auf Basis dieser Parameter 10 hochqualitative Produktnamen-Ideen.
> 5. Liefere für jeden Namen eine präzise Begründung ("Warum dieser Name funktioniert") und beschreibe das assoziierte psychologische Bild ("Hervorgerufenes Bild").
> 6. Sorge für stilistische Vielfalt (z.B. Neologismen, englische Begriffe, clevere Kofferwörter).
>
> **Einschränkungen (Constraints):**
>
> - Schließe Namen strikt aus, die länger als 3 Silben oder schwer auszusprechen sind.
> - Vermeide Namen, die offensichtliche Ähnlichkeiten zu bestehenden, bekannten Marken aufweisen.
> - Gib das Ergebnis **ausschließlich** als Markdown-Tabelle mit folgenden Spalten aus: `Name`, `Stil`, `Begründung`, `Assoziiertes Bild`.
>
> **Warnung (Warning):**
>
> - Erfinde keine Fakten über Markenrechte. Weise darauf hin, dass eine finale rechtliche Prüfung (Markenrecherche) durch den Nutzer unerlässlich ist.
