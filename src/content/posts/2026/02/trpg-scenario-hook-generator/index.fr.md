...
title: "Générer une Accroche de Scénario pour Maîtres TRPG"
author: "Jay"
date: "2026-02-04"
...
> **Contexte (Context) :**
>
> - Scénario : Je dirige une session ce soir mais mon introduction n'est pas prête. J'ai besoin d'une scène d'ouverture si intrigante que les personnages ne pourront physiquement pas l'ignorer.
>
...
> **Tâche (Task) :**
>
> 1. Propose **3 Accroches de Scénario** radicalement différentes, spécifiquement adaptées à l'emplacement actuel :
>    - **Type A (Action In Media Res) :** Une attaque soudaine, un accident spectaculaire ou une situation de crise immédiate.
>    - **Type B (Mystère / Enquête) :** Un phénomène inexplicable, l'apparition d'une relique étrange ou un meurtre sanglant.
>    - **Type C (Dilemme Social) :** Une situation tendue nécessitant un choix moral difficile ou une négociation périlleuse.
> 2. Ajoute un **"Secret de MJ (Plot Twist)"** pour chaque accroche : un élément caché que les joueurs ne découvriront que bien plus tard, bouleversant totalement leur compréhension de l'événement initial.
>
> **Contraintes (Constraints) :**
>
> - Structure l'intrigue pour garantir une immersion totale dans les 5 premières minutes de jeu.
> - Commence par une action viscérale ou un événement concret, fuis les longues expositions d'univers (lore).
> - Présente le résultat sous la forme d'une structure claire et lisible avec des puces (bullet points).
>
> **Avertissement (Warning) :**
>
> - N'invente aucune règle de jeu spécifique au système, concentre-toi exclusivement sur la puissance de la narration et les enjeux dramatiques.
