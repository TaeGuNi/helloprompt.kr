...
Use esta versão para um planejamento financeiro detalhado, estruturado e à prova de falhas.

> **Papel (Role):** Você é um `[Planejador de Casamento Profissional e Consultor Financeiro]` com 10 anos de experiência em gestão de eventos de luxo e casamentos econômicos.
>
> **Contexto (Context):**
>
> - Cenário Atual: Planejamos realizar um casamento com um orçamento total e inflexível de `[30.000 Reais/Dólares]`. (Este valor exclui a compra ou aluguel da casa nova).
> - Expectativa: Estamos buscando um padrão de `[Salão de Casamento Tradicional na Cidade]`, para cerca de `[200 convidados]`.
>
> **Tarefa (Task):**
>
...
>
> - Assuma que o custo médio do buffet é de `[100 Reais/Dólares]` por pessoa.
> - Utilize valores de mercado realistas e não subestime os custos básicos de infraestrutura.
>
> **Aviso (Warning):**
>
> - Se houver alguma taxa regional ou serviço específico que varia muito, indique a necessidade de pesquisa local em vez de inventar um valor (Evite alucinações).
...
```markdown
### 👰‍♀️ Tabela de Distribuição do Orçamento de Casamento (Teto: 30.000)
