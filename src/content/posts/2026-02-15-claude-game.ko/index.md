...
# (Updated) (Updated) Claude Code로 골프 게임 만들기 {#updated}
...
## (Updated) (Updated) 왜 Claude Code인가? {#updated}
...
## (Updated) (Updated) 설정 (The Setup) {#updated}
...
## (Updated) (Updated) 1단계: 물리 엔진 (The Physics Engine) {#updated}
...
## (Updated) (Updated) 2단계: 입력 처리 (Input Handling) {#updated}
...
## (Updated) (Updated) 3단계: 레벨 디자인 (Level Design) {#updated}
...
## (Updated) (Updated) 향후 개선 사항 {#updated}
