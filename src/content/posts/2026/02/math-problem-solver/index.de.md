...
**Eingabe:** "Löse $x^2 - 5x + 6 = 0$"

**Ergebnis der KI:** "Die Lösungen sind $x = 2$ und $x = 3$." _(Null Lerneffekt)_

### ✅ After (Mit unserem Pro-Prompt)

**[Schlüsselkonzepte]**
Um diese quadratische Gleichung zu lösen, verwenden wir die Faktorisierung (den Satz von Vieta).

**[Lösungsprozess]**
**Schritt 1: Faktoren finden**
Wir suchen zwei Zahlen, deren Produkt $+6$ und deren Summe $-5$ ergibt.

- $(-2) \times (-3) = 6$
- $(-2) + (-3) = -5$
  Die gesuchten Zahlen sind also $-2$ und $-3$.

**Schritt 2: Gleichung umschreiben**
Wir faktorisieren die quadratische Gleichung:
$$(x - 2)(x - 3) = 0$$

**Schritt 3: Nullproduktsatz anwenden**
Ein Produkt ist genau dann Null, wenn mindestens einer der Faktoren Null ist. Wir betrachten beide Fälle:

Fall 1:
$$x - 2 = 0 \rightarrow x = 2$$ (Äquivalenzumformung: $+2$ auf beiden Seiten)

Fall 2:
$$x - 3 = 0 \rightarrow x = 3$$ (Äquivalenzumformung: $+3$ auf beiden Seiten)

**[Probe]**
Setzen wir $x=2$ in die Ursprungsgleichung ein:
$$2^2 - 5(2) + 6 = 4 - 10 + 6 = 0$$ (Die Aussage ist wahr!)
