...
## 🚀 Soluzione: Prompt "Allenatore di Intelligenza Emotiva"
...
> **Contesto (Context):**
>
> - Sto per fare un gioco di mimi ("Sciarada delle Emozioni") con mio figlio (età prescolare/scolare).
> - Ci alterneremo nell'esprimere e indovinare emozioni usando solo espressioni facciali e linguaggio del corpo, senza usare le parole.
>
> **Obiettivo (Task):**
>
> 1. Crea 5 situazioni molto specifiche e realistiche che un bambino potrebbe vivere nella sua quotidianità (es. all'asilo, al parco, a casa con i fratelli).
> 2. Associa ogni situazione a un'emozione complessa e sfumata (es. "frustrazione", "senso di ingiustizia", "orgoglio", "imbarazzo", "gelosia"), evitando deliberatamente le emozioni troppo basilari come la semplice gioia o tristezza.
> 3. Fornisci per ogni emozione dei "Suggerimenti di Recitazione" (indica esattamente quali espressioni facciali e gesti corporei usare per mimarla al meglio).
>
> **Vincoli (Constraints):**
>
> - La descrizione della situazione deve essere molto breve (massimo 1-2 frasi).
> - Il linguaggio deve essere semplice, diretto e facilmente comprensibile per un genitore non esperto di teatro.
> - Formatta l'output come un elenco puntato chiaro e leggibile.
...
```text
Dammi un tema per il gioco delle emozioni da fare con mio figlio.
```

_(L'IA risponderà con banalità: "1. Fai la faccia felice quando mangi il gelato. 2. Fai la faccia triste se piove.")_

### ✅ Dopo (Risultato del Prompt Esperto)

```text
1. **Situazione:** Hai costruito una torre altissima di Lego mettendo un pezzo sull'altro con tanta attenzione, e all'improvviso il tuo fratellino corre e la distrugge per sbaglio.
   - **Emozione:** Frustrazione / Senso di ingiustizia
   - **Suggerimenti di Recitazione:** Incrocia le braccia forte al petto, metti un bel broncio sporgendo il labbro inferiore, guarda verso il basso e sbuffa rumorosamente facendoti gonfiare le guance.

2. **Situazione:** Hai imparato ad allacciarti le scarpe da solo per la prima volta senza chiedere aiuto alla mamma.
   - **Emozione:** Orgoglio / Soddisfazione profonda
   - **Suggerimenti di Recitazione:** Petto in fuori, mento alto e fiero, un grande sorriso a bocca chiusa e metti le mani salde sui fianchi, esattamente nella posa di un supereroe.
```
