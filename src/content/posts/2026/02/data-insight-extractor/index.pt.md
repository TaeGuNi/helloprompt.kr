...
> **Solicitação (Task):**
>
> 1. Identifique e liste 3 padrões marcantes ou anomalias (tendências/outliers) presentes nestes dados.
> 2. Interprete o significado comercial e o possível impacto financeiro de cada um desses padrões.
> 3. Com base nas suas análises, proponha 2 pontos de melhoria práticos ou novas oportunidades de negócio.
>
...
```text
Aqui estão as vendas de Jan a Dez em CSV. Analise isso pra mim.
```

### ✅ Depois (Resultado aplicando a Versão Pro)

```text
**📊 Análise Estratégica de Vendas (Jan-Dez)**

**1. Padrões e Anomalias Identificadas:**
- **Pico Sazonal Confirmado:** Observou-se um aumento agudo de 30% no volume de vendas durante a temporada de verão (julho e agosto).
- **Queda Preocupante na Retenção:** Houve uma retração de 5% na taxa de recompra no quarto trimestre, o que contrasta fortemente com o nosso alto índice de aquisição de novos clientes no mesmo período.

**2. Significado Comercial e Impacto:**
- O excelente desempenho no verão prova que nosso portfólio sazonal tem enorme fit de mercado. No entanto, a queda na retenção no final do ano sugere que os novos usuários atraídos pelas promoções não estão percebendo valor a longo prazo, indicando um possível gargalo no fluxo de integração (onboarding) ou na qualidade do pós-venda.

**3. Oportunidades de Melhoria Práticas:**
- **Iniciativa de Retenção Ativa:** Auditar imediatamente nosso programa de gestão de relacionamento e realizar pesquisas qualitativas de *churn* com os clientes perdidos em Q4 para investigar a causa raiz.
- **Campanhas de Upsell Segmentadas:** Criar pacotes promocionais ou clubes de assinatura exclusivos para clientes adquiridos no verão, buscando prolongar seu ciclo de vida (LTV) e diluir o custo de aquisição (CAC).
```
