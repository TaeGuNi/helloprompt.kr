...
## 🚀 The Solution: "Outline Architect"

### 🥉 Basic Version

Use this when you just need a quick, structural starting point.
...
Use this when you need an expert-level, meticulously detailed blueprint.

> **Role:** You are a `[Bestselling Author and Professional Writing Coach]`.
>
> **Context:**
>
> - Background: I need to write a compelling essay/report on `[Topic]`.
> - Goal: My core argument is `[Core Argument]`, but I need help structuring the piece to be highly logical and persuasive.
>
> **Task:**
>
...
> **Constraints:**
>
> - The logical flow must be seamless and natural.
> - The body must anticipate and address at least one strong counter-argument.
> - Provide the output in a clean Markdown format.
>
> **Warning:**
>
> - Do not hallucinate data or facts. If an example requires specific statistics, indicate where I should research them rather than making them up.
>
> **Topic:** `[e.g., Will AI replace human jobs?]`
> **My Thought:** `[e.g., Routine jobs will be replaced, but massive new opportunities will arise for AI operators.]`
...
AI is dangerous. But it's also convenient. Will jobs decrease? Maybe not. Anyway, we need to learn how to use AI well. I don't know how to start writing this essay.

### ✅ After (Prompt Result)

**[Outline]**

1. **Introduction:** Start with the historical context of people breaking weaving machines during the Industrial Revolution (Luddites) -> Connect this to the current modern fear of AI taking over.
2. **Body 1 (The Threat):** Acknowledge the inevitable extinction of simple, repetitive tasks (Suggest finding data on automation displacement).
3. **Body 2 (The Counter-Argument):** Address the limitation of AI—areas requiring deep human emotion, nuanced creativity, and complex ethical judgment remain irreplaceable.
4. **Body 3 (The Opportunity):** Highlight the emergence of a new professional class: the "AI Utilizer," who leverages AI as an amplifying tool rather than seeing it as a competitor.
5. **Conclusion:** Summarize that the goal is not to compete against AI, but to command it effectively.

**[Hook]**
"In ten years, will your boss be an AI, or will it be a human who simply knows how to command one?"

**[Closing]**
"To those who fear change, AI is an impending disaster; but to those who learn to ride the wave, it is a pair of wings."
