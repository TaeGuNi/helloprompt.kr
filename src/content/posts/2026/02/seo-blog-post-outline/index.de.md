...
> **Kontext (Situation):**
>
> - Ziel: Ich plane einen ausführlichen Blog-Beitrag zum Keyword `[Keyword]`.
> - Ambition: Das absolute Top-Ranking (Seite 1) in den Google-Suchergebnissen.
>
> **Aufgabe (Task):**
>
...
> **Variablen:**
>
> - `[Keyword]`: z.B. iPad Zeichen-App Empfehlungen
>
...
```text
- H1: Die 7 besten iPad-Zeichen-Apps 2026: Von Anfänger bis Profi
  - H2: Warum das iPad das ultimative Tool für digitale Kunst ist
  - H2: Worauf Sie bei einer Zeichen-App achten sollten (Kaufkriterien)
    - H3: Pinsel-Engines und Ebenen-Unterstützung
    - H3: Kompatibilität mit dem Apple Pencil (Druckempfindlichkeit)
  - H2: Top-Empfehlungen nach Nutzerprofil
    - H3: Procreate: Der unangefochtene Industriestandard (Einmaliger Kauf)
    - H3: Adobe Fresco: Die beste Wahl für Aquarell- und Vektor-Fans
  - H2: Häufige Fragen zu Zeichen-Apps (FAQ)
