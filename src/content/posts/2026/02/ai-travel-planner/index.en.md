...
Use this when you need a highly detailed, meticulously planned schedule. Copy the prompt below and paste it into your preferred AI.

> **Role:** You are a veteran `[Travel Guide with Local Residency Experience]` who knows the area inside out.
>
> **Context:**
>
> - Background: I am planning a trip to `[Destination]` for `[Duration]`.
> - Goal: Create an optimized travel itinerary that minimizes transit time and maximizes enjoyment based on my specific preferences.
>
> **Task:**
>
> 1. Design a daily travel schedule divided into morning, afternoon, and evening segments, heavily optimized for efficient geographical movement.
> 2. Recommend highly-rated local restaurants and hidden gems, avoiding typical tourist traps.
> 3. Specify the best means of transportation and exact estimated transit times between each destination.
>
> **Constraints:**
>
> - Travel Style: `[e.g., Relaxed walks and food tours rather than a tight sightseeing schedule. Cafe hopping preferred.]`
> - Companions: `[e.g., Couple (2 people)]`
> - Output Format: Present the daily itinerary using a clean Markdown table format.
>
> **Warning:**
>
> - Do not hallucinate. If you are uncertain about a restaurant's operating hours, current status, or the existence of a specific transit route, state "Needs Verification" rather than inventing facts.
...
```text
Plan a 4 days 3 nights itinerary for Osaka and Kyoto. It's a couple's trip. We like food and cafes. We don't like it too tight.
```

### ✅ After (With Our Prompt)

```text
**Day 1: Arrival & Osaka Cafe Culture (Relaxed Pace)**

| Time | Activity / Location | Transportation | Est. Transit | Notes |
| :--- | :--- | :--- | :--- | :--- |
| 10:00 AM | Arrive at KIX, head to Namba | Nankai Airport Exp. | 45 mins | Purchase IC cards at the airport. |
| 11:30 AM | Brunch at [Hidden Gem] Cafe in Nakazaki-cho | Subway Midosuji Line | 15 mins | Nakazaki-cho is famous for its retro vibe. |
| 01:00 PM | Explore Nakazaki-cho Vintage Shops | Walking | 5 mins | Very relaxed pace, great for couples. |
| 03:30 PM | Head to Umeda for early dinner | Subway Tanimachi Line | 10 mins | Beat the evening dinner rush. |

*(The AI provides a highly detailed, geographically logical schedule complete with transit times, meticulously tailored to a relaxed, cafe-hopping couple's trip.)*
```
