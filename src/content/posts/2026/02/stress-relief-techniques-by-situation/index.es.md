...
## 🚀 Solución: "Emergencia de Estrés 119"
...
> **Contexto (Context):**
>
> - Situación actual: `[Recibí una reprimenda injusta de mi jefe frente a mis compañeros]`
> - Emoción predominante: `[Ira, frustración y sensación de impotencia]`
> - Entorno: `[Oficina de espacio abierto]` (No puedo gritar, llorar en voz alta ni abandonar el lugar).
>
> **Tarea (Task):**
>
> 1. Proporcióname **3 técnicas inmediatas de contención emocional** que pueda realizar discretamente en mi asiento (ej. técnicas de respiración, estimulación del nervio vago, puntos de acupresión).
> 2. Recomiéndame 2 actividades efectivas para "limpiar" esta emoción al salir del trabajo (excluyendo el consumo de alcohol, compras compulsivas o atracones de comida).
> 3. Bríndame un reencuadre cognitivo (cognitive reframing) para evaluar esta situación desde una perspectiva más racional y proteger mi autoestima.
>
...
- **Q: ¿Puedo usar este prompt para el estrés crónico o el agotamiento a largo plazo?**
  - A: Este prompt está diseñado específicamente para intervenciones agudas (picos de estrés en el momento). Para tratar el estrés crónico, te sugiero cambiar el contexto a "burnout acumulado durante meses" y pedir a la IA "estrategias de rediseño de estilo de vida" en lugar de "técnicas inmediatas".

- **Q: ¿Qué pasa si la IA me da consejos médicos inadecuados?**
  - A: La IA proporciona estrategias de manejo emocional basadas en prácticas de psicoterapia general, pero **bajo ninguna circunstancia sustituye a un profesional de la salud mental**. Si experimentas ataques de pánico severos o ansiedad constante, utiliza la IA solo como una herramienta de apoyo temporal y busca ayuda psicológica especializada.
...
```text
Estoy muy enojado con mi jefe, ¿qué hago para calmarme?
```

_(Resultado típico: "Respira hondo, bebe un vaso de agua y trata de entender su punto de vista.")_

### ✅ After (Resultado con Prompt Pro)

```text
Entiendo perfectamente tu frustración. Aquí tienes tu **Kit de Primeros Auxilios Emocionales** diseñado para la oficina:

1. **Respiración Fisiológica (Suspiro Fisiológico):** Inhala profundamente por la nariz, haz una segunda inhalación corta y rápida para expandir los pulmones al máximo, y exhala lentamente por la boca. Repite 3 veces. Esto reduce los niveles de dióxido de carbono y calma el sistema nervioso autónomo al instante.
2. **Descarga Cognitiva (Brain Dump) Desechable:** Abre el Bloc de notas en tu ordenador. Escribe absolutamente todo lo que sientes sin ningún filtro durante 2 minutos. Luego, cierra el programa **sin guardar**. Esta acción física de "eliminar" ayuda a externalizar y descartar la carga mental.
3. **Reencuadre Cognitivo:** Repítete esto mentalmente: "La incompetencia comunicativa o el mal humor de mi jefe hablan exclusivamente de sus propias carencias de liderazgo, no de mi valor ni de mi capacidad como profesional".
```
