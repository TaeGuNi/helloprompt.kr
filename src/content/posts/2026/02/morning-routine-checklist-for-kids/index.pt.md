...
## 🚀 Solução: Prompt "Gerente de Rotina Matinal Divertida"
...
> **Contexto (Context):**
>
> - Meu filho tem `[Idade da criança, ex: 7]` anos e demora muito nas tarefas de `[Tarefas problemáticas, ex: vestir o uniforme e escovar os dentes]`.
> - O objetivo é criar um "Quadro de Missões Matinais" divertido para que ele faça tudo com autonomia e alegria.
>
> **Tarefa (Task):**
>
> 1. Transforme a rotina de 4 etapas (Acordar -> Lavar/Escovar os dentes -> Vestir -> Arrumar a mochila) em um jogo de missões épicas.
> 2. Crie nomes criativos e adequados para a idade de cada missão (ex: "Operação Caça-Cáries").
> 3. Sugira 'feitiços de sucesso' ou frases de incentivo específicas que eu devo dizer a ele cada vez que concluir uma etapa no tempo estipulado (`[Tempo, ex: 5 minutos]`).
>
...
> **Aviso (Warning):**
>
> - Não sugira sistemas de recompensas financeiras ou doces; foque na motivação intrínseca, elogios e pequenas celebrações (ex: uma dancinha da vitória).
...
```text
🌟 MESTRE DA MANHÃ: MISSÕES SECRETAS! 🌟

🛡️ Missão 1: Despertar do Dragão (Acordar)
- Desafio: Espreguiçar bem grande e dobrar a coberta como um escudo mágico!
- Frase de Sucesso do Papai: "Uau, o Dragão acordou cheio de energia hoje!"

💦 Missão 2: Ataque Aquático (Lavar e Escovar)
- Desafio: Derrotar todos os germes invisíveis em 3 minutos!
- Frase de Sucesso da Mamãe: "Incrível! Seus dentes estão brilhando mais que um sabre de luz!"

👕 Missão 3: Transformação Heroica (Vestir a Armadura/Uniforme)
- Desafio: Colocar o uniforme de super-herói sem ajuda!
- Frase de Sucesso: "Armadura equipada e pronta para a aventura escolar!"

🎒 Missão 4: Inventário de Suprimentos (Arrumar a Mochila)
- Desafio: Checar se todas as poções (garrafinha d'água) e artefatos mágicos estão dentro!
- Frase de Sucesso: "Missão Concluída! Você é o Mestre da Manhã!"
```
