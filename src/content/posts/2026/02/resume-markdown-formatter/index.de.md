...
## 🚀 Die Lösung: "Der saubere Lebenslauf-Formatierer"
...
> **Kontext (Context):**
>
> - Hintergrund: Ich habe meine beruflichen Stationen und Fähigkeiten nur grob in einem einfachen Notizblock skizziert.
> - Ziel: Diese Notizen sollen in ein professionelles, sauber strukturiertes und optisch ansprechendes Lebenslauf-Format überführt werden.
>
> **Aufgabe (Task):**
>
> 1. Konvertiere den unten stehenden Eingabetext in ein perfekt strukturiertes **Markdown-Format**.
> 2. Verwende Überschriften (`#`, `##`) für die Hauptabschnitte, Fettdruck (`**`) für Zeiträume und Jobtitel sowie Aufzählungszeichen (`-`) für die detaillierte Beschreibung der Tätigkeiten.
> 3. Füge horizontale Trennlinien (`---`) zwischen den einzelnen Abschnitten ein, um die Lesbarkeit zu maximieren.
> 4. Vereinheitliche alle Datumsangaben zwingend auf das Format `YYYY.MM` und platziere sie übersichtlich am rechten Rand (oder am Ende der jeweiligen Zeile, falls das Markdown-Layout dies besser unterstützt).
>
> **Eingabetext:**
> `[Fügen Sie hier Ihren unstrukturierten Lebenslauf-Text ein]`
>
> **Einschränkungen (Constraints):**
>
> - Erfinde unter keinen Umständen neue berufliche Stationen oder Fähigkeiten hinzu. Bleibe strikt bei den vorgegebenen Fakten.
> - Korrigiere lediglich Tippfehler und glätte ungeschickte Formulierungen, damit der Text professionell und elegant klingt.
> - Verwende passende, seriöse Emojis für die jeweiligen Abschnittsüberschriften (z. B. 💼 Berufserfahrung, 🎓 Ausbildung, 🛠️ Fähigkeiten).
...
### ❌ Vorher (Chaos im Notizblock)

```text
Berufserfahrung
Hab als stellvertreter bei ABC Marketing von 2020 bis 2023 gearbeitet. Meistens social media gemanagt und ads geschaltet. mein größter erfolg war 10k follower zu knacken.
ausbildung is bachelor an der universität berlin in bwl (2015-2019).
skills: Photoshop, excel, bisschen powerpoint
```

### ✅ Nachher (Sauberes Markdown)
...
**ABC Marketing** | Stellvertretender Manager | 2020.01 - 2023.12

- **Social Media Management:** Hauptverantwortlich für den strategischen Ausbau der Kanäle; erfolgreiches Erreichen eines Meilensteins von 10.000 Followern.
- **Performance Marketing:** Planung, Steuerung und erfolgreiche Durchführung von Online-Werbekampagnen (Ads).

---

## 🎓 Ausbildung

**Universität Berlin** | Bachelor in Betriebswirtschaftslehre (BWL) | 2015.03 - 2019.02

---

## 🛠️ Fähigkeiten

- **Software & Tools:** Adobe Photoshop, Microsoft Excel, Microsoft PowerPoint
```
...
Die Seele eines Lebenslaufs ist unbestreitbar sein Inhalt, aber erst die **klare, strukturierte Form** sorgt dafür, dass ein Personaler ihn auch wirklich lesen möchte. Beenden Sie mühsame und frustrierende Formatierungsarbeiten in weniger als 10 Sekunden und nutzen Sie die gewonnene Zeit lieber für eine gute Tasse Kaffee oder die Vorbereitung auf Ihr anstehendes Interview. Viel Erfolg! ☕️
