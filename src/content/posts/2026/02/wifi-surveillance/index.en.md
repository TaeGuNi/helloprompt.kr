...
> **Task:**
>
> 1. Considering the unique characteristics of the `[Target Space for Analysis]`, outline 3 specific scenarios where sensitive information could be compromised via WiFi sensing technology.
> 2. Provide step-by-step guidelines for both technical and physical countermeasures to defend against these invisible threats.
> 3. Draft a realistic security policy guide that effectively balances robust protection with the `[Primary Purpose of the Space]`.
>
> **Constraints:**
>
> - Format the output in Markdown. Present the core content using bullet points (-) and blockquotes (>) rather than tables.
> - Utilize concise sentences and relevant emojis to maximize readability on mobile devices.
>
> **Warning:**
>
...
>
> **AI:** To prevent WiFi hacking, ensure you use a complex password and avoid connecting to unknown networks. _(A superficial response that entirely misses the specific threat of WiFi sensing)_

### ✅ After (Using the Pro Prompt)

> **AI:**
> 🛡️ **[Startup Conference Room Dealing with Confidential IP] WiFi Sensing Vulnerability Analysis & Defense Guide**
>
> 🚨 **Anticipated Sensitive Information Exposure Scenarios**
>
> - **Detecting Exclusive Executive Meetings:** Inferring the timing of critical corporate decisions by tracking the exact headcount and physical movement patterns within the room at highly specific times.
> - **Keystroke Pattern Analysis:** Attempting to deduce passwords or highly sensitive key terms by meticulously analyzing the micro-reflection waves generated by subtle finger movements on keyboards.
> - **Stress Level Measurement:** Profiling the psychological states of key individuals during high-stakes negotiations by passively detecting minute fluctuations in attendees' breathing and heart rate patterns.
>
> 🛠️ **Step-by-Step Technical & Physical Defense Measures**
>
> - **Optimize Router Tx Power:** Strictly limit the router's transmission power (Tx) to the absolute minimum required for the room, ensuring signal leakage into public corridors or adjacent floors is structurally impossible.
> - **AP Isolation and Mesh Structuring:** Enforce a hard physical and logical separation between the internal, closed-loop Access Point (AP) dedicated to the conference room and any external or guest-facing networks.
> - **AP Firmware Integrity Monitoring:** Institute mandatory, periodic hash value verifications to actively detect and prevent stealthy firmware tampering specifically designed to illegally siphon CSI tracking data.

---

## 🎯 Conclusion

The invisible radio waves constantly bouncing around us have essentially transformed into hidden spotlights. Take a moment after work today to double-check your own home router configurations, ensuring you haven't unknowingly traded away your fundamental privacy in the name of mere convenience.

Stay vigilant and safe in your digital life! 🛡️
