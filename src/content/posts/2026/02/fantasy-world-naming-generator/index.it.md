...
## 🚀 La Soluzione: "Laboratorio di Naming per Mondi Fantasy"
...
> **Contesto (Context):**
>
> - Sfondo: Sto disegnando la mappa del mio mondo fantasy e ho bisogno di nomi per nuove regioni, montagne, città o fiumi.
> - Obiettivo: I nomi devono suonare unici, evocativi e assolutamente non banali (niente "Valle Verde" o "Monte Alto").
>
> **Richiesta (Task):**
>
...
> **Vincoli (Constraints):**
>
> - Fornisci la notazione nella lingua nativa inventata e la pronuncia adattata (es. Khazad-dûm - Kazad-dum).
> - Evita rigorosamente nomi protetti da copyright o troppo inflazionati (es. Azeroth, Terra di Mezzo, Narnia, Westeros).
> - Presenta il risultato in un formato chiaro, usando elenchi puntati.
>
> **Avvertenza (Warning):**
>
> - Assicurati che le radici etimologiche proposte abbiano un senso logico all'interno delle regole fonetiche che hai stabilito per quella razza. Non mescolare stili linguistici contrastanti nello stesso nome.
...
"Dammi un nome per una montagna di ghiaccio."

_(Risultato tipico dell'IA: "Monte Ghiacciato", "Picco del Gelo", "Frostmountain")_
...
Il nome è il primo, vero incantesimo che lancia il Creatore di un mondo. Grazie a questo prompt, potrai riempire la tua mappa di luoghi che respirano storia e mistero, abbandonando per sempre i banali "Foresta a Nord" o "Fiume Azzurro".

Ora vai e dai un nome al tuo universo! 🗺️🖋️
