...
### ❌ Before (A Abordagem do Buscador)

```text
Prompt: Como escrever um e-mail de vendas?

Resultado: (Um texto longo, teórico e genérico sobre funil de vendas, empatia e call-to-action, que não te ajuda a enviar o e-mail hoje e parece um artigo da Wikipédia.)
```

### ✅ After (A Abordagem do Diretor)

```text
Prompt: Atue como um Copywriter Sênior de B2B. Escreva um e-mail curto (máximo de 3 parágrafos) oferecendo nossos serviços de consultoria de SEO para um e-commerce de moda. O tom deve ser profissional, porém provocativo, focando em "quanto dinheiro eles estão perdendo para os concorrentes".

Resultado: (Um rascunho persuasivo, direto ao ponto, com um assunto magnético, pronto para você copiar, ajustar e enviar em menos de 2 minutos.)
```
