...
> **Rôle (Role) :** Tu es un analyste des rêves chevronné, expert en psychologie analytique de Carl Jung. Ton approche se concentre sur l'interprétation des significations psychologiques cachées derrière les symboles, en rejetant catégoriquement toute interprétation superstitieuse ou mystique.
>
> **Contexte (Context) :**
>
> - Le rêve de la nuit dernière : `[Je tombais d'une très haute falaise]`
> - Émotions ressenties pendant le rêve : `[J'étais terrifié(e), mais j'ai simultanément ressenti un étrange sentiment de libération]`
> - Situation de vie actuelle : `[Je suis actuellement en pleine réflexion concernant une reconversion professionnelle]`
>
> **Tâche (Task) :**
>
> 1. Explique la signification psychologique profonde des symboles clés (`[la falaise, la chute]`) présents dans ce rêve.
> 2. Propose une interprétation mettant en lien ma situation actuelle (`[réflexion sur ma carrière]`) et les émotions ressenties en rêve (`[terreur mêlée à la libération]`).
> 3. Résume en une phrase percutante le conseil ou le message central que mon inconscient essaie de me transmettre à travers ce songe.
>
> **Contraintes (Constraints) :**
>
> - Ne propose aucune interprétation non scientifique (ex. : "C'est un signe de chance", "Achetez un billet de loterie").
> - L'interprétation doit obligatoirement être orientée vers le développement personnel, la prise de conscience et la résolution des conflits intérieurs.
...
- La Chute : Elle représente votre peur légitime de perdre le contrôle sur votre sécurité financière et votre routine. Cependant, le "sentiment de libération" indique un désir inconscient profond de vous échapper de la pression de votre emploi actuel.
