...
## 🚀 Solution: "Global Table Manners Coach"
...
Use this for an in-depth, situation-specific etiquette briefing.

> **Role (Role):** You are a 'Global Etiquette Consultant' specializing in international food culture and dining manners.
>
> **Context (Context):**
>
> - Destination: `[Country Name]`
> - Occasion: `[Dining Context, e.g., Formal business dinner, casual street food, dining at a local's home]`
>
> **Task (Task):**
>
> 1. Identify the top 3 'Absolute Taboos' (actions that are considered highly offensive or disrespectful at the dining table in this culture).
> 2. Detail the correct usage of local eating utensils (e.g., chopsticks, specific fork/knife rules, eating with hands) and proper dining posture.
> 3. Provide culturally appropriate greetings, toasts, and expressions of gratitude to use before and after the meal.
>
> **Constraints (Constraints):**
>
> - Explicitly highlight differences that might be counterintuitive to a foreigner (e.g., whether slurping noodles is polite, if bowls should be lifted, leaving food on the plate vs. finishing everything).
> - Differentiate the expected etiquette between a high-end restaurant and a casual, everyday eatery.
> - Format the output using clean Markdown with bullet points for readability.
>
> **Warning (Warning):**
>
> - Do not invent cultural rules. If you are unsure about a specific regional custom, state that it varies or that you do not know.
...
```text
**Target:** Japan (Casual Restaurant)

**Absolute Taboos:**
- Never pass food directly from chopstick to chopstick (this resembles a funeral ritual).
- Never stick chopsticks vertically into a bowl of rice.
- Do not rest your elbows on the table.

**Utensil Rules:**
- **Bowls:** Always lift your rice or soup bowl with one hand while eating.
- **Slurping:** Slurping noodles (like ramen or udon) is entirely acceptable and often seen as a sign that you are enjoying the meal.

**Key Phrases:**
- Before eating: "Itadakimasu" (I humbly receive).
- After eating: "Gochisousama deshita" (Thank you for the meal).
```
