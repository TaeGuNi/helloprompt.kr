...
Sub CalculateProductSales()
    ...
    ' Trova l'ultima riga dei dati (si adatta dinamicamente all'aggiunta di nuove righe)
    lastRow = ws.Cells(ws.Rows.Count, "A").End(xlUp).Row
    totalSales = 0
    
    ' Ricerca con condizione e somma
    For i = 2 To lastRow ' Inizia dalla riga 2 poiché la riga 1 contiene le intestazioni
