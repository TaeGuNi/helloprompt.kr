...
> **Kontext (Context):**
>
> - Zielort: `[Name des Landes/der Stadt]`
> - Reiseart: `[z. B. Luxusurlaub, Backpacking, Geschäftsreise]`
>
> **Aufgabe (Task):**
>
> 1. Nenne mir den absolut angemessenen Trinkgeldbetrag oder Prozentsatz für folgende Situationen:
>    - Gastronomie: Café, Mittagessen, feines Abendessen, Bar/Pub
>    - Unterkunft: Gepäckträger, Zimmerreinigung, Concierge
>    - Mobilität: Standard-Taxi, Uber/Lyft
> 2. Erkläre den natürlichen Zeitpunkt und die korrekte Methode der Übergabe (z. B. bar auf dem Tisch liegen lassen, auf der Kreditkartenrechnung eintragen, direkt in die Hand geben).
> 3. **Warnung:** Nenne explizit Situationen, in denen ich _kein_ Trinkgeld geben sollte oder in denen es sogar als respektlos gilt.
>
...
### ❌ Before (Einfache Google-Suche / Schlechter Prompt)
...
```text
Gastronomie:
- Mittag-/Abendessen: 18–22 % (15 % gelten oft als Zeichen für unterdurchschnittlichen Service).
- Bar/Pub: 1 $ bis 2 $ pro bestelltem Drink.
Übergabe: Wird meist auf dem Kreditkartenbeleg in die Zeile "Tip" eingetragen und dann die Summe addiert.
Warnung: Prüfen Sie den Beleg auf "Auto-Gratuity" (oft bei Gruppen ab 6 Personen). In diesem Fall ist das Trinkgeld bereits inkludiert und Sie müssen nicht extra aufrunden!
```
