...
# (Updated) (Updated) 🎨 디자인 시스템 구축: 디자이너와 개발자가 안 싸우는 법 {#updated}
...
## (Updated) (Updated) 🚀 해결책: "Design Token Prompt" {#updated}

### (Updated) (Updated) 🥉 Basic Version (이름 짓기) {#updated}
...
### (Updated) (Updated) 🥇 Pro Version (코드 자동 생성) {#updated}
...
### (Updated) (Updated) ❌ Before (하드코딩) {#updated}

`background-color: #3b82f6;` (색상 바꿀 때 파일 100개 수정 😱)

### (Updated) (Updated) ✅ After (디자인 토큰) {#updated}
