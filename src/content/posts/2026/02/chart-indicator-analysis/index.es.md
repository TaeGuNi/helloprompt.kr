...
## 🚀 La Solución: "Detector de Señales de Trading"
...
> **Contexto (Context):**
>
> - Situación: Estoy analizando el gráfico de `[Nombre del Activo/Acción]` y tengo dudas sobre cuál es el punto de entrada óptimo.
> - Datos: El precio actual es `[Precio Actual]` y los indicadores muestran `[ej. RSI en 30, MACD cruzando al alza]`. (Revisa la imagen adjunta si está disponible).
>
> **Solicitud (Task):**
>
...
>
> - Presenta el resultado estructurado de forma clara utilizando viñetas y formato Markdown.
> - Explica el porqué de cada movimiento sin utilizar jerga innecesariamente compleja.
>
> **Advertencia (Warning):**
>
> - Incluye al final una breve nota legal indicando que "Toda inversión conlleva riesgos y esto es solo una opinión técnica".
...
1. **Asignación de Rol de Alto Nivel:** Al pedirle que actúe como un analista cuantitativo, forzamos a la IA a adoptar un tono frío, analítico y centrado en la gestión del riesgo.
2. **Estructura RTFC:** Evitamos respuestas vagas obligando a la IA a darnos un veredicto definitivo (Compra/Venta/Mantener) respaldado por datos concretos (Soportes/Resistencias).
3. **Restricción de Jerga:** Pedir que "explique el porqué" garantiza que no recibamos simplemente una lista de números, sino una narrativa lógica que nos ayuda a aprender _trading_ mientras invertimos.

---

## 📊 Demostración: Before & After

### ❌ Before (Entrada habitual)

```text
¿Es un buen momento para comprar acciones de Apple? El gráfico se ve bajo.
```

### ✅ After (Resultado usando el Prompt Pro)

```text
### 📊 Informe de Análisis Técnico: Apple Inc. (AAPL)

- **RSI (14 periodos):** 28 (Zona de Sobreventa extrema). El activo ha sido castigado con fuerza y muestra una divergencia alcista en el gráfico de 4 horas. → **Fuerte Señal de Compra**
- **MACD:** El histograma muestra agotamiento bajista y la línea MACD está a milímetros de cruzar al alza la línea de señal (Cruce Dorado inminente).
- **Medias Móviles:** El precio actual ha tocado milimétricamente la SMA de 200 días (soporte institucional histórico) y está dejando una vela tipo "Martillo" con fuerte rechazo a la baja.

### 🚦 Veredicto Final: Oportunidad de Compra Fuerte (Probabilidad de rebote: 80%)
El activo se encuentra en un soporte estructural clave con osciladores sobrevendidos. Es una configuración ideal para un rebote de alivio técnico a corto plazo.

- **🎯 Take-Profit (Objetivo 1):** $185.50 (Resistencia de la SMA de 20 días).
- **🛑 Stop-Loss:** $168.00 (Cierre diario por debajo del mínimo de la vela actual, invalidando la tesis).

*Nota: Toda inversión conlleva riesgos. Este análisis técnico no constituye asesoramiento financiero directo.*
```
...
Deja de operar guiado por la intuición, el pánico o el FOMO (_Fear Of Missing Out_). Al delegar la interpretación de gráficos pesados a la IA, puedes multiplicar tu tasa de acierto aplicando una estrategia fría, calculada y respaldada por datos.

¡Invierte con cabeza, gestiona tu riesgo y apaga la pantalla! 🍷
