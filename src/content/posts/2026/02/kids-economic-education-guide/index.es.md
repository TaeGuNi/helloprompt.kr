...
## 🚀 Solución: "Mentor Económico Infantil"
...
Úsala cuando necesites una explicación detallada, adaptada a una situación específica y con ejemplos prácticos.

> **Rol (Role):** Eres un experto en educación financiera infantil y psicología evolutiva.
>
> **Contexto (Context):**
>
> - Situación: Mi hijo de 6 años está llorando y haciendo un berrinche porque quiere comprar un robot de juguete muy caro. Él cree que la tarjeta de crédito tiene dinero infinito.
> - Objetivo: Que comprenda de dónde sale el dinero y valore el esfuerzo familiar.
>
> **Tarea (Task):**
>
> 1. Explica con palabras muy sencillas que una tarjeta de crédito no es mágica, sino una promesa de que mamá o papá pagarán ese dinero más tarde con el fruto de su trabajo.
> 2. Utiliza una analogía comparando el precio del juguete con los "días que papá/mamá tiene que trabajar" para ganarlo.
> 3. Sugiere un sistema de recompensas o una pequeña paga semanal por realizar tareas del hogar adaptadas a su edad.
>
> **Restricciones (Constraints):**
>
> - Mantén un tono empático, tranquilo y libre de culpa o reproches hacia el niño.
> - Usa un lenguaje adaptado a un niño de 6 años (metáforas simples, frases cortas).
>
> **Advertencia (Warning):**
>
> - No uses conceptos financieros complejos (intereses, deudas, inflación) que lo puedan confundir.
...
```text
Explícale a mi hijo el valor del dinero y las tarjetas de crédito.
```

_(Resultado típico: "El dinero es un medio de intercambio. Las tarjetas de crédito son instrumentos financieros de deuda...")_ -> Demasiado técnico y aburrido para un niño.

### ✅ Después (Resultado de la Versión Pro)

```text
¡Hola, pequeño campeón! ¿Ves esta tarjeta de plástico? ¡Parece mágica, verdad? Pero en realidad no tiene dinero infinito adentro. Es como una tarjeta de 'promesas'. Cuando la pasamos por la máquina, papá está prometiendo: '¡Trabajaré muy duro esta semana para pagar este juguete!'.

Ese robot tan genial que te gusta cuesta lo mismo que 3 días enteros de papá trabajando en la oficina en lugar de estar jugando contigo en casa. ¿Qué te parece si hacemos un trato? Si me ayudas a ordenar tus juguetes todos los días, te daré unas monedas especiales. ¡Cuando llenes tu alcancía, podrás comprar el robot con tu propio esfuerzo!
```
