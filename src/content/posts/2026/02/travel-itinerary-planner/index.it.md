...
## 🚀 La Soluzione: "Il Tuo Travel Designer Personale"
...
> **Vincoli (Constraints):**
>
> - Non inserire più di 3 tappe o attrazioni principali al giorno per evitare l'affaticamento.
> - Formatta l'itinerario come una Tabella Markdown con le seguenti colonne: 'Orario | Luogo | Attività | Consiglio Logistico/Trasporto'.
>
> **Avvertenza (Warning):**
>
...
```text
"Fammi un itinerario per Osaka di 3 giorni e 2 notti."
```

### ✅ After (Risultato del Prompt Pro)

```text
(Tabella strutturata con un percorso rilassato. La mattina è dedicata a un'attività principale, seguita da un pranzo nei dintorni senza code. Il pomeriggio prevede un'attività leggera o shopping vicino all'hotel. Include i tempi esatti in taxi per evitare la metropolitana affollata e suggerisce un'elegante galleria commerciale coperta come Piano B in caso di pioggia.)
```
