...
Ideal para uma reestruturação profunda e detalhada do seu portfólio de seguros.

> **Papel (Role):** Você é um `[Consultor Financeiro e Especialista em Auditoria de Seguros Independente]`. Seu aconselhamento deve ser totalmente imparcial, visando exclusivamente a eficiência financeira e a proteção do patrimônio do cliente, sem intenção de venda.
>
> **Contexto (Context):**
> Atualmente, pago `[250.000 wons]` por mês em prêmios de seguro. Esse valor está pesando no meu orçamento, e desejo realizar uma reestruturação inteligente.
> Os detalhes das minhas apólices atuais são:
>
> 1. Seguro A (Seguro de Vida Inteira): 150.000/mês (Cobertura por morte de 100 milhões)
> 2. Seguro B (Plano de Saúde / Despesas Médicas): 20.000/mês
> 3. Seguro C (Seguro contra Câncer): 80.000/mês (Modalidade renovável, prêmio de diagnóstico de 30 milhões)
>
> **Tarefa (Task):**
>
> 1. Identifique e explique 3 **falhas graves (ex: coberturas duplicadas, custo-benefício ruim, riscos de prêmios renováveis)** no meu portfólio atual.
> 2. Realize uma análise de lacunas (Gap Analysis) focada nas **4 áreas críticas de proteção (Despesas Médicas, Câncer, Doenças Cerebrovasculares, Doenças Cardíacas Isquêmicas)**.
> 3. Elabore um **Plano de Remodelagem (Cancelamento / Redução de Capital Segurado / Exclusão de Cláusulas Específicas)** concreto e detalhado para reduzir meu custo mensal para menos de `[150.000 wons]`.
>
> **Restrições (Constraints):**
>
> - Leve em consideração o fato de que sou solteiro e não possuo dependentes financeiros.
> - Não me dê respostas vagas como "consulte seu responsável". Forneça diretrizes matemáticas e objetivas com base na sua análise técnica.
...
### ❌ Antes (Input sem estruturação)

```text
Quero diminuir o valor que pago de seguro. Dá uma olhada nas minhas apólices e me diz o que fazer. (Colar detalhes)
```

### ✅ Depois (Resultado usando o Prompt Pro)

```text
### 🩺 Relatório de Auditoria e Otimização de Seguros

**1. Problemas Críticos Identificados**
- ❌ **Seguro de Vida Inteira Desnecessário:** Pagar 150.000/mês por uma cobertura de morte de 100 milhões sendo solteiro sem dependentes é ineficiente (Baixo ROI de proteção).
- ⚠️ **Armadilha do Seguro Renovável:** O seguro contra câncer de 80.000/mês parece adequado agora, mas prêmios renováveis aumentam exponencialmente após os 40 anos.

**2. Análise de Lacunas (Gap Analysis)**
- **Risco Cardio e Cerebrovascular:** Você possui excelente cobertura para câncer, mas está completamente desprotegido contra infartos e AVCs (as outras duas maiores causas de morbidade grave).

**3. Plano de Remodelagem (Meta atingida: ~120.000/mês)**
1. **Seguro A (Vida Inteira):** Interrompa os pagamentos. Solicite o resgate ou utilize a opção de "apólice saldada" (redução do capital para manter o seguro ativo sem novos aportes).
2. **Seguro C (Câncer):** Cancele e substitua por um "Seguro de Doenças Graves" não renovável (prêmio fixo) que inclua Câncer, Infarto e AVC. O prêmio estimado atual será de aprox. 100.000/mês fixos.
3. **Seguro B (Despesas Médicas):** **Manter Intacto.** É a base da sua proteção em caso de acidentes e internações cotidianas.

**👉 Resultado Esperado:** Aumento real da sua proteção para doenças graves e uma economia imediata de 130.000 por mês.
```
