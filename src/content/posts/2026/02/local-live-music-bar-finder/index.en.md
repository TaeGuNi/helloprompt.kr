...
## 🚀 The Solution: "Local Music Critic"
...
> **Task:**
>
> 1. Recommend 3 distinct live music venues that are revered by local audiophiles and largely untouched by mainstream tourists.
> 2. Describe the exact vibe of each venue (e.g., intimate and quiet, rowdy and energetic) and provide typical performance times.
> 3. Specify whether advanced reservations are required or if I can comfortably walk in.
>
> **Constraints:**
>
> - Strictly exclude venues located in neighborhoods with poor safety records.
> - Prioritize venues that are highly welcoming to solo travelers, particularly those with great bar seating.
> - Provide a realistic estimate of the total cost for the night (cover charge + one typical drink).
>
> **Warning:**
>
> - Do not hallucinate or invent venues. If you are unsure about a venue's current operating status, state that clearly.
...
- **Q: Does this prompt work well for smaller, less famous cities?**
...
```text
Recommend some jazz bars in New York.
```

### ✅ After (Result)

```text
Instead of the famous but crowded 'Blue Note', the AI introduces you to places like 'Smalls Jazz Club' in Greenwich Village for late-night jam sessions. It details the $20 walk-in cover charge, notes the excellent bar seating for solo listeners, and perfectly captures the gritty, authentic atmosphere.
```
...
Music is the universal language that requires no translation. Don't let your evenings go to waste—surrender yourself to the rhythm of an unfamiliar city and discover its true colors.

Get out there and let the music play! 🎷
