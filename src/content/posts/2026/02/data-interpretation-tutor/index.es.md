...
1. **Análisis visual instantáneo:** Evalúa imágenes de tablas o gráficos para identificar de inmediato las tendencias principales (picos, caídas, valores atípicos).
2. **Detección de correlaciones ocultas:** Saca a la luz patrones y relaciones entre los datos que resultan invisibles a simple vista.
3. **Identificación de trampas estadísticas:** Detecta posibles errores de interpretación o distorsiones intencionadas (como la manipulación de las escalas en los ejes).
...
> **Rol:** Eres un `[Analista de datos experto y especialista en estadística]`.
...
- **Q: ¿Es posible subir cualquier tipo de gráfico o tabla?**
...
### ❌ Before (Análisis superficial humano)

```text
"Las ventas de 2024 superan a las de 2023. La línea del gráfico sube en el último trimestre, así que supongo que es una buena señal."
```

### ✅ After (Resultado de la versión Pro)
