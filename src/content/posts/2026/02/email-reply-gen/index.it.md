...
1. **Efficienza Istantanea:** Trasforma pensieri frammentari in email professionali in meno di 3 secondi.
2. **Tono Perfetto:** Assicura un linguaggio educato, chiaro e diplomatico per qualsiasi situazione (rifiuti, riprogrammazioni, scuse).
3. **Zero Stress:** Elimina l'ansia da prestazione quando devi comunicare con manager o clienti importanti.

---

## 🚀 La Soluzione: "Il Maestro delle Email Aziendali"

### 🥉 Basic Version (Versione Base)

Usa questa versione quando hai bisogno di una bozza veloce senza troppi fronzoli.
...
> **Ruolo (Role):** Sei un Senior Copywriter aziendale e uno specialista in comunicazione esecutiva con 10 anni di esperienza nella stesura di email per aziende Fortune 500.
>
> **Contesto (Context):**
>
> - Contesto: `[Descrivi brevemente la situazione, es. Un cliente ha richiesto una consegna anticipata impossibile da rispettare]`
> - Obiettivo: `[Il tuo obiettivo, es. Rifiutare la richiesta mantenendo un'ottima relazione ed offrendo un'alternativa]`
> - Destinatario: `[A chi stai scrivendo, es. Manager, Cliente, Fornitore]`
>
> **Richiesta (Task):**
>
...
> **Vincoli (Constraints):**
>
> - La lunghezza non deve superare i 3 brevi paragrafi (massimo 150 parole).
> - Non usare un linguaggio eccessivamente burocratico o robotico; deve suonare naturale e umano.
> - Usa una formattazione chiara (es. elenchi puntati se devi elencare delle opzioni).
>
> **Avvertenza (Warning):**
>
> - Non inventare scuse o informazioni che non ho fornito. Attieniti rigorosamente ai fatti descritti nel contesto.
...
- **D: Funziona bene anche per le email in italiano formale (es. dando del "Lei")?**
...
### ❌ Prima (Appunti grezzi)

```text
Ciao Marco,
non riesco a finire il report per domani. C'è stato un problema con i dati di vendita.
Te lo mando venerdì. Spero non sia un problema.
```

### ✅ Dopo (Risultato dell'AI)

```text
Oggetto: Aggiornamento sulle tempistiche di consegna del Report

Gentile Marco,

Ti scrivo per aggiornarti sullo stato del report. A causa di un imprevisto tecnico nel recupero degli ultimi dati di vendita, avrò bisogno di un po' di tempo aggiuntivo per assicurare l'accuratezza del documento.

Ti invierò la versione completa e verificata entro questo venerdì, [Data, es. 15 Novembre] mattina.

Mi scuso per l'eventuale disagio che questo potrebbe causare alla tua pianificazione. Resto a disposizione se hai bisogno di un aggiornamento parziale nel frattempo.
