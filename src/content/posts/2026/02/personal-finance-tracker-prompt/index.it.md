...
## 🚀 La Soluzione: "Prompt Manager Finanziario"
...
```text
### 📊 Analisi del Budget Mensile

| Categoria | Voce di spesa | Importo | Tipologia |
| :--- | :--- | :--- | :--- |
| **Utenze/Fisse** | Bolletta Luce | 80,00 € | Spesa Fissa |
| **Salute/Sport** | Palestra | 50,00 € | Spesa Fissa |
| **Alimentari** | Spesa Coop + spesa generica | 65,00 € | Spesa Variabile |
| **Trasporti** | Benzina | 30,00 € | Spesa Variabile |
| **Intrattenimento**| Netflix + Ristorante Sushi | 73,00 € | Spesa Superflua |
| **Micro-spese** | Caffè vari | 3,50 € | Spesa Superflua |

### 🔍 Aree di Criticità Identificate
L'area 'Intrattenimento e Ristorazione' rappresenta una porzione significativa e sproporzionata delle tue spese non essenziali rispetto al budget totale.

### 🛠️ Piano d'Azione per Risparmiare il 20%
1. **Regola delle 48 ore:** Prima di prenotare una cena fuori o un acquisto non essenziale, attendi 48 ore per valutare a mente fredda se è una spesa davvero necessaria o solo un impulso.
2. **Sistema ad Involucri per gli Sfizi:** Preleva 50€ in contanti all'inizio del mese; sarà l'unico budget fisico destinato a bar, caffè e piccoli sfizi. Finiti quelli, non si spende più per quella categoria.
3. **Ottimizzazione Abbonamenti:** Valuta se utilizzi la Palestra e Netflix con sufficiente frequenza da giustificarne il costo fisso (totale 63€/mese). In caso contrario, congela l'abbonamento per un mese per testare l'effettiva mancanza.
```
