...
## 🚀 La Solución: "Rayos X de Estados Financieros"
...
Úsala cuando necesites un desglose detallado y riguroso antes de tomar una decisión financiera. (Recomendación: Pega los datos o el texto del informe financiero justo después del prompt para obtener la máxima precisión).

> **Rol (Role):** Eres un Analista Senior de Inversiones con 20 años de experiencia en Wall Street, especializado en análisis fundamental y value investing.
>
> **Contexto (Context):**
>
> - Fondo: Estoy evaluando la salud financiera y el potencial de crecimiento a largo plazo de `[Nombre de la Empresa]`. Sin embargo, los informes trimestrales/anuales son demasiado densos para extraer una conclusión rápida.
> - Objetivo: Obtener una radiografía clara de la solidez de la empresa para tomar una decisión de inversión informada.
>
> **Tarea (Task):**
>
> 1. Analiza la tendencia de los **Ingresos (Revenue), Beneficio Operativo (Operating Income) y Beneficio Neto (Net Income)** durante los últimos 3 años.
> 2. Evalúa la salud financiera calculando o extrayendo el **Ratio de Deuda (Debt-to-Equity), Ratio de Liquidez (Current Ratio) y el ROE (Return on Equity)**.
> 3. Basándote estrictamente en estos datos, califica el **"Atractivo de Inversión"** como Alto, Medio o Bajo, y justifica tu respuesta con 3 razones sólidas.
> 4. Explica cualquier jerga técnica de manera sencilla, utilizando analogías si es necesario, para que un inversor principiante lo entienda a la perfección.
>
> **Restricciones (Constraints):**
>
> - Estructura los datos cuantitativos obligatoriamente en formato de tabla Markdown.
> - Basa tu análisis exclusivamente en cifras objetivas y verificables, sin especulaciones.
> - Proporciona un análisis neutral de los fundamentales, NO recomendaciones directas de compra o venta.
>
> **Advertencia (Warning):**
>
> - Si faltan datos en el texto proporcionado, no los inventes bajo ninguna circunstancia. Indica explícitamente qué información falta para evitar alucinaciones.
...
```text
Dime si es buena idea invertir en Apple mirando sus números recientes.
```

### ✅ After (Resultado)

```text
| Métrica Financiera | 2023 | 2024 | 2025 (Est.) | Tendencia |
| :--- | :--- | :--- | :--- | :--- |
| Ingresos Totales | $383.2B | $394.3B | $405.1B | ↗️ Crecimiento moderado |
| Beneficio Operativo | $114.3B | $118.5B | $122.4B | ↗️ Sólido y estable |
| Margen Operativo | 29.8% | 30.0% | 30.2% | ➡️ Consistencia extrema |
| ROE | 160% | 155% | 150% | ➡️ Excepcionalmente alto |

**📊 Atractivo de Inversión: ALTO**

1. **Generación de Efectivo Abrumadora:** Con un margen operativo del 30%, la empresa demuestra un poder de fijación de precios innegable y una eficiencia sobresaliente.
2. **Retorno al Accionista Incomparable:** El enorme flujo de caja libre permite un programa agresivo y continuo de recompra de acciones y pago de dividendos.
3. **Resiliencia del Ecosistema:** La creciente proporción de ingresos por servicios (que poseen márgenes mucho más altos) compensa de manera efectiva la ciclicidad en las ventas de hardware como el iPhone.

*Nota técnica para principiantes: El ROE (Retorno sobre el Patrimonio) de Apple es inusualmente alto debido a su agresivo programa de recompra de acciones, el cual reduce artificialmente el capital contable base. Esto es una señal de extrema eficiencia del capital, no de un error contable.*
```
