...
## 🚀 Lösung: Der "Ethics Guard" Prompt
...
> **Kontext (Context):**
>
> - Hintergrund: Unser Unternehmen plant den Einsatz von KI-generierten Medien (Avataren/Stimmen) für `[Zweck des Projekts, z. B. Marketing-Kampagne]`.
> - Ziel: Erstellung eines ethischen Leitfadens und einer Risikoanalyse zur Vermeidung von Reputationsschäden und Non-Consensual Deepfakes.
>
> **Aufgabe (Task):**
>
> 1. Identifiziere die 3 größten ethischen Risiken in Bezug auf digitale Identität und fehlende Einwilligung.
> 2. Entwickle konkrete Richtlinien (Dos & Don'ts) für unser Content-Team.
> 3. Entwirf einen Krisenmanagement-Plan für den Fall, dass unsere Inhalte fälschlicherweise als bösartige Deepfakes markiert werden.
> 4. Markiere Platzhalter, die wir noch ausfüllen müssen, mit `[Variable]`.
>
> **Einschränkungen (Constraints):**
>
> - Die Ausgabe muss strukturiert in Markdown erfolgen.
> - Nutze Bullet-Points für maximale Übersichtlichkeit.
> - Formuliere klar, sachlich und im professionellen Unternehmensjargon.
>
> **Warnung (Warning):**
>
> - Gib keine verbindliche Rechtsberatung, sondern fokussiere dich streng auf ethische Best Practices und Risikominimierung. Erfinde keine fiktiven Gesetze (vermeide Halluzinationen).
...
```text
Was sollten wir bei unserem neuen KI-Video-Tool beachten, damit sich niemand wegen Deepfakes beschwert?
```

### ✅ Nachher (Ergebnis mit Pro Prompt)

```text
# 🛡️ KI-Ethik-Leitfaden & Risikoanalyse: [Marketing-Kampagne]

## 1. Top 3 Ethische Risiken
- Unbeabsichtigte Ähnlichkeit mit realen Personen (Identitätsdiebstahl).
- Mangelnde Transparenz über den synthetischen Ursprung der Medien.
- Fehlende, dokumentierte Einwilligung (Consent) bei der Nutzung realer Stimmmuster.

## 2. Dos & Don'ts für das Content-Team
- **DO:** Eindeutiges Wasserzeichen oder Metadaten-Tag für die KI-Genese in jedes Video einbetten.
- **DO:** Einen transparenten Disclaimer in der Videobeschreibung hinzufügen.
- **DON'T:** Niemals Gesichter, Stimmen oder Charakteristika realer Personen ohne explizite, schriftliche [Einwilligungserklärung] verwenden.

## 3. Krisenmanagement-Plan (Auszug)
- **Schritt 1 (Identifikation):** Sobald ein [Monitoring-Tool] meldet, dass unser Content als böswilliger Deepfake missverstanden wird, tritt Taskforce [Name] zusammen.
- **Schritt 2 (Transparenz):** Sofortige Veröffentlichung des originalen Prompts und der Metadaten, um die Herkunft zu belegen.
```
