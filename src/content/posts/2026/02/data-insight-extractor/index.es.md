...
> **Solicitud (Task):**
>
> 1. Identifica y describe 3 patrones o anomalías (tendencias/valores atípicos) que destaquen en estos datos.
> 2. Interpreta el impacto comercial y el significado de cada patrón identificado.
> 3. Basándote en el análisis, propón 2 puntos de mejora concretos o nuevas oportunidades de negocio.
>
...
```text
Aquí tienes las ventas de enero a diciembre. Analiza esto y dime qué hacer.
```

### ✅ After (Resultado con Prompt Pro)

```text
### 📊 Análisis Estratégico de Ventas Anuales

**1. Patrones Clave Identificados:**
- **Estacionalidad Pronunciada:** Las ventas muestran un pico significativo (+30%) durante los meses de verano (julio-agosto), representando el 45% de los ingresos anuales.
- **Caída en Retención:** A pesar del alto volumen de ventas en verano, la tasa de recompra en el trimestre posterior cayó un 5% en comparación con la media histórica.

**2. Impacto Comercial:**
- La alta dependencia de las ventas de verano indica una vulnerabilidad en el flujo de caja durante los meses de invierno.
- La caída en la recompra sugiere que los clientes adquiridos en temporada alta no están encontrando valor a largo plazo en nuestros productos.

**3. Oportunidades de Mejora:**
- **Iniciativa A:** Implementar un programa de fidelización automatizado post-verano (septiembre) que ofrezca descuentos exclusivos en productos de otoño a los compradores estacionales.
- **Iniciativa B:** Diversificar el catálogo de productos para incluir ofertas específicas de invierno, reduciendo la dependencia de la campaña de verano.
```
