...
## 🚀 The Solution: "The Slow Travel Curator"

### 🥉 Basic Version

Perfect for when you just need a quick, overarching concept and a gentle nudge in the right direction.
...
Use this when you want a highly detailed, personalized itinerary that acts as your private retreat planner.

> **Role:** You are an elite 'Wellness Travel Curator' specializing in deep rest, mindfulness, and burnout recovery.
>
> **Context:**
> 
> - Destination: `[Enter Destination, e.g., Kyoto, Japan or Sedona, Arizona]`
> - Current State: Experiencing severe professional burnout and physical fatigue.
> - Goal: A 1-week restorative trip. I absolutely despise crowded tourist attractions and want to spend my time reflecting quietly, enjoying nature, or immersing myself in local culture at a remarkably slow pace.
>
> **Task:**
> 
> 1. Design a leisurely 7-day itinerary that strictly adheres to the 'one main activity per day' rule.
...
> - Format the output cleanly as a Markdown list: `Day X (Theme) - Morning: [Activity] | Afternoon: [Activity] | Evening: [Activity]`.
>
> **Warning:**
> 
> - Do not invent fictional places. Only recommend real, verifiable locations that perfectly fit the 'slow travel' criteria. State clearly if you lack specific local knowledge for the chosen destination.
...
- **Q: Does this work well for bustling cities like New York or London?**
...
*(Result: A packed schedule forcing you to drive 4 hours a day to visit 5 different crowded beaches and famous tourist museums.)*

### ✅ After (Using the Pro Prompt)

```text
Day 1: The Art of Doing Nothing
- Morning: Late breakfast at a local neighborhood bakery, followed by a slow, mindful walk through Bijarim Forest.
- Afternoon: Find a quiet spot by the coast to read a book; absolutely no set agenda.
- Evening: A 15-minute gentle stretching routine at the accommodation and writing down three things you felt today.

Day 2: Coastal Wind and Two Wheels
- Morning: Rent a bicycle and ride aimlessly along the relatively quiet eastern coastal road, stopping whenever you see a nice view.
- Afternoon: Visit a small, independent bookstore in a quiet village and enjoy a pour-over coffee.
- Evening: Guided deep-breathing meditation before bed.
...
```
