...
- **🤖 Empfohlenes Modell:** ChatGPT, Claude, Gemini (Alle dialogorientierten KIs)
...
1. **Blitzschnell:** Generieren Sie kreative Quizfragen, die exakt auf Ihre Haushaltsgegenstände zugeschnitten sind.
2. **Altersgerecht:** Passen Sie den Schwierigkeitsgrad und den Sprachstil exakt an das Alter Ihres Kindes an.
3. **Stressfrei:** Reduzieren Sie Ihre Vorbereitungszeit von 30 Minuten auf unter eine Minute.

---

## 🚀 Lösung: Der "Meister-Detektiv" Prompt
...
Nutzen Sie diesen detaillierten Prompt für eine immersive und perfekt abgestimmte Schatzsuche.

> **Rolle (Role):** Du bist ein kreativer Erlebnispädagoge und Experte für kindgerechte Schatzsuchen.
>
> **Kontext (Context):**
>
> - Hintergrund: Ein verregneter Nachmittag zu Hause. Das Kind ist `[Alter]` Jahre alt und braucht eine spannende Beschäftigung.
> - Ziel: Eine Schatzsuche durch die Wohnung mit altersgerechten Rätseln.
> - Verstecke in dieser Reihenfolge: `[Versteck 1]`, `[Versteck 2]`, `[Versteck 3]`, `[Versteck 4]`.
>
> **Aufgabe (Task):**
>
...
```text
Mach ein Schatzsuchen-Rätsel für eine Waschmaschine.
```

_(Ergebnis: "Ich bin ein Gerät, das deine Kleidung wäscht. Wo bin ich?")_ - **Zu langweilig!**

### ✅ Nachher (Mit unserem Pro-Prompt)

```text
Ahoi, kleiner Pirat! Dein erstes Rätsel ist gar nicht schwer:
Ich schlucke schmutzige Socken und noch viel mehr!
Mit Wasser und Seife dreh ich mich rundherum,
und mache dabei ein lautes Brumm-brumm-brumm!
Wo bin ich?
```
