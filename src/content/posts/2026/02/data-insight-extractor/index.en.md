...
## 🚀 The Solution: "The AI Data Analyst"
...
```text
(Raw Jan-Dec Sales Table pasted as text)
Analyze this.
```
...
```text
### 1. Key Patterns & Anomalies
- **Summer Surge:** Sales increased by 30% during the July-August period compared to the Q2 average.
- **Retention Drop:** The customer repurchase rate declined by 5% in November.

### 2. Business Significance
- The summer surge indicates high responsiveness to our seasonal promotional campaigns, suggesting our target demographic is highly active during holidays.
- The drop in the repurchase rate coincides with the recent pricing tier update, indicating potential churn among price-sensitive legacy users.

### 3. Proposed Actions
- **Capitalize on Seasonality:** Allocate 20% more marketing budget to summer campaigns next year to maximize this proven peak season.
- **Retention Audit:** Immediately review the existing customer success program and consider a targeted "win-back" discount for users who churned in November.
```
