...
> **Tarefa (Task):**
>
> 1.  **5 Opções de Título Magnético:** Misture as seguintes estratégias psicológicas:
>     - Lacuna de Curiosidade ("Você está usando isso do jeito errado...")
>     - Viés de Negatividade ("NÃO compre isso antes de ver...")
>     - Autoridade/Listas ("Top 3 Segredos Revelados...")
> 2.  **3 Conceitos Visuais para a Miniatura (Thumbnail):**
>     - **Composição:** (ex., Close-up extremo no rosto, tela dividida de antes/depois)
>     - **Expressão/Ação:** (ex., Rosto em choque profundo, cobrindo a boca)
>     - **Texto (Copy):** Texto curto, de alto impacto, para colocar na imagem (máximo de 3 palavras).
> 3.  **Justificativa Psicológica:** Explique brevemente o porquê de cada combinação de título e miniatura funcionar no cérebro do espectador.
>
> **Variáveis do Público-Alvo (Input):**
>
> - Demografia: `[ex., Estudantes universitários de 18 a 24 anos]`
> - Dores/Necessidades: `[ex., Orçamento muito apertado, vontade de decorar um quarto pequeno]`
>
> **Restrições (Constraints):**
>
> - Não use jargões complexos. Mantenha a linguagem direta e emocional.
...
### ❌ Antes (O Caminho do Fracasso)

```text
Título: Minhas Recomendações da IKEA.
Miniatura: Uma foto normal de móveis com o texto "Compras na IKEA" em uma fonte padrão.
```

### ✅ Depois (A Fórmula de 1 Milhão de Views)

```text
🔥 [Opções de Título Magnético]
1. "Funcionários da IKEA Querem Esconder Isso (Sempre Esgota)"
2. "Pare de Gastar Dinheiro! (Esse Truque de R$20 Salva Vidas)"
3. "O Segredo da IKEA que Mudou Meu Quarto Minúsculo"

🎨 [Conceito Visual A]
- Composição: Visão em primeira pessoa segurando um recibo gigantesco que toca o chão.
- Expressão: Rosto desfocado ao fundo com as mãos na cabeça (Desespero/Choque).
- Texto (Copy): "SÓ R$20?!" (Amarelo vibrante, borda preta espessa).
- Psicologia: Aciona instantaneamente a satisfação de "Custo-Benefício" combinada com a curiosidade do que foi comprado.
```
