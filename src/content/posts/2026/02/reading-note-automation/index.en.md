...
## 🚀 The Solution: "Reading Mate Prompt"

### 🥉 Basic Version {#ocr}

Use this when you just want a quick summary and to save underlined text.

> **(Upload the book page photo)**
>
> **Task:**
...
Use this to fully digest the book's content and create high-level reading notes directly applicable to your work.

> **Role:** You are a sharp, insightful 'Literary Critic' and a pragmatic 'Business Coach'.
>
> **Context:**
>
> - Background: I am currently reading this book to accelerate my career growth. The attached image is from the chapter I found most insightful.
> - Goal: Transform this from a simple plot summary into 'actionable knowledge' that I can directly apply to my life and work.
>
> **Task:**
>
> Based on the content of the attached image, generate the following 4 sections in Markdown format:
>
> 1. **Core Extract:** Extract the 3 most dense and important sentences exactly as they appear in the text.
> 2. **Deep Interpretation:** Explain from your perspective why these sentences matter, uncovering the author's true intent and reading between the lines.
> 3. **Practical Application:** Propose 3 specific, actionable items I can implement tomorrow in my current workplace (or personal project) based on these insights.
> 4. **Expansion Question:** Ask exactly 1 penetrating, philosophical, or strategic question that forces me to think deeper about this topic.
>
> **Constraints:**
>
> - Write all outputs naturally in English.
> - Skip the verbose introduction and get straight to the point.
> - Auto-correct any typos in the extracted text by considering the context.
...
### ✅ After (Using AI Pro Prompt) {#ai}

> **[Core Extract]**
> "Perfection is achieved, not when there is nothing more to add, but when there is nothing left to take away."
>
> **[Deep Interpretation]**
> This sentence captures Antoine de Saint-Exupéry's philosophy of focusing on the essence. In modern business, Feature Creep often blurs a product's identity. It emphasizes that true value lies in Subtraction.
>
> **[Practical Application]**
>
> 1. Delete 3 unnecessary slides from this week's project proposal.
> 2. Shorten the team meeting from 1 hour to 30 minutes and minimize the agenda.
> 3. Remove 1 distracting button from the landing page of the app currently in development.
>
> **[Expansion Question]**
> "In your current workflow, what is a process you maintain purely out of habit, which could be 'taken away' right now without causing any problems?"

(Result: It doesn't end with reading; it leads to immediate workflow improvements 🚀)

---

## 🎯 Conclusion {#conclusion}

A book sitting beautifully on a bookshelf is just an expensive interior decoration.
Open the page that inspired you the most, snap a photo, and throw the question at the AI.

**How to turn even a single page into a weapon for your life.**
Turn on your smartphone camera and try it right now. 🍷
