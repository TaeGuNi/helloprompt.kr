...
> - **Dépenses fixes (incompressibles) :** `[Loyer 900 €, Électricité/Gaz 120 €, Internet/Mobile 40 €, Assurances 80 €, Abonnements 30 €]`
> - **Objectif d'épargne mensuel :** `[Minimum 500 €]`
>
> **Tâche (Task) :**
>
...
```text
Je gagne 3000 euros, fais-moi un budget.
```

### ✅ Après (Résultat avec la Version Pro)

```text
### 💰 Votre Plan Budgétaire Personnalisé (Revenu : 3 000 €)

**1. Résumé de votre Flux de Trésorerie**
- **Salaire Net :** 3 000 €
- **Dépenses Fixes (Incompressibles) :** -1 170 € (Loyer, Énergies, Assurances, etc.)
- **Objectif d'Épargne Prioritaire :** -500 € (Payé en premier !)
- **👉 Reste à vivre (Dépenses Variables) : 1 330 €**

**2. Allocation de votre Reste à Vivre (1 330 €)**

| Catégorie | Budget Alloué | Part (%) | Recommandation |
| :--- | :--- | :--- | :--- |
| **Alimentation & Courses** | 550 € | 41 % | Privilégiez le batch-cooking, limitez Uber Eats à 2x/mois |
| **Transports (Carburant/Pass)** | 150 € | 11 % | Optimisez vos trajets, vérifiez les aides employeur |
| **Loisirs & Shopping** | 430 € | 32 % | Budget "Plaisir" sans culpabilité. S'il est vide, on attend le mois prochain ! |
| **Imprévus & Santé** | 200 € | 15 % | À conserver sur le compte courant pour éviter de toucher à l'épargne |

**3. 💡 3 Astuces d'Optimisation pour vous :**
1. **L'Audit des Abonnements :** Vous avez 30 € d'abonnements. Vérifiez si vous utilisez vraiment toutes vos plateformes VOD ce mois-ci. Une rotation mensuelle (Netflix un mois, Disney+ l'autre) peut diviser cette facture par deux.
2. **La règle des 48h :** Pour tout achat "Plaisir" supérieur à 50 €, imposez-vous un délai de réflexion de 48h. Cela élimine 80% des achats impulsifs.
3. **Le "Fonds de Roulement" :** Laissez toujours les 200 € d'imprévus sur votre compte. S'ils ne sont pas utilisés en fin de mois, transférez-les vers votre épargne !
```
