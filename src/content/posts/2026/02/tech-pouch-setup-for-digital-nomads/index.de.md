...
## 🚀 Lösung: Der "Tech-Gear-Kurator" Prompt
...
```text
Empfiehl mir elektronisches Zubehör für meine Reise nach Japan. Ich möchte dort arbeiten.
```

_(Ergebnis: Eine oberflächliche Liste wie "Nimm eine Powerbank, einen Adapter und Kopfhörer mit." – Keine Rücksicht auf die Leistung der spezifischen Geräte.)_

### ✅ After (Mit Pro Prompt)

```text
1. Ladegerät: Ein GaN-Ladegerät mit mind. 100 W (z. B. 2x USB-C PD, 1x USB-A) – Lädt Ihr MacBook Pro 16" und das iPad gleichzeitig bei voller Leistung.
2. Kabel: Zwei 100-W-fähige USB-C-Kabel (mit E-Marker-Chip), idealerweise stoffummantelt für längere Haltbarkeit im Rucksack.
3. Dual-Monitor: Nutzen Sie die Apple "Sidecar"-Funktion drahtlos, um das iPad Pro als Zweitbildschirm zu verwenden. Ein kompakter, klappbarer Tablet-Ständer (aus Aluminium) wird empfohlen, um beide Bildschirme auf Augenhöhe zu bringen.
4. Stromversorgung Japan: In Japan wird der Steckertyp A (ohne Schutzkontakt) und 100 V verwendet. Ihr MacBook-Ladegerät unterstützt 100-240 V, Sie benötigen also keinen Spannungswandler, aber zwingend einen Steckeradapter auf Typ A.
5. Internet-Backup: Besorgen Sie sich vorab eine eSIM (z. B. über Ubigi oder Airalo), da das öffentliche WLAN in japanischen Cafés oft zeitlich begrenzt ist.
```
