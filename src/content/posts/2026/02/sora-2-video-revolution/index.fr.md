...
- **🤖 Modèle recommandé :** ChatGPT (pour structurer le prompt), Sora 2.0 (pour la génération)
...
## 🚀 La Solution : "Le Prompt du Réalisateur Hollywoodien"

### 🥉 Version Basique (Idéation Rapide)
...
>
> **Requête (Task) :**
> Rédige un prompt vidéo ultra-détaillé en anglais pour Sora 2.0 en remplissant les variables suivantes :
>
...
>
> - Évite les descriptions physiquement impossibles, métaphoriques ou ambiguës qui pourraient provoquer des hallucinations visuelles. Reste d'une précision chirurgicale.
...
### ❌ Avant (Prompt amateur direct sur Sora)

```text
Une femme marche dans une rue de Tokyo la nuit. Il pleut.
```

_(Résultat : Éclairage plat, mouvements robotiques, flaques d'eau statiques et arrière-plan incohérent qui se déforme au fur et à mesure que la caméra avance.)_

### ✅ Après (Résultat généré grâce à la Version Pro)

```text
A cinematic tracking shot following a young woman walking through the neon-lit streets of Shinjuku, Tokyo, during a heavy downpour. She is holding a clear plastic umbrella, the vibrant neon lights reflecting dynamically off the wet asphalt and the umbrella's surface. Volumetric lighting cuts through the mist. Shallow depth of field focusing on her determined expression. Shot on 35mm lens, 8k resolution, photorealistic, with a subtle handheld camera sway.
```

_(Résultat : Une séquence digne de Blade Runner, avec une gestion parfaite des reflets, une ambiance visuelle immersive et une stabilité d'image absolue du début à la fin.)_
