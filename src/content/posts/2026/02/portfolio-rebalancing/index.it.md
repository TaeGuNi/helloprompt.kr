...
## 🚀 La Soluzione: "L'Equilibratore di Portafoglio"
...
> **Contesto (Context):**
>
> - Obiettivo: Devo effettuare il ribilanciamento periodico del mio portafoglio di investimenti.
> - Capitale Totale: `[100.000 €]`
> - Allocazione Target desiderata: `[Azioni 60%, Obbligazioni 30%, Liquidità 10%]`
>
> **Portafoglio Attuale (Current Assets):**
>
> - Azioni: `[75.000 €]` (es. Apple, ETF MSCI World, ecc.)
> - Obbligazioni: `[15.000 €]` (es. BTP, ETF Obbligazionari Globali)
> - Liquidità: `[10.000 €]` (Conto deposito, cash)
>
> **Richiesta (Task):**
>
...
```text
Ho un po' di azioni e di obbligazioni, le azioni sono salite troppo. Come faccio a rimettere a posto le percentuali?
```

### ✅ Dopo (Risultato del Prompt Pro)

```text
### ⚖️ Piano Strategico di Ribilanciamento del Portafoglio

**1. Analisi dell'Allocazione Attuale vs Target**

| Classe di Asset | Valore Attuale | Peso Attuale | Peso Target | Discrepanza | Azione Richiesta |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Azioni** | 75.000 € | 75% | 60% | 🔻 -15% | Eccesso (da vendere) |
| **Obbligazioni** | 15.000 € | 15% | 30% | 🔺 +15% | Carenza (da comprare) |
| **Liquidità** | 10.000 € | 10% | 10% | ✅ 0% | In Target |

**2. Piano d'Azione Operativo**

Per ripristinare l'allocazione target del 60/30/10, ti consiglio di procedere con le seguenti operazioni in quest'ordine:

1. **[VENDI] Azioni per 15.000 €:** Realizza i profitti sulle posizioni azionarie in eccesso per generare liquidità. Questo riporterà l'allocazione azionaria esattamente a 60.000 € (60% del totale).
2. **[COMPRA] Obbligazioni per 15.000 €:** Utilizza la liquidità appena generata dalla vendita delle azioni per acquistare asset obbligazionari. Questo innalzerà il valore del comparto obbligazionario a 30.000 € (30% del totale).
3. **[MANTIENI] Liquidità:** Non sono richieste operazioni sui contanti, poiché i 10.000 € attuali rappresentano già il 10% del portafoglio.

**3. Effetti Previsti del Ribilanciamento**

Questa operazione di "sell high, buy low" forzata andrà a ridurre significativamente la volatilità complessiva del portafoglio, riportando il livello di rischio in linea con il tuo profilo di tolleranza iniziale. Proteggerai i profitti generati dal recente rally azionario reinvestendoli in asset obbligazionari attualmente sottopesati.
```
