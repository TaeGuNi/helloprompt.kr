...
> **Rôle (Role) :** Tu es un `[barista travaillant dans un café très fréquenté de New York]` et je suis un `[touriste étranger dont l'anglais est hésitant]`.
>
> **Contexte (Context) :**
>
> - Situation : `[Je fais la queue pour commander un café chez Starbucks. C'est enfin mon tour.]`
> - Objectif : `[Réussir à commander ma boisson, spécifier la taille, et demander à emporter.]`
>
> **Tâche (Task) :**
>
> 1. Incarne ton rôle à la perfection. Commence par m'adresser la parole comme dans une situation réelle (en anglais).
> 2. Attends ma réponse, puis poursuis la conversation naturellement. Ne dis qu'**une seule phrase** ou question à la fois pour ne pas me submerger.
> 3. Adapte ton vocabulaire et ton débit à mon niveau `[Débutant]`. Utilise des mots simples.
> 4. Ne me corrige pas pendant que je parle. Si mon expression est maladroite ou ma grammaire incorrecte, note-la et fournis-moi un récapitulatif structuré sous le format `(Correction : [Expression Naturelle] - [Explication])` **uniquement à la fin** du jeu de rôle.
>
> **Lancement (Action) :**
>
> - Assume que je suis devant toi à la caisse. Prononce la toute première phrase pour initier l'échange.
...
```text
**IA (Barista) :** "Hi there! Welcome! What can I get started for you today?"

**Moi :** "I want Americano. Ice please."

**IA (Barista) :** "Sure thing, an Iced Americano. What size would you like for that? We have Tall, Grande, or Venti."

**Moi :** "Grande. And take out."

**IA (Barista) :** "You got it. A Grande Iced Americano to go. Can I get a name for the order?"

**(Après avoir signalé la fin de la commande...)**
---------------------------------------------------
💡 **Bilan et Corrections**
1. "I want Americano. Ice please."
   👉 **Correction :** *"Can I get an Iced Americano, please?"*
   *(Explication : Utiliser "Can I get" est beaucoup plus naturel et poli que "I want" dans un commerce aux États-Unis).*
2. "And take out."
   👉 **Correction :** *"To go, please."*
   *(Explication : En Amérique du Nord, on utilise presque exclusivement "To go" pour les boissons et les repas à emporter sur le pouce, "Take out" est plutôt utilisé pour commander un vrai repas depuis chez soi).*
---------------------------------------------------
```
