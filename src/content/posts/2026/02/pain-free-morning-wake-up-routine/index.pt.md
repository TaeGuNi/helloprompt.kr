...
1. **Ativação Sensorial:** Utilize a sequência comprovada de Luz → Água → Movimento para ativar o cérebro imediatamente após o alarme.
2. **Micro-hábitos:** Elimine a inércia do sono com alongamentos simples e indolores feitos ainda deitado na cama.
3. **Recompensa Imediata:** Incorpore um gatilho de dopamina (algo que você ama) logo nos primeiros minutos para gerar motivação real.

---

## 🚀 A Solução: "Arquiteto da Manhã Perfeita"
...
Utilize este prompt para obter uma rotina altamente personalizada e cientificamente embasada.

> **Papel (Role):** Você é um neurocientista e coach de alta performance especializado em otimização do sono e rotinas matinais.
>
> **Contexto (Context):**
>
...
> **Tarefa (Task):**
>
> 1. Desenvolva uma **"Rotina de Ativação de 10 Minutos"** projetada especificamente para me tirar da cama sem dor ou estresse mental.
> 2. Integre os elementos de **Luz (Iluminação), Hidratação e Som (Música)** em uma sequência lógica e biologicamente correta para inibir a melatonina e estimular o cortisol saudável.
> 3. Forneça uma sequência de **"Micro-alongamentos na Cama"** que dure apenas 1 minuto e possa ser feita ainda deitado para iniciar a circulação sanguínea.
> 4. Desenhe um sistema de **"Recompensa Imediata"** atrelado às minhas preferências que me dê um motivo real para querer sair da cama.
>
> **Restrições (Constraints):**
>
> - PROIBIDO usar conselhos genéricos baseados em "força de vontade" ou "motivação". O foco deve ser estritamente em fisiologia e criação de sistemas.
> - Todas as diretrizes devem ser ações físicas específicas, imediatas e de baixíssimo atrito.
...
- **Q: Eu não gosto de olhar para a tela do celular logo de manhã. Existe alternativa para a "Luz"?**
...
> "Me dê dicas para acordar cedo e não me atrasar."

**Resultado da IA:**
_"1. Durma mais cedo. 2. Coloque o despertador longe da cama. 3. Tenha força de vontade e levante assim que tocar."_ (Frustrante, óbvio e incrivelmente difícil de aplicar quando se está exausto).

### ✅ Depois (Resultado do Prompt Pro)

**[Protocolo de Ativação às 07:00 - Sem Dor]**

- **07:00 (O Gatilho de Luz):** Assim que o alarme suave tocar, não tente se levantar. Apenas alcance o celular, coloque o brilho da tela no máximo e aponte para o rosto por 30 segundos. _(Fisiologia: A luz forte nos olhos inibe imediatamente a produção de melatonina e sinaliza para o cérebro que é dia)._
- **07:01 (O Despertar do Sangue):** Ainda debaixo das cobertas, faça 20 rotações vigorosas com os tornozelos e abra e feche as mãos com força 10 vezes. _(Fisiologia: Ativa o sistema cardiovascular sem exigir esforço mental ou resistência)._
- **07:03 (A Ancoragem Sonora):** Dê o comando de voz para o seu assistente virtual ou celular tocar a sua playlist favorita de Jazz instrumental em volume médio-baixo.
- **07:05 (A Recompensa Líquida):** Sente-se na borda da cama e vire de uma vez um copo de água (que foi deixado na mesa de cabeceira na noite anterior).
- **07:06 (O Prêmio Maior):** Levante-se com o único e exclusivo objetivo de ir até a cozinha iniciar a preparação da sua cápsula de café favorita. O aroma será a sua recompensa final.
