...
>
> - Si el concepto es demasiado abstracto para graficarse con ASCII, indícalo claramente y enfócate en fortalecer la analogía en lugar de forzar un diagrama confuso.
>
> **Entrada del Usuario:**
> Concepto a visualizar: `[Ingresa aquí el concepto que deseas comprender]`
...
```text
  [Cliente]                               [Servidor]
     |                                        |
     |------- (1) SYN (Sincronizar) --------->|  "¡Hola! ¿Estás ahí para hablar?"
     |                                        |
     |<------ (2) SYN + ACK (Acuse) ----------|  "¡Sí, estoy aquí! ¿Tú me escuchas?"
     |                                        |
     |------- (3) ACK (Acuse de recibo) ----->|  "¡Te escucho fuerte y claro! Empecemos."
     |                                        |
