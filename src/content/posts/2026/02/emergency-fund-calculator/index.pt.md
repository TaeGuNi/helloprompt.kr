...
```text
Quanto de fundo de emergência eu preciso ter? Sou freelancer.
```

### ✅ Depois (Resultado com o Prompt Pro)

```text
### 🛡️ Plano de Fundo de Emergência para Designer Freelancer

**1. Meses de Cobertura Necessários: 6 a 12 meses**
Como freelancer atuando há 3 anos, sua renda é variável e sujeita à sazonalidade do mercado. Diferente de um trabalhador assalariado (que geralmente precisa de 3 a 6 meses), recomendamos uma reserva de **9 meses** para garantir segurança total contra períodos de "vacas magras" ou atrasos de clientes.

**2. Valor Total do Fundo (Meta)**
- Despesas fixas mensais: R$ 4.000,00
- Multiplicador: 9 meses
- **Meta Total: R$ 36.000,00**

**3. Onde Investir (Alta Liquidez e Segurança)**
- **Tesouro Selic:** Risco baixíssimo (soberano) e liquidez D+0 (pedindo até as 13h). Ideal para o montante principal.
- **CDBs de Liquidez Diária (100% do CDI):** Oferecidos por bancos sólidos. Ótimo para a parte do fundo que você pode precisar usar em um fim de semana.
- **Contas Digitais Remuneradas:** Como Nubank ou Mercado Pago. Útil para deixar cerca de 1 a 2 meses de despesas para acesso instantâneo via Pix.

**4. Plano de Acumulação Mensal**
- Meta: R$ 36.000,00
- **Estratégia Agressiva Inicial (Criando o "Colchão Mínimo"):** Poupe R$ 1.000/mês. Em 12 meses, você terá R$ 12.000 (3 meses de garantia).
- **Consolidação:** Continue aportando R$ 800/mês pelos próximos 30 meses para atingir o valor total, enquanto ajusta seu padrão de vida.
```
