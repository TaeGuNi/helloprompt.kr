...
1. La clave de esta técnica reside en combinar las palabras mágicas `Knolling` y `Flat lay`.
2. Fija la perspectiva geométrica de la cámara utilizando `Top-down view` o `Zenithal view`.
3. Añade el término `Deconstructed` o `Disassembled` si deseas mostrar dispositivos tecnológicos desmontados pieza por pieza con precisión quirúrgica.
...
> **Rol:** Eres un fotógrafo profesional especializado en fotografía de producto y bodegones.
>
...
> **Contexto (Context):**
>
> - Fondo: Necesito crear una imagen publicitaria de altísima calidad para un catálogo visual premium.
> - Objetivo: Mostrar una disposición impecable y milimétrica de varios elementos temáticos utilizando la técnica Knolling.
>
> **Solicitud (Task):**
>
...
>
> - Ángulo de cámara: Estrictamente `Top-down view` (vista cenital absoluta, sin ángulos inclinados).
> - Iluminación: Iluminación de estudio suave y difusa (soft studio lighting) para eliminar sombras duras que ensucien la composición.
> - Fondo: Fondo de color neutro y mate (`[COLOR DEL FONDO]`) para que los objetos sean los protagonistas indiscutibles.
>
> **Parámetros recomendados (Midjourney):**
>
> - `--ar 3:2 --style raw --v 6.0 --no messy, overlapping, shadows, touching`
...
**Un truco profesional:** Si los objetos que solicitas tienen tamaños radicalmente distintos (por ejemplo, una mochila y un pendrive), añade la frase _"items neatly arranged by size and weight, maintaining visual balance"_ para que la IA distribuya el peso visual de la composición de manera armónica. ¡Es genuinamente hipnótico ver cómo la IA alinea cada píxel!
...
```text
Un montón de equipo de fotografía y viaje sobre una mesa de madera.
```

_(Resultado: Una imagen caótica donde las cámaras están amontonadas sobre mapas arrugados, lentes rodando peligrosamente por la mesa y correas enredadas. Es imposible distinguir cada elemento con claridad)._

### ✅ Después (Con Knolling)

```text
Equipo de explorador clásico: cámara fotográfica vintage, brújula de latón, mapa de cuero, diario de viaje, estilográfica y gafas de aviador. Composición estricta de estilo Knolling, flat lay, disposición en cuadrícula perfecta, vista cenital. Iluminación suave de estudio, fondo neutro beige mate. --ar 16:9 --v 6.0 --no messy, overlapping, touching
```

_(Resultado: Una imagen impecable de calidad editorial donde cada elemento respira, está perfectamente alineado a 90 grados y transmite una sensación absoluta de orden, limpieza y profesionalismo visual)._

---

## 🎯 Conclusión

En un ecosistema digital saturado de imágenes caóticas y composiciones aleatorias, dominar el prompt de Knolling te otorga el superpoder de generar imágenes que transmiten paz mental, claridad absoluta y un diseño exquisito en cuestión de segundos.

¡Organiza tus prompts con precisión quirúrgica y sal del trabajo a tiempo! 🍷
