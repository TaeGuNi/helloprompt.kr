...
> **Situation (Context) :**
>
> - Profil : Je suis un débutant complet en fitness.
> - Mensurations : `[175 cm / 80 kg, Homme]`
> - Objectif principal : `[Perdre 5 kg de masse grasse tout en développant la masse musculaire (Recomposition corporelle)]`
> - Contraintes : Je peux m'entraîner `[4 fois]` par semaine, pendant environ `[1 heure]` par séance.
>
> **Demande (Task) :**
>
...
>
> - Ne propose pas d'exercices trop avancés ou dangereux pour un débutant (ex: soulevé de terre lourd sans supervision). Si l'objectif semble irréaliste, ajuste-le pour préserver la santé des articulations.
...
| Jour | Cible | Exercice | Séries x Répétitions | Repos |
| :--- | :--- | :--- | :--- | :--- |
| **Lundi** | Haut du corps | Développé couché aux haltères | 3 x 10-12 | 90 sec |
| | | Tirage vertical à la poulie (Dos) | 3 x 10-12 | 90 sec |
| **Mardi** | Bas du corps | Goblet Squat (Jambes) | 4 x 10 | 120 sec |
| | | Presse à cuisses | 3 x 12 | 90 sec |
| **Jeudi** | Haut du corps | Développé militaire assis | 3 x 10-12 | 90 sec |
| **Vendredi**| Bas du corps | Soulevé de terre jambes tendues | 3 x 10 | 120 sec |

**⚠️ Précautions de Sécurité :**
- *Goblet Squat :* Gardez le dos droit, le regard vers l'avant. Ne laissez pas vos genoux rentrer vers l'intérieur lors de la montée (valgus du genou). Respirez avec le ventre pour gainer.

**🍏 Plan Alimentaire Journalier (Objectif ~2000 kcal) :**
- **Petit-déjeuner :** Flocons d'avoine (60g) + 1 mesure de whey protéine + 1 pomme.
- **Déjeuner :** Blanc de poulet (150g) + Riz basmati (50g cru) + Brocolis à volonté.
- **Collation :** Yaourt grec 0% + Poignée d'amandes (20g).
- **Dîner :** Filet de saumon (120g) + Patate douce (100g) + Salade verte (vinaigrette à l'huile d'olive).
```
