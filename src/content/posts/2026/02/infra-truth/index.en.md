...
## 🚀 The Solution: "The AI Hype Filter Prompt"
...
Leverage this advanced prompt for deep, VC-grade due diligence and comprehensive market analysis.

> **Role:** You are a seasoned Venture Capitalist and AI Infrastructure Expert.
>
> **Context:**
>
> - Background: The AI market is deeply saturated with surface-level applications, yet infrastructure providers are capturing the vast majority of actual profits. We are currently facing severe "AI fatigue" and an impending market correction.
> - Objective: I need to rigorously evaluate the true sustainability, defensibility, and profitability of a specific AI company or product.
>
> **Task:**
>
> 1. Analyze the core business model of `[Company/Product Name]`.
> 2. Break down their dependency on underlying infrastructure (e.g., GPU computing costs, reliance on foundational model APIs).
> 3. Identify their true competitive moat. Do they possess proprietary data, deep workflow integration, or robust network effects? Or is their only edge UI/UX?
> 4. Estimate their long-term survival probability against big tech monopolies (e.g., assess the risk of being "Sherlocked" by Apple, Google, or OpenAI).
>
> **Constraints:**
>
> - Output the analysis strictly in a well-structured Markdown format using bullet points.
> - Avoid marketing jargon entirely; employ harsh, realistic financial and technical metrics.
>
> **Warning:**
>
> - Do not hallucinate financial data. If specific revenue or cost figures are unknown, explicitly state "Data unavailable" and provide an educated industry estimate based on verifiable trends.
...
```text
Is "ChatPDF" a good business?
```

### ✅ After (Pro Prompt Output)

```text
**Company/Product:** ChatPDF

**1. Business Model & Infrastructure Dependency:**
- **Dependency:** Extremely High. Heavily reliant on OpenAI/Anthropic APIs for core text processing and embedding generation.
- **Cost Structure:** Characterized by high marginal costs that scale linearly with user document size and query volume, limiting gross margins.

**2. Competitive Moat:**
- **Defensibility:** Low. The primary value proposition lies entirely in UI/UX convenience and basic PDF parsing logic.
- **Proprietary Edge:** Critically lacks proprietary foundational models, exclusive data sets, or deep enterprise workflow integration.

**3. Survival Probability & Risks:**
- **Probability:** Low to Medium.
- **Sherlock Risk:** Extremely High. Foundational model providers (like ChatGPT or Claude) are already heavily integrating native document uploads, rapidly eroding the core value proposition and standalone utility of simple wrapper applications.
```
