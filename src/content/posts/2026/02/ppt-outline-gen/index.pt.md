...
## 🚀 Solução: "Arquiteto de Apresentações"
...
> **Contexto (Context):**
>
> - Cenário atual: `[Ex: Precisamos apresentar os resultados do 3º trimestre para a diretoria, destacando o crescimento de 15% nas vendas, mas também justificando o aumento nos custos de marketing.]`
> - Objetivo final: `[Ex: Aprovar o orçamento de marketing para o próximo ano sem cortes.]`
> - Público-alvo: `[Ex: CEO, CFO e diretores, que têm pouco tempo e preferem dados diretos.]`
>
> **Tarefa (Task):**
>
...
```text
Preciso de uma apresentação sobre os resultados de vendas.
(Gera uma lista genérica: 1. Introdução, 2. Vendas, 3. Custos, 4. Conclusão)
```
...
```text
### Slide 1: Título
- **Título do Slide:** Resultados do 3º Trimestre: Crescimento Sustentável
- **Mensagem Chave:** Atingimos nossas metas de vendas, impulsionados pela nova linha de produtos.
- **Tópicos:**
  - Crescimento de 15% na receita (YoY).
  - Nova linha representa 30% do faturamento.
- **Sugestão Visual:** Gráfico de linhas comparando Q3 2025 vs Q3 2026.

### Slide 2: Desafios e Custos
...
```
