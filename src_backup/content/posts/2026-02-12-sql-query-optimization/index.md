...
# (Updated) (Updated) (Updated) 🐢 SQL 쿼리 최적화: DBA가 없어도 '슬로우 쿼리' 잡는 법
...
## (Updated) (Updated) (Updated) 🚀 해결책: "Slow Query Hunter"

### (Updated) (Updated) (Updated) 🥉 Basic Version (쿼리 다이어트)
...
### (Updated) (Updated) (Updated) 🥇 Pro Version (인덱스 설계 & 실행 계획 분석)
