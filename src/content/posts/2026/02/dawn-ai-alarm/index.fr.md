...
## 🚀 La Solution : "Le Coach Matinal Intraitable"
...
Pour une personnalisation profonde qui résonne avec votre emploi du temps quotidien et vos véritables objectifs de vie.

> **Rôle (Role) :** Tu es un coach de performance de classe mondiale et un expert en psychologie comportementale, connu pour tes discours francs, percutants et profondément motivants.
>
> **Contexte (Context) :**
>
...
> **Tâche (Task) :**
>
> 1. Rédige un script de réveil de 150 mots maximum, conçu pour être lu à voix haute dès la première seconde de mon réveil.
> 2. Détruis impitoyablement ma "plus grande excuse matinale" dès la première phrase.
> 3. Connecte directement mon lever immédiat à la réussite de mon "grand objectif de l'année".
> 4. Mentionne au moins une tâche de "mon emploi du temps aujourd'hui" pour m'ancrer immédiatement dans la réalité de ma journée.
>
> **Contraintes (Constraints) :**
>
> - Le ton doit être intense, urgent, mais profondément bienveillant (comme un grand frère exigeant).
> - N'utilise absolument pas de clichés génériques comme "Saisis ta journée" ou "Carpe Diem".
> - Termine par une instruction d'action physique immédiate (ex: "Jette cette couverture maintenant et mets tes pieds au sol").
>
> **Attention (Warning) :**
>
> - Fournis uniquement le script exact, prêt à être lu par une synthèse vocale (Text-to-Speech), sans aucune introduction, salutation ou conclusion de ta part.
...
### ❌ Avant (Alarme classique / Auto-motivation)

```text
Sonnerie : Bip... Bip... Bip...
(Pensée interne) : "Juste 5 minutes de plus... Je n'ai ma première réunion qu'à 9h de toute façon, je peux sauter ma séance de sport ce matin..."
```

### ✅ Après (Script généré par l'IA lu à haute voix)

```text
Arrête de te raconter que tu as besoin de 5 minutes de plus. Ton excuse pathétique sur le froid de ta chambre ne construira jamais ta startup. Aujourd'hui, tu as cette présentation cruciale devant les investisseurs à 10h. Chaque minute que tu passes sous cette couette est une minute où ton concurrent travaille sur son produit. Lève-toi, jette cette couverture tout de suite, mets tes pieds sur le sol et va chercher ta liberté financière. Debout !
```
