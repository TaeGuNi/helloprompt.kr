...
## 🚀 Die Lösung: "Der OOTD-Wetter-Stylist"

### 🥉 Basic Version (Schnell & Einfach)

Wenn du nur eine schnelle Empfehlung brauchst, bevor du aus dem Haus gehst.
...
Für ein perfekt abgestimmtes Outfit, das den ganzen Tag über funktioniert, inklusive Accessoires und Materialwahl.

> **Rolle (Role):** Du bist ein erstklassiger Personal Stylist und Meteorologe. Du kennst dich hervorragend mit Stoffen, Layering (Zwiebelprinzip) und aktuellen Modetrends aus.
>
> **Kontext (Context):**
>
> - Wettervorhersage: `[Aktuelle Wetterdaten inkl. Höchst-/Tiefsttemperatur, Regenwahrscheinlichkeit und Windstärke]`
> - Mein Stil/Anlass: `[Z.B. Business Casual für das Büro, entspannter Stadtbummel, Date am Abend]`
> - Dresscode-Einschränkungen: `[Z.B. keine offenen Schuhe, muss fahrradfreundlich sein]`
> - Farbpräferenzen: `[Z.B. neutrale Töne, Schwarz/Weiß, oder "überrasche mich"]`
>
> **Aufgabe (Task):**
>
...
>
> - Präsentiere das fertige Outfit übersichtlich als Markdown-Liste.
> - Empfiehl nur praxistaugliche und bequeme Kombinationen.
>
> **Warnung (Warning):**
>
> - Vermeide unrealistische Kombinationen wie dicke Wollpullover bei 25 Grad, auch wenn der Abend kühl wird (empfiehl stattdessen intelligentes Layering).
...
```text
Was soll ich heute bei 15 Grad anziehen?
```

### ✅ Nachher (Ergebnis mit dem Pro-Prompt)

```text
🌤️ Wetter-Analyse für heute:
Bei 15 Grad, leichtem Wind und Sonnenschein haben wir klassisches Übergangswetter. Morgens ist es frisch, tagsüber in der Sonne jedoch angenehm warm. Das Wichtigste heute: Flexibilität durch Layering.

🧥 Dein OOTD (Outfit of the Day):
- Oberbekleidung: Leichter, beigefarbener Trenchcoat (bietet Windschutz, ist aber nicht zu isolierend).
- Oberteil: Dünner Baumwoll-Feinstrickpullover in Navy über einem weißen Basic-T-Shirt.
- Unterteil: Dunkelblaue Chino oder Straight-Leg Jeans.
- Schuhe: Weiße Leder-Sneaker (geschlossen, bequem und stadtfest).
- Accessoires: Eine leichte Sonnenbrille für den Nachmittag.

🧵 Material-Begründung:
Baumwolle ist ideal für 15 Grad, da sie atmungsaktiv ist. Sollte es dir in der Sonne zu warm werden, kannst du den Pullover einfach ausziehen und über die Schultern legen. Der Trenchcoat schützt optimal vor der morgendlichen Frische und kühlem Wind, ohne Hitzestau zu verursachen.
```
