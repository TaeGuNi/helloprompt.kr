...
## 1단계: 물리 엔진 (The Physics Engine) {#the-physics-engine}
...
## 2단계: 입력 처리 (Input Handling) {#input-handling}
...
## 3단계: 레벨 디자인 (Level Design) {#level-design}
