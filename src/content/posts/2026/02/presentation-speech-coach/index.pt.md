...
## 🚀 A Solução: "Prompt de Treinador de Discurso de IA"
...
> **Context (Contexto):**
>
> - Tópico: `[Proposta de introdução de alternativas ecológicas aos canudos de plástico]`
> - Público: `[5 executivos que valorizam a redução de custos e a eficiência]`
> - Objetivo: `[Aprovar o projeto focando no valor da marca a longo prazo e na redução de custos, mesmo que haja um custo inicial de implementação]`
>
> **Task (Tarefa):**
>
...
### ❌ Antes (Simples Transmissão de Informação)

```text
Atualmente, o custo de descarte de resíduos plásticos está aumentando 15% ao ano.
Portanto, nosso departamento acredita que devemos introduzir alternativas ecológicas, mesmo que o custo inicial seja 20% maior.
A longo prazo, será lucrativo. Com isso, encerro a apresentação. Alguma pergunta?
```

### ✅ Depois (Storytelling e Direção de Palco)

```text
(Pausa de 3 segundos, fazendo contato visual com o público)
Senhores, vocês sabem qual foi o custo de descarte de resíduos plásticos que geramos no ano passado?
Esse valor disparou nada menos que 15%. Se continuarmos assim, em três anos, enfrentaremos um déficit insustentável.

(Com voz firme e tom assertivo)
Claro, a alternativa ecológica que proponho hoje custará 20% a mais inicialmente.
Mas isso não é um 'custo', é um 'investimento' para a nossa sobrevivência.

(Sorrindo e falando com tom mais suave)
Peço que pensem no aumento do valor da marca a longo prazo que está por trás desses números. Obrigado.
```
