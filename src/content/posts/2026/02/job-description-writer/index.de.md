...
- **🤖 Empfohlenes Modell:** Alle interaktiven KI-Modelle (Claude 3.5 Sonnet, ChatGPT-4o)
...
## 🚀 Die Lösung: "Der HR-Branding-Experte"

### 🥉 Basic Version (Schnelleinstieg)

Nutzen Sie diesen Prompt, wenn Sie unter Zeitdruck stehen und einen soliden ersten Entwurf benötigen.
...
Verwenden Sie diesen detaillierten Prompt für maßgeschneiderte, hochkonvertierende Stellenausschreibungen, die exakt auf Ihre Unternehmenskultur abgestimmt sind.

> **Rolle (Role):** Du bist ein Senior Employer Branding Stratege und Copywriter für Tech-Unternehmen. Deine Spezialität ist es, Stellenbeschreibungen zu verfassen, die passive Top-Talente magisch anziehen.
>
> **Kontext (Context):**
>
> - Unser Unternehmen: `[Kurze Unternehmensbeschreibung, z.B. ein stark wachsendes FinTech-Startup]`
> - Zu besetzende Position: `[Exakter Jobtitel, z.B. Senior Performance Marketer]`
> - Zielgruppe: Hochqualifizierte Fachkräfte, die Autonomie schätzen und echten Impact haben wollen.
>
> **Aufgabe (Task):**
>
> 1. Entwickle 3 kreative, neugierig machende Titel für die Stellenausschreibung.
> 2. Verfasse ein starkes Intro: Warum ist diese Rolle geschäftskritisch für uns und welchen Impact hat der Kandidat ab Tag 1?
> 3. Strukturiere die Hauptaufgaben (R&R) und Anforderungen (Must-haves vs. Nice-to-haves) klar und realistisch.
> 4. Präsentiere unsere Unternehmenskultur und die Benefits (Perks) auf eine unwiderstehlich attraktive Weise.
>
> **Einschränkungen (Constraints):**
>
> - Verzichte strikt auf ausgelutschte Buzzwords wie "familiäre Atmosphäre", "Work-Hard-Play-Hard" oder "flache Hierarchien".
> - Fokussiere dich auf den tatsächlichen Wert für den Bewerber (WIIFM - What's In It For Me). Verwende eine aktive, energiegeladene Sprache ohne maßlose Übertreibungen.
>
> **Format:** Formatiere die Ausgabe mit klaren Markdown-Überschriften (`###`), strukturierten Bullet-Points und in einem professionellen, aber nahbaren Ton.
...
```text
> **Option 1:** Growth Marketing Lead (m/w/d) – Gestalte das Wachstum im E-Commerce der Zukunft
> **Option 2:** Senior Growth Marketer – Vom ersten Euro zur ersten Million
>
> **Die Mission:**
> Bei uns bist du nicht nur ein kleines Zahnrad in einer großen Maschine. Du übernimmst von Tag 1 an die Verantwortung für unser wichtigstes Asset: Unser Wachstum. Wenn du es liebst, aus Daten messbare Hypothesen zu bauen und Budgets in greifbaren Umsatz zu verwandeln, bist du hier richtig.
>
> **Dein Impact (Warum wir dich brauchen):**
> - Skalierung unserer Paid-Kanäle (Meta, Google Ads) von 0 auf 100.
> - Eigenverantwortliches Testing von neuen Creatives und Funnels...
>
> **Was du mitbringst (Must-haves):**
> - Du hast bereits größere Budgets profitabel verwaltet.
> - Statt "Bauchgefühl" regieren bei dir Pivot-Tabellen und fundierte Tracking-Setups...
```
