...
- **🤖 Modelos recomendados:** GPT-4, Claude 3 Opus, Gemini 2.5 Pro (Modelos com alto poder de raciocínio)
...
Ideal para validar rapidamente a segurança ética de uma nova ideia ou funcionalidade.

> **Função:** Você é um `[Especialista em Ética e Compliance de IA]`.
> **Tarefa:** Avalie o seguinte projeto de IA: `[Breve descrição do projeto ou funcionalidade]`. Aponte os 3 principais riscos éticos (ex: viés algorítmico, privacidade, transparência) e sugira mitigações rápidas e práticas.
...
> **Contexto (Context):**
>
> - Cenário: Nossa empresa está desenvolvendo um sistema de IA com o seguinte objetivo: `[Descreva o objetivo central do sistema de IA]`.
> - Dados utilizados: `[Descreva a origem e o tipo dos dados usados no treinamento e operação]`.
>
> **Tarefa (Task):**
>
...
> **Avisos (Warning):**
>
> - Não invente leis ou regulamentações que não existem. Baseie-se exclusivamente nas estruturas reais e vigentes de governança de IA estabelecidas globalmente.
...
1. Classificação de Risco: ALTO RISCO (Possivelmente Inaceitável). Sistemas de IA usados em recrutamento que inferem emoções ou características cognitivas com base em biometria são estritamente regulados ou explicitamente banidos em várias jurisdições sob o EU AI Act.
2. Análise de Viés: Risco extremo de penalizar pessoas neurodivergentes, indivíduos de diferentes culturas (onde as normas de contato visual e expressões variam drasticamente) e minorias raciais devido a falhas crônicas no reconhecimento facial.

Plano de Mitigação:
- Ação 1: Interromper imediatamente o desenvolvimento da funcionalidade de análise de microexpressões faciais.
- Ação 2: Mudar o foco exclusivamente para a análise semântica estruturada das transcrições de texto.
...
```
...
A verdadeira "Alfabetização em IA" não se resume a saber como gerar um bom código em Python ou uma imagem hiper-realista. Trata-se de ter a sabedoria para questionar profundamente as implicações em larga escala daquilo que estamos construindo.

Audite seus projetos de forma implacável. Inove, mas sempre com responsabilidade! 🛡️
