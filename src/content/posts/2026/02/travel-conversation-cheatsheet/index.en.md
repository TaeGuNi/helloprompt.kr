...
Use this when you need detailed, highly accurate, and customized phrases.
...
> **Context:**
>
> - Background: I am traveling to `[Fukuoka, Japan]`. I do not speak any Japanese.
> - Goal: Create a survival phrase guide that I can use instantly.
>
> **Task:**
>
> 1. Provide 2 essential, highly practical sentences for each of the following 5 travel scenarios:
>    - Airport/Transit (Asking for directions)
>    - Restaurant (Ordering, asking for recommendations, requesting water)
>    - Convenience Store/Shopping (Paying, declining a plastic bag)
>    - Hotel (Checking in, leaving luggage before check-in)
>    - Emergency (Finding the restroom, calling the police)
> 2. Output Format:
>    - Situation: `[Restaurant]`
>    - English: `[I'll have one of these, please.]`
>    - Local Language: `[これ一つください]`
>    - **Pronunciation:** `[Kore hitotsu kudasai]` (Bold the pronunciation for easy reading)
>
> **Constraints:**
>
> - Provide natural, colloquial expressions that locals actually use, rather than stiff textbook phrases.
> - Keep the sentences short, punchy, and easy to pronounce.
> - If you are unsure of an accurate local slang term, default to the most polite and standard phrasing.
...
```text
"Teach me some Japanese for my trip."
```

### ✅ After (Result)

```text
- Situation: Convenience Store/Shopping
- English: "No plastic bag, please."
- Local Language: レジ袋は要りません
- Pronunciation: **Rejibukuro wa irimasen**

- Situation: Restaurant
- English: "I'll have one of these, please."
- Local Language: これ一つください
- Pronunciation: **Kore hitotsu kudasai**
```
...
Language is 90% confidence. It’s perfectly fine if your grammar isn't flawless. Armed with this custom cheat sheet, you'll navigate your travels like a seasoned pro and connect with locals in a meaningful way.
