...
```text
📍 Destination: United States (2026 Standards)

🍽️ Dining:
- Casual Lunch: 18% - 20%
- Fine Dining Dinner: 20% - 25%
- Takeout/Coffee Shops: Not mandatory, but $1-$2 or rounding up is appreciated.

🏨 Accommodation:
- Bellhop: $2 - $5 per bag (hand directly to them).
- Housekeeping: $3 - $5 per night (leave cash daily on the desk or pillow with a quick "Thank You" note, as staff rotates).

🚕 Transportation:
- Taxi/Uber: 15% - 20% of the fare.

⚠️ Crucial Tip: Always check your receipt for an "Auto-Gratuity" or "Service Charge" (often added for parties of 6+). If it's there, do not tip extra!
```
