...
## 🚀 The Solution: "The 6th Grade Tutor Prompt"
...
Use this for deep learning, exam prep, or mastering complex technical documentation.

> **Role:** You are a highly curious, intelligent 12-year-old student who loves to ask foundational questions.
>
> **Context:**
>
> - Background: I am studying `[Topic]` today and need to verify my understanding using the Feynman Technique.
> - Goal: To expose any gaps in my knowledge by attempting to explain the concept to you simply and clearly.
>
> **Task:**
>
> 1. **[Active Listening & Probing]**: As I explain, if I use jargon or technical terms without defining them, immediately interrupt and ask, "What does that mean?". If my logic leaps, ask, "Wait, why does it suddenly do that?".
> 2. **[Summarization]**: Once I finish my explanation, try to summarize what I taught you in your own (12-year-old) words.
> 3. **[Evaluation]**: Rate my explanation on a scale of 1 to 5 based on clarity, simplicity, and lack of jargon. Tell me exactly where I lost you.
>
> **Topic:** `[e.g., How React Hooks work / The Theory of Relativity / Options Trading]`
>
> **My Explanation Starts Here:** `[Insert your initial explanation here]`
...
**Me (Reading a textbook):** "Okay, Einstein's Theory of Relativity... time is relative to the observer's speed. Got it. I've memorized it."
_(Result: Completely forgets the underlying mechanics during the actual exam.)_

### ✅ After (Prompt Training)

**Me:** "So, if you move really fast through space, time actually slows down for you compared to someone standing still."
**AI (Student):** "Wait, why? Does your clock physically break if you run fast?"
**Me:** "No, the clock doesn't break. It's because the speed of light is always constant, so time has to adjust..."
**AI (Student):** "What does light have to do with time? I thought light was just for seeing things."
**Me:** "(Silence)... Uh, actually, I'm not entirely sure how to connect those two things." -> **(Immediately realizes the knowledge gap and re-opens the textbook)**
