...
## 🚀 A Solução: "O Entrevistador Mestre"
...
```text
Me dê perguntas de entrevista para um desenvolvedor sênior.
```
...
Conte-me sobre um momento crítico em que o prazo do seu projeto estava estourando devido a um obstáculo técnico imprevisto. Como você reestruturou as prioridades e comunicou a situação aos stakeholders?

- **Pergunta de Sondagem:** Houve alguma resistência da sua equipe em adotar o novo plano de contingência? Como você gerenciou essa frustração interna?

- 🟢 **Excelente Resposta (Green Flag):** Assume total responsabilidade; foca em comunicação transparente e proativa; demonstra mentalidade focada na solução; utilizou dados para recalibrar o escopo e tranquilizar o cliente.
- 🔴 **Resposta Preocupante (Red Flag):** Transfere a culpa para terceiros; foca excessivamente em relatar o problema técnico em vez de explicar o gerenciamento da crise; não relata como ajustou as expectativas com as partes interessadas.
```
