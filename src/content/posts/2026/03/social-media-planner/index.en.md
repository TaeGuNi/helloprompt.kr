...
> - Main Target: `[Junior marketers and planners with less than 3 years of experience who work overtime every day]`
> - Channel: `[Instagram Reels, TikTok]`
> - Upload Frequency: `[3 times a week - Tuesday, Wednesday, Thursday]`
> - Tone & Manner: `[Professional but not too stiff, refreshingly blunt communication style with a hint of B-tier humor]`
>
> **Task:**
> 1. Based on the conditions above, plan a short-form content calendar of exactly 12 posts to be uploaded over the next 4 weeks (one month).
> 2. Each content piece MUST include the following elements:
>    - 🗓️ Upload week and day
>    - 🎯 Content Topic (stimulating the target's pain points)
>    - 🎣 3-Second Hook Script (the very first sentence of the video)
>    - 📝 Visual Direction Guide (the scene that should be visible on screen)
>    - 💬 Caption Draft and 3 hashtags
> 3. The contents inside `[ ]` are variables I have inputted to fit my service.
>
> **Constraints:**
> - NEVER use Markdown tables for the output format. 
> - Instead, output in a highly readable list format utilizing bullet points and emojis.
> - Hooking scripts must not be abstract; use specific numbers or impactful words. (e.g., "If you don't know this, you'll be working overtime forever", etc.)
> - Output ONLY the calendar content immediately, without any unnecessary introductions or conclusions.
>
> **Warning:**
