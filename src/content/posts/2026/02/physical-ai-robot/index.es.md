...
## 🚀 La Solución: "Analista de IA Física"
...
> **Contexto (Context):**
>
> - Fondo: `[La adopción de la IA Física está aumentando rápidamente en sectores demográficos clave, impulsada por avances exponenciales en eficiencia y escala operativa en 2026]`
> - Objetivo: `[Crear un reporte ejecutivo sobre la transición de la IA del entusiasmo superficial (hype) a la aplicación práctica real, destacando proyectos integrales como EXAONE]`
>
> **Tarea (Task):**
>
> 1. Analiza las métricas proporcionadas sobre adopción tecnológica, innovación de hardware y sentimiento del mercado.
> 2. Identifica el punto de inflexión exacto que evidencia el paso a la comercialización tangible de la robótica.
> 3. Utiliza la variable `[Datos de Mercado]` para incorporar las estadísticas específicas que el usuario entregue en el prompt.
>
> **Restricciones (Constraints):**
>
> - El resultado debe estar estructurado estrictamente en formato Markdown, empleando listas con viñetas claras (prohibido usar tablas).
> - Emplea un tono corporativo, analítico y altamente persuasivo.
>
> **Advertencia (Warning):**
>
> - Si los datos suministrados son insuficientes para establecer una macrotendencia, indícalo de manera explícita. Bajo ninguna circunstancia inventes o infieras métricas no comprobadas (evita las alucinaciones).
...
- **Q: ¿Puedo usar este framework para analizar otra empresa o tecnología que no sea de LG?**
...
### ❌ Before (Entrada ineficiente)

```text
Dime qué está pasando con la IA física y el robot de LG este año.
```

### ✅ After (Resultado utilizando la Pro Version)

```text
**Reporte Ejecutivo: El Estado de la IA Física y el Ecosistema EXAONE en 2026**

**1. Aceleración en la Adopción del Mercado:**
Observamos un incremento sostenido en sectores demográficos estratégicos. Las corporaciones están integrando agentes robóticos autónomos en entornos industriales un 40% más rápido que en los dos trimestres anteriores.

**2. Eficiencia y Escala Tecnológica (El Caso EXAONE):**
La arquitectura de EXAONE impulsada por LG AI Research ha catalizado un salto cualitativo en la cognición aplicada a la motricidad. Se han reportado mejoras exponenciales en la eficiencia energética y una reducción de latencia que permite interacciones mecánicas en tiempo real.

**3. Cambio de Sentimiento y Punto de Inflexión:**
Si bien persiste una justificada cautela en torno al impacto socioeconómico a largo plazo, los indicadores internos muestran un punto de inflexión definitivo: el mercado ha superado la etapa de "hype". Hemos entrado oficialmente en la era de la implementación y el retorno de inversión (ROI) a través de aplicaciones prácticas sólidas.
```
