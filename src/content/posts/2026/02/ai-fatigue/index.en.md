...
### ❌ Before (Riding the Hype Cycle)

```text
User: Should I use [Trendy New AI Video Generator]?

AI Default: Yes! [Trendy New AI Video Generator] is an amazing, revolutionary tool that can create stunning videos. It features incredible capabilities and is taking the industry by storm. You should definitely try it out!

(Result: You waste 4 hours learning an interface you'll never use for your actual job as a backend developer.)
```

### ✅ After (Using the Evaluator Prompt)

```text
**Recommendation: IGNORE**

**Analysis:**
- **Core Value:** Generates short-form B-roll video from text prompts.
- **Overlap:** As a Backend Developer, your primary bottleneck is debugging legacy code, not video creation. Your current stack (GitHub Copilot, ChatGPT) is already optimized for your actual bottlenecks.
- **Time-to-Value:** High learning curve for prompt engineering specific to video generation. Estimated time saved for your role: 0 hours/week. Estimated time wasted learning it: 5+ hours.

**Conclusion:**
This tool solves a problem you do not have. Do not adopt it. Focus your bandwidth on mastering your current code-generation tools.
```
