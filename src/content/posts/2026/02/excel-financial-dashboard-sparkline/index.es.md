...
```text
Dime cómo hacer una tabla de Excel que se vea bonita e interesante para mi jefe.
```

### ✅ After (Resultado de la IA)

```text
¡Por supuesto! Vamos a transformar esos datos en un tablero visual profesional. Sigue estos pasos exactos en tu Excel:

**1. Crear la Línea de Tendencia Anual (Minigráfico)**
- Selecciona la celda **N2** (donde quieres que aparezca el gráfico).
- Ve a la pestaña **[Insertar]** en la cinta de opciones superior.
- En el grupo "Minigráficos", haz clic en **[Línea]**.
- Aparecerá un cuadro de diálogo. En la casilla "Rango de datos", selecciona con el ratón o escribe **B2:M2**.
- Haz clic en **Aceptar**. ¡Listo! Ahora verás el flujo de todo el año en una sola celda. Arrastra la celda N2 hacia abajo para aplicarlo a los demás productos.

**2. Visualizar la Tasa de Logro (Barra de Datos)**
- Selecciona todas las celdas de tu columna "Tasa de Logro (%)".
- Ve a la pestaña **[Inicio]**.
- Haz clic en **[Formato Condicional]** > **[Barras de datos]** > Selecciona el color de "Relleno degradado" que prefieras (ej. Azul).
- *Efecto:* Ahora la celda actuará como una barra de progreso. El 100% llenará la celda completa, haciendo muy fácil ver quién superó la meta sin leer el número.

**3. Crear Alertas Visuales (Conjuntos de Iconos para Crecimiento)**
- Selecciona las celdas de tu columna "Tasa de Crecimiento vs Mes Anterior".
- Ve a la pestaña **[Inicio]** > **[Formato Condicional]** > **[Conjuntos de iconos]**.
- En la sección "Direccional", elige las **[3 flechas (de colores)]**.
- *Nota Pro:* Por defecto, Excel asignará los colores según percentiles. Si quieres que estrictamente los números negativos sean rojos, ve a "Administrar reglas" > "Editar regla" y cambia el 'Tipo' a 'Número' asegurándote de que la flecha roja se asigne cuando el valor sea < 0.
```
