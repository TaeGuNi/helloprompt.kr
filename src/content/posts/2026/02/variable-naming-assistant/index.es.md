...
## 🚀 La Solución: "Maestro Nombrador de Variables"
...
Úsala cuando necesites nombres precisos, con calidad profesional y explicaciones de los matices. Copia el contenido a continuación y pégalo en tu IA favorita.

> **Rol (Role):** Eres un Desarrollador Senior con amplia experiencia y un profundo conocimiento de la semántica en inglés. Dominas a la perfección tanto el sentido lingüístico como las convenciones de codificación modernas (Clean Code).
>
> **Situación (Context):**
>
> - Contexto: Estoy nombrando variables o funciones para mi proyecto y quiero encontrar la expresión en inglés más apropiada, natural y profesional.
> - Objetivo: Obtener nombres que cualquier desarrollador nativo entendería de inmediato sin necesidad de leer comentarios.
>
> **Tarea (Task):**
>
> Recomienda **3 a 5** nombres adecuados para la situación descrita a continuación.
>
> 1. **Nombre:** Propón cada opción respetando el formato `[camelCase / snake_case / PascalCase]` según el lenguaje.
> 2. **Explicación:** Explica detalladamente por qué elegiste esta palabra, cuál es su matiz técnico y en qué contexto específico brilla más.
> 3. **Recomendación:** Selecciona y destaca tu recomendación principal (la opción más estándar y elegante).
>
> **Variables a definir:**
>
...
> **Advertencia (Warning):**
>
> - Si la situación descrita es demasiado ambigua, pídeme más detalles antes de generar los nombres.
...
1. `isLoggedIn` (La convención más común e intuitiva para representar el estado de conexión actual).
2. `isAuthenticated` (Una expresión más técnica y profesional, ideal si estás trabajando en la capa de seguridad o middleware).
3. `hasActiveSession` (Excelente opción si quieres enfatizar que la sesión no solo existe, sino que no ha expirado).

**🏆 Mejor Selección:** `isLoggedIn`
Recomendada por ser la más fácil de leer en condicionales: `if (isLoggedIn) { ... }`.
```
