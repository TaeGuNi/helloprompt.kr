...
## 🚀 La Soluzione: "Generatore di Email per la Negoziazione Salariale"
...
Usala quando hai bisogno di un'email impeccabile, strategica e calibrata al millimetro. Copia questo prompt, compila i campi e invialo all'IA.

> **Ruolo:** Sei un Senior HR Business Partner e un esperto negoziatore aziendale.
>
> **Contesto (Context):**
>
...
> **Richiesta (Task):**
>
> 1. Scrivi l'oggetto dell'email in modo che sia professionale, chiaro e non troppo aggressivo (non usare la parola "soldi").
> 2. Nel corpo dell'email, proponi un momento per incontrarsi, menzionando in modo naturale i risultati che ho ottenuto per contestualizzare la richiesta.
> 3. **Non inserire cifre o importi specifici** nell'email. L'obiettivo è solo portare il manager al tavolo delle trattative con l'atteggiamento giusto.
> 4. Mantieni un tono (Tone of Voice) educato, positivo e collaborativo, ma sii fermo sull'intenzione di parlare di "sviluppo della carriera e compensi".
>
> **Vincoli (Constraints):**
>
> - La lunghezza massima deve essere di circa 150 parole (deve poter essere letta in meno di 1 minuto).
> - Usa una formattazione chiara, andando a capo nei punti giusti per facilitare la lettura.
> - Indica tra parentesi quadre `[ ]` le parti che devo personalizzare prima dell'invio.
...
### ❌ Prima (Diretto/Emotivo)

```text
Oggetto: Aumento di stipendio

Ciao Marco,
Penso di star lavorando molto ultimamente e il mio stipendio è troppo basso rispetto al mercato e a quello che faccio.
Possiamo parlarne per un aumento?
```

_(Effetto sul manager: si mette sulla difensiva, percepisce la richiesta come una lamentela e si prepara a dire di no)._

### ✅ Dopo (Professionale e Strategico)

```text
Oggetto: Richiesta di incontro: Allineamento performance 2025 e sviluppo carriera

Gentile Marco,

Spero che questa settimana stia procedendo per il meglio. Ti scrivo per chiederti la disponibilità per un breve incontro nelle prossime settimane.

Alla luce della recente e positiva conclusione del Progetto Migrazione Cloud, che ha portato a una riduzione dei costi del 20%, mi farebbe piacere fare il punto della situazione sulle mie performance e discutere insieme le prospettive di sviluppo e di adeguamento retributivo per il prossimo anno.

Fammi sapere quando avrai un momento libero nella tua agenda.
