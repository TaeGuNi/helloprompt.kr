...
# (Updated) (Updated) 🤖 AutoGen 입문: AI 에이전트끼리 대화하게 만들기
...
## (Updated) (Updated) 🚀 해결책: "Multi-Agent Setup Prompt"

### (Updated) (Updated) 🥉 Basic Version (코딩 듀오)
...
### (Updated) (Updated) 🥇 Pro Version (가상 회사 놀이)
...
### (Updated) (Updated) ❌ Before (혼자 코딩)

GPT-4에게 "뱀 게임 짜줘" -> 코드 줌 -> 실행 안 됨 -> 내가 디버깅함 -> 귀찮아서 포기. 🤯

### (Updated) (Updated) ✅ After (AutoGen 팀) {#autogen}
