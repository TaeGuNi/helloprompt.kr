...
- **🎯 Empfohlen für:** Büroangestellte, Anfänger ohne Fitnessstudio-Erfahrung, Menschen mit wenig Zeit
...
## 🚀 Die Lösung: "Ihr persönlicher 1:1 KI-Trainer"
...
> **Kontext (Context):**
>
> - **Hintergrund:** Ich bin ein `[Fitness-Anfänger]` und plane, ausschließlich zu Hause zu trainieren. Ich kann täglich `[30 Minuten]` investieren. Das einzige Equipment, das mir zur Verfügung steht, ist `[eine Yogamatte und zwei 2kg-Hanteln]`.
> - **Ziel:** Ich möchte mich besonders auf `[den Abbau von Bauchfett und die Korrektur meines Handynackens (Rundrücken)]` konzentrieren.
>
> **Aufgabe (Task):**
>
...
```text
| Phase | Übung | Sätze | Wdh. / Dauer | Pause | Intensität (RPE) | Anmerkung |
| :--- | :--- | :---: | :---: | :---: | :---: | :--- |
| Aufwärmen | Armkreisen & Schulterrollen | 1 | 2 Min | - | 3/10 | Löst Verspannungen im Nacken |
| Hauptteil | Glute Bridge (Beckenheben) | 3 | 15 | 45 Sek | 6/10 | Knieschonend; stärkt den unteren Rücken |
| Hauptteil | Vorgebeugtes Rudern (mit 2kg Hanteln) | 3 | 12 | 60 Sek | 7/10 | Wichtig gegen den Rundrücken / Handynacken |
| Hauptteil | Deadbug (Käfer-Übung) | 3 | 10 pro Seite | 45 Sek | 7/10 | Bauchmuskeltraining ohne Nackenbelastung |
| Abkühlen | Child's Pose (Kindshaltung) | 1 | 60 Sek | - | 2/10 | Ruhiges Dehnen auf der Yogamatte zur Entspannung |
```
