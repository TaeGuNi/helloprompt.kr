...
## 🚀 Soluzione: Prompt "Clinica del Sonno IA"
...
> **Contesto (Context):**
>
> - Background: Soffro di insonnia da una settimana. Ieri sera mi sono messo a letto alle [23:00], ma mi sono addormentato solo alle [03:00] e mi sono svegliato alle [07:00].
> - Stato d'animo: Sono dominato dall'ansia per il pensiero ricorrente: "[Se non dormo stanotte, domani le mie prestazioni al lavoro saranno un disastro]".
>
> **Compito (Task):**
>
...
> **Vincoli (Constraints):**
>
> - Mantieni un tono empatico, rassicurante ma clinicamente fermo e autorevole.
> - Avvertimi preventivamente che la restrizione del sonno può causare stanchezza nei primi giorni, ma che è fondamentale per il successo a lungo termine.
> - Formatta la risposta utilizzando elenchi puntati e sezioni ben distinte per facilitare la lettura.
...
```text
"Non riesco a dormire, sono in ansia. Aiutami."
```

_(Risposta dell'IA: "Mi dispiace che tu non riesca a dormire. Prova a contare le pecore, ascoltare musica rilassante o bere un bicchiere di latte caldo...")_ → Inutile e frustrante.

### ✅ Dopo (Risultato con Versione Pro)

```text
[Analisi dell'Efficienza del Sonno]
- Risultato: 50% (Il tuo tempo a letto è di 8 ore, ma dormi solo 4 ore).
- Valutazione: L'efficienza clinica ottimale è superiore all'85%. Attualmente, il tuo letto è associato all'ansia e alla veglia.

[Prescrizione: Terapia di Restrizione del Sonno]
- Finestra di Sonno: 5 ore.
- Ora di andare a letto: 02:00 (Non sdraiarti prima di quest'ora, anche se sei stanco).
- Ora di sveglia: 07:00 (Alzati immediatamente, indipendentemente da quanto hai dormito).
- Attenzione: I primi 3-4 giorni saranno difficili, ma è essenziale per accumulare la pressione del sonno necessaria.

[Ristrutturazione Cognitiva]
- Il tuo pensiero: "Se non dormo stanotte, domani sarà un disastro."
- La realtà oggettiva: "Una singola notte di cattivo sonno non distrugge le tue capacità cognitive. Il corpo umano possiede meccanismi di compensazione. Domani potresti sentirti affaticato, ma sarai in grado di svolgere i tuoi compiti. L'ansia di dover dormire a tutti i costi è molto più dannosa della mancanza di sonno in sé."
```
