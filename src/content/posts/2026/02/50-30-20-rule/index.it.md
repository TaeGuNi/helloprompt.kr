...
> **Contesto (Context):**
>
> - Voglio iniziare a gestire il mio denaro con la 'Regola 50/30/20' perché trovo opprimenti le classiche app di bilancio familiare.
> - Il mio reddito netto mensile è di `[2.500 Euro]`.
> - La mia situazione abitativa: `[Vivo da solo in affitto e pago 800 Euro al mese]`.
>
> **Compito (Task):**
>
> 1. Calcola con precisione gli importi destinati a **Necessità (Spese Essenziali), Desideri (Svago/Hobby) e Risparmi (Risparmio/Investimenti/Debiti)** basandoti sul mio stipendio.
> 2. Fornisci esempi specifici e quotidiani di quali spese dovrebbero essere incluse in ogni categoria (es. l'affitto e la spesa al supermercato sono Necessità, l'abbonamento a Netflix e le cene fuori sono Desideri).
> 3. Considerando la mia situazione abitativa specifica (es. l'incidenza dell'affitto sul mio stipendio), consigliami come regolare realisticamente queste percentuali senza compromettere il mio benessere finanziario a lungo termine.
>
> **Vincoli (Constraints):**
>
> - Mostra il risultato della ripartizione in una chiara tabella Markdown.
> - Includi la creazione di un 'Fondo di Emergenza' all'interno della categoria Risparmi e spiegane brevemente l'importanza.
> - Usa un tono incoraggiante ma professionale e oggettivo.
...
```text
Calcola la regola 50 30 20 con 2.500 euro.
```

### ✅ Dopo (Risultato)

```text
### ⚖️ Rapporto Aureo 50/30/20 Basato su 2.500 Euro (Netto)

| Categoria | Rapporto | Importo | Voci Incluse (Esempi) |
| :--- | :--- | :--- | :--- |
| **Necessità** | 50% | **1.250 €** | Affitto, Bollette, Spesa (Alimentari di base), Trasporti, Assicurazione medica |
| **Desideri** | 30% | **750 €** | Cene fuori, Shopping, Abbonamenti (Netflix, Spotify), Viaggi, Hobby |
| **Risparmi** | 20% | **500 €** | Fondo di emergenza, Investimenti (ETF, Azioni), Estinzione debiti extra |

**💡 Il Consiglio del tuo Coach:**
Hai menzionato che paghi 800 Euro di affitto. Questo assorbe già il 32% del tuo reddito totale, lasciandoti solo 450 Euro per le altre necessità (bollette, cibo, trasporti).
Poiché 1.250 Euro totali per le necessità potrebbero essere troppo stretti nella tua situazione, ti consiglio un approccio flessibile:
Rimodula temporaneamente il budget a **60/20/20**. Aumenta le Necessità a 1.500€ (60%), riduci i Desideri a 500€ (20%) e mantieni saldo il tuo impegno di Risparmio a 500€ (20%). Il risparmio deve rimanere la tua priorità per costruire resilienza finanziaria a lungo termine!
```
