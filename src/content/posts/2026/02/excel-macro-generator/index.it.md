...
## 🚀 La Soluzione: Il Prompt "Mago di Excel"
...
Automatizza le attività quotidiane più tediose, come unire decine di file separati o formattare report complessi.

> **Ruolo (Role):** Sei un MVP di Microsoft Excel e un Senior Specialist in automazione d'ufficio. Scrivi codice VBA pulito, estremamente efficiente e a prova di errore.
>
> **Contesto (Context):**
>
...
> **Compito (Task):**
>
> 1. **Scrivi il Codice VBA:** Crea una macro completa per risolvere questo specifico problema.
> 2. **Aggiungi Commenti:** Spiega ogni singola riga di codice in italiano semplice, così posso capire esattamente cosa fa il programma.
> 3. **Guida Utente:** Spiega passo-passo come inserire ed eseguire questo codice in Excel (es. "Premi Alt + F11, poi...") come se stessi parlando a un principiante assoluto.
> 4. **Gestione Errori:** Aggiungi un sistema di sicurezza (Error Handling) per gestire file mancanti, nomi di fogli errati o imprevisti senza far bloccare Excel.
>
...
> **Vincoli (Constraints):**
>
> - Non usare funzioni deprecate. Assicurati che il codice sia compatibile con le ultime versioni di Excel.
...
### ❌ Prima (Processo Manuale e Logorante)

```text
Apri il file 1 -> Seleziona A1:G50 -> Copia -> Vai al file Master -> Incolla -> Chiudi il file 1
Apri il file 2 -> Seleziona A1:G50 -> Copia -> Vai al file Master -> Incolla -> Chiudi il file 2
... (Ripeti 100 volte) -> Fai un errore di distrazione alla riga 73 -> Devi ricominciare da capo -> Esci dall'ufficio alle 20:00 🌙
```
...
Sub CombineSheets()
    ...
    ' Cambia solo questo percorso con la cartella dei tuoi report!
    Path = "C:\Report\"
    Filename = Dir(Path & "*.xlsx")

    Do While Filename <> ""
        ' L'IA apre i file, copia e chiude tutto in background in un decimo di secondo
        Workbooks.Open Filename:=Path & Filename, ReadOnly:=True
        ' [Codice di elaborazione e formattazione magica]
        Filename = Dir()
    Loop

    MsgBox "Tutto fatto! Ottimo lavoro, puoi andare a casa presto! 🎉", vbInformation
End Sub
```
...
Il tuo tempo e la tua intelligenza sono troppo preziosi per essere sprecati facendo il "copia-incolla" umano. Delega i compiti meccanici e ripetitivi all'Intelligenza Artificiale.

Inizia a trasformare lavori snervanti da 3 ore in operazioni fulminee da 3 secondi, e preparati a essere riconosciuto come il vero **"Genio dell'Ufficio"**.

Stasera il brindisi lo offri tu. 🍷
