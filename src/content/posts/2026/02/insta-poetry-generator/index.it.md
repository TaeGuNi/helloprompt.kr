...
> **Contesto (Context):**
>
> - Sfondo: Ho bisogno di una poesia breve e di grande impatto visivo da inserire nel mio feed di Instagram o come testo in sovrimpressione per un Reel/Short.
> - Obiettivo: Catturare l'attenzione dell'utente in meno di 3 secondi, generando forte empatia, salvataggi del post e condivisioni.
>
> **Informazioni di Input:**
>
> - **Tema:** `[es.: Il lunedì mattina in ufficio, La dieta, Una cotta non dichiarata, Una birra tornando a casa]`
> - **Tono e Stile:** `[es.: Spiritoso e ironico, Profondamente empatico, Brutalmente onesto, Caldo e confortante]`
>
> **Richiesta (Task):**
>
> 1. Scrivi **3 Poesie Brevi** basate sul tema fornito. (Massimo 5 righe ciascuna).
> 2. **Stile 1 (Ironia/Colpo di Scena):** Un approccio sagace che faccia sorridere o riflettere con un finale inaspettato.
> 3. **Stile 2 (Emozione/Conforto):** Un approccio intimo e caloroso, pensato per confortare una mente stanca.
> 4. Fornisci **5 Hashtag** altamente pertinenti e un **Concetto per l'Immagine di Sfondo** per ogni poesia.
>
> **Vincoli (Constraints):**
>
> - Non usare un linguaggio forbito o accademico. Crea una risonanza profonda utilizzando parole della vita quotidiana.
> - Utilizza le interruzioni di riga (a capo) in modo strategico per dare un ritmo visivo e poetico alla lettura.
...
### ❌ Prima (Input: La dieta, senza prompt strutturato)

"Devo perdere peso, ma ho troppa fame per resistere al cibo."

### ✅ Dopo (Risultato con Stile 1: Ironia/Colpo di Scena)

**[Il Cervello e lo Stomaco]**

Il cervello dice:
"Lo so, dobbiamo resistere."

Lo stomaco risponde:
"Io non so niente."

Solo per oggi,
scegliamo la pace (e la pizza).

_(Concetto Immagine: Un'insegna al neon spenta in una strada piovosa o una scatola di pizza mezza aperta illuminata da una luce calda, scattata in stile polaroid.)_
_(Hashtag: #DietaDaDomani #IroniaPortamiVia #PensieriNotturni #CiboAMe #VitaVera)_
