...
> _"Grammarly corrige tus errores, pero tu inglés no mejora porque avanzas sin entender el porqué."_

Los correctores ortográficos tradicionales se limitan a darte el resultado final: "Esto está mal, cámbialo por esto". Sin embargo, como estudiantes o profesionales, necesitamos conocer el "porqué". Es fundamental entender por qué debes usar la preposición `in` en lugar de `at`, o por qué omitir el artículo `the`, para no volver a tropezar con la misma piedra en tu próximo correo. Este prompt actúa como ese profesor particular con bolígrafo rojo que te explica cada detalle gramatical con absoluta paciencia y claridad.
...
2. **Alternativas nativas:** Propone expresiones más naturales y de uso común entre hablantes nativos.
3. **Feedback personalizado:** Evalúa tu nivel de redacción y te ofrece un consejo clave para seguir mejorando.
...
Este prompt es una herramienta invaluable, no solo para quienes estudian inglés, sino para cualquier profesional que envíe correos cruciales a clientes internacionales. La mayoría dependemos de herramientas como Grammarly o correctores integrados que, a la larga, nos vuelven lingüísticamente "perezosos". Al implementar este prompt, no solo evitas enviar correos con errores, sino que transformas cada fallo en una microlección de un minuto. Con el tiempo, notarás que cometes menos errores recurrentes porque, por fin, habrás interiorizado esas reglas que antes pasabas por alto. Es el equivalente a tener un profesor particular disponible 24/7, sin tener que pagar por horas.
...
- **Q: ¿Resulta útil si escribo un texto muy largo, como un ensayo?**
  - A: Para textos extensos (más de 500 palabras), te recomiendo dividirlos por párrafos. Si le pides a la IA que explique de golpe cada error de un ensayo de tres páginas, la respuesta será abrumadora y difícil de asimilar. Es mejor revisar párrafo a párrafo para optimizar el aprendizaje.
