...
## 🚀 A Solução: "Escritor de E-mail de Negociação Salarial"

### 🥉 Basic Version (Versão Básica)

Use esta versão quando precisar de um rascunho rápido para se inspirar.
...
Use esta versão quando precisar de um e-mail detalhado, polido e pronto para enviar, adaptado à sua situação específica.

Copie o conteúdo do **PROMPT** abaixo e use-o.

> **Role (Papel):** Você é um estrategista de carreira sênior e um mestre em comunicação corporativa.
>
> **Context (Contexto):**
>
> - Objetivo: Quero enviar um e-mail para solicitar uma reunião de negociação salarial com meu gestor direto, `[Nome do Gestor]`.
> - Tópico Principal: Revisão do meu desempenho ao longo deste ano e discussão sobre o ajuste salarial e de benefícios para o próximo ciclo.
> - Minha Conquista Principal: `[Sua Conquista: ex. - Conduzi o projeto X que resultou em 20% de redução de custos operacionais]`
> - Tom de Voz: Educado, colaborativo e positivo, mas declarando de forma firme e inabalável que o propósito da reunião é a 'Revisão de Remuneração'.
>
> **Task (Tarefa):**
>
> 1. Escreva uma Linha de Assunto (Subject) que seja profissional, clara e impossível de ser ignorada.
> 2. No corpo do e-mail, sugira de forma natural um horário de reunião, vinculando o pedido à minha conquista principal deste ano.
> 3. `[Importante]` Não mencione nenhum valor numérico específico ou porcentagem de aumento no e-mail. O objetivo é induzir uma discussão cara a cara.
> 4. `[Espaços em Branco]` Deixe espaços entre colchetes para as informações que eu preciso preencher (como datas e horários sugeridos).
>
> **Constraints (Restrições):**
>
> - O e-mail deve ser conciso o suficiente para ser lido e compreendido em menos de 1 minuto (máximo de 3 parágrafos curtos).
> - Não use uma linguagem excessivamente submissa ou arrogante. Mantenha o tom estritamente corporativo.
...
### ❌ Antes (Direto, Emocional e Inadequado)

```text
Assunto: Sobre o meu salário

Olá Líder,
Acho que o meu salário está muito baixo comparado ao mercado e às minhas responsabilidades.
Estou trabalhando muito ultimamente. Podemos conversar sobre um aumento?
```
...
Prezado [Nome do Gestor],

Gostaria de agendar uma breve reunião na próxima semana para discutirmos meu desenvolvimento e as perspectivas para o próximo ciclo.

Com a recente conclusão do projeto [Sua Conquista], acredito que este seja um excelente momento para revisarmos meus resultados do ano e alinharmos as expectativas de remuneração daqui para frente.

Você teria disponibilidade para conversarmos na [Dia da Semana] às [Horário] ou [Dia da Semana] às [Horário]?

Atenciosamente,
[Seu Nome]
```

_(Reação do Gestor: Vê profissionalismo, reconhece a conquista mencionada e entende que a conversa será baseada em fatos e mérito.)_
