...
## 🚀 La Solution : "Le Styliste Météo OOTD"
...
> **Contexte (Context) :**
>
> - Météo du jour : `[Température matinale]` le matin, `[Température maximale]` l'après-midi. `[Probabilité de pluie / Humidité / Vent]`.
> - Occasion : `[Ex: Réunion client importante / Sortie entre amis / Télétravail puis sport]`.
> - Mon style habituel : `[Ex: Minimaliste, Chic décontracté, Streetwear, Bohème]`.
> - Ma garde-robe : `[Ex: J'ai surtout des tons neutres, j'aime superposer les vêtements, je ne porte pas de jupes]`.
>
> **Requête (Task) :**
>
...
```text
Prompt : Que dois-je porter aujourd'hui, il fait 15 degrés et il pleut.

Résultat IA : Vous devriez porter un pantalon, un pull, un imperméable et des bottes de pluie. N'oubliez pas votre parapluie.
```
...
```text
Résultat IA :
🌟 Votre OOTD : L'Élégance Imperméable

Défi Météo du Jour : La température de 15°C est douce, mais la pluie et l'humidité exigent des matières qui sèchent vite et coupent l'humidité.

👗 La Tenue :
- Haut : Un pull fin en laine mérinos col rond (bleu marine). La laine mérinos régule la température et reste chaude même légèrement humide.
- Bas : Un pantalon chino coupe droite déperlant (beige ou kaki) ou un jean avec un peu d'élasthanne pour le confort.
- Vêtements d'extérieur : Un trench-coat classique imperméabilisé. C'est l'ultime bouclier contre la pluie tout en restant chic pour votre réunion.
- Chaussures : Des bottines en cuir lisse (bien cirées pour résister à l'eau) ou des Chelsea boots. Évitez absolument le daim aujourd'hui !
- Accessoires : Un parapluie cloche transparent (très tendance) et une fine écharpe en soie pour protéger votre cou de la brise humide.

💡 Pourquoi ça marche : Les couches fines vous permettent de ne pas transpirer une fois à l'intérieur, et le trench apporte la structure et l'élégance nécessaires pour votre occasion, tout en étant purement fonctionnel contre l'averse.
```
