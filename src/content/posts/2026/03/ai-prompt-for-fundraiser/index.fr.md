...
title: "💸 Le prompt magique de collecte de fonds pour renflouer vos caisses"
author: "Jay"
date: "2026-03-01"
...
## 🚀 Solution : "Prompt de copywriting pour Lead Fundraiser"
...
> **Contexte (Context) :**
>
> - Nom de l'organisation : `[Nom de l'association ou du projet]`
> - Objectif de la collecte de fonds : `[Objectif spécifique, ex. : distribuer 100 repas chauds à des enfants démunis]`
> - Public cible : `[Profil des donateurs, ex. : jeunes cadres de 30-40 ans, donateurs réguliers, etc.]`
> - Ton et style : `[Ton souhaité, ex. : authentique et touchant, ou bien urgent et direct]`
>
> **Tâche (Task) :**
>
...
>
> - N'utilise sous aucun prétexte l'approche du « Misérabilisme » (Poverty Porn) qui se contente d'exploiter la pitié du lecteur.
> - Intègre des chiffres concrets pour illustrer clairement le changement réel qu'apportera la contribution du donateur.
>
...
### ❌ Before (Lors de la saisie d'un prompt standard)

```text
Objet : Aidez les enfants sous-alimentés

Bonjour cher donateur. Notre association organise actuellement une collecte de fonds pour aider les enfants sous-alimentés. Les enfants ont faim et c'est vraiment triste et pitoyable. Votre petite contribution sera d'un grand espoir pour ces enfants. S'il vous plaît, soutenez-nous régulièrement via le lien ci-dessous. Merci.
```

### ✅ After (Lors de l'application du prompt Pro Version)

```text
Option d'objet 1 : L'heure du déjeuner, le moment de la journée que certains redoutent le plus
Option d'objet 2 : Comment offrir une semaine d'avenir avec seulement 10 euros

Bonjour cher donateur,

Chaque jour, à midi. Pendant que nous choisissons joyeusement notre menu avec nos collègues dans la bonne humeur, 300 000 enfants à travers le pays sont assis seuls face à une table vide.

Pour mettre fin à cette faim silencieuse et douloureuse, nous lançons le projet « Un Repas Chaud ». Les 10 euros que vous nous confiez ne sont pas simplement de la nourriture pour remplir un estomac. C'est l'équivalent d'une semaine de repas équilibrés et nutritifs pour un enfant, et le pouvoir de lui offrir la force d'affronter sereinement son avenir.

Le mois dernier, grâce à ce projet, 50 enfants ont pu bénéficier d'un repas chaud et nourrissant après l'école. Cependant, il y a encore 100 enfants sur liste d'attente qui espèrent désespérément notre aide.

Votre geste d'aujourd'hui peut changer l'avenir d'un enfant.
👉 [Lien de don]

Ne vous limitez pas à de la simple compassion, investissez dans un changement concret qui transforme la vie d'un enfant. Merci.
```
