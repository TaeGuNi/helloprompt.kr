...
```text
Recommend a morning routine chart for my kid.
```

### ✅ After (Pro Prompt Output)

```text
Mission 1: The Great Slumber Escape (Defeat the Drowsiness Monster by making the bed!)
Mission 2: Sparkle Knight's Quest (Scrub away the Sugar Bugs in the bathroom cave!)
Mission 3: Superhero Suit-Up (Equip your daily armor and prepare for action!)
```
