...
> **Contexte (Context) :**
>
> - Sujet : Je viens de rédiger un article de blog sur `[Sujet/Mot-clé]`.
> - Objectif : J'ai besoin d'un titre accrocheur capable de maximiser le taux de clics (CTR) sur les moteurs de recherche et les réseaux sociaux.
>
> **Requête (Task) :**
>
> 1. Analyse le contenu central : `[Résumé bref de l'article]`
> 2. Cible : `[Profil du lecteur idéal]`
> 3. Propose 2 titres pour chacune des 5 catégories psychologiques suivantes (soit 10 titres au total) :
>    - Type A : Éveil de la curiosité (Question intrigante, mystère)
>    - Type B : Méthode concrète / Chiffres (Liste, étapes claires)
>    - Type C : Aversion à la perte / Urgence (Erreurs à éviter, danger)
>    - Type D : Preuve d'autorité / Révélation (Le secret des experts)
>    - Type E : Solution rapide et sans effort (Résultat en peu de temps, astuce facile)
>
...
### ❌ Avant (Ce que l'on fait souvent)

```text
Comment apprendre l'anglais facilement
```

### ✅ Après (Les propositions de l'IA)

```text
- Curiosité : La vraie raison pour laquelle votre niveau d'anglais stagne depuis 5 ans ?
- Chiffres/Méthode : 3 routines quotidiennes pour parler comme un natif (en 30 min/jour).
- Peur/Perte : Arrêtez d'apprendre des listes de vocabulaire par cœur (Voici pourquoi).
- Autorité : La technique de "Shadowing" secrète utilisée par les interprètes de l'ONU.
- Solution Rapide : L'astuce ultra-simple pour débloquer votre compréhension avec Netflix.
```
