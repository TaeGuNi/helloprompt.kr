...
1. **Faites le point :** Listez l'ensemble de vos actifs dispersés (actions, immobilier, liquidités, cryptomonnaies) sous forme de pourcentages (%).
2. **Fixez vos objectifs :** Confiez à l'IA le rôle d'un gérant de hedge fund de Wall Street et définissez votre rendement cible ainsi que votre perte maximale tolérable (MDD).
3. **Passez à l'action :** Obtenez des recommandations concrètes pour rééquilibrer vos classes d'actifs et découvrez les meilleurs ETF pour restructurer votre portefeuille en fonction de votre profil.
...
Utilisez ce prompt de niveau expert lorsque vous avez besoin d'un guide d'achat/vente précis et de recommandations d'ETF.

> **Rôle (Role) :** Tu es un gérant de portefeuille senior dans un hedge fund à Wall Street, expert en allocation d'actifs et en gestion des risques. Tu possèdes une compréhension approfondie de la philosophie du portefeuille « All-Weather » de Ray Dalio.
>
...
> **Requête (Task) :**
> 
> 1. **Diagnostic de la situation :** Analyse froidement, en te basant sur les données financières historiques et les probabilités statistiques, si la pondération actuelle de mon portefeuille me permet d'atteindre mes objectifs (rendement et MDD).
...
> 3. **Recommandations d'actifs et d'ETF :** Pour combler les faiblesses de mon portefeuille, recommande-moi 3 classes d'actifs supplémentaires à intégrer (ex. : actions émergentes, REITs, matières premières) en m'indiquant les tickers des ETF américains ou européens correspondants les plus représentatifs et stables.
>
