...
## 🚀 La Solución: "Tutor Matemático Paso a Paso"
...
> **Tarea (Task):**
>
> 1. Primero, define claramente los **Conceptos Clave y Fórmulas** necesarios para abordar este problema.
> 2. Explica el proceso de resolución dividiéndolo en **Pasos Lógicos Numerados** (Paso 1, Paso 2, etc.).
> 3. Cada vez que transformes una ecuación o apliques una fórmula, explica **qué principio o ley aplicaste** entre paréntesis (ej., Propiedad distributiva, Teorema de Pitágoras, despeje de X).
> 4. Al final, demuestra que la respuesta es correcta mediante un proceso de **Comprobación (Check)**.
>
...
### ❌ Before (Pregunta General sin Prompt)

> **Usuario:** "Resuelve x² - 5x + 6 = 0"

**Respuesta de la IA:** "Las soluciones son x = 2 y x = 3." (Fin de la interacción)

### ✅ After (Usando la Versión Pro)

**[Conceptos Clave]**
Para resolver esta ecuación cuadrática (de segundo grado), utilizaremos el método de **Factorización**. Esto significa que buscaremos transformar la ecuación en el producto de dos binomios que den como resultado cero.

**[Proceso de Solución]**
**Paso 1: Encontrar los factores adecuados**
Necesitamos encontrar dos números que cumplan dos condiciones al mismo tiempo:

- Que multiplicados den +6 (el término independiente).
- Que sumados den -5 (el coeficiente del término medio).

Probemos:

- (-2) × (-3) = 6 (¡Cumple la multiplicación!)
- (-2) + (-3) = -5 (¡Cumple la suma!)
  Los números que necesitamos son -2 y -3.

**Paso 2: Reescribir la ecuación factorizada**
Sustituimos los números encontrados para crear los binomios:
$$(x - 2)(x - 3) = 0$$ (Factorización del trinomio)

**Paso 3: Encontrar las soluciones (Raíces)**
Para que una multiplicación dé como resultado 0, obligatoriamente uno de los factores debe ser 0. Evaluamos ambos casos:

Caso 1:
$$x - 2 = 0$$
$$x = 2$$ (Transposición de términos: pasamos el -2 sumando al lado derecho)

Caso 2:
$$x - 3 = 0$$
$$x = 3$$ (Transposición de términos: pasamos el -3 sumando al lado derecho)
