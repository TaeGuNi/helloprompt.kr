...
> - Situation : Je vais partager un repas dans un restaurant local ou chez l'habitant.
>
> **Requête (Task) :**
>
...
```text
Quelles sont les règles à table au Japon ?
```

### ✅ Après (Résultat)

```text
🎌 Étiquette à table au Japon : Guide de survie

🚫 3 Tabous Absolus :
1. Le "Tsukitate-bashi" : Ne plantez jamais vos baguettes verticalement dans votre bol de riz (cela rappelle les rituels funéraires bouddhistes).
2. Le "Hiroi-bashi" : Ne passez jamais de nourriture de baguettes à baguettes (également lié aux rites funéraires).
3. La sauce soja : Ne versez jamais la sauce soja directement sur le riz blanc, trempez plutôt les aliments dans une petite coupelle.

🍽️ Posture et Couverts :
- Le bol : Contrairement à l'Occident, il est recommandé de soulever son bol de riz ou de soupe près de sa bouche.
- Les bruits : Aspirer bruyamment vos nouilles (ramen, soba) n'est pas impoli ; c'est un signe que vous appréciez le plat et cela aide à refroidir les nouilles.

🗣️ Formules de Politesse :
- Avant le repas : "Itadakimasu" (Je reçois humblement ce repas).
- Après le repas : "Gochisousama deshita" (Merci pour ce festin).
```
