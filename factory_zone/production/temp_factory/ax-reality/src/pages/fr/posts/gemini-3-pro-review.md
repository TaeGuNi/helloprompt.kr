...
Étonnamment, il ne s'est pas contenté de nous lancer du code ; il a expliqué _pourquoi_ la vectorisation est plus rapide du point de vue de la disposition en mémoire.
