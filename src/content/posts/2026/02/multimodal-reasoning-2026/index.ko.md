...
- **⏱️ 소요 시간:** 1시간 → 3분 단축
- **🤖 추천 모델:** GPT-4o, Claude 3.5 Sonnet, Gemini 2.5 Pro (비전 인식 가능 모델)
...
- **Q: 회의 녹음 같은 음성 파일도 같이 넣을 수 있나요?**
  - A: 모델에 따라 다릅니다. Gemini 2.5 Pro나 GPT-4o 같은 최신 네이티브 멀티모달 모델은 회의 녹음 파일(음성)과 화이트보드 사진을 동시에 넣고 "이 음성 회의 내용과 스케치를 합쳐서 기획서로 써줘"라고 지시하는 것도 완벽하게 수행합니다.
