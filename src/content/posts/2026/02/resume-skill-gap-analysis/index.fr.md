...
| Exigence JD | Statut | Commentaire / Écart (Gap) |
| :--- | :---: | :--- |
| Anglais courant (Business) | ⚠️ Gap | Aucun score TOEIC/TOEFL mentionné sur le CV. |

💡 **Stratégie de Compensation**
Ne pas avoir de certification linguistique n'est pas rédhibitoire si vous prouvez la compétence autrement.
- *Action pour le CV / Lettre :* Mettez en avant votre expérience chez [Entreprise Précédente] où vous gériez quotidiennement les communications par e-mail avec les fournisseurs asiatiques et américains.
- *Entretien :* Préparez une anecdote précise sur la résolution d'un problème complexe en anglais. Proposez de mener une partie de l'entretien en anglais pour rassurer le recruteur.

🎯 **Probabilité de Succès : 75/100**
Votre adéquation technique est excellente. Le seul frein majeur est la validation de votre niveau linguistique. Si vous appliquez la stratégie ci-dessus, vous avez de fortes chances d'obtenir un entretien.
```
