...
> **Kontext (Context):**
>
> - Reiseziel: `[Bangkok, Thailand]`
> - Dauer: `[5 Tage]`, ab dem `[20. Dezember]`
> - Hauptaktivitäten: `[Schwimmen im Hotelpool, Besichtigung des Grand Palace, Besuch einer Rooftop-Bar]`
> - Begleitung: `[2 Freunde]`
>
> **Aufgabe (Task):**
>
> 1. Empfiehl mir die passenden Kleidungsstücke unter Berücksichtigung des erwarteten Wetters in `[Bangkok]` während meines Reisezeitraums. Achte dabei besonders auf kulturelle Dresscodes (z. B. für den Grand Palace).
> 2. Erstelle eine 'Essenzielle Checkliste' und gliedere sie in die folgenden Kategorien:
>    - 📄 Dokumente & Wertsachen (Reisepass etc.)
>    - 👕 Kleidung & Schuhe
>    - 💊 Hygieneartikel & Reiseapotheke
>    - 🔌 Elektronik (inklusive Informationen zur lokalen Netzspannung/Steckern)
>    - ✨ 3 Geheimtipps: Gegenstände, die die Reisequalität vor Ort enorm steigern
> 3. Füge einen kurzen, aber wichtigen Warnhinweis zu Handgepäckrichtlinien oder streng verbotenen Gegenständen für dieses Reiseziel hinzu.
>
> **Einschränkungen (Constraints):**
>
> - Achte auf Minimalismus: Hilf mir, unnötigen Ballast zu vermeiden und das Gepäckgewicht zu reduzieren.
> - Das Ausgabeformat MUSS eine Markdown-Checkbox-Liste (`- [ ]`) sein, damit ich sie ausdrucken und direkt abhaken kann.
>
> **Warnung (Warning):**
>
> - Erfinde keine Gepäckrichtlinien oder Visabestimmungen. Wenn du dir unsicher bist, weise mich darauf hin, die offiziellen Behördenseiten zu prüfen. (Vermeidung von Halluzinationen)
...
```text
Schreib mir eine Packliste für Bangkok.
```

### ✅ Nachher (Ergebnis)

```text
- [ ] Reisepass (Gültigkeit prüfen: mindestens 6 Monate)
- [ ] Lange, leichte Stoffhose (Zwingend erforderlich für den Grand Palace)
- [ ] Schulterbedeckendes T-Shirt oder Bluse (Für Tempelbesuche)
- [ ] Smart-Casual Hemd/Kleid (Für die Rooftop-Bar, keine Flip-Flops!)
- [ ] Universal-Reiseadapter (Thailand nutzt Stecker Typ A, B, C und O, meist 220V)
- [ ] Mückenspray mit hohem DEET-Anteil (Essenziell gegen Dengue)
✨ Geheimtipp: Ein wasserdichter Dry-Bag für den Pool oder plötzliche tropische Schauer!
```
