...
- **🤖 Modello Consigliato:** Claude 3.5 Sonnet (Migliore per il Tone of Voice aziendale)
...
## 🚀 Soluzione: "Il Costruttore di Scuse Professionali"
...
> **Contesto (Context):**
>
> - **Destinatario:** `[Dott. Rossi, Key Client del progetto X]`
> - **Incidente:** `[Consegna del progetto in ritardo di 3 giorni rispetto alla scadenza pattuita]`
> - **Causa Reale:** `[Un bug improvviso ha corrotto il database, costringendoci a ripristinare un backup precedente]`
> - **Soluzione Immediata:** `[Abbiamo allocato 2 sviluppatori senior extra, lavoreranno nel weekend a nostre spese. Consegna garantita lunedì mattina]`
>
> **Richiesta (Task):**
>
> Scrivi un'**Email Ufficiale di Scuse** basandoti sulle informazioni fornite, che risulti estremamente professionale, sincera e orientata alla soluzione.
>
...
> **Oggetto: Scuse ufficiali in merito al ritardo della consegna del progetto X e piano di risoluzione**
>
> Gentile Dott. Rossi,
>
> Le scrivo per porgerle le nostre più sincere scuse per il ritardo nella consegna del progetto, originariamente prevista per oggi.
>
> Sebbene un malfunzionamento critico del database ci abbia costretti a ripristinare un backup precedente, riconosciamo che è stata una nostra mancanza non aver predisposto un sistema di ridondanza tale da evitare ripercussioni sulle Sue tempistiche. Ci assumiamo la piena responsabilità dell'accaduto.
>
> **[Il nostro piano d'azione immediato]**
> Per assicurarci di ridurre al minimo l'impatto sul Suo lavoro, abbiamo già implementato le seguenti misure d'emergenza:
>
> - Abbiamo allocato due sviluppatori senior aggiuntivi dedicati esclusivamente al Suo progetto.
> - Il team lavorerà in via straordinaria durante il fine settimana (i costi extra saranno totalmente a nostro carico).
> - Le garantiamo la consegna completa e testata per lunedì mattina alle 09:00.
>
> Mi assicurerò personalmente di monitorare lo stato di avanzamento e Le invierò un aggiornamento formale domani pomeriggio.
>
> La ringrazio per la pazienza e per la fiducia.
