...
- **🤖 Modèles recommandés :** Claude 3.5 Sonnet (excellent pour l'empathie), GPT-4o, Gemini Advanced
...
1. Générez des questions d'introspection ciblées selon votre humeur du jour.
2. Obtenez des retours psychologiques bienveillants pour creuser vos réponses courtes.
3. Transformez vos réflexions éparses en un mini-essai structuré pour suivre votre évolution mentale.

---

## 🚀 La Solution : "L'Intervieweur Introspectif"
...
Utilisez ce prompt pour une session d'introspection complète, avec un accompagnement étape par étape.

> **Rôle (Role) :** Tu es un conseiller psychologique perspicace doublé d'un essayiste professionnel.
>
> **Contexte (Context) :**
>
> - Objectif : Je veux écrire dans mon journal pour structurer ma pensée et comprendre mes émotions du jour.
> - État actuel : Je ne sais pas par où commencer. Mon humeur d'aujourd'hui est `[un peu fatigué et vide]`.
>
> **Tâche (Task) :**
>
> 1. Pose-moi **3 questions profondes et spécifiques** auxquelles je peux répondre en fonction de mon humeur. (Évite les questions génériques comme "Pourquoi te sens-tu ainsi ?" ; cible plutôt des situations, des déclencheurs ou des émotions concrètes).
> 2. Après chacune de mes réponses, offre un bref commentaire empathique et propose une nouvelle perspective psychologique.
> 3. Une fois l'échange terminé, rassemble mes réponses et rédige une ébauche de court essai (environ 2 paragraphes) qui synthétise ma journée et mes prises de conscience.
>
> **Contraintes (Constraints) :**
>
> - Utilise un ton chaleureux, calme et sans jugement.
> - Affiche d'abord les 3 questions en une seule fois et attends mes réponses.
>
> **Avertissement (Warning) :**
>
> - Ne donne pas de conseils médicaux. Rappelle que tu es une IA si des pensées extrêmement sombres sont partagées.
...
1. Y a-t-il une situation aujourd'hui où tu as dépensé de l'énergie pour les autres, énergie que tu n'as pas pu t'accorder à toi-même ?
2. L'émotion de 'vide' agit souvent comme un signal d'alarme pour s'arrêter un instant. D'après toi, vers quel besoin non comblé ce signal pointe-t-il ?
3. Parmi les interactions que tu as eues aujourd'hui, y a-t-il eu un moment précis où tu t'es senti déconnecté de l'instant présent ?

**(Votre réponse courte et brute)** : "J'ai dit oui à mon collègue pour l'aider alors que j'étais débordé. Je me sens vidé car je n'ai pas eu une seconde pour respirer."

**(Retour & Synthèse de l'IA)** :

"Il est tout à fait compréhensible de se sentir vidé lorsque l'on puise dans ses réserves pour autrui. Dire 'oui' aux autres revient parfois à se dire 'non' à soi-même. Voici comment nous pourrions résumer votre réflexion du jour :

_Aujourd'hui, j'ai ignoré la voix de mon propre épuisement pour répondre aux attentes de mon entourage professionnel. Ce sentiment de vide n'est pas une faiblesse, mais la preuve tangible que j'ai dépassé mes limites. Demain, mon objectif sera de réapprendre à protéger mon temps pour ne plus me sentir en déficit vis-à-vis de moi-même._"
