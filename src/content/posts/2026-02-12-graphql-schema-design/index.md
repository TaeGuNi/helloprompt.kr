...
# (Updated) (Updated) (Updated) 🕸️ GraphQL 스키마 설계: REST API에서 넘어오기 {#updated}
...
## (Updated) (Updated) (Updated) 🚀 해결책: "Schema Designer Prompt" {#updated}

### (Updated) (Updated) (Updated) 🥉 Basic Version (REST 변환) {#rest}
...
### (Updated) (Updated) (Updated) 🥇 Pro Version (N+1 문제 해결 & 엣지 케이스) {#n-1}
...
### (Updated) (Updated) (Updated) ❌ Before (REST)

API 3번 호출: `/user`, `/posts`, `/comments` (네트워크 왕복 3회 🐢)

### (Updated) (Updated) (Updated) ✅ After (GraphQL)
