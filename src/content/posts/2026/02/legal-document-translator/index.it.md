...
## 🚀 La Soluzione: "Il Tuo Avvocato Tascabile"

### 🥉 Basic Version (Versione Base)

Usala quando hai bisogno di capire velocemente il succo del discorso.
...
Usala per un'analisi approfondita e per prepararti a una negoziazione. Copia il contenuto del prompt qui sotto e incollalo nel tuo modello IA preferito.

> **Ruolo (Role):** Sei un `[Avvocato Esperto in Diritto Civile]`, specializzato nella tutela dei consumatori e dei lavoratori.
>
> **Situazione (Context):**
>
> - Background: Sto per firmare un `[Contratto di Locazione / Contratto di Collaborazione / Termini di Servizio]`, ma il linguaggio è eccessivamente tecnico e oscuro.
> - Obiettivo: Voglio assicurarmi di non firmare nulla che possa ledere i miei diritti o mettermi in una posizione di netto svantaggio.
>
> **Richiesta (Task):**
>
> 1. Analizza la clausola contrattuale fornita di seguito e spiegala con parole semplici e chiare, comprensibili anche a un bambino di 10 anni.
> 2. Individua la presenza di eventuali "clausole vessatorie", trappole legali o fattori di rischio che potrebbero danneggiarmi in quanto `[Inquilino / Freelance / Utente]`.
> 3. Se la clausola risulta sbilanciata a favore della controparte, suggerisci una formulazione alternativa o una modifica da proporre per tutelare i miei interessi.
>
> **Clausola da analizzare (Variable):**
> "Articolo 5 (Risoluzione del Contratto): Qualora la 'Parte B' violi le disposizioni del presente contratto, la 'Parte A' si riserva il diritto di risolvere immediatamente l'accordo, e la 'Parte B' rinuncia sin d'ora a sollevare qualsiasi eccezione in merito."
>
> **Limitazioni (Constraints):**
>
> - Non utilizzare gergo legale senza averlo prima spiegato con un esempio pratico.
> - Mantieni l'output strutturato con elenchi puntati per facilitare la lettura rapida.
>
> **Avvertenza (Warning):**
>
> - Precisa sempre all'inizio della tua risposta che l'analisi generata non sostituisce una consulenza legale professionale e non ha valore giuridico.
...
```text
Cosa significa questa clausola? È un male per me?
"Articolo 5 (Risoluzione del Contratto): Qualora la 'Parte B' violi le disposizioni del presente contratto, la 'Parte A' si riserva il diritto di risolvere immediatamente l'accordo, e la 'Parte B' rinuncia sin d'ora a sollevare qualsiasi eccezione in merito."
```
...
```text
⚠️ **Avvertenza:** Questa analisi ha scopo informativo e non sostituisce il parere di un legale professionista.

**Spiegazione semplice (per un bambino di 10 anni):**
Immagina di giocare a un gioco con un amico. Questa regola dice che se tu (Parte B) infrangi anche una sola piccola regola, il tuo amico (Parte A) può prendere il pallone e finire la partita all'istante. E la cosa peggiore è che tu hai già promesso di non lamentarti in nessun caso, anche se ritieni di avere ragione.

🚨 **Clausole Vessatorie e Rischi:**
Sì, questa clausola è **molto sbilanciata e pericolosa** per te.
- **Risoluzione immediata:** La controparte può chiudere il contratto senza darti il tempo materiale per rimediare a un piccolo errore o disguido.
- **Rinuncia alle eccezioni:** Ti toglie il diritto di difenderti. Nel diritto italiano, rinunciare preventivamente a difendersi è spesso considerata una clausola "vessatoria" e potrebbe essere nulla, ma accettarla ti mette in netto svantaggio negoziale.

✍️ **Suggerimento di Modifica (Da proporre alla controparte):**
"Articolo 5: Qualora la Parte B violi le disposizioni contrattuali, la Parte A dovrà inviare un preavviso scritto concedendo 15 giorni lavorativi per rimediare alla violazione. Solo in caso di mancata risoluzione del problema entro tale termine, la Parte A potrà risolvere l'accordo. Restano salvi i diritti di difesa e di eccezione di entrambe le parti."
```
