...
```text
Buongiorno,
sono in attesa dei dati. Per favore rispondetemi velocemente perché è urgente e siamo in ritardo.
Saluti.
```
...
```text
Oggetto: Promemoria gentile: Materiali necessari per [Nome Progetto]

Gentile [Nome Partner],

Spero che questa email la trovi bene. Immagino che questo sia un periodo particolarmente denso di impegni per lei e per il suo team.

La contatto semplicemente per un rapido aggiornamento in merito ai [Nome Materiale Richiesto] relativi al [Nome Progetto], che avevamo richiesto nei giorni scorsi.

Per permetterci di rispettare le tempistiche condivise e procedere con le prossime fasi senza intoppi, avremmo bisogno di ricevere i materiali entro il [Data di Scadenza].

Se ha bisogno di ulteriori chiarimenti da parte nostra o se c'è qualcosa in cui possiamo supportarla per agevolare l'invio, non esiti a farmelo sapere.

La ringrazio in anticipo per la preziosa collaborazione.
