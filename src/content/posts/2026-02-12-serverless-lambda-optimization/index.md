...
# (Updated) (Updated) ⚡️ 서버리스(Serverless) 최적화: AWS Lambda 콜드 스타트 해결법 {#serverless}
...
## (Updated) (Updated) 🚀 해결책: "Lambda Tuner Prompt"

### (Updated) (Updated) 🥉 Basic Version (메모리 튜닝)
...
### (Updated) (Updated) 🥇 Pro Version (코드 레벨 최적화 & 스냅샷)
...
### (Updated) (Updated) ❌ Before (통통한 람다)

`import AWS from 'aws-sdk'` (전체 로드) -> 용량 50MB -> 콜드 스타트 1.5초 🐢

### (Updated) (Updated) ✅ After (날씬한 람다)
