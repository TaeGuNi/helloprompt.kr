...
> **Situación (Context):**
>
> - Tarea actual: Hago `[Tarea Repetitiva: ej., Copiar hojas 'Resumen' de 100 archivos diferentes a un archivo maestro]` todos los días.
> - Problema: Me toma demasiado tiempo y es propenso a errores humanos. Quiero automatizar todo el proceso.
>
> **Tarea (Task):**
>
> 1. Crea un código VBA completo (macro) para ejecutar esta tarea con un solo clic.
> 2. Añade comentarios explicativos en cada línea para que pueda entender qué hace el código, aunque no sepa programar.
> 3. Incluye una guía paso a paso explicando cómo insertar y ejecutar este código en Excel (ej., presionar Alt + F11, insertar módulo) como si le hablaras a un principiante.
> 4. Añade manejo de errores para evitar que la macro falle si falta algún archivo o hay datos incorrectos.
>
> **Estructura de Datos (Entrada):**
>
> - Ruta de la carpeta principal: `[ej., C:\Reportes\ (todos los archivos .xlsx)]`
> - Nombre de la hoja de cálculo: `[ej., 'Resumen']`
> - Rango de celdas a procesar: `[ej., A1:G50]`
>
> **Restricciones (Constraints):**
>
> - El código debe ser compatible con las versiones más recientes de Excel.
...
```text
Abrir archivo 1 -> Copiar rango -> Abrir archivo maestro -> Pegar -> Cerrar archivo 1 ->
Abrir archivo 2 -> Copiar rango -> ... (Repetir 100 veces) -> Salir de la oficina tarde 🌙
```

### ✅ Después (Macro impulsada por IA)

```text
' ¡Combina 100 archivos con un solo clic!
Sub CombineSheets()
    Dim Path As String, Filename As String

    Path = "C:\Reportes\" ' ¡Solo cambia esta ruta por la tuya!
    Filename = Dir(Path & "*.xlsx")

    Do While Filename <> ""
        ' (Código mágico generado por la IA...)
        Workbooks.Open Filename:=Path & Filename, ReadOnly:=True
        ' ...
        Filename = Dir()
    Loop

    MsgBox "¡Proceso terminado! ¡Vete a casa temprano! 🎉"
End Sub
```
