...
1. **Pianificazione Micro-strutturata:** Suddivide argomenti complessi in task giornalieri facilmente digeribili.
2. **Apprendimento Orientato all'Azione:** Privilegia la pratica (regola 80/20) rispetto alla noiosa teoria passiva.
3. **Prevenzione del Burnout:** Include momenti di ripasso strategico e traguardi raggiungibili per mantenere alta la dopamina.

---

## 🚀 La Soluzione: "Prompt Generatore di Roadmap"
...
Usala per ottenere un curriculum dettagliato, su misura per il tuo livello e i tuoi obiettivi specifici.

> **Ruolo (Role):** Agisci come un Senior Instructional Designer e un Tutor Esperto specializzato in apprendimento accelerato.
>
> **Contesto (Context):**
>
> - Background: Sono un `[Tuo Livello Attuale, es. principiante assoluto / studente intermedio]` con a disposizione circa `[Ore al Giorno]` ore al giorno per lo studio.
> - Obiettivo: Voglio imparare `[Argomento o Competenza]` per riuscire a `[Obiettivo Finale, es. creare un sito web / superare un test / conversare in spagnolo]`.
>
> **Richiesta (Task):**
>
> 1. Crea una roadmap di apprendimento ultra-dettagliata di `[3 giorni / 3 settimane]`.
> 2. Applica il Principio di Pareto (80/20): concentrati sul 20% dei concetti che mi daranno l'80% dei risultati.
> 3. Per ogni giorno, fornisci:
>    - **Focus Principale:** L'argomento chiave della giornata.
...
> **Vincoli (Constraints):**
>
> - Formatta il piano utilizzando il Markdown, suddividendo chiaramente i giorni.
> - Usa un tono motivante e diretto. Non inserire argomenti teorici superflui o accademici.
>
> **Attenzione (Warning):**
>
> - Se l'obiettivo finale è irrealistico per il lasso di tempo indicato, avvisami subito e proponi una versione semplificata dell'obiettivo.
...
```text
Voglio imparare Python. Cosa devo fare in 3 settimane?
```

_(Risultato tipico: un lungo e noioso elenco di concetti teorici, dai cicli alle classi, senza alcun esercizio pratico strutturato o stima del tempo)._

### ✅ Dopo (Risultato con la Pro Version)

```text
### Settimana 1: Le Fondamenta (Il 20% che genera l'80% dei risultati)

**Giorno 1: Variabili e Stampa a Schermo**
- 🎯 **Focus:** Far parlare il computer.
- 📚 **Teoria (20%):** Sintassi di `print()`, tipi di dati base (stringhe, interi).
- 🛠️ **Pratica (80%):** Scrivi uno script che stampa un biglietto da visita digitale con il tuo nome, età e professione.
- 🧪 **Verifica:** Se provi a sommare "10" (stringa) e 5 (numero), cosa succede e perché?
```
