...
## 🚀 A Solução: "Prompt Escudo de Privacidade Wi-Fi"
...
```text
Usuário: Ouvi dizer que dá pra espionar pessoas pelo Wi-Fi. Como eu bloqueio isso?

IA: Para evitar invasões no seu Wi-Fi, configure uma senha complexa e não se conecte a redes desconhecidas. (Resposta genérica e totalmente fora do foco do problema do sensoriamento)
```
...
```text
IA:
🛡️ Guia de Defesa e Análise de Vulnerabilidades Wi-Fi para [Sala de reuniões de uma startup que lida com dados confidenciais]
