...
- **🤖 Modello Consigliato:** DeepL (per la bozza) + ChatGPT-4o / Claude 3.5 (per le sfumature)
...
## 🚀 Soluzione: Prompt "Lucidatore di Sfumature"

### 🥉 Basic Version (Versione Base)

Ideale quando hai bisogno di rendere un'email rapida più cortese e professionale senza perdere tempo.

> **Ruolo (Role):** Agisci come un Esperto di Etichetta Commerciale USA.
>
...
Perfetta per situazioni delicate che richiedono tatto: Rifiuti, Scuse o Negoziazioni sui prezzi.

> **Ruolo (Role):** Agisci come un Senior Global Communication Consultant con un MBA ad Harvard.
>
> **Contesto (Context):**
>
> - Destinatario: Partner commerciale estero con cui abbiamo un rapporto consolidato.
> - Obiettivo: La loro proposta tecnica è ottima, ma il prezzo è fuori budget. Voglio ottenere uno sconto del 10% mantenendo ottimi i rapporti.
> - La Mia Bozza: `Your proposal is good. But price is expensive. Discount 10% please.`
>
> **Richiesta (Task):**
>
> Riscrivi la mia bozza trasformandola in un'email commerciale naturale, persuasiva ed elegante.
>
> **Condizioni (Constraints):**
>
> 1. Tono: Gentile, collaborativo, ma fermo sulla questione economica.
> 2. Strategia (Tecnica Sandwich): Inizia riconoscendo il grande valore della proposta, inserisci il vincolo di budget come motivazione logica, e concludi invitandoli a rivedere il prezzo per poter procedere insieme.
> 3. Formato di Output: Restituisci l'Oggetto (Subject) e il Corpo dell'Email. Fornisci due varianti (una più diretta, una più diplomatica).
...
### ❌ Before (Bozza Diretta e Scortese)

```text
Subject: Discount needed

Hi, your proposal is good. But the price is too expensive for us. Discount 10% please, then we can sign.
```

### ✅ After (Risultato dell'IA - Tono Professionale ed Elegante)

```text
Subject: Exploring next steps regarding your recent proposal

Dear [Name],

Thank you for sending over the detailed proposal. We are genuinely impressed with the quality of your approach and believe your solution aligns perfectly with our technical goals.

While we are eager to move forward, our current budget constraints make the proposed pricing a bit challenging for us. Would it be possible to explore a 10% adjustment to the overall cost? This would allow us to secure the necessary internal approvals and proceed with the partnership immediately.
