...
> **Contesto (Context):**
>
> - Situazione: Sono un dipendente con `[Inserisci anni]` anni di esperienza e stiamo negoziando il mio adeguamento salariale per il prossimo anno.
> - Obiettivo: Aumentare il mio stipendio attuale da `[Stipendio Attuale]` a `[Stipendio Desiderato]`.
>
> **Le Mie Carte / Performance (Input):**
>
> 1. `[Performance 1: es. Ho superato l'obiettivo di vendita annuale del 120%]`
> 2. `[Performance 2: es. Ho guidato con successo il lancio del nuovo progetto X riducendo i costi del 15%]`
>
> **Regole del Gioco (Task & Constraints):**
>
...
### ❌ Before (Appello Emotivo e Debole)

```text
Io: "Ho lavorato davvero tantissimo quest'anno, facendo spesso gli straordinari non pagati. Spero davvero possiate alzarmi lo stipendio, anche perché l'affitto e il costo della vita sono aumentati..."
HR: "Apprezziamo il tuo impegno, ma le policy aziendali quest'anno sono molto rigide a causa dell'inflazione. Non possiamo fare eccezioni per nessuno." (Fine della negoziazione)
```

### ✅ After (Dati, Logica e Strategia)

```text
Io: "Nel Q3 ho superato i target del 120%, generando un extra profitto documentato di 50.000€. Considerando che la media di mercato per le mie attuali mansioni è superiore del 15% rispetto al mio inquadramento, un adeguamento del 10% è un investimento ragionevole per l'azienda per mantenere questo livello di performance."
HR: "Un 10% è fuori policy per questo trimestre. Tuttavia, vista la documentazione sui 50.000€ extra che hai portato, posso presentare al Direttore una proposta per un 7% fisso più un bonus una tantum legato ai prossimi obiettivi."
```
