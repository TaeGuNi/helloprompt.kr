...
## 🚀 A Solução: "Arquiteto de Orçamentos de Viagem"
...
```text
Quanto custa ir para Osaka por 4 dias e 3 noites?
```

### ✅ After (Resultado com o Prompt)

```text
### ✈️ Estimativa de Orçamento: Osaka 4 Dias / 3 Noites (Por Pessoa)

| Categoria | Detalhe | Valor Esp. (BRL) | Valor Local (JPY) |
| :--- | :--- | :--- | :--- |
| **Voo** | Low Cost (Ida e Volta) | R$ 4.500 | - |
| **Hospedagem** | Hotel Business (3 Noites, Quarto Duplo) | R$ 650 | ~ ¥19.500 |
| **Alimentação** | Média de R$ 60/refeição + Lanches | R$ 750 | ~ ¥22.500 |
| **Transporte** | Osaka Amazing Pass 1 Dia + Translado Aeroporto | R$ 180 | ~ ¥5.400 |
| **Compras/Lazer** | Don Quijote & Lembranças | R$ 500 | ~ ¥15.000 |
