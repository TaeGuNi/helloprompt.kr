...
## 🚀 A Solução: "O Encantador de Cães de IA"

### 🥉 Basic Version (Versão Básica)

Ideal para tirar dúvidas rápidas ou lidar com problemas comportamentais leves do dia a dia.
...
> **Contexto (Context):**
>
> - Problema atual: Meu cachorro está sofrendo de `[Problema Comportamental: ex., uivos incessantes e destruição de móveis ao ficar sozinho]`.
> - Gravidade da Situação: É urgente, pois `[Consequência: ex., os vizinhos estão prestando queixas formais ao condomínio]`.
>
> **Tarefa (Task):**
>
> 1. **Análise de Causa Raiz:** Com base nas informações fornecidas abaixo, deduza as 3 principais razões psicológicas ou ambientais que estão engatilhando este comportamento.
> 2. **Plano de Ação:** Crie um 'Programa de Treinamento e Dessensibilização de 7 Dias' altamente prático que eu possa iniciar hoje mesmo. Especifique os equipamentos necessários (ex: tipo de guia, brinquedos recheáveis) e o nível de valor dos petiscos.
> 3. **Erros do Tutor (Ações NG - No Good):** Liste de forma incisiva o que eu **NÃO DEVO** fazer em hipótese alguma para evitar agravar o trauma ou a ansiedade do pet.
> 4. Mantenha os espaços em `[colchetes]` intactos para que eu possa preencher os dados como um template no futuro.
>
> **Informações Detalhadas (Input):**
>
> - Raça/Idade/Sexo: `[ex., Golden Retriever / 2 anos / Macho castrado]`
> - Rotina de Exercícios (Físico/Mental): `[ex., 3 passeios curtos por semana na coleira curta, sem enriquecimento ambiental em casa]`
> - Ambiente de Vivência: `[ex., Apartamento pequeno, muito barulho da rua]`
> - Histórico/Mudanças Recentes: `[ex., Voltei a trabalhar presencialmente após 2 anos em home office]`
...
### ❌ Before (A abordagem leiga)

```text
Meu cachorro não para de latir quando a campainha toca. É muito barulhento e me irrita. Como eu faço ele calar a boca?
```

### ✅ After (O diagnóstico da IA usando o Prompt Pro)

```text
🐶 [Análise de Causa Raiz]
Considerando a falta de enriquecimento ambiental e os passeios limitados, o latido excessivo na campainha não é "desobediência", mas sim uma combinação de hipervigilância (defesa do território) e uma válvula de escape para energia acumulada. O som da campainha tornou-se um gatilho de alta excitação.

📅 [Plano de 7 Dias: Projeto "Campainha Zen"]

- **Ferramentas:** Petiscos de altíssimo valor (frango desfiado ou salsicha em pedaços minúsculos), tapete de lamber (lick mat) ou caminha específica (Target).
- **Dias 1 e 2 (Gestão de Ambiente):** Desligue a campainha temporariamente (coloque um aviso na porta pedindo para mandarem mensagem). O objetivo é desintoxicar o cão do gatilho e focar em gastar a energia mental dele com brinquedos recheáveis.
- **Dias 3 e 4 (Mudança de Associação):** Grave o som da campainha no celular. Toque no volume 1 (quase inaudível). Se ele não latir, elogie calmamente e dê o super petisco. Repita 5 vezes. O som deve significar "comida deliciosa apareceu", não "invasor na porta".
- **Dias 5 a 7 (Treino de Lugar/Place):** Ensine-o a ir para a caminha quando ouvir o som do celular no volume 3. A recompensa só é entregue quando ele estiver com as quatro patas na cama.

🚫 [Ações NG (No Good) - O que o tutor NÃO DEVE fazer]
- **Gritar "Quieto!" ou "Não!":** Cães não entendem português. Para ele, se você grita enquanto ele late para a porta, você está "latindo" junto com ele, validando a ameaça.
- **Punir fisicamente ou assustar:** Isso associará a chegada de visitas a experiências traumáticas e dor, podendo escalar os latidos para agressividade real contra os convidados.
```
