...
> **Task:** Progetta i ruoli di 3 agenti specializzati e il relativo flusso di lavoro (pipeline) per eseguire in modo impeccabile questa `[complessa attività di ricerca]`.
...
Da utilizzare quando è necessaria una rigorosa divisione dei ruoli, un'interazione fluida e a prova di errore all'interno della pipeline di produzione.
...
> 2. Sulla base del `[Tipo di attività]`, progetta una pipeline (Workflow) step-by-step che indichi la sequenza esatta e il formato dei dati con cui gli agenti comunicheranno.
...
Sei pronto a smettere di fare il babysitter all'intelligenza artificiale? È arrivato il momento di prendere il comando dei tuoi Avengers dell'IA personali e scalare i tuoi processi lavorativi. Ora chiudi tutto e goditi la tua meritata uscita in orario! 🚀
