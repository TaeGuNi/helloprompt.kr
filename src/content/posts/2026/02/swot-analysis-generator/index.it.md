...
## 🚀 La Soluzione: "Consulente Strategico Virtuale"
...
```text
La nostra azienda gestisce un bar locale, fammi un'analisi SWOT.
```

### ✅ Dopo (Risultato con il Prompt Pro)

```text
| Categoria | Elemento Analizzato | Motivazione di Mercato |
|---|---|---|
| **Forza (S)** | Differenziazione del prodotto (Micro-Roasting) | Il controllo diretto sulla tostatura dei chicchi garantisce un profilo aromatico unico, difficile da replicare per le grandi catene. |
| **Debolezza (W)** | Bassa brand awareness | L'assenza di un budget di marketing strutturato limita l'acquisizione di nuovi clienti oltre il traffico pedonale locale. |
| **Opportunità (O)** | Trend del consumo consapevole ed etico | I consumatori della Gen Z e Millennial preferiscono sempre più i caffè di nicchia con filiera tracciabile. |
| **Minaccia (T)** | Aumento dei costi delle materie prime | Le fluttuazioni del prezzo del caffè crudo a livello globale possono erodere rapidamente i margini di profitto. |

**Strategie Derivate:**
- **Strategia SO:** Lanciare campagne social mirate che evidenziano l'approvvigionamento etico e la tostatura artigianale per attrarre la Gen Z.
- **Strategia WT:** Creare abbonamenti mensili per i clienti fedeli per stabilizzare le entrate e ammortizzare i picchi di costo della materia prima.
```
