...
- **🤖 Modèle recommandé :** Tous les modèles interactifs (ChatGPT avec Voice, Claude, Gemini)
...
## 🚀 La Solution : « Le Coach de Conversation sur Mesure »
...
> **Tâche (Task) :**
>
> 1. Commence la conversation en te glissant immédiatement dans ton rôle. Ne dis **qu'une seule phrase courte** à la fois et attends ma réponse.
> 2. Si je fais des erreurs de grammaire ou si j'utilise des tournures maladroites, ne me corrige pas pour ne pas briser l'immersion. Continue la conversation naturellement.
> 3. Si je tape le mot-clé `(Feedback)`, mets la discussion en pause et donne-moi 3 points d'amélioration cruciaux basés sur mes phrases précédentes.
> 4. Si je tape le mot-clé `(Indice)`, propose-moi 2 ou 3 exemples de réponses naturelles que je pourrais utiliser à ce moment précis, avec leur traduction en français.
>
> **Contraintes (Constraints) :**
>
> - Utilise des expressions courantes, des tournures idiomatiques et de l'argot léger, exactement comme un vrai locuteur natif le ferait.
> - Fais avancer la conversation en me posant régulièrement des questions.
>
> **Début (Action) :** S'il te plaît, lance la conversation en disant la première phrase.
...
### ❌ Avant (Discussion classique sans cadre)

**Moi :** "Coffee please."
**IA :** "Le café est une boisson originaire d'Éthiopie. Voici comment le commander dans un café anglophone : 1. Choisissez la taille. 2. Choisissez le type (Americano, Latte...). Quel café désirez-vous aujourd'hui et comment puis-je vous aider ?"
_(L'IA agit comme une page Wikipédia, ruinant totalement l'immersion.)_

### ✅ Après (Avec la Version Pro)

**IA (Barista) :** "Hi there! Welcome to Starbucks. What can I get started for you today?"
**Moi :** "I want Americano."
**IA (Barista) :** "Sure thing. Hot or iced?"
**Moi :** "Iced please."
**IA (Barista) :** "Great choice. What size would you like for that iced Americano? Tall, Grande, or Venti?"
**Moi :** "(Feedback)"
**IA (Feedback) :** "Voici quelques suggestions pour améliorer vos réponses :

1. Au lieu de 'I want Americano', dites plutôt 'Can I get an iced Americano, please?' (C'est beaucoup plus poli et naturel).
2. 'Iced please' est correct, mais vous pouvez aussi dire 'I'd like it iced, please.'
   Reprenons la conversation. Tall, Grande, ou Venti ?"
