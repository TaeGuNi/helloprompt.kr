...
category: "Écriture"
description: "Un prompt redoutable pour métamorphoser une succession de faits soporifiques en un récit captivant qui touchera vos lecteurs en plein cœur."
...
La formule complète pour générer un contenu nuancé, profond et hautement engageant. Copiez-collez simplement ce prompt.

> **Rôle (Role) :** Tu es un `[auteur de best-sellers et maître du storytelling]`.
>
> **Contexte (Context) :**
>
> - Problème : `[Mon texte actuel est purement informatif, rigide et ne retient pas l'attention.]`
> - Objectif : `[Susciter l'empathie, créer une véritable connexion humaine et captiver le lecteur de la première à la dernière ligne.]`
>
> **Tâche (Task) :**
>
