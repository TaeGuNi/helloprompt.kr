...
## 🚀 Solución: "Optimizador de Rutina Matutina"
...
> **Tarea (Task):**
>
> 1. Crea una rutina matutina estructurada en bloques de tiempo exactos que se ajuste a mis restricciones y objetivos.
> 2. Diseña la rutina utilizando el método de "Acumulación de Hábitos" (Habit Stacking) para facilitar su adopción.
> 3. Proporciona una estrategia específica de 3 pasos para superar mi "mayor obstáculo matutino".
> 4. Los valores entre corchetes `[ ]` son variables que el usuario puede modificar.
>
> **Restricciones (Constraints):**
>
> - La rutina debe ser realista y sostenible a largo plazo, no un entrenamiento militar agotador.
> - Preséntame el horario en un formato de tabla Markdown clara.
> - No incluyas actividades que requieran equipo especial o preparación previa excesiva.
>
> **Advertencia (Warning):**
>
> - Si detectas que mis objetivos son demasiado ambiciosos para el tiempo disponible, prioriza la actividad de mayor impacto y avísame de la limitación para evitar la frustración.
...
### ❌ Antes (Sin dirección clara)

```text
Despierto a las 7:00 AM, reviso Instagram y correos por 20 minutos en la cama. Me levanto apresurado, me salto el desayuno, bebo un café rápido y empiezo a trabajar estresado porque siento que ya he perdido el control del día.
```

### ✅ Después (Con la Rutina Generada por IA)

```text
| Hora | Actividad | Beneficio / Por qué funciona |
| :--- | :--- | :--- |
| 06:30 | Regla de los 5 Segundos & Hidratación | Rehidrata el cerebro tras dormir y rompe el ciclo de dopamina. |
| 06:35 | Movimiento Ligero (Yoga 10 min) | Aumenta el flujo sanguíneo de forma suave y progresiva. |
| 06:45 | Mentalidad (Diario 5 min) | Reduce la ansiedad y establece la intención primordial del día. |
| 06:50 | Avance de Proyecto Personal | Garantiza progreso antes de que la rutina laboral te consuma. |
| 07:30 | Fin de la Rutina | Transición natural y calmada hacia el trabajo. |

*Estrategia para el obstáculo matutino:*
Deja tu celular cargando en el baño. Esto te obligará a levantarte físicamente para apagar la alarma, rompiendo de inmediato la inercia del "scrolling" en la cama.
```
