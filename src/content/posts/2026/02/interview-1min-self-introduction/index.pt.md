...
Use esta versão para um roteiro personalizado, persuasivo e pronto para a entrevista.

> **Papel (Role):** Você é um estrategista de carreira de elite e especialista em comunicação corporativa.
>
> **Contexto (Context):**
>
...
>
> 1. Força 1: `[Ex: Habilidade avançada em análise de dados e Python]`
> 2. Força 2: `[Ex: Experiência em liderança de equipes multiculturais]`
>
> **Tarefa (Task):**
>
...
### ❌ Antes (O Clichê Genérico e Entediante)

```text
Olá, muito prazer! Meu nome é Kim e eu sou como uma esponja.
Estou sempre pronto para absorver novos conhecimentos e vestir a camisa da empresa.
Desde a faculdade, eu me destaco por ser muito dedicado, perfeccionista e sempre escuto com muita atenção o que meus superiores têm a dizer... (Muito longo e sem diferencial)
```

### ✅ Depois (O Impacto Profissional e Assertivo)

```text
Especialista em marketing orientado a dados com foco na conversão ágil de clientes.
Trago para esta posição duas forças principais.
Primeiro, a capacidade de transformar dados complexos em estratégias reais de vendas, habilidade que aprimorei durante 3 anos gerenciando a operação de e-commerces de alto volume.
Segundo, a fluência em negociações globais, liderando a comunicação direta com stakeholders internacionais e clientes de língua inglesa.
Com essas competências consolidadas, meu objetivo é contribuir diretamente para a meta de expansão de 10% nas vendas globais da equipe a partir do meu primeiro trimestre com vocês.
```
