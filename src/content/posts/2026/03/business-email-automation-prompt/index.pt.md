...
- **🤖 Modelo Recomendado:** Claude 3.5 Sonnet (Excelente em captar nuances sutis), ChatGPT (GPT-4o)
- ⭐ **Dificuldade:** ⭐☆☆☆☆
- ⚡️ **Eficácia:** ⭐⭐⭐⭐⭐
- 🚀 **Utilidade:** ⭐⭐⭐⭐⭐
...
1. Atribua à IA a persona de um "Especialista em Comunicação B2B com 10 anos de experiência".
2. Forneça o objetivo central, o tom de voz desejado e os pontos-chave em formato de tópicos (bullet points).
3. Obtenha um e-mail com a nuance corporativa perfeita em menos de 1 minuto, preservando sua energia mental e emocional.

---

## 🚀 A Solução: "Prompt de Automação de E-mails Corporativos"

### 🥉 Versão Básica (Basic Version)

Use esta versão quando precisar apenas de resultados rápidos. Se estiver com pressa, basta copiar e colar.

> **Função:** Você é um `[Profissional de uma empresa global com 10 anos de experiência]`.
> **Tarefa:** Escreva um e-mail corporativo `[educado e firme]` com base nas seguintes informações.
> **Contexto:** `[Solicitação de adiamento de reunião devido a um atraso em um projeto interno]`

### 🥇 Versão Profissional (Pro Version)

Use esta versão quando precisar de um alto nível de detalhes: para responder a reclamações de clientes, redigir e-mails cruciais em inglês ou fazer recusas diplomáticas.

> **Função (Role):** Você é um gerente de comunicação sênior com 10 anos de experiência e um especialista em comunicação B2B.
>
> **Contexto (Context):**
> - Destinatário: `[Ponto de contato do cliente / Parceiro comercial / Executivo interno]`
> - Objetivo: `[Recusar uma exigência fora do escopo / Adiar o cronograma de entrega / Enviar um cold e-mail em inglês]`
> - Pontos-chave: 
>   1. `[A alternativa viável que podemos oferecer]`
>   2. `[O motivo real pelo qual a solicitação atual é inviável]`
>   3. `[Sugestão clara para os próximos passos]`
>
> **Tarefa (Task):**
> 1. Escreva um rascunho de e-mail corporativo impecável, perfeitamente adequado à situação descrita acima.
> 2. Crie opções de assunto para o e-mail que permitam ao destinatário entender intuitivamente o propósito da mensagem (sugira no máximo 2 opções).
> 3. Redija o e-mail em `[Português / Inglês]`.
> 4. O tom de voz deve ser `[educado, mas firme / empático e amigável / extremamente formal e institucional]`.
>
> **Restrições (Constraints):**
> - Evite estritamente qualquer vocabulário emocional, tom passivo-agressivo ou nuances que soem como justificativas defensivas.
> - Mantenha as frases concisas, diretas e elimine floreios desnecessários.
> - Use colchetes (`[ ]`) para indicar as variáveis que eu precisarei preencher posteriormente, como `[Nome da Empresa]`, `[Nome do Contato]`, `[Data e Hora]`.
>
> **Aviso (Warning):**
> - Não invente motivos falsos que não foram fornecidos nem faça promessas ou concessões que não poderão ser cumpridas.
...
### ❌ Antes (Entrada - O rascunho emocional)

```text
Olá, fulano, nossa equipe de desenvolvimento está sobrecarregada com outro problema no servidor agora, então não poderemos adicionar esse recurso até amanhã de jeito nenhum. 
Fica muito difícil trabalhar se vocês continuarem pedindo coisas de última hora que nem estão no contrato. 
Vamos conversar de novo na semana que vem para alinhar isso.
```

### ✅ Depois (Resultado - O e-mail refinado pela IA)

```text
Assunto: [Solicitação] Reajuste de cronograma e análise de viabilidade para recurso adicional
...
No momento, nossos recursos de engenharia estão integralmente focados nas prioridades críticas do projeto em andamento. Por esse motivo, é inviável implementarmos o recurso solicitado até o prazo de amanhã.

Além disso, confirmamos que este item específico se configura como um escopo adicional, não previsto no contrato original. 
Sendo assim, gostaríamos de agendar uma breve reunião para discutirmos os detalhes sobre a viabilidade técnica, o impacto comercial e o novo cronograma de implementação dessa funcionalidade. 

Poderia nos confirmar se estaria disponível para uma videochamada na próxima [Terça-feira, às 14h] ou sugerir um horário de sua conveniência?

Agradecemos a compreensão e a parceria contínua. Caso tenha alguma dúvida urgente, não hesite em nos contatar.
