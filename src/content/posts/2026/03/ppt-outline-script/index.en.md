...
- **🤖 Recommended Models:** Any conversational AI (Claude 3.5 Sonnet, ChatGPT, etc.)
...
## 🚀 Solution: "The Slide Skeleton Maker"
...
> - Presentation Time: `[15 minutes (approx. 10 to 15 slides)]`
> - Core Objective: `[Secure budget approval for the solution's deployment]`
>
> **Task:**
>
> 1. Construct the complete slide outline, ensuring the opening instantly grabs the audience's attention.
> 2. You must include the following 4 distinct elements for every single slide:
>    - Slide Headline
>    - Recommended visual materials for the screen (Visual Idea)
>    - Core text to be displayed on the slide (Key Message)
>    - The exact script the speaker will deliver (written in a natural, conversational tone, lasting about 1 minute per slide)
> 3. Keep the `[Topic]`, `[Audience]`, `[Presentation Time]`, and `[Core Objective]` in brackets so I can easily swap out the variables later.
>
> **Constraints:**
>
> - Strictly minimize technical jargon. Use clear, persuasive business language that resonates with the target audience.
> - Do not start with cliché greetings like "Hello everyone." The opening script must immediately hook the audience with a hard-hitting question that targets their primary pain point.
> - Format the final output as a highly readable list, organized sequentially by slide number.
>
> **Warning:**
>
> - Avoid vague, fluffy statements (e.g., "This will be very helpful"). You must present concrete, specific expected outcomes to prevent hallucinated claims.
