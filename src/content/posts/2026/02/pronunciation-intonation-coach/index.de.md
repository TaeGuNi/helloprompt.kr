...
## 🚀 Die Lösung: "Visueller Aussprache-Guide"
...
**[Muttersprachliche Schreibweise]**
**Wha**-der yu **do**-in?
...
**[Verbindungsregeln / Linking]**
- Wenn "What are" in normalem Tempo gesprochen wird, verwandelt sich das 't' in ein weiches Flap-T (klingt fast wie ein weiches deutsches 'd' oder 'r'), was zu "Wha-der" führt.
- Das 'ou' in "you" wird oft zu einem kurzen 'Schwa'-Laut abgeschwächt ("yu").
- Das 'g' am Ende von "doing" wird in der Umgangssprache meist weggelassen (G-Dropping), sodass es wie "do-in" klingt.
```
