...
## 🚀 Lösung: Der "AI-Era HR Strategy" Prompt
...
```text
### 🎯 Hybride Personalstrategie für [B2B SaaS]

| Entwicklungsphase | Automatisierbare KI-Aufgabe | Fokus für Junior-Talente (Gen Z) |
| :--- | :--- | :--- |
| **Phase 1: Onboarding** | Basis-Datenanalyse, Code-Generierung | Validierung der KI-Ergebnisse, Kontext-Lernen |
| **Phase 2: Integration** | Erstellung von Standard-Reports | Komplexe Problemlösung, Kundenempathie |
| **Phase 3: Impact** | Skalierung wiederkehrender Prozesse | Strategische KI-Orchestrierung & Führung |

**KPIs zur Erfolgsmessung:**
- Beförderungsrate von Junior zu Mid-Level innerhalb von 18 Monaten.
- Anzahl der intern entwickelten, KI-gestützten Prozessoptimierungen durch Einsteiger.
```
