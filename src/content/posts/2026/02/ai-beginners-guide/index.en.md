...
Here is exactly how to set this up for your Customer IDs:

1. Click on the empty cell where you want the Purchase History to appear.
2. Type `=XLOOKUP(`
3. Click your first Customer ID...
[Continues with highly specific, easy-to-follow steps]
```
