...
> **Contexto (Context):**
>
> - Perfil: `[Sua Idade, Peso, Altura, Nível de Atividade Física]`
> - Objetivo Principal: `[Ex: Ganho de massa muscular, Perda de gordura, Manutenção]`
> - Restrições Alimentares: `[Ex: Intolerância à lactose, Vegetariano, Nenhuma]`
> - Orçamento/Estilo: `[Ex: Econômico, Premium, Focado em ingredientes orgânicos]`
> - Culinária de Preferência: `[Ex: Brasileira, Mediterrânea, Asiática]`
>
> **Tarefa (Task):**
>
...
```text
Usuário: "Me dê uma dieta para ganhar músculo."

IA: Aqui está uma dieta básica:
Segunda:
Café: Ovos e aveia
Almoço: Frango com batata doce
Jantar: Carne moída com arroz
...
```
...
```text
# Plano Alimentar Semanal (Foco: Hipertrofia)

| Dia | Café da Manhã | Almoço | Lanche | Jantar | Macros Diários |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Seg** | 3 Ovos mexidos + 1 fatia de pão integral | 150g Peito de frango + 100g Arroz + Brócolis | Iogurte proteico + Banana | 150g Patinho moído + Purê de abóbora | 2400 kcal (160g P, 220g C, 65g G) |
| **Ter** | Aveia c/ Whey + Morangos | 150g Tilápia + Quinoa + Salada | 3 Ovos cozidos + Castanhas | Sobras do frango desfiado + Wrap integral | 2350 kcal (155g P, 210g C, 70g G) |

# Lista de Compras (Para 1 pessoa / 7 dias)

| Seção | Itens e Quantidades |
| :--- | :--- |
| **Hortifruti** | 2 Cachos de banana, 1 Maço de brócolis, 1 Abóbora cabotiá... |
| **Açougue/Peixaria** | 1.5kg Peito de Frango, 1kg Patinho moído, 500g Tilápia... |
| **Laticínios** | 2 Dúzias de ovos, 7 Iogurtes proteicos... |
```
