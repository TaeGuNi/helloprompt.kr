...
## 🚀 La Solution : « L'Intervieweur IA »

### 🥉 Version Basique (Basic Version)

Utilisez ce prompt lorsque vous manquez de temps et avez besoin d'une liste rapide.
...
> **Tâche (Task) :**
>
> 1. Formule 3 questions comportementales (méthode STAR) approfondies pour valider ses compétences techniques et son expérience professionnelle.
> 2. Crée 2 questions de mise en situation spécifiques pour vérifier l'adéquation culturelle (Cultural Fit).
> 3. Pour chaque question, fournis 2 questions de relance (Follow-up / Probing Questions) pour creuser le sujet si le candidat reste superficiel.
> 4. Propose une grille d'évaluation (Rubric) claire précisant ce qui constitue une excellente réponse ("Green Flag") et une réponse alarmante ("Red Flag").
>
> **Contraintes (Constraints) :**
>
> - Structure ta réponse en Markdown avec des titres clairs.
> - Pose exclusivement des questions ouvertes auxquelles on ne peut répondre par "Oui" ou "Non".
> - Privilégie les questions basées sur des expériences passées réelles (Entretien Comportemental) plutôt que des scénarios hypothétiques.
>
> **Avertissement (Warning) :**
>
> - Ne donne pas de questions génériques de type "Quels sont vos défauts ?". Les questions doivent être pointues et spécifiques au profil fourni.
...
```text
Donne-moi des questions d'entretien pour un développeur.
```

### ✅ After (Résultat avec la Version Pro)

```text
**Question 1 (Compétence Technique) :**
« Parlez-moi d'une situation où vous avez dû reprendre un code legacy complexe écrit par un autre développeur. Comment avez-vous procédé pour le comprendre et le refactoriser sans casser le système en production ? »

*Questions de relance :*
- « Quels tests précis avez-vous mis en place avant de modifier le code ? »
- « Quelle a été la réaction de l'équipe face à vos changements ? »

**Grille d'évaluation :**
- 🟢 Green Flag : Mentionne l'écriture de tests unitaires, la lecture de la documentation existante, et une approche de refactorisation progressive.
- 🔴 Red Flag : Critique ouvertement l'ancien développeur, avoue avoir "tout réécrit de zéro" sans justifier d'une analyse d'impact préalable.
```
