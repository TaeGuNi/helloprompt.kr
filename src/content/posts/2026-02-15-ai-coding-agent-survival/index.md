...
## (Updated) (Updated) 1. Copilot이 아니라 Autopilot입니다 {#updated}
...
### (Updated) (Updated) 무엇이 달라졌나? {#updated}
...
## (Updated) (Updated) 2. 에이전트에게 일을 맡기는 법 (The Delegation Framework) {#the-delegation-framework}
...
## (Updated) (Updated) 3. 실전: 리팩토링 위임 프롬프트 {#updated}
...
- 현재 `User` 클래스가 2000줄이 넘습니다.
  **# (Updated) (Updated) Constraints (절대 준수)**
...
6. 승인 후, 단계별로 코드를 수정하고 각 단계마다 단위 테스트를 작성하세요.
   **# (Updated) (Updated) Definition of Done**
...
## (Updated) (Updated) 4. Writer's Insight: 믿되, 검증하라 {#updated}
