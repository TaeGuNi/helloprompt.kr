...
## (Updated) (Updated) 2. OpenAI의 선택: "가볍고 빠른 전용 칩 모델" {#updated}
...
## (Updated) (Updated) 3. 실무 가이드: "내 서비스엔 뭘 써야 할까?" {#updated}
...
### (Updated) (Updated) 🧪 "Distillation QA" 프롬프트 {#updated}
