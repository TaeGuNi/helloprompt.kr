...
## (Updated) Chrome DevTools MCP 서버란? {#updated}
...
## (Updated) 주요 기능 및 활용 사례 {#updated}

이 MCP 서버를 통해 AI 에이전트는 다음과 같은 강력한 기능을 수행할 수 있습니다:

### (Updated) 1. 콘솔 로그 분석 (Console Logs) {#console-logs}
...
### (Updated) 2. DOM 구조 검사 (DOM Inspection) {#dom-inspection}
