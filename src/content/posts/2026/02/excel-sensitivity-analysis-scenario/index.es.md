...
```text
¿Cómo hago escenarios de cambio de divisas y ventas en Excel?
```

### ✅ Después (Resultado con la Versión Pro)

```text
### 🌪️ Guía Maestra: Análisis de Sensibilidad Bidireccional en Excel

**1. Preparando el Tablero (Estructura de la Matriz)**
- Ingresa tus escenarios de **Tipo de Cambio** (1200, 1250, 1300...) verticalmente en la Columna A (ej. A2:A6).
- Ingresa tus escenarios de **Volumen de Ventas** (10k, 20k, 30k...) horizontalmente en la Fila 1 (ej. B1:F1).
- **⚠️ Paso Crítico:** En la celda de la esquina superior izquierda donde se cruzan (A1), debes vincular obligatoriamente la fórmula final de tu modelo que calcula el **'Beneficio Operativo'** (ej. `=Z100`).

**2. Ejecutando la Magia (Tabla de Datos)**
- Selecciona toda la matriz que acabas de crear, incluyendo la celda de la esquina de la fórmula, todas las variables y las celdas en blanco (ej. rango A1:F6).
- Ve a la pestaña **[Datos]** ➔ haz clic en **[Análisis de hipótesis]** ➔ selecciona **[Tabla de datos]**.
- **Celda de entrada de fila:** Selecciona la celda original de tu modelo de donde proviene el 'Volumen de Ventas' (porque las ventas están extendidas en horizontal).
- **Celda de entrada de columna:** Selecciona la celda original de tu modelo de donde proviene el 'Tipo de Cambio' (porque los tipos de cambio están en vertical).

**3. Análisis e Interpretación**
- Al hacer clic en Aceptar, la matriz se poblará instantáneamente con el Beneficio Operativo exacto para cada cruce de escenarios.
- **💡 Insight Estratégico:** Selecciona los resultados y aplica **Formato Condicional (Escalas de color)**. El punto donde el color pasa de verde brillante a rojo oscuro te indica tu 'umbral de dolor'. Si observas que con un tipo de cambio de 1350 KRW y ventas por debajo de 30k entras en pérdidas operativas, tienes un argumento irrefutable para proponer una estrategia de cobertura cambiaria de inmediato a la dirección.
```
