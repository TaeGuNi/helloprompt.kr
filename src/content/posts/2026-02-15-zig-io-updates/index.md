...
## (Updated) (Updated) (Updated) 주요 변경 사항 {#updated}

### (Updated) (Updated) (Updated) 1. `std.io`의 안정화 {#updated}
...
### (Updated) (Updated) (Updated) 3. 새로운 `std.event.Loop` {#updated}

사용자가 직접 이벤트 루프를 커스터마이징하거나 기존 런타임에 통합하기 쉬워졌습니다. 이는 게임 엔진이나 고성능 네트워크 서버를 개발하는 분들에게 희소식입니다.

## (Updated) (Updated) (Updated) 앞으로의 계획 {#updated}
