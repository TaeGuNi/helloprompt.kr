...
- **🤖 Modèle recommandé :** Tous les modèles d'IA générative (Midjourney, DALL-E 3, Stable Diffusion)
...
1. L'ajout du terme `Golden hour` transforme instantanément une image froide en une scène chaleureuse et cinématographique.
2. Combinez-le avec `Sun flare` (reflet du soleil) ou `Backlight` (contre-jour) pour un effet visuel encore plus dramatique.
3. C'est un véritable "cheat code" universel, parfait pour sublimer les portraits, les paysages et même l'architecture.

---

## 🚀 La Solution : « Le Prompt de l'Heure Dorée »
...
Utilisez cette structure pour un contrôle total de la lumière, de l'ambiance et du rendu photographique simulé. Copiez le prompt en anglais (la langue native des modèles de génération d'images) pour un résultat optimal.

> **Rôle (Role) :** Tu es un directeur de la photographie récompensé et un maître du prompting.
>
> **Contexte (Context) :**
>
...
>
> - Ne traduis pas le prompt final. Il doit impérativement rester en anglais.
