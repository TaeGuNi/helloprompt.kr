...
- **🤖 Modelli consigliati:** Claude 3.5 Sonnet (Ottimizzato per l'analisi dei dati), GPT-4o (Advanced Data Analysis)
...
> **Vincoli (Constraints):**
>
> - L'output deve essere formattato rigorosamente come una tabella Markdown. (Colonne: Categoria | Contenuto Principale | Frequenza | Citazione Reale | Insight di Business)
>
> **Avvertenze (Warning):**
>
...
| :--- | :--- | :--- | :--- | :--- |
| **Peso / Ergonomia** | Il prodotto del concorrente A ha ottime prestazioni ma è troppo pesante, causando affaticamento nell'uso prolungato. | Alta (45%) | "Il design è carino, ma dopo soli 30 minuti di utilizzo mi fa malissimo il polso ㅠㅠ" | **Marketing incentrato su materiali ultraleggeri (es. Titanio) e miglioramento dell'ergonomia.** |
| **Finiture / Controllo Qualità** | Delusione per la qualità costruttiva, con giunture allentate e vernice scrostata sin dai primi utilizzi. | Media (28%) | "La spedizione è stata veloce, ma appena aperta la scatola il rivestimento sugli angoli era già staccato." | **Introduzione della 'Garanzia di Ispezione al 100%' ed enfasi sui processi di assemblaggio premium.** |
```
