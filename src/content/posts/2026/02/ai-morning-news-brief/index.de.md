...
## 🚀 Lösung: Der "Persönliche KI-News-Anchor"-Prompt
...
```text
Nutzer: Was gibt es heute Neues in der Tech-Welt?

KI: Hier sind einige allgemeine Tech-Trends aus diesem Jahr. KI entwickelt sich weiter, viele Unternehmen investieren in Cloud-Computing und die Cybersicherheit wird immer wichtiger. Außerdem gab es einige neue Smartphones... (Endloser, allgemeiner Text ohne echten Informationswert).
```

### ✅ Nachher (Ergebnis der Pro-Version)

```text
Guten Morgen! Hier ist dein 3-Minuten-Briefing für den Tech- und Finanzsektor.

📰 **1. OpenAI veröffentlicht neues "Reasoning"-Modell**
- **Die Fakten:** OpenAI hat gestern Abend überraschend ein neues KI-Modell vorgestellt, das komplexe mathematische Probleme in Echtzeit lösen und seine Gedankengänge offenlegen kann.
- **Warum das wichtig ist:** Dies markiert einen entscheidenden Schritt in Richtung autonomer KI-Agenten und könnte die Softwareentwicklung und Automatisierung grundlegend verändern.
