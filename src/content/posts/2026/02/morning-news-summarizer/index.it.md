...
```text
Riassumi le principali notizie di questa mattina.
```

### ✅ Dopo (Risultato)

```text
📊 [Briefing Economico/IT Mattutino del Giornalista Esperto]

1. 🇺🇸 Chiusura del Mercato Azionario USA
   - Il Nasdaq chiude in rialzo dell'1,5%, l'S&P 500 tocca un nuovo massimo storico.
   - Causa del rialzo: Sorprendenti annunci sugli utili delle principali aziende Big Tech e aspettative di taglio dei tassi di interesse.
   - [Aziende correlate] Nvidia (NVDA), Microsoft (MSFT)
   - 🔗 Fonte: [Bloomberg (Link)]

2. 🇮🇹 Principali Questioni Aziendali
   - Esportazioni di semiconduttori in crescita a doppia cifra per il quinto mese consecutivo: Esplosione della domanda di memorie per l'IA.
   - [Aziende/Settori correlati] STMicroelectronics / Settore dei componenti per semiconduttori
   - 🔗 Fonte: [Il Sole 24 Ore (Link)]
   - L'export del settore cosmetico raggiunge i massimi storici: Espansione della quota di mercato in Nord America.
   - [Aziende/Settori correlati] Intercos, Kiko Milano / Produzione di cosmetici
   - 🔗 Fonte: [Milano Finanza (Link)]

3. 📱 Trend IT/Tech Approfondito
   - Apple: Si diffondono voci sull'imminente rilascio di un nuovo sistema operativo con massiccia integrazione di funzioni IA On-Device.
   - [Aziende/Settori correlati] Apple (AAPL), Produttori di componenti / Titoli legati all'IA On-Device
