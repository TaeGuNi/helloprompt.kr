...
> **Contesto (Context):**
>
> - Background: Ho appena pubblicato un video YouTube denso di informazioni di grande valore. Voglio utilizzare lo script di questo video per distribuire il traffico verso altre piattaforme.
> - Obiettivo: Preservare il messaggio chiave dello script originale, generando al contempo 3 tipologie di contenuti derivati, ciascuno perfettamente ottimizzato per le specifiche caratteristiche della piattaforma di destinazione.
>
> **Fonte (Source):**
>
...
> **Azione (Task):**
>
> 1. **Articolo Blog Ottimizzato SEO:** Struttura il testo come un articolo informativo, impiegando i tag `<H2>` e `<H3>` per favorirne il posizionamento in cima ai motori di ricerca. Fai largo uso di elenchi puntati per massimizzarne la leggibilità.
> 2. **Testo per Carosello Instagram:** Estrai 5 insight fondamentali e riassumili in frasi brevi e d'impatto, perfette per 5 slide separate. La prima slide deve includere una frase gancio (hook) estremamente potente per catturare immediatamente l'attenzione.
> 3. **Thread Virale per Twitter (X):** Inizia con un incipit intrigante che stimoli la dopamina, seguito da un thread composto da 5-7 frasi brevi e incisive, ciascuna rigorosamente entro i 140 caratteri.
>
> **Restrizioni (Constraints):**
>
> - Non inventare MAI fatti o informazioni non presenti nel testo originale. (Le allucinazioni sono severamente vietate).
> - Restituisci l'output in formato Markdown, separando in modo netto le 3 sezioni: Blog, Instagram e Twitter.
> - Inserisci emoji appropriate e coerenti con il tone of voice di ciascun social media.
...
(Lo script confusionario lasciato esattamente com'è; le visualizzazioni su YouTube si arenano a quota 1.000 e la crescita del traffico si paralizza).

### ✅ After (Rielaborazione OSMU Completata)

> **[Blog]** H2: Come anticipare l'uscita dal lavoro di 3 ore grazie alla Marketing Automation (Posizionamento al top nelle ricerche)
> **[Instagram]** (Slide 1) "Marketer, stai ancora perdendo tempo con task manuali e ripetitivi?" (Esplosione di salvataggi e condivisioni)
> **[Twitter]** Padroneggiando appena 5 tool di marketing, puoi svolgere il lavoro di 3 persone. Te lo dimostro in questo thread 👇 (Diffusione virale tramite RT)

📈 **Copertura (Reach) totale decuplicata, innescando un formidabile circolo virtuoso in cui ogni singolo canale spinge traffico verso gli altri.**
