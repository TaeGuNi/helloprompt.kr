...
- **🤖 Empfohlenes KI-Modell:** Alle dialogfähigen KIs (ChatGPT, Claude, Gemini etc.)
...
## 🚀 Die Lösung: Der "KI-Recruiter" Prompt
...
> **Kontext (Context):**
>
> - Hintergrund: Ich bereite mich auf ein Vorstellungsgespräch mit einem Bewerber für die Position als `[Jobposition]` vor.
> - Kernpunkte des Lebenslaufs: `[Zusammenfassung des Lebenslaufs]`
>
> **Aufgabe (Task):**
>
...
> **Warnung (Warning):**
>
> - Erfinde keine fachspezifischen Konzepte. Wenn der Lebenslauf unklare Technologien oder Begriffe nennt, formuliere die Fragen so, dass der Bewerber diese selbst im Detail erklären muss (Vermeidung von Halluzinationen).
...
```text
Nenne mir ein paar gute Interviewfragen für einen Entwickler.
```

### ✅ After (Ergebnis mit Pro-Prompt)

```text
F: Erzählen Sie mir von einem Projekt, bei dem Sie auf ein unvorhergesehenes technisches Problem gestoßen sind, das den Launch gefährdet hat. Wie haben Sie es gelöst?
(Nachfrage): Welche Architektur-Alternativen hatten Sie damals in Betracht gezogen und warum haben Sie sich genau für diesen speziellen Weg entschieden?
(Bewertungsmaßstab):
- Exzellent: Nennt konkrete Trade-offs, übernimmt proaktiv Verantwortung, erklärt den Entscheidungsprozess logisch und nachvollziehbar.
- Ungenügend: Schiebt die Schuld auf andere Teammitglieder, bleibt extrem abstrakt ("wir haben das dann irgendwie gefixt").
```
