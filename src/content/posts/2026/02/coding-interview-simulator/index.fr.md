...
> _"Votre code passe tous les tests, mais que répondez-vous lorsque l'intervieweur vous demande pourquoi vous avez choisi cette approche spécifique plutôt qu'une autre ?"_

Réussir un test d'algorithmique ne se résume pas à obtenir un terminal au vert. Les recruteurs des géants de la tech chercheront toujours à sonder votre réflexion : « Pourquoi cette structure de données ? », « Pourriez-vous optimiser cette complexité temporelle ? ». Ce prompt transforme votre IA en un intervieweur technique impitoyable qui décortique votre logique, traque vos faiblesses et vous pousse vers l'excellence.

---

## ⚡️ 3 points à retenir (TL;DR)

1. **Évaluation approfondie :** Analyse systématique de la complexité temporelle ($O$) et spatiale de votre code.
2. **Simulation sous pression :** Génération de questions de relance (follow-ups) typiques des véritables entretiens.
3. **Pédagogie active :** L'IA refuse de donner la réponse immédiate, offrant plutôt des indices pour vous guider vers la solution optimale.

---

## 🚀 La Solution : « Le Simulateur d'Entretien IA »
...
> **Contexte (Context) :**
>
> - Scénario : Je viens de résoudre un problème d'algorithmique et de te soumettre mon code lors d'un entretien technique en direct (whiteboarding).
> - Objectif : Évaluer ma compréhension profonde de l'algorithme, la qualité de mon code et ma capacité à l'optimiser face aux contraintes.
>
> **Tâche (Task) :**
>
...
>
> - Structure ta réponse en utilisant des titres Markdown clairs pour chaque section.
> - Reste strictement dans ton personnage de recruteur technique.
