...
- **Q: 이 프롬프트를 다른 언어 모델(Claude, Gemini 등)에 써도 되나요?**
  - A: 네, 대부분의 최신 모델에서 훌륭하게 작동하는 범용 프롬프트입니다. 특히 최신 Claude 3.5 모델이나 Gemini 2.5 Pro와 같이 컨텍스트 창이 크고 지시어 준수(Instruction Following) 능력이 뛰어난 모델에서 더욱 완벽하고 안정적인 결과를 보여줍니다.
