...
```text
Ottimo! Iniziamo il nostro percorso. Basandoci sul tuo interesse per le auto sportive, esploriamo questo concetto affascinante.

**Lezione 1: Il concetto di "Relatività" (Tutto dipende da chi guarda)**

Immagina di essere in autostrada, alla guida di una Ferrari che viaggia esattamente a 100 km/h. Se un'altra auto sportiva ti affianca e viaggia anche lei esattamente a 100 km/h, se la guardi dal finestrino ti sembrerà **completamente ferma** rispetto a te. Questa è la base della relatività: la velocità non è assoluta, ma dipende sempre dal punto di vista (il sistema di riferimento) dell'osservatore.

La genialità di Einstein è stata chiedersi: cosa succede se applichiamo questo stesso principio non alle auto, ma alla **luce**?

Prima di passare alla Lezione 2, ecco una domanda per te:
Se sei a bordo di un treno che viaggia a 200 km/h e cammini verso la parte anteriore del treno a 5 km/h, a quale velocità ti vedrà muovere una persona ferma in stazione a guardare il treno che passa?
