...
## 🚀 The Solution: "Tech News Editor Prompt"
...
> **Context:**
>
> - Background: `[Raw technical facts or press release notes]`
> - Goal: `[Transform these dry facts into an engaging, accessible news article for general tech enthusiasts]`
>
> **Task:**
>
...
```text
Waymo update. 6th gen driver has started fully autonomous operations.
New sensors are better with wider field of view and higher resolution for urban areas.
Works better in rain and snow now because of sensor cleaning and new perception algorithms.
Rides are smoother, less sudden stops, feels like a human driver because they used millions of miles of data.
Major milestone for autonomous driving tech.
```

### ✅ After (Output)

```markdown
### Waymo Begins Fully Autonomous Operations with 6th-Generation Driver

Waymo has officially launched fully autonomous operations utilizing its state-of-the-art 6th-generation driver system. This highly anticipated update marks a significant leap forward in both hardware and software, aiming to deliver a safer, more intuitive, and highly comfortable experience for passengers.

**Key Features**

- **Enhanced Sensor System:**
  The new driver boasts a highly precise and powerful suite of sensors. Offering a wider field of view and superior resolution, it enables incredibly accurate detection of surrounding objects and pedestrians, even in the most complex urban environments.
- **Improved Weather Handling:**
  Adverse weather is no longer a roadblock. Thanks to integrated sensor cleaning systems and vastly enhanced perception algorithms, the vehicle delivers consistent, reliable service through rain, fog, and snow.
- **Smoother Ride Capability:**
  By optimizing driving logic with millions of miles of real-world data, Waymo has drastically reduced sudden stops. Acceleration and deceleration now feel remarkably natural, providing a ride quality that mimics a highly skilled human driver.

The rollout of Waymo's 6th-generation system stands as a pivotal milestone, rapidly accelerating the timeline for the widespread commercialization of autonomous driving technology.
```
