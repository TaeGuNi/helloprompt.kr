...
1. Las palabras clave `Wide angle lens` y `Ultra-wide shot` garantizan un campo de visión expansivo y cinematográfico.
2. El modificador `Fisheye lens` distorsiona la imagen esféricamente, añadiendo un dinamismo extremo a la escena.
3. El uso de `GoPro footage` emula a la perfección el distintivo ángulo de las cámaras de acción, ideal para tomas inmersivas en primera persona.

---

## 🚀 La Solución: "Prompt Panorámico"
...
Úsala cuando necesites un control absoluto sobre la perspectiva y una calidad fotorrealista.

> **Rol (Role):** Eres un director de fotografía de ciencia ficción y naturaleza, experto en perspectivas inmersivas.
>
> **Situación (Context):**
>
> - Fondo: `[Interior de una nave espacial / Paisaje inmenso, etc.]`
> - Objetivo: Lograr una inmersión total del espectador mediante una perspectiva expansiva y distorsionada que resalte la escala épica del entorno.
>
> **Solicitud (Task):**
>
> 1. Genera un prompt en inglés utilizando los siguientes parámetros y estructura.
> 2. Mantén los modificadores de lente precisos.
> 3. El `[Sujeto]` debe ser reemplazado por la idea que el usuario proporcione.
>
> **Prompt Base:**
> **Subject:** `[Descripción detallada de la escena, ej: Interior of a small futuristic spaceship cockpit, glowing buttons, view of earth through window]`
...
>
> - El output debe ser directamente el prompt listo para copiar y pegar, formateado en un bloque de código markdown.
> - No uses distancias focales superiores a 24mm (mantén 14mm, 8mm o fisheye).
>
> **Advertencia (Warning):**
>
> - Asegúrate de incluir iluminación dramática para acentuar la profundidad y no recortes los bordes de la escena.
...
- **Q: ¿Estos prompts funcionan igual de bien en DALL-E 3?**
...
Si sientes que tus imágenes generadas están atrapadas en un marco estrecho y aburrido, es hora de montar un lente ultra gran angular virtual. ¡Expande tus horizontes visuales y domina el espacio de tus composiciones!

¡Termina tu trabajo a tiempo hoy! 🍷
