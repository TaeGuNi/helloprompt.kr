...
## 🚀 La Soluzione: "Guida Visiva alla Pronuncia Madrelingua"
...
Perfetta per uno studio approfondito e per fare "shadowing" visivo di interi paragrafi.

> **Ruolo (Role):** Sei un Senior Pronunciation Coach specializzato in fonetica inglese e riduzione dell'accento per parlanti non madrelingua.
>
> **Contesto (Context):**
>
> - Background: Voglio leggere una frase in inglese in modo fluido e naturale, esattamente come farebbe un madrelingua, ma non so dove fare le pause (chunking) e quali sillabe accentare.
> - Obiettivo: Creare una guida visiva alla pronuncia che mi permetta di esercitarmi senza dover ascoltare l'audio.
>
> **Richiesta (Task):**
>
> 1. **[IPA]**: Fornisci la trascrizione nell'Alfabeto Fonetico Internazionale (IPA) basata sull'inglese americano standard (General American).
> 2. **[Lettura Intuitiva]**: Trascrivi il suono reale che i madrelingua pronunciano usando un'ortografia intuitiva. Segna le sillabe su cui cade l'accento tonico in **Grassetto**.
> 3. **[Ritmo & Accento]**: Crea una mappa visiva dell'energia della frase usando gli emoji. (Sillaba forte/accentata: 🔴, Sillaba debole/non accentata: ⚪️).
> 4. **[Consigli di Linking]**: Spiega in modo specifico i fenomeni fonetici che avvengono tra le parole (es. Flap T, elisione, assimilazione, linking R).
>
> **Vincoli (Constraints):**
>
...
>
> **Frase di Input:**
> `[Inserisci qui la frase che vuoi esercitarti a pronunciare]`
...
```text
"What are you doing this weekend? I thought we could get some coffee."
```
...
```text
**[IPA]**
/ˈwʌt ər jə ˈduɪŋ ðɪs ˈwikˌɛnd? aɪ θɔt wi kəd gɛt səm ˈkɔfi./

**[Lettura Intuitiva]**
**Uà**-der yə **dù**-in dis **uì**-kend? Ai thot uì cəd ghét səm **cò**-fi.

**[Ritmo & Accento]**
🔴⚪️⚪️🔴⚪️⚪️🔴⚪️
(What-are-you-DO-ing-this-WEEK-end)
⚪️🔴⚪️⚪️🔴⚪️🔴⚪️
(I-THOUGHT-we-could-GET-some-COFF-ee)

**[Consigli di Linking]**

- **Flap T**: Quando "What are" viene pronunciato velocemente, la 't' di 'what' si ammorbidisce in una 'r' monovibrante veloce, suonando come "Uà-der".
- **Riduzione vocalica (Schwa)**: La parola "you" si riduce quasi a "yə" e "could" diventa "cəd".
- **Caduta della 'g'**: Nella parola "doing", la 'g' finale viene spesso inghiottita nel parlato informale, diventando "doin'".
```
...
Non c'è bisogno di una sala insonorizzata per migliorare la tua pronuncia. Con questo prompt, puoi "leggere" il ritmo della lingua madrelingua direttamente con i tuoi occhi, ovunque tu sia.

Ora chiudi il PC, fai un bel respiro, e vai a sfoggiare il tuo nuovo accento al prossimo meeting! 🍷
