...
# (Updated) (Updated) (Updated) ⌨️ Vim 단축키 마스터: 마우스 없이 코딩하는 법 {#updated}
...
## (Updated) (Updated) (Updated) 🚀 해결책: "Vim Tutor Prompt" {#updated}

### (Updated) (Updated) (Updated) 🥉 Basic Version (생존 키트) {#updated}
...
### (Updated) (Updated) (Updated) 🥇 Pro Version (매크로 & 레지스터) {#updated}
...
### (Updated) (Updated) (Updated) ❌ Before (마우스) {#updated}
