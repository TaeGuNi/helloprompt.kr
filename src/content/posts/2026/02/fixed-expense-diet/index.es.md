...
> **Rol (Role):** Eres un `[Asesor Financiero Personal]` experto en frugalidad estratégica y optimización del costo de vida.
>
> **Contexto (Context):**
>
> - Antecedentes: Quiero aplicar una "dieta" estricta a mis gastos fijos sin sacrificar drásticamente mi calidad de vida. Mis gastos actuales son:
>   - Telefonía: $60/mes (Plan ilimitado con operador principal)
>   - Suscripciones (OTT): Netflix, YouTube Premium, Spotify (Total $45/mes)
>   - Seguros: $120/mes (Salud y auto)
>   - Transporte: $80/mes (Abono de transporte público)
> - Objetivo: Reducir al menos un 20% de estos gastos fijos mensuales encontrando alternativas más inteligentes.
>
> **Solicitud (Task):**
>
> 1. Sugiere 2 **Alternativas Específicas (Action Items)** para reducir el costo de cada categoría mencionada. (Ej: operadores móviles virtuales, planes familiares, subsidios de transporte).
> 2. Calcula el **Ahorro Mensual Esperado** al aplicar los métodos sugeridos.
> 3. Proyecta el **Capital Acumulado** después de 1 año si invierto el dinero ahorrado en un fondo con un rendimiento anual del `[4%]`.
>
> **Restricciones (Constraints):**
>
> - Excluye métodos que reduzcan severamente mi calidad de vida (ej., ir caminando a todas partes o cancelar el seguro de salud).
> - Adapta las sugerencias a la realidad financiera de mi país: `[Tu País]`.
> - Presenta tu respuesta utilizando una tabla en formato Markdown para mayor claridad.
>
> **Advertencia (Warning):**
>
> - No inventes nombres de empresas o planes de servicios que no existan. Si no conoces alternativas específicas para el país indicado, sugiere estrategias generales aplicables a nivel global.
...
```text
### 💸 Tu Plan de Optimización de Gastos Fijos

| Categoría | Solución Sugerida (Action Item) | Ahorro Mensual Esperado |
| :--- | :--- | :--- |
| **Telefonía** | Cambiar a un Operador Móvil Virtual (MVNO) conservando tu número. | 🔻 $35.00 |
| **Suscripciones** | Contratar un plan familiar compartido de Spotify y alternar Netflix/YouTube cada mes. | 🔻 $20.00 |
| **Transporte** | Adquirir la tarjeta de abono anual corporativo o aprovechar subsidios locales. | 🔻 $15.00 |
| **Seguros** | Consolidar las pólizas de salud y auto con el mismo proveedor para obtener un descuento por paquete. | 🔻 $25.00 |

**💰 Ahorro Mensual Total: $95.00**
**📈 Proyección a 1 Año (al 4% anual): $1,165.20 aprox.**

*Nota: Te recomiendo verificar los planes exactos de los MVNO en tu región para ejecutar el cambio hoy mismo.*
```
