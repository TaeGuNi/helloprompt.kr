...
Idéal pour obtenir rapidement une trame standard.
...
> **Contexte (Context) :**
>
> - Notre entreprise : `[Décrivez brièvement votre entreprise, ex : Une startup FinTech de 50 personnes en pleine croissance]`
> - Notre mission : `[Votre mission ou vision]`
> - Le besoin actuel : Nous cherchons à recruter un `[Titre du Poste, ex : Senior Product Manager]` pour `[Objectif principal du poste, ex : piloter le lancement de notre nouvelle application mobile]`.
>
> **Tâche (Task) :**
>
> 1. Propose 3 titres d'offres d'emploi originaux et percutants qui attisent la curiosité (évite les titres trop classiques).
> 2. Rédige une introduction captivante qui explique pourquoi ce rôle est crucial pour notre mission et quelles sont les perspectives d'évolution réelles.
> 3. Structure clairement les responsabilités (R&R) et les prérequis techniques/humains en utilisant des puces (bullet points).
> 4. Mets en valeur notre culture d'entreprise et nos avantages de manière concrète et séduisante.
>
> **Contraintes (Constraints) :**
>
> - Bannis les expressions RH clichées telles que "esprit de famille", "leader sur son marché", ou "recherche le mouton à 5 pattes".
> - Adopte une approche centrée sur le candidat (What's In It For Me - WIIFM) : montre précisément ce qu'il a à gagner en nous rejoignant.
> - Utilise le `[Tutoiement / Vouvoiement]`.
> - Le ton doit être professionnel, dynamique et transparent.
> - Formate le résultat final en Markdown avec une structure claire et aérée.
...
### ❌ Avant (Entrée classique sans structure)
...
```markdown
# 🚀 Rejoins l'aventure : Growth Marketer (H/F) pour scaler notre croissance !

**L'opportunité en un mot :**
Tu en as marre des stratégies marketing poussiéreuses et tu veux avoir un véritable impact ? Chez [Nom de l'entreprise], nous passons de la phase de validation à la phase d'hyper-croissance. Nous avons besoin d'un(e) véritable architecte de la croissance pour transformer nos ambitions en data et en acquisition concrète.

**Ce que tu vas construire (Tes Missions) :**

- Concevoir, lancer et analyser des campagnes d'acquisition multicanales (Paid, SEO, Cold Emailing).
- Mettre en place des tests A/B rigoureux pour optimiser constamment nos taux de conversion.
- Identifier et exploiter de nouveaux leviers de croissance non conventionnels.

**Pourquoi nous rejoindre ? (Ce qu'on t'offre) :**

- **Impact immédiat :** Pas de validation à 5 niveaux hiérarchiques. Si la data te donne raison, tu déploies.
- **Budget de formation :** 1500€/an alloués pour tes outils de veille ou tes formations.
- **Flexibilité totale :** Remote-friendly (jusqu'à 4 jours par semaine) et horaires flexibles.
```
