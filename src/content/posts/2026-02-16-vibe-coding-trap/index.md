...
# (Updated) 바이브 코딩(Vibe Coding)의 함정: AI가 당신의 개발 실력을 망치고 있다 {#vibe-coding}
...
## (Updated) AI 코딩의 "나쁜 몰입(Junk Flow)" {#junk-flow}
...
### (Updated) 규칙 2: 아키텍처가 먼저, 프롬프트는 나중 {#updated}
...
### (Updated) 규칙 3: "소크라테스식 코드 리뷰어" 프롬프트 활용 {#updated}
...
## (Updated) 추천 프롬프트: "아키텍처 심문관" {#updated}
...
## (Updated) Writer's Insight: "내가 만들었다"는 감각 {#updated}
