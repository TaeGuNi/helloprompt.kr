...
title: "Generador de Tramas «¿Y si...?» para Vencer el Bloqueo del Escritor"
author: "Jay"
date: "2026-02-04"
...
> **Situación (Context):**
>
> Estoy escribiendo una novela y he sufrido un severo bloqueo creativo. No logro dar con un desarrollo que sea a la vez convincente e impactante para la próxima escena.
>
> **Solicitud (Task):**
>
> 1. Basándote en el `[Género]`, la `[Situación actual]` y la `[Personalidad del protagonista]` que te proporciono a continuación, sugiéreme 5 escenarios ingeniosos con la estructura «¿Y si...?» (What if?) para continuar la historia.
> 2. Cada escenario debe presentar una atmósfera, un tono y una dirección narrativa radicalmente distintos entre sí.
> 3. Para cada uno de ellos, incluye un breve análisis del «Efecto esperado (reacción del lector)» y del «Riesgo (posibles fallos de verosimilitud)».
>
> **Variables de entrada (Input Info):**
>
> - **Género:** `[p. ej., Fantasía oscura, Thriller psicológico, Romance de oficina]`
> - **Situación actual:** `[p. ej., El protagonista por fin acorrala al objetivo de su venganza, pero descubre que es su hermano desaparecido, a quien daba por muerto.]`
> - **Personalidad del protagonista:** `[p. ej., Frío y calculador, pero con una debilidad fatal por los lazos de sangre.]`
>
> **Restricciones (Constraints):**
>
> - Evita a toda costa los Deus Ex Machina, los desarrollos predecibles y los clichés desgastados. (Si te ves obligado a usar un cliché, dale un giro oscuro, irónico o subversivo).
> - Estructura tu respuesta utilizando viñetas y listas numeradas para facilitar la lectura. No utilices tablas bajo ningún concepto.
...
```text
"El protagonista se encuentra cara a cara con el villano, pero por motivos morales, se niega a pelear. No sé cómo continuar la escena sin que el ritmo decaiga o resulte anticlimático."
```
