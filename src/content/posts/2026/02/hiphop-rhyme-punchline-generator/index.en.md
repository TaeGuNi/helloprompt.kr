...
> **Context:**
>
> - Background: I am writing a rap on a Boom Bap style beat.
> - Topic: `[Ambition for Success]`
>
> **Task:**
>
...
> - **Atmosphere:** Aggressive, confident, and hungry
>
> **Constraints:**
>
...
```text
I want to succeed. I will be the best.
I fly so high above the rest.
```

### ✅ After (With Pro Prompt)

```text
My position is always **High**, the gap between us doesn't narrow, **No Lie**
Success is a **Necktie** around my collar, choking you out, say **Bye Bye**
I'm a kid walking on clouds already, my account doesn't age, it never eats **Pie**
When you crawl on the floor, I strike down like lightning from the **Sky**

*(Punchline Breakdown: "Account doesn't eat Pie" -> A play on the mathematical Pi (infinite) and eating pie (getting fat/old), meaning the wealth is infinite and untouchable.)*
```
