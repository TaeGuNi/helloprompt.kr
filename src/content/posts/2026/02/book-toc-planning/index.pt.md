...
## 🚀 A Solução: "O Planejador de Best-sellers"
...
> **Situação (Context):**
>
> - Cenário: Planejo escrever um `[Livro Físico / E-book]` sobre `[O tema principal do seu livro]`.
> - Objetivo: Criar um livro que ofereça soluções altamente práticas aos leitores e garanta um alto volume de vendas.
>
> **Tarefa (Task):**
>
...
```text
Estou escrevendo um livro sobre finanças para assalariados. Planeje um índice. Eu economizei muito dinheiro apenas com poupança e renda extra, sem investir em ações ou imóveis.
```
...
```text
**Títulos Sugeridos:**
1. O Milionário Invisível: Como construir riqueza com seu salário atual (Sem depender da bolsa de valores)
2. A Fórmula da Renda Extra: O mapa definitivo para multiplicar seus ganhos além do horário comercial
3. O Poder do Básico: Vencendo o jogo financeiro apenas com poupança estratégica e suor

**Público-Alvo:** Profissionais assalariados (25-40 anos) frustrados com promessas de "fique rico rápido" e que buscam estabilidade através de métodos seguros e palpáveis.

**Índice Estruturado:**

**Parte 1: A Ilusão do Investidor Moderno (Por que o arroz com feijão funciona)**
- Capítulo 1: O mito de que você precisa da bolsa de valores para enriquecer.
- Capítulo 2: Dissecando seu contracheque: O dinheiro invisível que você está perdendo.

**Parte 2: A Engenharia da Poupança Extrema**
- Capítulo 3: Orçamento de Guerra: Cortando supérfluos sem cortar a alegria de viver.
- Capítulo 4: O sistema automático que guarda dinheiro por você enquanto você dorme.

**Parte 3: O Império da Renda Extra (Monetizando o que você já sabe)**
- Capítulo 5: De hobby a boleto pago: Identificando suas habilidades altamente rentáveis.
- Capítulo 6: O guia prático para captar seus primeiros clientes sem gastar com marketing.

**Parte 4: A Escalada Silenciosa (Mantendo a constância até o milhão)**
- Capítulo 7: Blindagem mental: Como ignorar o vizinho que comprou o carro do ano financiado em 60x.
- Capítulo 8: O seu primeiro grande marco e os próximos passos rumo à liberdade definitiva.
```
