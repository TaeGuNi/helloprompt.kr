...
> - Target Principale: `[Junior Marketer e Project Manager con meno di 3 anni di esperienza, stanchi di fare straordinari tutti i giorni]`
> - Canali: `[Instagram Reels, TikTok]`
> - Frequenza di Pubblicazione: `[3 volte a settimana: Martedì, Mercoledì, Giovedì]`
> - Tone of Voice: `[Professionale ma rilassato, con una vena di umorismo tagliente e molto diretto]`
>
> **Richiesta (Task):**
> 1. In base alle specifiche sopra elencate, pianifica un calendario editoriale per contenuti short-form, includendo un totale di 12 video da pubblicare nelle prossime 4 settimane (un mese esatto).
> 2. Per ciascun contenuto, devi rigorosamente includere:
>    - 🗓️ Settimana e giorno esatto di pubblicazione
>    - 🎯 Argomento chiave (mirato a colpire chirurgicamente i pain point del target)
...
> - Struttura l'output esclusivamente come elenco puntato (bullet points), rendendolo facilmente leggibile e arricchendolo con le relative emoji.
> - Gli hook non devono mai essere astratti o generici. Usa dati specifici, numeri o affermazioni di forte impatto (es. "Se ignori questo trucco, farai straordinari per i prossimi 10 anni").
...
### ❌ Prima (Input di un prompt generico e superficiale)

- Sono un marketer che vende SaaS B2B, creammi un mese di argomenti per i Reels di Instagram.
*(Risultato: Un'enorme tabella che si allarga orizzontalmente con una valanga di testi da manuale, freddi e noiosi come "Settimana 1: Cos'è un SaaS?", "Settimana 2: I vantaggi del Cloud per le aziende")*

### ✅ Dopo (Estratto dei risultati della Versione Pro)

- 🗓️ **Settimana 1 - Martedì**
- 🎯 **Argomento:** Attaccare frontalmente l'inefficienza della raccolta dati manuale
- 🎣 **Hook dei 3 Secondi:** "Stai ancora piangendo perché Excel è crashato mentre facevi un CERCA.VERT?"
- 📝 **Guida alla Regia Visiva:** Inquadratura in prima persona di un monitor completamente bloccato, guardato con un'espressione visibilmente esausta e vistose occhiaie.
- 💬 **Bozza Caption:**
  "Chi ha visto crashare Excel a 10 minuti dalla fine del turno? 🙋‍♂️🙋‍♀️
  Quanto tempo passate a unire manualmente questi dati? Fuggite dall'inferno del copia-incolla! 
