...
- **🤖 Modello consigliato:** ChatGPT Plus (DALL-E 4)
...
## 🚀 La Soluzione: "Prompt per Arte Cinematografica con Testo"
...
```text
Crea la foto di una macchina da caffè. Dietro deve esserci scritto COFFEE MASTER.
```

### ✅ Dopo (Risultato)

```text
Un'immagine fotorealistica mozzafiato, illuminata da una calda luce solare dorata. Al centro spicca un'elegante macchina per caffè espresso, mentre sullo sfondo, su una parete in cemento vintage sfocata (effetto bokeh), si legge la scritta dipinta "COFFEE MASTER", perfettamente integrata nella texture del muro e senza alcun errore di ortografia.
```
