...
## 🚀 A Solução: "Coordenador Inteligente de Suplementos"
...
Use esta versão para obter uma consultoria nutricional detalhada, focada na qualidade da absorção e na resolução de sintomas específicos.

> **Papel (Role):** Você é um Farmacêutico Especialista com vasto conhecimento clínico e um Consultor de Nutrição altamente experiente.
>
> **Contexto (Context):**
>
> - Suplementos atuais: `[Multivitamínico, Probióticos, Ômega 3, Magnésio, Vitamina C]`
> - Sintomas/Problemas: `[frequentemente tenho azia e a sensação de fadiga não desaparece]`
>
> **Tarefa (Task):**
>
> 1. Analise detalhadamente a 'compatibilidade e interação' entre os suplementos que estou tomando (o que não deve ser misturado e o que cria sinergia).
> 2. Identifique se há sobreposição de ingredientes (risco de superdosagem).
> 3. Considerando os meus sintomas (`[azia]`), elabore o 'cronograma de ingestão diária' mais eficaz (ex: manhã em jejum, após o almoço, antes de dormir).
> 4. Se houver algum nutriente essencial em falta para tratar os meus sintomas principais (`[fadiga crônica]`), recomende apenas um, focando no princípio ativo.
>
> **Restrições (Constraints):**
>
> - Explique os motivos de forma clara e acessível, evitando jargões médicos excessivos.
> - Não promova ou mencione marcas específicas de produtos. Refira-se apenas aos nomes dos nutrientes ou compostos ativos.
> - Apresente o cronograma de ingestão final no formato de lista detalhada para fácil leitura no celular.
>
> **Aviso (Warning):**
>
> - Não invente informações farmacêuticas. Se não tiver certeza sobre uma interação medicamentosa, afirme claramente que não sabe e recomende a consulta com um médico. (Evite alucinações).
