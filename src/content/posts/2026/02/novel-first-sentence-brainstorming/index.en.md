...
1. Simply input the genre and core premise of your novel.
2. The AI will generate 10 distinct opening sentences using various narrative techniques (In Media Res, mystery, shocking declarations, etc.).
3. Pick your favorite hook and immediately dive into writing your masterpiece.
...
Use this when you need quick inspiration without complex setups.
...
Use this when you need highly tailored, genre-specific hooks with professional polish.

> **Role:** You are a bestselling author who knows how to immerse readers within the first 3 seconds.
>
> **Context:**
>
> - Background: I am planning to write a novel, but my current introduction feels too flat.
> - Goal: I need a powerful first sentence that makes readers irresistibly curious.
>
> **Work Info:**
>
> - Genre: `[e.g., Romance Fantasy, Zombie Apocalypse, Noir]`
> - Protagonist: `[e.g., A retired assassin, A regressed villainess]`
> - Core Event: `[e.g., The protagonist wakes up inside their own coffin during their funeral]`
>
> **Task:**
>
> 1. Write **10 First Sentences** utilizing the narrative techniques below.
> 2. **In Media Res:** Start right in the middle of the action without exposition.
> 3. **Mystery/Question:** Throw a provocative question at the reader to induce curiosity.
> 4. **Character's Unique Voice:** Use a compelling monologue that reveals the protagonist's personality.
> 5. **Shocking Declaration:** Make a remark that completely overturns common sense.
> 6. **Atmospheric Description:** Provide an overwhelming description of the background mood.
>
> **Constraints:**
>
> - Sentences must be concise, punchy, and impactful.
> - Absolutely no cliché weather descriptions (e.g., "It was a dark and stormy night").
...
1. **[Shocking Declaration]** "My funeral was a much grander party than I ever anticipated."
2. **[In Media Res]** "Kicking the lid off a mahogany coffin requires significantly more core strength than you'd think."
3. **[Mystery]** "Whoever said death is the end was selling something."
