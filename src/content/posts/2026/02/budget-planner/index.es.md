...
## 🚀 La Solución: "Tu Asesor Financiero Personal"

### 🥉 Versión Básica (Basic Version)

Úsala cuando necesites una estructura rápida y sin complicaciones.
...
Úsala cuando necesites un análisis detallado, porcentajes exactos y consejos personalizados.

Copia el contenido del **PROMPT** a continuación y ajusta los valores entre corchetes `[ ]`.

> **Rol (Role):** Eres un `[Asesor Financiero y YouTuber exitoso]` con años de experiencia ayudando a oficinistas a salir de las deudas y multiplicar sus ahorros.
>
> **Contexto (Context):** Quiero empezar a ahorrar dinero de forma disciplinada a partir de este mes. Necesito que elabores un plan de presupuesto realista y altamente estructurado que se ajuste a mi salario sin matarme de hambre.
>
> **Mi Estado Financiero:**
>
> - **Ingreso Neto Mensual:** `[3,000 USD]`
> - **Gastos Fijos:** `[Alquiler 800 USD, Internet/Teléfono 100 USD, Seguros 150 USD, Suscripciones 30 USD]`
> - **Meta de Ahorro Mínima:** `[600 USD]`
>
> **Tarea (Task):**
>
> 1. Calcula mi **'Presupuesto para Gastos Variables'** restando estrictamente mis gastos fijos y mi meta de ahorro de mis ingresos netos. (¡El ahorro no es negociable!).
> 2. Distribuye de manera inteligente la cantidad restante en categorías esenciales: **Alimentación, Transporte, Compras/Cuidado Personal y Ocio/Imprevistos**. (Básate en el estilo de vida de un trabajador de oficina promedio).
> 3. Proporcióname **3 consejos de ahorro prácticos y específicos** para no salirme de este presupuesto.
> 4. Presenta los resultados de forma limpia y estructurada utilizando una tabla Markdown.
>
...
### ❌ Before (Entrada simple sin contexto)

```text
Gano 3000, hazme un presupuesto.
```

### ✅ After (Usando la Versión Pro)

```text
### 💰 Tu Plan Financiero Personalizado (Ingreso: 3,000 USD)

**1. Resumen de Flujo de Efectivo**
- **Ingreso Neto:** 3,000 USD
- **Gastos Fijos:** -1,080 USD (Alquiler, Teléfono, Seguros, Suscripciones)
- **Meta de Ahorro:** -600 USD (¡Pagado a ti mismo primero!)
- **👉 Restante para Gastos Variables: 1,320 USD**

**2. Asignación Detallada de Gastos Variables (Total: 1,320 USD)**

| Categoría | Presupuesto Asignado | % del Variable | Consejo Práctico |
| :--- | :--- | :--- | :--- |
| **Alimentación/Café** | 600 USD | 45% | Prepara el almuerzo en casa 3 veces por semana. |
| **Transporte** | 200 USD | 15% | Evalúa un pase mensual si usas transporte público. |
| **Compras/Cuidado** | 320 USD | 24% | Aplica la regla de las 48 horas antes de comprar ropa. |
| **Ocio/Imprevistos** | 200 USD | 16% | Busca actividades gratuitas en tu ciudad este mes. |

**3. 💡 Consejos Estratégicos de Ahorro**
1. **Auditoría de Suscripciones:** Revisa esos 30 USD. ¿Realmente usas todas las plataformas de streaming? Cancela una y suma esos dólares a tu ahorro.
2. **Días de Cero Gastos:** Intenta establecer dos días a la semana donde tu gasto sea absolutamente 0 USD. Esto frena el impulso de las compras hormiga.
3. **Automatiza el Ahorro:** Transfiere esos 600 USD a una cuenta separada el mismo día que recibas tu sueldo. Si no lo ves, no lo gastas.
```
