...
### (Updated) (Updated) 규칙 2: 아키텍처가 먼저, 프롬프트는 나중
...
### (Updated) (Updated) 규칙 3: "소크라테스식 코드 리뷰어" 프롬프트 활용
...
## (Updated) (Updated) 추천 프롬프트: "아키텍처 심문관"
...
## (Updated) (Updated) Writer's Insight: "내가 만들었다"는 감각
