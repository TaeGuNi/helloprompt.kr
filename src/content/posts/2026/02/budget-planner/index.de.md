...
> **Situation (Context):**
>
> - Hintergrund: Ich möchte ab diesem Monat meine Finanzen ernst nehmen und nachhaltig Geld sparen.
> - Ziel: Erstelle einen realistischen, auf mein Gehalt zugeschnittenen Budgetplan, den ich im Alltag tatsächlich einhalten kann.
>
> **Mein Finanzstatus:**
>
> - **Monatliches Nettoeinkommen:** `[3.000 €]`
> - **Fixkosten:** `[Miete 900 €, Internet/Handy 60 €, Versicherungen 150 €, Streaming-Abos 30 €]`
> - **Sparziel:** `[Mindestens 800 €]`
>
> **Aufgabe (Task):**
>
> 1. Berechne mein **"Verfügbares Budget für variable Ausgaben"**, indem du die Fixkosten und das Sparziel von meinem Nettoeinkommen abziehst.
> 2. Verteile den verbleibenden Betrag sinnvoll auf die Kategorien **Lebensmittel/Supermarkt, Transport, Shopping/Pflege und Freizeit/Rücklagen**. (Orientiere dich dabei an einem durchschnittlichen Angestellten).
> 3. Nenne **3 spezifische, im Alltag leicht umsetzbare Spartipps**, um dieses Budget strikt einzuhalten.
> 4. Präsentiere das fertige Budget übersichtlich in einer Markdown-Tabelle.
>
> **Einschränkungen (Constraints):**
>
> - Plane auf einem realistisch machbaren Niveau. Extreme, unrealistische Sparmaßnahmen sind tabu.
> - Achte besonders darauf, dass das Budget für Lebensmittel nicht zu knapp bemessen ist, da dies im Alltag zum Scheitern führt.
> - Erfinde keine zusätzlichen Kostenpunkte, die nicht in meinen Angaben stehen.
> - Falls bestimmte Informationen unklar sind, weise mich darauf hin, anstatt Werte zu erfinden (vermeide Halluzinationen).
...
```text
Ich verdiene 3000 Euro. Mache mir einen Budgetplan.
```

### ✅ Nachher (Ergebnis)

```text
### 💰 Maßgeschneiderter Budgetplan: 3.000 € Einkommen

**1. Cashflow-Zusammenfassung**
- **Einkommen:** 3.000 €
- **Fixkosten:** -1.140 € (Miete, Internet, Versicherungen, Abos)
- **Sparziel:** -800 € (Das "Pay Yourself First"-Prinzip!)
- **👉 Verfügbar (Variable Ausgaben): 1.060 €**

**2. Detaillierte Zuweisung (Gesamt: 1.060 €)**

| Kategorie | Budget | Anteil | Experten-Tipp |
| :--- | :--- | :--- | :--- |
| **Lebensmittel/Supermarkt** | 450 € | 42% | Großeinkauf 1x pro Woche, mit Einkaufszettel! |
| **Transport/Mobilität** | 100 € | 10% | Monatsticket oder Deutschlandticket nutzen. |
| **Shopping/Körperpflege** | 250 € | 24% | 30-Tage-Regel bei Impulskäufen anwenden. |
| **Freizeit/Rücklagen** | 260 € | 24% | Ein festes Spaß-Budget verhindert Frustration. |

**3. 💡 3 smarte Spartipps für Ihren Alltag**
1. **Der Abo-Check:** 30 € für Streaming klingen wenig, sind aber 360 € im Jahr. Nutzen Sie wirklich alle Dienste jeden Monat? Pausieren Sie, was Sie gerade nicht schauen.
2. **Meal Prep ist King:** Vorkochen spart bares Geld. Wer nur zweimal pro Woche das Mittagessen mit ins Büro nimmt, spart locker 80–100 € im Monat.
3. **Die 24-Stunden-Regel:** Bevor Sie etwas online bestellen, lassen Sie es 24 Stunden im Warenkorb liegen. Meistens verfliegt das Verlangen danach.
```
