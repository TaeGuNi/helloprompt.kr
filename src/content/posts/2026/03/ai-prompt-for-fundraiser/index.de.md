...
title: "💸 Der magische Fundraiser-Prompt, der leere Konten füllt"
author: "Jay"
date: "2026-03-01"
...
> **Kontext (Context):**
>
> - Name der Organisation: `[Name der Organisation oder des Projekts]`
> - Spendenzweck: `[Konkretes Ziel, z. B.: Warme Mahlzeiten für 100 unterernährte Kinder]`
> - Zielgruppe: `[Zielgruppe für Spenden, z. B.: Berufstätige in den 30ern/40ern, bestehende Spender etc.]`
> - Tone of Voice: `[Gewünschter Tonfall, z. B.: aufrichtig und bewegend oder dringlich und bestimmt]`
>
> **Aufgabe (Task):**
>
> 1. Verfasse den Entwurf einer Spenden-E-Mail, die eine tiefe emotionale Resonanz bei der Zielgruppe erzeugt und gleichzeitig eine glasklare, logische Begründung für die Spende liefert.
> 2. Schlage 3 verschiedene Betreffzeilen vor, die unwiderstehlich neugierig machen, um die Öffnungsrate zu maximieren.
> 3. Der Haupttext muss strikt der folgenden Struktur folgen: [Begrüßung - Problemstellung - Lösung (Unsere Aktivitäten) - Spendenaufruf (Call to Action) - Schlusswort].
> 4. Lass den Bereich für den `[Spendenlink]` in Klammern leer, damit ich ihn später einfügen kann.
>
...
### ❌ Before (Bei Nutzung eines Standard-Prompts)
...
### ✅ After (Bei Anwendung des Pro Version Prompts)
