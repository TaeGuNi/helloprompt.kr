...
## 🚀 The Solution: "The Bestseller Architect"
...
Use this when you need a publishing-ready, highly detailed structural blueprint.

Copy the **PROMPT** content below and paste it into ChatGPT or Claude.

> **Role:** You are an elite, highly experienced `[Major Publishing House Editor-in-Chief]` known for creating consecutive bestsellers.
>
> **Context:**
>
...
>
> - `[Paper Book / E-book]`: E-book
> - `[Topic]`: The realistic financial success story of an ordinary office worker in their 30s (Zero stocks, zero real estate, pure savings and side hustles).
>
> **Constraints:**
>
> - Format your output using clear Markdown headings and bullet points.
> - Do not generate generic, textbook-style chapter names. Use persuasive, modern copywriting techniques.
...
```text
## 📚 Title Suggestions
1. "The 100 Million Won Formula: No Stocks, No Real Estate, Just Pure Hustle"
2. "The Boring Way to Wealth: How an Ordinary 30-Something Saved $100K"
3. "Side-Hustle Millionaire: The Office Worker's Guide to Bulletproof Finances"

## 🎯 Target Demographic & Editorial Intent
- Target: Office workers in their 20s and 30s who are exhausted by high-risk stock trading and unreachable real estate markets.
- Intent: To prove that traditional savings combined with strategic side hustles can still build massive wealth.

## 📑 Table of Contents
**Part 1: Why the "Smart" Money is Keeping You Broke**
- Chapter 1: The Illusion of High Returns: Why I Quit the Stock Market
- Chapter 2: Real Estate is a Rich Man's Game (And That's Okay)
- Chapter 3: The Forgotten Power of "Boring" Savings

**Part 2: The 100 Million Won Blueprint**
- Chapter 4: Auditing Your Life: Plugging the Invisible Money Leaks
- Chapter 5: The "Pay Yourself First" Automation System
...
```
