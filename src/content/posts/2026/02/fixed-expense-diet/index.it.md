...
## 🚀 La Soluzione: "Consulente per la Riduzione dei Costi"
...
>
> - **Telefonia/Internet:** 90€/mese (Fibra a casa + Giga illimitati su smartphone)
> - **Abbonamenti (OTT):** Netflix, Spotify, Amazon Prime (Totale: 40€/mese)
> - **Assicurazioni:** 150€/mese (Auto e polizza infortuni base)
> - **Trasporti:** 120€/mese (Abbonamento mezzi pubblici e benzina)
>
> **Compito (Task):**
>
> 1. Suggerisci almeno 2 **Alternative Specifiche e Pratiche (Action Items)** per ridurre i costi di ogni singola voce (es. passare a un operatore virtuale MVNO, condivisione abbonamenti).
> 2. Calcola il **Risparmio Mensile Stimato** applicando i tuoi suggerimenti.
> 3. Mostra il capitale accumulato dopo 1 anno se investissi la cifra risparmiata in un conto deposito con rendimento annuo netto del 4%.
>
> **Vincoli (Constraints):**
>
> - L'output deve essere presentato in formato Markdown con una tabella riassuntiva.
> - Escludi soluzioni estreme che peggiorano significativamente la qualità della vita (es. "vai a lavoro a piedi per 10 km" o "smetti di usare internet").
> - Adatta i consigli al mercato europeo/italiano (es. menziona operatori virtuali, agevolazioni sui trasporti locali, ecc.).
>
> **Attenzione (Warning):**
>
> - Se non hai dati aggiornati su offerte specifiche, non inventarle; fornisci invece linee guida generali su cosa cercare (es. "Cerca offerte sotto i 10€/mese").
...
```text
Come posso spendere meno ogni mese?
```

### ✅ Dopo (Risultato della Versione Pro)

```text
### 💸 Proposta per la Dieta delle Spese Fisse

Ecco un piano d'azione mirato per ottimizzare il tuo budget mensile senza drastiche rinunce:

| Categoria | Soluzione Pratica (Action Item) | Risparmio Stimato |
| :--- | :--- | :--- |
| **Telefonia/Internet** | Passa a un operatore virtuale (MVNO) per smartphone (es. Iliad, Ho. Mobile) e rinegozia la fibra casa. | 🔻 45,00 € |
| **Abbonamenti (OTT)** | Alterna i servizi (es. tieni Netflix un mese, poi disdici e attiva Prime) o usa piani supportati da pubblicità. | 🔻 20,00 € |
| **Assicurazioni** | Confronta preventivi online per l'RC Auto ed elimina coperture duplicate nella polizza infortuni. | 🔻 30,00 € |
| **Trasporti** | Verifica agevolazioni aziendali, bonus trasporti statali o valuta il car-pooling per la tratta casa-lavoro. | 🔻 25,00 € |

**💰 Risparmio Mensile Totale: 120,00 €**
**📈 Capitale accumulato in 1 Anno (al 4% annuo): ~1.468,00 €**

*Consiglio:* Dedica un'ora questo weekend per effettuare i cambi di operatore. Il passaggio richiede pochi minuti online e i benefici durano anni!
```
