...
>
> - Cinematic Lighting, 8k-Auflösung, Makro-Details, Unreal Engine 5 Render-Stil, extrem fotorealistisch.
>
> **Parameter (Nur für Midjourney):**
>
> - Hänge `--ar 16:9 --style raw --v 6.0` an das Ende des Prompts an.
...
```text
Ein Wald in der Nacht mit leuchtenden Pflanzen.
```
