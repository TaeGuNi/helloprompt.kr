...
## 🚀 Lösung: Der "Kinder-Balance-Spiel-Macher"
...
>
> - Schließe Optionen streng aus, die zu grausam, gewalttätig oder übermäßig eklig sind.
> - Integriere lustige Dilemmata, die das Kind zum Lachen bringen und ein gespieltes "Ihh!" oder "Oh nein!" entlocken.
...
```text
Mach ein paar Balance-Spiel-Fragen für mein Kind.
```
...
2. Lieber Schokolade oder Vanille?
(Gähn... Das Kind antwortet mit einem Wort und das Gespräch ist sofort wieder beendet.)
```

### ✅ Nachher (Pro Version)

```text
**Rolle:** Du bist ein humorvoller Unterhaltungsautor... (Pro-Prompt angewendet)
```

_Ergebnis der KI:_

```text
1. Lieber für immer in der Pokémon-Welt leben (aber du darfst Pikachu nie treffen) VS. lieber der beste Fußballspieler der Welt sein (aber du musst bei jedem Spiel ein Hühnchenkostüm tragen)?
2. Lieber ein 1-gegen-1 Fußballspiel gegen Lionel Messi spielen (und er spielt mit verbundenen Augen) VS. lieber einen echten Pokémon-Kampf gegen Ash Ketchum austragen (aber du hast nur ein Raupy)?
(Das Kind lacht, denkt nach und fängt an wild zu argumentieren!)
```
