...
### 🥉 Basic Version (The 3.0 Way)

Use this when the AI has enough context (like an uploaded image, document, or raw data) to infer your ultimate goal. Let the AI do the heavy lifting.
...
>
> **Core Intent:** `[Your ultimate goal, e.g., Drive product sales via Instagram]`
>
> **Task:**
>
> 1. Analyze the attached file and extract the core selling points naturally.
> 2. Generate a `[Desired Output, e.g., promotional caption]`.
>
> **Constraints:**
>
> - Match the tone exactly to the visual aesthetic or underlying mood of the uploaded file.
> - Ensure the final output is immediately ready to publish.
...
### ❌ Before (Prompt 2.0 Approach)

```text
You are a professional social media marketer with 10 years of experience. Write an Instagram promotional caption based on the product description below. The product is a sleek, black coffee mug that keeps coffee hot for 12 hours. Use emojis, include 5 hashtags, and keep the tone friendly, energetic, and persuasive. Format it with line breaks.
```

### ✅ After (Prompt 3.0 Approach)

```text
[Attached: Image of the sleek black mug]
Insta promo for this. Emphasize the 12-hour heat retention.
```
