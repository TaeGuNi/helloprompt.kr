...
## 🚀 Solution: "Winter Packing Master"
...
Use this when you need a tailored, highly detailed packing strategy optimized for your specific trip.
...
> **Task:**
>
> 1. Provide an efficient "Upper/Lower Body Layering" combination that eliminates the need for excessively thick, bulky sweaters.
> 2. Explain the step-by-step packing method and order to drastically reduce the volume inside my suitcase.
> 3. Recommend 3 "small but mighty" winter essentials that I absolutely must pack.
>
> **Constraints:**
>
> - Assume my bulkiest outerwear (e.g., a long down coat) will be worn during transit, not packed.
> - Account for strong indoor heating by suggesting versatile layers that are easy to put on and take off.
> - Limit footwear to 1-2 pairs of comfortable, non-slip winter shoes.
> - Format the output using clean Markdown lists for ultimate readability.
>
> **Warning:**
>
> - Only recommend practical, proven packing methods. Do not suggest unrealistic compression techniques that could damage delicate clothing.
...
```text
Tell me what to prepare for a winter trip to Sapporo.
```

### ✅ After (Result)

```text
Based on your trip to Sapporo in February (Average Temp: -3°C) and your preference for traveling light:

**1. The 'No-Bulk' Layering System:**
*   **Base:** 2x Merino wool long-sleeve tops (odor-resistant, ultra-warm).
*   **Mid:** 1x Packable ultra-light down vest (core warmth without sleeve bulk).
*   **Outer:** Your main windproof/waterproof parka (worn on the plane).

**2. Space-Saving Packing Strategy:**
*   **Roll, Don't Fold:** Tightly roll all base layers and socks, stuffing them inside your packed shoes to maintain shoe shape and save space.
*   **Vacuum Compression:** Use travel vacuum bags specifically for your mid-layers and fleece items.

**3. Small but Mighty Essentials:**
*   **Attachable Heat Packs (Kairo):** Perfect for placing on your lower back or inside pockets.
*   **Touchscreen Glove Liners:** Wear these under thicker mittens so you don't freeze your hands while taking photos.
*   **Attachable Snow Spikes (Crampons):** Sapporo streets get extremely icy; these take up zero space but prevent serious falls.
```
