...
- **🤖 Empfohlene Modelle:** Alle konversationsfähigen KIs (ChatGPT mit Web-Zugriff, Perplexity, Gemini)
...
## 🚀 Lösung: "Der KI-Verkehrsassistent"

### 🥉 Basic Version (Einfach)

Für den schnellen Routen-Check am Morgen.
...
Für die detaillierte, proaktive Planung des Arbeitsweges unter Berücksichtigung aller Störfaktoren.

> **Rolle (Role):** Du bist ein proaktiver, KI-gestützter `[Mobilitäts- und Zeitmanagement-Experte]`.
>
> **Kontext (Context):**
>
> - Hintergrund: Ich pendle täglich von `[Heimatadresse/Stadtteil]` nach `[Büroadresse/Stadtteil]`.
> - Ziel: Ich möchte meine morgendliche Fahrzeit minimieren, den Berufsverkehr umgehen und pünktlich um `[Ankunftszeit, z.B. 09:00 Uhr]` im Büro ankommen.
>
> **Aufgabe (Task):**
>
> 1. Analysiere historische Verkehrsmuster, aktuelle Baustellen und die Echtzeit-Verkehrslage für diese Strecke.
> 2. Empfiehl mir die exakte `[optimale Abfahrtszeit]`.
> 3. Nenne mir eine Hauptroute und mindestens eine `[alternative Ausweichroute]`.
> 4. Berücksichtige die aktuellen Wetterbedingungen und deren mögliche Auswirkungen auf den Straßenverkehr.
>
...
> **Warnung (Warning):**
>
> - Erfinde keine Verkehrsmeldungen. Wenn keine Echtzeitdaten verfügbar sind, weise ausdrücklich darauf hin und greife auf historische Durchschnittswerte zurück.
...
```text
Wann muss ich morgen losfahren, um um 9 Uhr im Büro zu sein?
```
