...
> **Contexto (Context):**
>
> - Perfil: Soy un principiante que desea hacer la transición al veganismo sin complicaciones.
> - Objetivo: Cocinar el fin de semana para tener listos los almuerzos de los 5 días laborables.
> - Ingredientes actuales: Tengo `[berenjena, tofu, espinacas, champiñones]` en el refrigerador, y tengo presupuesto para comprar ingredientes adicionales esenciales.
>
> **Solicitud (Task):**
>
> 1. Crea un **menú de almuerzos para 5 días** maximizando el uso de mis ingredientes actuales (ej. Bowls de arroz, ensaladas de pasta, wraps).
> 2. Sugiere los ingredientes faltantes más económicos y versátiles para asegurar un aporte adecuado de proteínas vegetales.
> 3. Redacta una guía paso a paso para el proceso de "Batch Cooking", optimizando el tiempo en la cocina.
> 4. Proporciona instrucciones detalladas de almacenamiento para garantizar que la comida se mantenga fresca y segura hasta el quinto día.
>
> **Restricciones (Constraints):**
>
> - El proceso de cocción debe ser sumamente eficiente (prioriza recetas de una sola sartén o bandeja de horno).
> - Incluye al menos dos recetas rápidas de aderezos o salsas para variar los sabores.
> - Utiliza condimentos accesibles (salsa de soja, aceite de sésamo, especias básicas).
> - Presenta el resultado en un formato de tabla Markdown clara y estructurada.
>
> **Advertencia (Warning):**
>
> - No incluyas ingredientes difíciles de conseguir o extremadamente costosos. Si una receta requiere técnicas complejas, sustitúyela por una alternativa más sencilla.
