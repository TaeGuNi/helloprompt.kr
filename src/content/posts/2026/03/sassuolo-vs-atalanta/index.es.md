...
title: "⚽ Sassuolo vs Atalanta: Prompt para extraer análisis de rendimiento e insights de apuestas de una vez"
author: "Jay"
date: "2026-03-01"
...
## 🚀 Solución: "Match-Analyzer-X"

### 🥉 Basic Version (Versión básica)

Ideal para cuando necesitas un vistazo rápido y directo a las claves del encuentro.

> **Rol:** Eres un `[analista experto en fútbol europeo]`.
> **Tarea:** Resume los 3 puntos clave a observar, las probables alineaciones y el pronóstico del próximo partido `[Sassuolo vs Atalanta]`.

### 🥇 Pro Version (Versión experta)

La opción definitiva cuando debes publicar informes detallados o contenido fundamentado en métricas de alta precisión.

> **Rol (Role):** Eres un `[analista de datos deportivos]` con más de 10 años de trayectoria. Tu mayor habilidad es extraer insights profundos basándote exclusivamente en datos objetivos y en la compatibilidad táctica de los equipos.
>
> **Contexto (Context):**
> 
...
> **Tarea (Task):**
>
> 1. Sintetiza el balance de los últimos 5 partidos, incluyendo el promedio de goles a favor y en contra de ambos conjuntos.
> 2. Desglosa los factores tácticos determinantes del choque (duelos individuales, jugadores franquicia y el impacto de las posibles ausencias).
> 3. Plantea los 2 escenarios tácticos más probables para este partido, respaldados por el historial reciente y las tendencias de rendimiento.
> 4. Mantén las variables de `[Sassuolo]` y `[Atalanta]` claramente delimitadas para que cualquier usuario pueda sustituirlas por los equipos que prefiera.
>
> **Restricciones (Constraints):**
>
> - Estructura tu respuesta utilizando formato Markdown. Organiza la comparativa de datos con viñetas limpias e integra emojis para facilitar la lectura visual.
> - Omite cualquier tipo de predicción emocional, fanatismo o sesgo subjetivo. Toda afirmación debe estar anclada en la estadística pura.
>
> **Advertencia (Warning):**
>
> - Bajo ninguna circunstancia inventes datos sobre lesiones, sanciones o estadísticas de última hora si no tienes absoluta certeza. Si la información es ambigua, añade la nota: "Pendiente de confirmación oficial de última hora". (Evita cualquier tipo de alucinación).
...
1. **Asignación de Rol (Blindaje de profesionalidad):** Al investir a la IA como un analista de datos veterano en lugar de un simple redactor deportivo, forzamos al modelo a adoptar un tono clínico, objetivo y fundamentado, erradicando cualquier rastro de opinión amateur.
2. **Segmentación de la Tarea (Ingeniería de estructura):** Si dejas a la IA a su libre albedrío, te entregará un muro de texto infumable. Al imponerle una columna vertebral rígida (balance, táctica y escenarios), garantizamos que la lectura sea rítmica y fácilmente escaneable.
3. **Restricciones y Advertencias (El cortafuegos contra alucinaciones):** El mayor riesgo en el periodismo deportivo asistido por IA es publicar que un jugador lesionado marcará el gol de la victoria. La cláusula de advertencia actúa como un seguro de vida, obligando a la máquina a admitir dudas antes de inventar datos estadísticos.
...
```text
¿Qué crees que pasará en el partido entre el Sassuolo y el Atalanta de esta semana? Hazme un análisis.
```

### ✅ After (Resultado)

```text
🔥 Informe de análisis de rendimiento en profundidad [Sassuolo vs Atalanta]

📊 1. Momento actual y datos
- 🟢 Sassuolo (Últimos 5 partidos): 1 victoria, 2 empates, 2 derrotas (Inestabilidad defensiva continua, promedio de 1.8 goles en contra por partido)
- 🔵 Atalanta (Últimos 5 partidos): 3 victorias, 1 empate, 1 derrota (Poder ofensivo abrumador, promedio de 2.2 goles a favor por partido)

⚔️ 2. Puntos tácticos clave
- ♟️ Análisis de compatibilidad: Es muy probable que el fuerte marcaje al hombre y la presión alta del Atalanta dificulten enormemente la inestable salida de balón desde atrás del Sassuolo.
- 🔑 Jugadores clave: Sassuolo (Berardi - despliegue de contraataques por las bandas), Atalanta (Lookman - penetración en los medios espacios)
- 🚑 Variables de ausencias: Ausencia por acumulación de tarjetas del defensa clave del Sassuolo (Requiere confirmar la alineación final)

🔮 3. Escenarios probables
- 📌 Escenario A (Probable): Un desarrollo en el que el Atalanta provoca pérdidas de balón con una fuerte presión temprana, marca el primer gol y toma el control.
- 📌 Escenario B (Sorpresa): El Sassuolo baja sus líneas, resiste y logra un contraataque exitoso con un solo pase largo hacia Berardi.
```
