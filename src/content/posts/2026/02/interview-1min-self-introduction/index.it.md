...
## 🚀 La Soluzione: "Generatore di Elevator Pitch"
...
>
> 1. `[Punto di Forza 1: es. Eccellenti capacità di analisi dei dati]`
> 2. `[Punto di Forza 2: es. Comprovata esperienza nella gestione di team internazionali]`
>
> **Richiesta (Task):**
>
...
> **Vincoli (Constraints):**
>
> - Sono severamente vietate metafore astratte e cliché (es. "Sono come una spugna", "Sono il motore dell'azienda").
> - Salta i saluti iniziali generici (es. "Buongiorno a tutti") e vai dritto al punto. (Li aggiungerò io al momento del colloquio).
> - Usa un tono professionale: **sicuro di sé ma umile** (Educato e Assertivo).
...
- **Q: Questo prompt va bene anche per colloqui in inglese?**
  - A: Assolutamente sì. Basterà aggiungere ai "Vincoli" la dicitura: "Rispondi e scrivi il discorso in lingua inglese a livello C1 Business".

- **Q: 45-50 secondi non sono pochi per presentarsi?**
  - A: In realtà, 50 secondi di parlato equivalgono a circa 120-130 parole. È la lunghezza perfetta per mantenere alta l'attenzione senza annoiare. Ricorda, è un "trailer", non il film completo!
...
### ❌ Prima (Il Cliché del Candidato Medio)

```text
"Buongiorno a tutti! Mi candido per questo ruolo perché sono come una spugna, pronto ad assorbire ogni informazione. Fin da giovane mi è sempre piaciuto lavorare in team e ascoltare i consigli dei più esperti. Sono una persona molto volenterosa e prometto che darò il 100% per l'azienda se mi assumerete..."
```

### ✅ Dopo (L'Impatto del Professionista)

```text
"Sono Marco Rossi, il marketer che trasforma i dati in decisioni strategiche. In questi anni ho sviluppato due punti di forza: primo, la capacità di analizzare enormi moli di dati collegandoli direttamente all'aumento delle conversioni, come ho dimostrato nei miei 3 anni nel settore e-commerce. Secondo, una mentalità globale, gestendo trattative direttamente con clienti internazionali. Con queste competenze, il mio obiettivo qui è chiaro: guidare l'espansione del vostro nuovo mercato europeo nel prossimo trimestre. Grazie per il vostro tempo."
```
