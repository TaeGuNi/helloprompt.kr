...
## 🚀 La Solution : « Maître de Proposition »
...
> **Rôle (Role) :** Tu es un Rédacteur Professionnel de Propositions Commerciales (Proposal Writer) doté d'une expertise en copywriting persuasif et affichant un taux de conversion de 90%.
>
> **Contexte (Context) :**
>
> - Notre offre : `[Insérez le nom de votre entreprise/service]`
> - Cible : `[Insérez votre client cible ou persona]`
> - Objectif : Proposer `[Insérez le cœur de votre proposition]` et convaincre le prospect de signer.
>
> **Tâche (Task) :**
>
> 1. Rédige une introduction percutante qui appuie directement sur le point de douleur (Pain Point) principal du client.
> 2. Explique comment notre solution résout ce problème précis, en mettant l'accent sur les bénéfices concrets (Bénéfice > Fonctionnalité).
> 3. Élabore une section qui met en valeur notre proposition de valeur unique (USP) et nos avantages concurrentiels.
> 4. Suggère des exemples de preuves sociales (Social Proof) ou d'études de cas nécessaires pour asseoir notre crédibilité.
>
> **Contraintes (Constraints) :**
>
> - Adopte un ton résolument orienté client (utilise massivement le "Vous" plutôt que le "Nous").
> - Privilégie les avantages tangibles et mesurables ; évite le jargon technique ou l'auto-promotion excessive.
> - Formate le résultat final avec des titres Markdown clairs.
>
> **Attention (Warning) :**
>
...
```text
Écris une proposition pour notre agence de marketing digital. Nous faisons des réseaux sociaux et du SEO. Nos prix sont attractifs et nous avons une bonne équipe.
```

### ✅ Après (Résultat)

```text
# Transformez votre Trafic en Revenus : Proposition de Partenariat Stratégique

**1. Votre Défi Actuel : Un Trafic qui ne Convertit Pas**
Vous attirez des visiteurs sur votre site, mais ils repartent sans acheter. Ce manque de conversion vous coûte non seulement des ventes immédiates, mais gaspille également votre budget d'acquisition durement gagné.

**2. Notre Solution : Des Stratégies Orientées ROI**
Plutôt que de vous noyer sous des métriques vaniteuses (likes, impressions), nous nous concentrons sur une seule chose : votre retour sur investissement. Grâce à notre méthode combinant SEO technique et Social Ads ciblées, vous verrez une augmentation directe de vos prospects qualifiés.

**3. Pourquoi Nous Choisir (Notre Différence)**
Contrairement aux agences traditionnelles qui vous facturent au temps passé, notre approche est centrée sur la performance. Vous bénéficiez d'une transparence totale sur l'impact de chaque euro investi.

**4. Ils Nous Font Confiance**
- [Étude de Cas : +XX% de croissance pour le Client A]
- [Témoignage : Comment nous avons réduit le coût d'acquisition du Client B de XX%]
```
