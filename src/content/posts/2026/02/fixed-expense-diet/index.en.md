...
> **Role:** You are a seasoned `[Financial Advisor]` and an expert in personal finance optimization.
>
> **Context:** I want to drastically reduce my fixed expenses. My current monthly recurring spending is as follows:
>
> - **Telecom:** $80/month (Major carrier, unlimited data)
> - **Subscriptions:** Netflix, YouTube Premium, Spotify (Total $45/month)
> - **Insurance:** $150/month (Health and Auto)
> - **Transport:** $100/month (Subway commute)
>
> **Task:**
>
> 1. Suggest 2 **Specific Alternatives (Action Items)** to reduce the cost for each category. (e.g., comparing MVNO budget phone plans).
> 2. Calculate the **Expected Monthly Savings** if I apply your suggested methods.
> 3. Show me the compound interest effect: calculate the total amount accumulated after 1 year if I invest the saved money into a high-yield savings account at a 4% annual interest rate.
>
> **Constraints:**
>
...
```text
Tell me how to reduce my living costs.
```
...
| Category | Solution (Action Item) | Expected Monthly Savings |
| :--- | :--- | :--- |
| **Telecom** | Switch to an MVNO budget unlimited plan (e.g., Mint Mobile) | 🔻 $50.00 |
| **Subscriptions** | Switch to Netflix Basic with Ads, use Spotify Duo | 🔻 $15.00 |
| **Transport** | Purchase a monthly commuter pass instead of pay-per-ride | 🔻 $20.00 |
| **Insurance** | Bundle Health and Auto, raise Auto deductible slightly | 🔻 $25.00 |

**💰 Total Monthly Savings: $110.00**
**📈 1-Year Investment (at 4% APY): $1,348.64**

*Action Step:* Order your MVNO SIM card today. The number porting process takes less than 15 minutes!
```
