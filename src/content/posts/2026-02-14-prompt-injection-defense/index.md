...
# (Updated) (Updated) (Updated) 🛡️ 내 AI 서비스 지키기: 프롬프트 인젝션 방어 가이드 {#updated}
...
## (Updated) (Updated) (Updated) 🚀 해결책: "방어 프롬프트 템플릿" {#updated}

<!-- ⚠️ [Lint Rule] 인용구(>)는 이곳(Prompt 섹션)에서만 프롬프트 박스로 변환됩니다. -->

### (Updated) (Updated) (Updated) 🥉 Basic Version (샌드위치 기법) {#updated}
...
### (Updated) (Updated) (Updated) ❌ Before (취약함) {#updated}
...
### (Updated) (Updated) (Updated) ✅ After (방어됨) {#updated}
