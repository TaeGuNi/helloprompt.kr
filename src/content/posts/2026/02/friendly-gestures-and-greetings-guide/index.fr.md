...
- Bonjour (Bon-jour) : À utiliser en journée. Obligatoire en entrant dans une boutique.
- Bonsoir (Bon-soir) : À utiliser à partir de 18h environ.
- Merci beaucoup (Mer-si bo-kou).

🚫 Gestes Interdits (Tabous) :
- Le signe "OK" (👌) : En France, faire un cercle avec le pouce et l'index signifie souvent "zéro" ou "nul". Pour dire "parfait", utilisez plutôt le pouce en l'air (👍).

✅ Gestes Recommandés :
- Au restaurant : N'appelez pas le serveur en claquant des doigts ou en criant "Garçon !". Cherchez le contact visuel et levez légèrement la main en disant "S'il vous plaît".

🤝 Étiquette du Contact Physique :
- La Bise : Courant entre amis et famille. Le nombre de bises varie selon les régions (souvent 2). Dans un cadre formel ou avec des inconnus, privilégiez une poignée de main ferme mais brève.
```
