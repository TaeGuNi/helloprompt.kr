...
```css
/* L'ancienne méthode lourde avec JavaScript et classes injectées */
.card-component.is-active {
  background-color: var(--color-blue);
  /* Nécessite +50 lignes de JS pour écouter les redimensionnements et les états */
}
```

### ✅ Après (Standards 2026)

```css
/* Utilisation élégante et native des CSS State Queries */
@container state(active: true) {
  .card-component {
    background-color: var(--color-blue);
