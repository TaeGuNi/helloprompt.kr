...
## 🚀 A Solução: "Banco de Ideias SCAMPER"
...
```text
Me dê algumas ideias novas para o design de um copo de café.
```

### ✅ Depois (Resultado com Versão Pro)

```text
### 🧠 Ideação SCAMPER para Design de Copos de Café

1. **(Combinar)** Copo de café termo-reativo + Hub de carregamento sem fio na base.
2. **(Eliminar)** Copo sem tampa física — uso de tensão superficial projetada ou campo magnético leve para evitar derramamentos.
3. **(Colocar em outro uso)** Embalagem biodegradável infundida com sementes: após o uso, o copo é plantado e germina.

### 🚀 Benchmarking "Fora da Caixa" (Indústrias Distintas)
- **Indústria Aeroespacial:** Copos com sistema de isolamento a vácuo pressurizado inspirado em trajes espaciais, mantendo a temperatura exata por 24 horas.
- **Indústria de Software:** Copos "Open Source" modulares onde os usuários podem imprimir em 3D e encaixar suas próprias alças e acessórios personalizados.
```
