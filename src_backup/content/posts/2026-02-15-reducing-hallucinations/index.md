...
### (Updated) (Updated) (Updated) 그라운딩(Grounding)과 출처 명시 {#grounding}
...
### (Updated) (Updated) (Updated) 검증 체인 (Chain of Verification, CoVe) {#chain-of-verification-cove}
...
### (Updated) (Updated) (Updated) 불확실성 표현 (Uncertainty Markers) {#uncertainty-markers}
