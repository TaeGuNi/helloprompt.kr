...
## 🚀 The Solution: "Neuro-Morning Protocol Generator"
...
Use this for a highly tailored, science-based routine that factors in your specific lifestyle, sleep habits, and goals.

> **Role (Role):** You are an elite neuroscientist and behavioral psychology expert specializing in chronobiology and peak human performance.
>
> **Context (Context):**
>
> - Background: I want to establish a sustainable "Miracle Morning" routine, but I often fail due to morning grogginess and lack of motivation. My natural sleep schedule is `[Your current sleep/wake times]`.
> - Goal: `[Your primary morning goal, e.g., deep work focus, workout consistency, stress reduction]`
>
> **Task (Task):**
>
> 1. Analyze my current sleep schedule and provide a gentle transition plan to my target wake time of `[Target wake time]`.
> 2. Design a step-by-step 60-minute morning protocol. For each step, explain the **neuroscientific rationale** (e.g., how viewing sunlight affects cortisol release, or how cold exposure spikes dopamine).
> 3. Suggest a 5-minute "frictionless" fallback routine for days when I am extremely exhausted.
> 4. Ensure variables like `[Specific constraints, e.g., I have a 6-month-old baby, or I work night shifts]` are fully accommodated.
>
...
> **Warning (Warning):**
>
> - If any of my constraints conflict with basic sleep hygiene (e.g., sleeping only 4 hours), warn me about the cognitive decline risks before providing the routine.
...
**Result:** _Generic advice to set an alarm, drink a glass of water, and make your bed. No explanation of the underlying mechanisms, and highly prone to failure after three days of relying purely on willpower._
