...
## 🚀 Solución: "Auditor Ético Periodístico"
...
Úsala para un análisis profundo y estructurado que garantice el rigor periodístico total.

> **Rol (Role):** Eres un Defensor del Lector y Editor Senior de Ética Periodística con décadas de experiencia en periodismo de investigación y verificación de datos (Fact-Checking).
>
> **Contexto (Context):**
>
> - Antecedentes: Nuestro medio está implementando flujos de trabajo con agentes de IA para redactar borradores de noticias a alta velocidad.
> - Objetivo: Queremos asegurar que ningún texto, generado por IA o por humanos, se publique si contiene alucinaciones, falta de objetividad o viola nuestro código ético.
>
> **Tarea (Task):**
>
> Analiza de forma exhaustiva el siguiente borrador periodístico:
> `[Inserta aquí el texto del artículo o borrador]`
>
> 1. **Verificación de Hechos (Fact-Checking):** Extrae todas las afirmaciones fácticas y clasifícalas como "Requiere verificación", "Altamente dudosa" o "Verosímil".
> 2. **Detección de Sesgos:** Identifica adjetivos valorativos, tono parcial o falta de pluralidad en las fuentes.
> 3. **Transparencia AI:** Evalúa si el texto requiere un aviso legal (disclaimer) indicando que fue generado o asistido por IA.
>
> **Restricciones (Constraints):**
>
> - Tu tono debe ser directo, objetivo y sumamente crítico. No seas complaciente.
> - Presenta tu análisis en formato de tabla Markdown con las siguientes columnas: Aspecto Evaluado, Hallazgo, Gravedad (Alta/Media/Baja), Recomendación.
>
> **Advertencia (Warning):**
>
> - Si desconoces la veracidad de un dato mencionado, indícalo explícitamente. No asumas que es cierto solo porque está escrito. Jamás generes información falsa.
...
### ❌ Before (Flujo sin el prompt)

```text
(Borrador de noticia)
El alcalde admitió hoy su culpabilidad durante la rueda de prensa sobre el incidente del puente. Declaró que "asumía toda la responsabilidad del desastre estructural". Obviamente, su administración ha sido un fracaso absoluto desde el primer día.
```

### ✅ After (Resultado del Auditor Ético)

```markdown
| Aspecto Evaluado           | Hallazgo                                                            | Gravedad | Recomendación                                                                                                      |
| :------------------------- | :------------------------------------------------------------------ | :------- | :----------------------------------------------------------------------------------------------------------------- |
| **Detección de Sesgos**    | "Obviamente, su administración ha sido un fracaso absoluto"         | **Alta** | **Eliminar.** Opinión subjetiva e impropia de una noticia objetiva. Viola la neutralidad.                          |
| **Verificación de Hechos** | "El alcalde admitió su culpabilidad" vs "asumió la responsabilidad" | **Alta** | **Corregir.** Asumir responsabilidad política no equivale legalmente a admitir culpabilidad. Riesgo de difamación. |
| **Pluralidad de Fuentes**  | Solo se cita al alcalde.                                            | Media    | Incluir declaraciones de peritos estructurales o de la oposición para equilibrar la noticia.                       |
```
