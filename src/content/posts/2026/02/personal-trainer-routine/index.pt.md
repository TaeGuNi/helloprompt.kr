...
> **My Data (Meus Dados):**
>
> - Idade / Sexo: `[Sua Idade]` / `[Seu Sexo]`
> - Altura / Peso: `[Sua Altura, ex: 175cm]` / `[Seu Peso, ex: 80kg]`
> - Objetivo Principal: `[ex: Perder 5kg e ganhar massa magra]`
> - Frequência de Treino: `[ex: 4 vezes por semana, 1 hora por dia]`
> - Restrições: `[ex: Nenhuma / Dor no joelho direito / Intolerância à lactose]`
>
...
1. Supino Reto com Halteres
   ...
   - Descanso: 90s
   - 💡 Dica de Biomecânica: Mantenha as escápulas retraídas (peito "estufado") contra o banco durante todo o movimento. Isso protege as articulações dos ombros e ativa mais as fibras do peitoral.

2. Tríceps na Polia com Corda
   - Séries x Reps: 3 x 12-15
   - Descanso: 60s
   - 💡 Dica de Biomecânica: Trave os cotovelos ao lado do tronco. Se os cotovelos se moverem para frente, você estará usando as costas para ajudar no movimento.

[Exemplo de Nutrição]
Café da manhã (Foco Protéico):
- 3 ovos inteiros mexidos (proteína e gorduras boas)
- 1 fatia de pão integral
- Café preto sem açúcar (atua como leve termogênico antes do trabalho)
```
