...
## 🚀 Solução: "Scanner Psicológico de Investimentos"

### 🥉 Basic Version (Versão Básica)

Use isto quando precisar de um diagnóstico rápido e direto ao ponto.
...
Use isto para uma análise profunda e personalizada através de dramatização (Role-play).

> **Papel (Role):** Você é um `[Conselheiro Sênior de Psicologia Financeira]`, especialista em economia comportamental e gestão de risco.
>
> **Contexto (Context):**
>
> - Objetivo: Quero descobrir meu verdadeiro perfil de investidor.
> - Método: Teste minha resiliência mental através de cenários (dilemas) práticos e extremos, não através de perguntas teóricas de múltipla escolha.
>
> **Tarefa (Task):**
>
> 1. Apresente **3 dilemas de crise financeira**, um de cada vez. (ex: O mercado cripto desabou 50% da noite para o dia, o que você faz?).
> 2. Aguarde minha resposta antes de enviar o próximo cenário.
> 3. Após a terceira resposta, analise meu comportamento e defina minha **Tolerância ao Risco (Risk Tolerance)** em uma das 5 categorias: Conservador / Moderado-Conservador / Moderado / Arrojado / Agressivo.
> 4. Com base no diagnóstico, recomende a **proporção ideal de alocação de portfólio (Ações : Renda Fixa : Caixa)**.
>
> **Restrições (Constraints):**
>
> - Faça **apenas UMA pergunta por vez**. O formato deve ser estritamente interativo.
> - Suas análises devem ser baseadas em vieses cognitivos reais (ex: Aversão à perda, Excesso de confiança).
>
> **Aviso (Warning):**
>
> - Não me dê conselhos de investimento específicos (tickers de ações). Foque na estratégia de alocação e na psicologia.
...
_(Após interagir com os 3 cenários de crise, a IA entrega o diagnóstico profundo)_

```text
### 🧠 Diagnóstico do seu Perfil de Investidor: [Arrojado / Growth Investor]

**1. Base da Análise (Comportamento Observado)**
- No Cenário 1 (Queda de 40% do mercado), você optou por aportar mais capital, demonstrando baixa aversão à perda em cenários de pânico extremo.
- No Cenário 2 (Inflação alta correndo solta), você demonstrou entender que o risco real não é a volatilidade, mas a perda do poder de compra no longo prazo.

**2. Alocação de Portfólio Recomendada (70 : 20 : 10)**
- 📈 **Renda Variável (70%):** Foco em crescimento de longo prazo (ETFs de índices globais, Ações de tecnologia).
- 🛡️ **Renda Fixa (20%):** Títulos atrelados à inflação e prefixados de alta qualidade para estabilizar o portfólio.
- 💰 **Caixa de Oportunidade (10%):** Liquidez imediata para comprar ativos descontados durante os crashes.

**3. Alerta de Gestão Mental (Vieses)**
Como um investidor arrojado, seu maior inimigo é o **Excesso de Confiança (Overconfidence)**. Você gosta de volatilidade, mas lembre-se de que nem toda queda é uma oportunidade de compra; às vezes, os fundamentos de uma empresa realmente pioraram. Mantenha a disciplina rígida na diversificação e nunca se apaixone por um ativo.
```
...
No mundo dos investimentos, você não joga contra o mercado; você joga contra si mesmo. "Se você conhece o inimigo e conhece a si mesmo, não precisa temer o resultado de cem batalhas." Descubra o verdadeiro limite do seu estômago financeiro antes de arriscar seu suado dinheiro na bolsa.

Agora feche o home broker e vá descansar! 🍷
