...
- **🤖 Modello consigliato:** ChatGPT, Claude 3.5 Sonnet, Gemini Advanced
...
Perfetta quando hai bisogno di una panoramica rapida e immediata prima di una riunione.
...
> **Contesto (Context):**
>
> - Scenario: Stiamo assistendo a un'enorme crescita nell'adozione di `[Nome Prodotto, es. Meta Smart Glasses]`.
> - Obiettivo: Comprendere le dinamiche psicologiche e di mercato che guidano questo successo per applicarle ai nostri prodotti.
>
> **Azione (Task):**
>
> 1. Analizza i principali motori di adozione (`[Design, UX, Prezzo, Percezione Sociale]`).
> 2. Valuta il "sentiment" generale degli utenti e identifica le principali resistenze (es. privacy, barriere tecnologiche).
> 3. Fornisci 3 insight strategici (Lezioni Apprese) che aziende in altri settori possono applicare subito.
>
> **Vincoli (Constraints):**
>
> - Struttura la risposta in Markdown usando elenchi puntati per massima leggibilità.
> - Mantieni un tono esperto, persuasivo e basato sui dati.
>
> **Avvertenza (Warning):**
>
> - Non inventare metriche. Se mancano dati precisi, basati sui trend macro-economici attuali. (Niente allucinazioni)
...
```text
Perché la gente compra i Meta Smart Glasses?
```

### ✅ Dopo (Risultato con Pro Version)

```text
**Analisi Strategica: Meta Smart Glasses**

**1. Motori di Adozione Principali:**
* **Attrito Zero:** Si indossano come i classici Ray-Ban. Non richiedono un "rituale" di utilizzo come i visori VR tradizionali.
* **Utilità a Mani Libere:** Catturare momenti o interagire con l'IA senza dover estrarre lo smartphone risolve un micro-problema universale.

**2. Sentiment e Resistenze:**
* **Sentiment Positivo (75%):** Gli utenti amano la naturalezza dell'integrazione e il design ultraleggero.
* **Resistenza (25%):** Permane la "paura del Grande Fratello" per via delle telecamere sempre pronte all'uso, frenando l'adozione nei contesti professionali o in luoghi pubblici chiusi.

**3. Insight Strategici per il Tuo Business:**
* Nascondi la complessità: il prodotto migliore non sembra un prodotto tecnologico.
* Posizionati su abitudini esistenti (indossare occhiali) anziché crearne di nuove (indossare caschetti).
```
