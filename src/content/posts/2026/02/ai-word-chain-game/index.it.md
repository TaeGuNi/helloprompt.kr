...
## 🚀 La Soluzione: "Prompt del Maestro di Parole"
...
> **Inizio (Task):**
>
> - Ora, se hai compreso tutte le regole, inizia il gioco con una parola di tre lettere che inizia per 'A'.
...
```text
IA: "Iniziamo. Xilofono."
Utente: "O... O...? ㅠㅠ Ho perso."
(Risultato: Gioco finito miseramente in un solo turno)
```

### ✅ Dopo (Risultato)

```text
IA: "Albero (Pianta perenne con fusto legnoso)"
Utente: "Orologio"
IA: "Orso (Grande mammifero onnivoro peloso)"
Utente: "Ombrello"
IA: "Oceano (Vasta distesa di acqua salata)"
(Risultato: 30 minuti di scambi serrati 🏓. E il tuo vocabolario ringrazia!)
```
