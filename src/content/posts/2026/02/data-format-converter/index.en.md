...
> **Role:** You are a senior Data Engineer and ETL (Extract, Transform, Load) expert with a meticulous eye for data integrity.
>
> **Context:**
>
...
3. **Constraint on Output:** The instruction to "Output ONLY the final converted data" is critical. It stops the AI from generating chatty responses like "Here is your converted data!", which would otherwise force you to manually clean the output before using it.
...
Don't waste your precious engineering hours wrestling with Excel formulas or writing throwaway regex scripts for simple data transformations. By clearly defining your mapping rules and offloading the conversion to AI, you'll finish tedious tasks in seconds and get closer to clocking out on time. 🍷
