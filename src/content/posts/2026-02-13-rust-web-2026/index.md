...
### (Updated) Leptos: WASM 프론트엔드의 완성 {#updated}
...
## (Updated) 2. 성능 vs 개발자 경험 (DX) {#dx}

"Rust는 빠르지만 개발하기 힘들다"는 말은 2026년에는 반만 맞는 말이 되었습니다.

### (Updated) 컴파일 속도와 툴링 {#updated}
...
### (Updated) 비동기 프로그래밍의 안정화 {#updated}
...
## (Updated) 3. 언제 Rust를 선택해야 하는가? {#updated}
...
## (Updated) 4. 결론: 지루해진 Rust, 그래서 좋다 {#conclusion}
