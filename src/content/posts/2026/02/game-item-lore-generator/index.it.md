...
## 🚀 La Soluzione: "Fucina degli Artefatti Leggendari"
...
Usala in fase di progettazione del gioco o per preparare la campagna, quando hai bisogno di una lore profonda e di meccaniche altamente bilanciate.

> **Ruolo (Role):** Sei un Master Game Designer specializzato in giochi di ruolo (GDR) e un perito di antiche reliquie magiche. Hai una profonda conoscenza del bilanciamento "High Risk, High Reward" (Alto Rischio, Alta Ricompensa).
>
> **Contesto (Context):**
>
> - I giocatori hanno appena aperto un forziere nascosto nelle profondità di un dungeon antico.
> - L'oggetto all'interno non deve essere assolutamente ordinario; deve suscitare immensa meraviglia ma anche un profondo senso di timore.
>
> **Richiesta (Task):**
>
...
>    - **Abilità Peculiare:** (Una meccanica di gioco unica, non un semplice aumento di statistiche. Es: "Diventi invisibile dopo un'uccisione ma...")
>    - **Penalità / Maledizione:** (Il terribile prezzo da pagare per usare il potere. Es: "L'uso riduce permanentemente la salute massima")
>    - **Lore (Leggenda):** (Un breve paragrafo drammatico che narra la storia tragica del suo creatore o del precedente possessore)
>
> **Vincoli (Constraints):**
>
> - Evita abilità eccessivamente sbilanciate (Overpowered/Munchkin). La penalità deve essere perfettamente proporzionata al potere.
> - Usa un tono narrativo oscuro, epico e misterioso.
> - L'output deve essere strutturato in modo chiaro, usando liste e grassetti per facilitarne la lettura.
...
```text
Crea una spada forte che spara fuoco.
```

### ✅ Dopo (Risultato del Prompt Pro)

```text
**Nome dell'Oggetto:** Lama delle Ceneri Eterne
**Rarità:** Epico (Maledetto)

**Design Visivo:**
La lama non è forgiata in acciaio, ma scolpita in una singola lastra di carbone pietrificato, densa e porosa. Non riflette alcuna luce, ma al suo interno pulsano venature cremisi incandescenti. Quando viene sguainata, l'aria circostante trema violentemente per il calore e l'arma lascia dietro di sé una scia di faville ardenti e fumo nero.

**Abilità Peculiare (Incenerimento Instabile):**
Ogni fendente andato a segno cauterizza istantaneamente la ferita del nemico, infliggendo danni da ustione catastrofici che ignorano le armature convenzionali. Il bersaglio colpito non può rigenerare punti vita né ricevere cure magiche per i successivi 3 turni.

**Penalità (Il Prezzo della Fornace):**
La spada esige combustibile vitale. Mentre è impugnata, la temperatura corporea di chi la utilizza sale a livelli critici. Il possessore subisce danni da fuoco non mitigabili alla fine di ogni proprio turno. Se l'arma viene riposta nel fodero senza aver versato sangue, punisce il portatore ustionandogli gravemente l'avambraccio, riducendo permanentemente la sua Destrezza di 1 punto fino al prossimo lungo riposo.

**Lore:**
Si narra che fu forgiata dal Folle Fabbro Ignis, che immerse la lama incandescente non nell'acqua di sorgente, ma nel cuore ancora pulsante di un Antico Drago Rosso morente. La spada assorbì l'agonia, il calore inestinguibile e la furia della bestia. La leggenda vuole che l'ultimo proprietario della lama non sia caduto in battaglia sotto i colpi nemici, ma sia stato ritrovato ridotto a un mucchio di ceneri fumanti nel mezzo del proprio accampamento, con la mano scheletrica ancora fusa all'elsa.
```
