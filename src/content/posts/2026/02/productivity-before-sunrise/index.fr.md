...
> **Contexte (Context) :**
>
> - Situation actuelle : Je me lève à `[Heure du réveil, ex: 5h30]` mais je perds souvent de précieuses minutes à scroller ou à chercher par quoi commencer.
> - Objectif principal : Accomplir ma tâche la plus importante (`[La tâche, ex: rédiger le chapitre d'un livre]`) avant que le reste de la maison ne se réveille à `[Heure, ex: 7h30]`.
>
> **Tâche (Task) :**
>
> 1. Conçois un emploi du temps matinal implacable et sans faille, divisé en blocs de 15 à 30 minutes.
> 2. Intègre la règle des "5 minutes de mise en route" pour vaincre instantanément la procrastination.
> 3. Propose une méthode en 3 étapes pour préparer mon environnement de travail dès la veille au soir.
> 4. Laisse les parties variables comme `[Ceci]` pour que je puisse ajuster le plan.
>
> **Contraintes (Constraints) :**
>
> - L'emploi du temps doit être présenté sous forme de liste claire à puces (aucun tableau).
>
> **Avertissement (Warning) :**
>
> - Ne propose pas d'activités irréalistes ou de routines de bien-être interminables (ex: 1 heure de méditation). Reste strictement focalisé sur le travail profond (Deep Work) et l'efficacité brute.
...
5:50 - Se lève enfin, traîne pour faire du café
6:05 - S'assoit au bureau, se demande par quoi commencer
6:15 - Ouvre ses e-mails "juste pour vérifier rapidement"
6:45 - Essaie de commencer le vrai travail, mais les enfants se réveillent
...
5:35 - Verre d'eau, bureau déjà préparé la veille
5:40 - Début du Bloc Focus 1 (Écriture - 45 min) sans aucune connexion internet
6:25 - Pause de 5 min (Café / Étirements rapides)
6:30 - Début du Bloc Focus 2 (Édition - 45 min)
7:15 - Planification rapide de la journée à venir
7:30 - Tâche principale accomplie à 100%, prêt et serein pour la journée !
```
