...
Utiliza a Matriz de Eisenhower para criar um planejamento de tempo impecável. Perfeito para usar no ChatGPT ou Claude.

> **Papel (Role):** Você é o melhor Coach de Gestão de Tempo e Produtividade Executiva do mundo.
>
> **Contexto (Context):**
>
...
>
> **Entrada de Dados:**
> `[Insira sua lista caótica de tarefas aqui]`
>
> **Tarefa (Task):**
>
> 1. Analise minha lista e classifique cada item usando a **Matriz de Eisenhower** (4 Quadrantes):
>    - Faça Agora (Importante e Urgente)
>    - Agende (Importante, mas Não Urgente)
>    - Delegue (Urgente, mas Não Importante)
>    - Elimine/Adie (Não Importante e Não Urgente)
> 2. Com base nessa classificação, crie uma **Linha do Tempo (Time-blocking)** realista para o meu dia, assumindo que começo a trabalhar às `[09:00]` e termino às `[18:00]`.
> 3. Reserve obrigatoriamente um bloco de 1 hora para o almoço (ex: 12:00 - 13:00).
> 4. Adicione uma **'Dica de Foco'** curta e prática ao lado de cada bloco de tempo intenso.
>
...
**[🔥 Faça Agora - Foco Máximo]**

- **09:00 ~ 11:30** | Proposta do Projeto X
  _Dica de Foco: Coloque o celular em outro cômodo e use a técnica Pomodoro (50/10)._

**[📅 Agende - Administrativo]**

- **11:30 ~ 12:00** | Marcar reuniões de feedback e responder e-mails
  _Dica de Foco: Faça em lote. Não abra e-mails fora deste bloco._
...
- **19:00** | Lavanderia
- **19:15** | Pedir pasta de dente no app de farmácia

**[🗑️ Elimine / Adie]**

- Assistir série na Netflix (Movido para o fim de semana como recompensa).
