...
## 🚀 Die Lösung: "Shadowing Coach Prompt"
...
> **Aufgabe (Task):**
>
> 1. **Dialoganalyse:** Analysiere den folgenden Dialog: `[Hier Dialog einfügen]`
...
>
> - Formatiere die Ausgabe übersichtlich als Markdown.
> - Erkläre die Aussprache so praxisnah und muttersprachlich wie möglich.
...
### ❌ Vorher (Einfaches Ablesen)

```text
Dialog: "What are you talking about?"
Aussprache: What! Are! You! Talking! About! (Abgehacktes Lesen, bei dem jedes Wort einzeln betont wird 🤖)
Emotion: Monotones Vorlesen wie aus einem Lehrbuch.
```

### ✅ Nachher (Mit KI-Coaching)

```text
Dialog: "What are you talking about?"
Linking & Betonung: "Whaddaya talking about?" (What und are verschmelzen weich miteinander 🇺🇸)
Regieanweisung: Runzle leicht die Stirn und betone das Wort 'talking' stark, als wärst du völlig fassungslos über den Unsinn, den dein Gegenüber gerade von sich gibt.
```
