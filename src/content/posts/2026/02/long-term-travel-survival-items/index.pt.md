...
## 🚀 Solução: "Consultor Nômade de Sobrevivência"
...
Para uma lista cirúrgica, considerando o tipo de hospedagem e regras do país. Copie o bloco abaixo.

> **Role (Papel):** Você é um 'Nômade Digital Especialista' com mais de 10 anos de experiência vivendo temporadas de meses em diversos países, mestre em otimização de bagagem e qualidade de vida em trânsito.
>
> **Context (Contexto):**
>
> - Destino: `[Inserir País/Cidade, ex: Berlim, Alemanha]`
> - Duração: `[Inserir Duração, ex: 6 meses]`
> - Tipo de Acomodação: `[Inserir Tipo, ex: Quarto alugado em apartamento compartilhado / Airbnb]`
> - Estilo de viagem: `[Inserir Estilo, ex: Minimalista viajando apenas com bagagem de mão / Mala despachada de 23kg]`
>
> **Task (Tarefa):**
>
> 1. **Ouro Oculto:** Liste 5 itens do dia a dia (higiene, saúde, conforto) que são fundamentais para este destino específico, mas que são caros, de má qualidade ou impossíveis de achar lá. Explique o _porquê_.
> 2. **Cozinha de Sobrevivência:** Recomende 3 mini utensílios ou temperos compactos que farão toda a diferença para cozinhar na acomodação descrita.
> 3. **Organização Extrema:** Sugira 2 soluções inteligentes de armazenamento para facilitar o processo de fazer e desfazer as malas repetidas vezes.
> 4. **O que NÃO levar:** Liste 3 itens que as pessoas costumam levar para este destino, mas que são um desperdício de espaço (porque são baratos lá ou inúteis no contexto).
>
> **Constraints (Restrições):**
>
> - Exclua estritamente qualquer item que seja proibido pelas leis alfandegárias do país de destino (ex: sementes, certos medicamentos).
> - Priorize itens duráveis, multifuncionais, leves e que não quebrem fácil.
> - Formate a saída usando marcadores claros e adicione links genéricos de busca ou preços estimados (em USD ou moeda local) se possível.
>
> **Warning (Aviso):**
>
> - Se não tiver certeza sobre restrições alfandegárias para um item específico, avise para eu verificar oficialmente. Não invente regras para preencher espaço. (Prevenção de alucinação)
...
### ❌ Before (Busca Comum / Prompt Fraco)

> "Faça uma lista de bagagem para morar um mês na Itália."

**Resultado:** A IA sugere "Roupas íntimas, calças, blusas, passaporte, câmera, produtos de higiene, adaptador de tomada..." (Uma lista genérica e preguiçosa que não oferece nenhum valor tático ou insight local).

### ✅ After (Usando a Pro Version)

**Resultado (Trecho do Output):**

> 1. **Ouro Oculto na Itália:**
>    - **Filtro de Chuveiro Compacto:** A água em muitas cidades italianas (como Roma) é extremamente "dura" (rica em calcário). Se você ficar um mês, seu cabelo e pele vão sofrer ressecamento. Leve um filtro portátil rosqueável.
>    - **Desodorante Antitranspirante Forte:** Os europeus preferem desodorantes em spray com formulações mais suaves. Se você está acostumado com os roll-ons clínicos de alta fixação, leve estoque de casa.
> 2. **Cozinha de Sobrevivência (Airbnb):**
>    - **Sacos Zip-Lock Reutilizáveis de Silicone:** Airbnbs na Itália raramente têm potes sobrando para guardar sobras de queijos ou embutidos abertos. Eles salvam muito espaço na pequena geladeira típica europeia e também na sua mala.
> 3. **O que NÃO levar:**
>    - **Muitos casacos pesados:** A menos que seja pleno inverno nos Alpes, é melhor viajar com camadas leves. Você pode comprar roupas de frio com melhor tecnologia e mais baratas em lojas locais (como a Decathlon europeia ou OVS) se precisar. Guarde espaço na bagagem.
