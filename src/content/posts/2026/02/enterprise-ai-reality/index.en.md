...
- **🤖 Recommended AI:** Any conversational AI (Claude 3.5 Sonnet, GPT-4o, etc.)
...
## 🚀 The Solution: "AI Solution Feasibility X-Ray Scanner"
...
Use this when you need a flawless feasibility report for an executive presentation.

> **Role:** You are a Lead IT Partner at a top-tier global strategic consulting firm. You are an expert in preventing unnecessary IT budget waste and selecting only solutions that generate actual ROI.
> 
> **Context:**
> 
> - Solution under review: `[Solution Name and Core Features]`
> - Our Company Profile: `[Industry, Size, Major pain points currently experienced]`
> - Adoption Goal: `[Core outcomes expected from adopting this solution]`
> 
> **Task:**
> 
...
> **Constraints:**
> 
> - Maintain a professional and objective business tone.
> - Format the output as an easy-to-read report using Markdown bullet points and lists.
> 
> **Warning:**
> 
> - Do not make up information about the solution's features if you are unsure. State "Requires further verification" to prevent hallucinations.
...
### ❌ Before (Standard Search/Question)

```text
Q: "Would it be good for our company to adopt Company A's AI automation solution?"

A: "Yes, Company A's AI solution greatly improves productivity through workflow automation, reduces customer response times, and maximizes operational efficiency..."
(A generic response at the level of a sales brochure)
```

### ✅ After (Applying the Pro Prompt)

```text
# Feasibility Report for AI Solution (Company A)

## 1. Hype vs. Reality
- Marketing: "Flawless CS response generation with one click."
- Realistic Limitation: If your internal product manuals are not perfectly structured into a vector DB, there is an extremely high risk of fatal hallucinations (e.g., guiding customers with incorrect refund policies).

## 2. Hidden Costs and Risks
- Data Cleansing Cost: It will require at least 2-3 weeks of internal workforce dedication to clean existing PDF and Word manuals into an AI-readable format.
- Security Risk: The architecture lacks verification on whether prompts containing customer Personally Identifiable Information (PII) are transmitted to external LLM APIs.

## 3. Alternatives and Conclusion
Before adopting this solution at $20,000/year, it is strongly recommended to first test if 70% of the current CS bottleneck can be resolved at no extra cost using your existing Zendesk macro features integrated with Zapier.
```
