...
WORKDIR /app
# (Updated) (Updated) 빌드 스테이지에서 설치한 패키지만 복사
COPY --from=builder /root/.local /root/.local
COPY . .

# (Updated) (Updated) 환경 변수 설정
ENV PATH=/root/.local/bin:$PATH
# (Updated) (Updated) 보안을 위해 non-root 유저 생성 및 전환
