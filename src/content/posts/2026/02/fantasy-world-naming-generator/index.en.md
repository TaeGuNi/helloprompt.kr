...
## 🚀 The Solution: "The Lore-Master Cartographer"
...
```text
Give me names for a dwarf city.
1. Stonehold
2. Deepmine
3. Ironforge
```
...
```text
Linguistic Flavor: Harsh, guttural, Nordic-inspired.
Culture: Industrious, volcanic dwarves.

1. **Krag-Thromar (The Ember Crucible)**
   - *Lore:* Built within the caldera of an active volcano, this capital city is powered by geothermal vents and is the only place where Star-Iron can be forged.
2. **Vulkan-Kald (Ashgate)**
   - *Lore:* The heavily fortified obsidian gates that guard the primary entrance to the underground kingdom, stained black by centuries of volcanic ash.
3. **Drakengard Deep (The Wyrm's Rest)**
   - *Lore:* An ancient, abandoned mining colony that breached a hibernating ancient dragon's lair, now sealed off and considered a forbidden zone.
```
