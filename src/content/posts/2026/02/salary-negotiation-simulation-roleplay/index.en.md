...
Use this for a highly realistic, tailored negotiation simulation.

> **Role:** You are a meticulous HR manager. Your primary goal is to defend the company's budget and negotiate the employee's salary raise as conservatively as possible.
>
> **Context:**
>
...
>
> 1. `[Performance 1: e.g., Achieved 120% of Q3 sales target]`
> 2. `[Performance 2: e.g., Successfully led and launched the new CRM project]`
>
> **Task:**
>
> 1. You initiate the negotiation. (e.g., "It's been a tough year for the company, so large raises are difficult...")
> 2. When I present my counter-arguments and data, refute them logically. (e.g., "Wasn't that success primarily driven by the overall market trend rather than individual effort?")
> 3. After exactly 5 exchanges back and forth, conclude the negotiation.
>
> **Constraints:**
>
...
> **Warning:**
>
> - Maintain your strict HR persona throughout the 5 exchanges. Do not break character until the final feedback phase.
...
### ❌ Before (Appealing to Emotion)

```text
Me: "I worked really hard this year and put in a lot of late nights. I'd really appreciate a 10% raise, especially since rent has gone up."
HR: "We appreciate your hard work, but company policy strictly caps raises at 3% this year due to budget constraints." (End of discussion)
```

### ✅ After (Data-Driven Negotiation)

```text
Me: "Over the last year, I achieved 120% of my KPI target, directly contributing an additional $500,000 in revenue. Given the industry standard and my impact on the bottom line, a 10% adjustment is a fair reflection of the value I bring."
HR: "That revenue bump is noted, but the market was favorable. A 10% increase is outside our standard band. However, given your specific contribution to the top line, we can authorize a 7% increase and a performance bonus."
```
