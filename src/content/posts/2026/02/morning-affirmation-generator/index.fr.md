...
- **🎯 Recommandé pour :** Les salariés au bord du burn-out, les freelances en manque de motivation matinale, les chefs de projet à l'approche d'une échéance cruciale.
...
> _« La première pensée que vous avez en ouvrant les yeux détermine vos performances pour le reste de la journée. À quoi ressemblent vos matins ? »_
...
Les affirmations génériques du type « Je peux le faire » que l'on trouve sur YouTube perdent vite de leur efficacité. Pourquoi ? Parce qu'elles ne tiennent compte ni de votre état émotionnel actuel, ni des objectifs cruciaux que vous devez atteindre aujourd'hui. Ce prompt, fondé sur les neurosciences et les thérapies cognitivo-comportementales (TCC), génère en 10 secondes **des affirmations positives 100 % personnalisées et parfaitement synchronisées avec votre réalité immédiate**.

---

## ⚡️ Résumé en 3 points (TL;DR)

1. **Hyper-personnalisation :** Créez des phrases sur mesure qui reflètent votre humeur, vos défis du jour et vos objectifs à long terme.
2. **Approche neuroscientifique :** Reprogrammez votre subconscient en imposant le temps présent, une formulation que le cerveau assimile sans aucune résistance.
...
> 2. Toutes les phrases doivent impérativement être rédigées au **présent** (ex. : **« Je suis déjà... »**, **« En ce moment, je... »**). N'utilise jamais le futur (« Je serai... »).
...
>
> - Évite les métaphores abstraites ou les clichés (« Je suis une étoile brillante »). Reste ancré dans des actions concrètes directement liées à ma situation réelle (la présentation à la direction).

---

## 💡 L'Avis de l'Expert (Insight)

Le secret de ce prompt réside dans **la maîtrise du temps verbal** et **l'éradication de la négation**. Si vous vous dites « Je ne vais pas rater ma présentation aujourd'hui », votre cerveau se focalise immédiatement sur le mot « rater ». C'est le fameux effet de l'éléphant rose : demandez à quelqu'un de ne pas y penser, et c'est la seule chose qu'il verra.

C'est pourquoi, dans les **Contraintes (Constraints)**, nous bloquons strictement l'usage de termes négatifs, forçant l'IA à décrire votre réalité uniquement à travers un prisme positif. De plus, l'utilisation du futur (« Je réussirai ») signale subtilement à votre subconscient un état de manque (« Je ne réussis pas *encore* »). En exigeant le **présent**, on « trompe » le cerveau pour qu'il agisse comme si le succès était déjà là. Lisez le résultat à voix haute devant votre miroir. Ce n'est pas de la pensée magique, mais une technique d'hygiène mentale scientifiquement prouvée qui tire parti de la neuroplasticité.
...
- **Q : Dois-je générer de nouvelles affirmations tous les jours ?**
  - R : Si votre situation est stable, il est recommandé de répéter les mêmes affirmations pendant environ une semaine pour habituer votre cerveau. Cependant, si votre humeur ou vos défis changent, n'hésitez pas à modifier la variable `[Contexte (Context)]` pour en générer de nouvelles qui soient parfaitement adaptées.

- **Q : L'IA génère parfois des phrases qui sonnent un peu trop « cliché » ou artificielles à mon goût.**
...
Ce qui détermine la qualité de votre journée, ce n'est pas seulement votre nombre d'heures de sommeil, c'est la qualité des données que vous injectez dans votre cerveau lors des 10 premières minutes de votre réveil.
