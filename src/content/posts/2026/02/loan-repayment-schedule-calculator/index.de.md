...
title: "Darlehensrückzahlungsplan: Annuitätentilgung vs. Ratentilgung in Excel"
author: "Jay"
date: "2026-02-04"
...
1. **Monatsrate berechnen:** Ermitteln Sie die konstante monatliche Gesamtrate (Tilgung + Zins) automatisch mit der Funktion `PMT` (RMZ).
...
> 3. Liefere die Formeln zwingend mit **absoluten Zellbezügen ($)**, damit ich sie problemlos über die vollen 120 Monate per AutoFill nach unten kopieren kann.
>
> **Einschränkungen:**
>
...
> - Liefere das Ergebnis als übersichtlichen Text mit gut lesbaren Code-Blöcken für die Formeln. Keine langen theoretischen Abhandlungen!
