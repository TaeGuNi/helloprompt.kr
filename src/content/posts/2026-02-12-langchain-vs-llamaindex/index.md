...
# (Updated) ⛓️ LangChain vs LlamaIndex: 도대체 뭘 써야 할까?
...
## (Updated) 🚀 해결책: "Framework Selector Prompt"

### (Updated) 🥉 Basic Version (특징 비교)
...
### (Updated) 🥇 Pro Version (아키텍처 설계 조언)
