...
## 🚀 La Soluzione: "Il Ghostwriter IA"
...
> **Contesto (Context):**
>
> - Background: Sto scrivendo un pezzo rap su un beat in stile Boom Bap anni '90.
> - Argomento: `[Ambizione e fame di successo]`
>
> **Richiesta (Task):**
>
> 1. Scrivi un testo rap di 8 barre utilizzando le rime indicate in "Info Input".
> 2. Non limitarti a forzare le rime: il testo deve avere un senso logico, un flow naturale e un messaggio d'impatto.
> 3. Includi almeno 1 **Punchline (Doppio Senso)** che faccia impazzire chi ascolta.
>
> **Info Input:**
>
> - **Vocale Obiettivo (Rima):** `[ai] (es.: Mai, Fai, Dai, Sai, High, Sky)`
> - **Atmosfera (Vibe):** Aggressivo, crudo e sicuro di sé.
>
> **Vincoli (Constraints):**
>
> - Mescola italiano e inglese con un rapporto 80/20 per dare più ritmo.
> - Usa lo slang hip-hop in modo appropriato, senza sembrare forzato o innaturale.
> - Evita frasi banali o rime cuore/amore.
>
> **Attenzione (Warning):**
>
...
- **Q: Posso usare questo prompt anche per la trap o la drill?**
...
"La mia posizione è sempre **High**, il divario con te non si restringe **No Lie**
Il successo è un cappio stretto al collo, ti sto salutando **Bye Bye**
Cammino sulle nuvole, fra', il mio conto non mangia mai la **Torta**
Quando strisci sul pavimento, io ti punto dritto dal **Sky**"

_(Punchline: "Il mio conto non mangia mai la torta" → Riferimento ai compleanni; il conto in banca non invecchia, ma continua a crescere)._
