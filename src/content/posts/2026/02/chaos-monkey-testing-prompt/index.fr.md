...
category: "프롬프트 엔지니어링"
description: "Marre des succès artificiels générés par l'IA ? Voici le code de triche impitoyable qui simule des scénarios de chaos pour blinder votre système."
...
> 
> **Contexte (Context) :**
> - Arrière-plan : Tu dois rédiger les tests Unitaires/E2E pour le `[module ou composant cible]`.
