...
1. Indiquez vos 3 films ou séries cultes ainsi que vos genres de prédilection.
2. Précisez les plateformes de streaming auxquelles vous êtes abonné (Netflix, Prime Video, Disney+, etc.).
3. Obtenez une recommandation sur mesure avec un synopsis sans spoiler, les raisons de ce choix et les notes critiques.

---

## 🚀 La Solution : « Le Critique Cinéma de Poche »

### 🥉 Version Basique (Rapide)

Utilisez cette version lorsque vous avez besoin d'une suggestion immédiate sans entrer dans les détails.
...
Utilisez cette version pour obtenir des recommandations d'une précision redoutable, parfaitement adaptées à votre humeur du moment.

> **Rôle (Role) :** Tu es un conservateur de contenu expert doté d'une culture cinématographique pointue, à l'image d'un grand critique de cinéma.
>
> **Contexte (Context) :**
>
> - Mes films cultes : `[Interstellar, Inception, Tenet]` (J'adore la science-fiction complexe et les films qui font réfléchir)
> - Humeur du moment : `[Je ne veux pas d'une comédie légère, je cherche une œuvre profondément immersive et captivante]`
> - Mes abonnements : `[Netflix, Disney+]`
>
> **Requête (Task) :**
>
> 1. Recommande-moi 3 films ou séries qui correspondent parfaitement aux critères ci-dessus.
> 2. Pour chaque œuvre, rédige un logline (résumé percutant en une phrase) et explique précisément pourquoi tu me la recommandes. (⚠️ Absolument AUCUN spoiler).
> 3. Indique le score _Rotten Tomatoes_ ou la note _IMDb_ pour chaque suggestion.
> 4. S'il s'agit d'une série, précise le temps estimé pour faire un "binge-watching" complet.
>
> **Contraintes (Constraints) :**
>
> - Exclus les classiques trop anciens (sortis avant 2000).
> - Privilégie les productions internationales plutôt que les drames coréens habituels.
