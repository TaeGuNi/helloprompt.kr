...
1. **Context is Everything:** Pinpoint exactly when, where, and how the unwanted behavior occurs.
2. **Assign an Expert Persona:** Instruct the AI to act as a seasoned, positive-reinforcement behavioral specialist.
3. **Demand an Actionable Roadmap:** Don't settle for generic advice; ask for a concrete, step-by-step 7-day training plan.

---

## 🚀 The Solution: "The AI Dog Whisperer"
...
> **Task:**
>
> 1. **Root Cause Analysis:** Based on the detailed information provided below, deduce the top 3 psychological or environmental reasons driving this behavior.
> 2. **Action Plan:** Design a concrete, step-by-step '7-Day Behavioral Modification Program' that I can implement starting today. Include a list of any necessary tools or high-value treats.
> 3. **Owner's Blind Spots:** Explicitly list 3 "NG (No Good) Actions"—things I absolutely MUST NOT do, as they will worsen the behavior.
> 4. Keep your tone empathetic but highly authoritative. Format the output clearly using Markdown headers and bullet points.
>
> **Detailed Info (Input):**
>
> - Breed/Age/Sex: `[e.g., Rescue Mix / 2 years old / Spayed Female]`
> - Daily Routine & Exercise: `[e.g., Two 15-minute walks a day, mostly indoor play]`
> - Living Environment: `[e.g., 2nd-floor apartment with lots of street noise]`
> - Recent Life Changes: `[e.g., I recently transitioned from remote work to going into the office]`
...
- **Q: Can I use this for my cat?**
  - A: Yes! Simply change the role to "Feline Behaviorist" and adjust the context (e.g., litter box habits, scratching, vertical space). Cats are driven by entirely different instincts, and the AI will adapt its advice accordingly.
...
### ❌ Before (Vague, Frustrated Input)

```text
My dog keeps barking all day while I'm working from home. It's driving me crazy. How do I make him stop?
```

### ✅ After (AI Expert Output via Pro Prompt)

```text
🐶 [Root Cause Analysis]
Based on the transition to a high-traffic apartment and limited physical exertion, your dog is likely experiencing:
1. Alert Barking (protecting the territory from hallway noises).
2. Pent-up physical energy (15-minute walks are insufficient for this breed).
3. Boredom/Lack of mental stimulation during your work hours.

📅 [7-Day "Calm Office" Protocol]

- **Tools Needed:** Kong toy, peanut butter (xylitol-free), white noise machine.
- **Day 1-2 (Management):** Block visual access to the front door. Turn on a white noise machine near your workspace to muffle hallway sounds.
- **Day 3-5 (The 'Settle' Command):** Keep a jar of high-value treats on your desk. The moment he lies down quietly on his bed, toss a treat. Do not say a word; just reward the calm.
- **Day 6-7 (Mental Exhaustion):** Before you start work, replace his morning food bowl with a frozen stuffed Kong. Mental foraging burns as much energy as a brisk walk.

🚫 [Owner's NG Actions (What NOT to do)]
- **DO NOT shout "Quiet!":** Your dog thinks you are joining in the alarm barking.
- **DO NOT pet him to soothe him while he's barking:** You are actively rewarding the anxious state.
- **DO NOT rely solely on weekends for exercise:** Consistency is key; a tired dog is a quiet dog.
```
