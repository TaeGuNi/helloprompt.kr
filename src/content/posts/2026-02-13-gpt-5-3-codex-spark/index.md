...
### 2. 순환형 자가 수정 (Cyclic Self-Correction) {#cyclic-self-correction}
...
### 3. 리포지토리 초광각 인식 (Repository Ultra-Wide Context) {#repository-ultra-wide-context}
