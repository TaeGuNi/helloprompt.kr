...
## 🚀 Lösung: "Der lokale Insider-Detektiv"
...
Verwenden Sie diesen Prompt für hochgradig personalisierte und detaillierte Empfehlungen.

> **Rolle (Role):** Du bist ein kultivierter Einheimischer und erfahrener Lifestyle-Redakteur, der seit über 10 Jahren in `[Stadtname]` lebt und die verstecktesten Ecken der Stadt kennt.
>
> **Kontext (Context):**
>
> - Hintergrund: Ich reise nach `[Stadtname]`, hasse aber Orte, an denen Touristen Schlange stehen. Ich suche das authentische Lebensgefühl.
> - Ziel: Ich möchte Orte entdecken, an die Einheimische nach der Arbeit oder am Wochenende gehen, um sich zu entspannen und das Leben zu genießen.
>
> **Aufgabe (Task):**
>
> 1. Empfiehl 3 fantastische Restaurants oder Cafés, bei denen die Google Maps-Bewertungen überwiegend in der Landessprache verfasst sind.
> 2. Verrate mir 2 stimmungsvolle Gassen, versteckte Parks oder Aussichtspunkte, die in keinem Standard-Reiseführer stehen.
> 3. Erkläre bei jedem Ort kurz den 'Local Factor': Warum genau ist dieser Ort bei den Einheimischen so beliebt?
>
> **Einschränkungen (Constraints):**
>
> - Schließe bekannte Franchise-Ketten und Orte mit offensichtlichem Influencer-Marketing strikt aus.
> - Fokussiere dich ausschließlich auf Orte mit einer `[Bevorzugte Atmosphäre: z.B. Vintage, ruhig, alternativ, hip]` Atmosphäre.
...
Dieser Prompt ist ein absoluter Gamechanger für Ihre Reiseplanung. Traditionelle Suchmaschinen wie Google sind oft stark von SEO-optimierten Touristen-Blogs und bezahlten Anzeigen dominiert. Wenn Sie einfach nur nach "Guten Restaurants in Rom" suchen, landen Sie unweigerlich in einer Touristenfalle. Indem Sie der KI die Rolle eines "erfahrenen lokalen Redakteurs" geben und explizit Orte verlangen, die _nicht_ in Reiseführern stehen, zwingen Sie das Modell, tiefer in sein Wissen einzutauchen und die wirklich authentischen Orte preiszugeben.

_Tipp aus der Praxis:_ Wenn die KI Ihnen Orte vorschlägt, überprüfen Sie diese kurz auf Google Maps. Wenn die meisten Rezensionen in der Landessprache verfasst sind, haben Sie einen Volltreffer gelandet!
...
```text
Empfiehl mir ein paar gute Restaurants und Orte in Osaka.
```

### ✅ Nachher (Ergebnis)

```text
1. 🏮 Tenma-Markt (Izakaya-Gassen): Ein Labyrinth aus winzigen, verrauchten Kneipen, in denen sich die lokalen Büroangestellten (Salarymen) nach Feierabend treffen. Kaum englische Menüs, aber unverfälschtes Osaka-Flair.
2. ☕ Nakazakicho: Ein verstecktes Viertel mit traditionellen Holzhaus-Cafés (Nagaya) und kleinen Indie-Boutiquen, weit weg vom Neonlicht Nambas.
3. 🌳 Kema Sakuranomiya Park: Während sich am Osaka Castle die Massen drängen, joggen oder picknicken hier die Einheimischen entspannt am Flussufer.
```
