...
## 🚀 La Soluzione: "Manager del Recruiting (HR)"
...
> **Contesto (Context):**
>
> - La nostra azienda: `[Inserisci una breve descrizione dell'azienda e della sua missione]`
> - Posizione aperta: `[Inserisci la Posizione Lavorativa, es. Senior Growth Marketer]`
>
> **Obiettivo (Task):**
>
> 1. Crea 3 opzioni di titoli per l'annuncio che siano creativi e stimolino la curiosità dei candidati.
> 2. Scrivi un'introduzione coinvolgente che spieghi perché questo ruolo è cruciale per la nostra missione aziendale.
> 3. Elenca in modo chiaro e conciso le Responsabilità Principali (R&R) e i Requisiti Minimi.
> 4. Presenta la nostra cultura aziendale e i benefit, mettendoli in una luce estremamente attraente per i migliori talenti.
>
> **Vincoli (Constraints):**
>
> - Evita assolutamente espressioni cliché e stereotipate come "ambiente dinamico e giovane" o "siamo come una famiglia".
> - Usa la prospettiva WIIFM (What's In It For Me?): concentrati fortemente su ciò che il candidato guadagna unendosi a noi, non solo su ciò che noi vogliamo da lui.
> - Formatta il risultato in Markdown usando elenchi puntati e grassetti per renderlo facilmente scansionabile.
>
> **Avvertenze (Warning):**
>
> - Non inventare benefit o condizioni di lavoro non specificati nel contesto. Attieniti a un tono realistico e onesto.
...
### ❌ Prima (Input generico e risultato noioso)
...
```text
Titolo 1: Growth Marketer: Guida l'espansione da 0 a 1 nella nostra Startup
Titolo 2: Non il solito marketing: Cerchiamo la mente analitica dietro la nostra prossima fase di crescita
Titolo 3: Growth Marketer: Scala il nostro prodotto e la tua carriera

**Perché unirti a noi?**
Sei stanco delle solite campagne e vuoi avere un impatto reale e misurabile sul business? In [Nome Azienda], non cerchiamo un semplice esecutore di task, ma un architetto della crescita. Avrai il budget, l'autonomia decisionale e la tecnologia per testare le tue ipotesi più audaci.

**Cosa farai (Le tue responsabilità):**
- Progetterai e implementerai funnel di acquisizione data-driven ad alta conversione.
- Analizzerai costantemente i dati degli utenti per individuare nuovi canali di crescita.
- [...]

**Cosa ti offriamo (Perché sceglierci):**
- Budget annuale garantito per la tua formazione personale e corsi di aggiornamento.
- Libertà totale sui metodi: flessibilità oraria e approccio basato sui risultati, zero micro-management.
- [...]
```
