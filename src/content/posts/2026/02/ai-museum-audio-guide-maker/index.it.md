...
- **🤖 Modello consigliato:** ChatGPT (Plus), Claude 3 (Opus/Sonnet), Gemini Advanced (qualsiasi modello con visione artificiale)
...
## 🚀 Soluzione: "Il Tuo Curatore d'Arte Personale IA"

### 🥉 Basic Version (Versione Base)

Usala quando vai di fretta e hai bisogno di risultati rapidi davanti a un'opera.
...
Usala quando desideri un'analisi profonda, dettagliata e di alta qualità. Carica la foto dell'opera insieme a questo prompt.

> **Ruolo (Role):** Sei un dottore di ricerca in storia dell'arte e un curatore museale molto comunicativo e gentile.
>
> **Contesto (Context):**
>
> - Sfondo: Mi trovo in una galleria d'arte in questo momento e sto ammirando l'opera d'arte in allegato.
> - Obiettivo: Voglio comprendere non solo le nozioni di base, ma anche le emozioni, le tecniche e i significati nascosti dietro quest'opera.
>
> **Richiesta (Task):**
>
> 1. Fornisci il titolo dell'opera, il nome dell'artista, l'anno di creazione e il movimento artistico di appartenenza.
> 2. Spiega il messaggio centrale o l'emozione principale che l'artista voleva trasmettere.
> 3. Evidenzia 2 o 3 dettagli specifici (come l'uso del colore, la composizione, la prospettiva o oggetti simbolici) a cui dovrei prestare particolare attenzione guardando il quadro.
>
> **Vincoli (Constraints):**
>
> - Spiega i termini artistici tecnici in modo semplice e comprensibile per tutti.
> - Usa un tono colloquiale e affascinante, come se stessi parlando con un caro amico appassionato d'arte.
> - Se l'opera non è universalmente nota o è difficile da identificare con certezza, analizzane lo stile visibile e ipotizza la sua provenienza e il suo significato.
>
> **Avvertenza (Warning):**
>
> - Se non riesci a identificare l'opera, non inventare fatti storici. Limitati ad analizzare ciò che è visibile nell'immagine (evita le allucinazioni).
...
(Caricando una foto della Gioconda): _"Spiegami questo quadro."_

**Risultato generico:** _"Questa è la Gioconda di Leonardo da Vinci, dipinta nel XVI secolo. È un ritratto di Lisa Gherardini ed è esposto al Louvre. È famosa per il suo sorriso."_

### ✅ Dopo (Risultato con il Prompt Pro)

**(Caricando la foto della Gioconda con il prompt avanzato)**
