...
category: "AI 활용"
description: "AI prompt for Smart Breakfast Nutritionist"
...
### (Updated) (Updated) (Updated) 나의 냉장고 재료: {#updated}

[여기에 재료를 입력하세요. 예: 계란 2개, 시금치 조금, 식빵 1장, 치즈, 토마토]

### (Updated) (Updated) (Updated) 요청 사항: {#updated}
...
3. **형식:**
   ...
   - 간단한 레시피 (3단계 이내)
   - 예상 칼로리 및 주요 영양소
4. **추가 옵션:** 집에 있는 기본 양념(소금, 후추, 올리브유 등)은 있다고 가정합니다.
