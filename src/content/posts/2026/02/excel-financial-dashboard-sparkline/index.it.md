...
## 🚀 La Soluzione: Il Prompt "Maestro del Visual Excel"
...
```text
### 📊 Guida alla Dashboard Visiva in Excel (Pronta in 2 Minuti)

**1. Tendenza Annuale con 'Sparkline'**
- **Percorso:** Seleziona la cella `[N2]` ➔ Vai sulla scheda **[Inserisci]** ➔ Nel gruppo **[Sparkline]**, clicca su **[Linee]**.
- **Azione:** Nella finestra di dialogo che appare, inserisci `B2:M2` nel campo "Intervallo dati" e clicca OK.
- **Risultato:** Un elegante e minimale grafico a linee apparirà magicamente all'interno della cella N2, mostrando l'andamento dei 12 mesi senza rubare spazio prezioso.

**2. Tasso di Raggiungimento con 'Barre dei dati'**
- **Percorso:** Seleziona l'intera colonna delle percentuali ➔ Scheda **[Home]** ➔ **[Formattazione Condizionale]** ➔ **[Barre dei dati]**.
- **Azione:** Scegli un "Riempimento sfumato" verde o azzurro.
- **Risultato:** Ogni singola cella si riempirà proporzionalmente al suo valore percentuale (es. 100% cella piena, 50% cella colorata a metà). Hai appena creato un grafico a barre integrato!

**3. Evidenziare le Criticità con i 'Set di icone'**
- **Percorso:** Seleziona la colonna del "Tasso di Crescita" ➔ Scheda **[Home]** ➔ **[Formattazione Condizionale]** ➔ **[Set di icone]** ➔ Scegli la categoria **[Direzionali]** (Frecce).
- **Azione:** I valori negativi verranno automaticamente segnalati, ma puoi perfezionarli cliccando su "Gestisci regole".
- **Risultato:** 🔻 Le frecce rosse verso il basso evidenzieranno immediatamente i cali, permettendoti di individuare a colpo d'occhio i problemi che richiedono attenzione.
```
