...
- **🤖 Modèle recommandé :** ChatGPT (GPT-4), Claude 3 (Opus/Sonnet), Gemini Advanced
...
## 🚀 Solution : "Planificateur de Jeûne Sur-Mesure"
...
> **Tâche (Task) :**
>
> 1. Analyse mon mode de vie et définis la **Fenêtre d'Alimentation** (heures de repas) et la **Fenêtre de Jeûne** les plus stratégiques et les plus faciles à tenir pour moi.
> 2. Dresse une liste stricte des boissons autorisées pendant le jeûne (celles qui ne rompent ni l'autophagie ni le repos digestif) et de celles à bannir absolument.
> 3. Propose-moi un plan d'action (scénarios "Si... Alors...") pour adapter mes horaires de jeûne lors d'un imprévu, comme un dîner d'entreprise tardif ou un brunch le week-end.
> 4. Donne-moi 3 astuces d'urgence ("SOS Faim") psychologiques ou physiologiques pour calmer une envie irrépressible de manger en moins de 5 minutes.
>
> **Contraintes (Constraints) :**
>
> - Le programme doit être réaliste, hyper-flexible et adapté au monde réel (pas de perfectionnisme toxique).
> - Toutes tes recommandations doivent avoir pour but principal de maintenir l'insuline au plus bas pendant la phase de jeûne.
> - Présente le planning sous forme de liste à puces claire et structurée.
