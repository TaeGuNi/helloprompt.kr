...
## 🚀 The Solution: "Dramatic Silhouette Prompt Generator"
...
> **Task (Task):**
>
> 1. Create a prompt based on the following variables:
>    - Subject: `[e.g., A lone samurai holding a katana]`
>    - Light Source: `[e.g., A giant, blood-red moon]`
>    - Environment: `[e.g., Standing atop a windswept hill]`
> 2. Strictly format the final output using the structure below.
>
...
> **Output Format:**
>
> - **Subject:** `[Detailed description of the subject's pose]`
> - **Lighting:** `[Specific lighting keywords, e.g., strong backlight, rim light]`
> - **Style:** `[Art style, e.g., minimalist graphic novel, cinematic]`
> - **Parameters:** `[Any specific model parameters, e.g., --ar 16:9 --style raw]`
...
_(Result: A flat image where the samurai's armor is fully visible, and the moon acts as a weak, ambient light rather than a dramatic backdrop. The overall mood is dull and lacks focus.)_

### ✅ After (Pro Prompt Applied)

```text
A lone samurai holding a katana, standing atop a windswept hill. Pure black silhouette, strong backlight against a giant, blood-red moon. Rim lighting, high contrast, minimalist graphic novel style, cinematic composition. --ar 16:9 --style raw
```

_(Result: A breathtaking, poster-quality image. The samurai is reduced to a stark, razor-sharp outline, while the massive glowing moon dominates the background, creating immense tension and a highly professional aesthetic.)_
