...
- **🤖 Empfohlenes Modell:** GPT-4o, Claude 3.5 Sonnet, Gemini 2.5 Flash
...
## 🚀 Die Lösung: "Tech-Campaign-Architect"
...
Für die Entwicklung einer kompletten, medienübergreifenden Werbekampagne (inkl. 3D-Billboard-Regieanweisung).

> **Rolle (Role):** Du bist ein Senior Creative Director und Top-Tier Tech-Copywriter in einer internationalen Werbeagentur.
>
> **Kontext (Context):**
>
> - **Produkt:** `[Produktname, z. B. Samsung Galaxy S26]`
> - **Kern-Specs:** `[Spezifikationen, z. B. Exynos 2600 Chip, Next-Gen Galaxy AI, 3D-Display-Fähigkeiten]`
> - **Kampagnen-Medium:** `[Medium, z. B. 3D-Billboards am Times Square und Social Media Video-Ads]`
> - **Zielgruppe:** `[Zielgruppe, z. B. Tech-Enthusiasten, Early Adopters, Gen Z]`
> - **Ziel:** Die rohe technische Leistung ("Monster-Specs") in eine emotionale Geschichte über die Evolution der KI im Alltag übersetzen.
>
> **Aufgabe (Task):**
>
> 1. Entwickle ein zentrales **Kampagnen-Motto** (Catchphrase), das Technik und Emotion verbindet.
> 2. Skizziere ein **Konzept für ein 3D-Billboard** (Was passiert in Sekunde 1 bis 10? Wie wirkt der 3D-Effekt auf Passanten?).
> 3. Schreibe einen **Instagram-Reel-Voiceover-Text** (max. 30 Sekunden), der die Specs greifbar und dynamisch macht.
>
> **Einschränkungen (Constraints):**
>
> - Verwende keine übermäßig komplizierten Fachbegriffe, ohne sie sofort in einen spürbaren Nutzen zu übersetzen.
> - Gib das Ergebnis klar strukturiert im Markdown-Format (mit Überschriften und Aufzählungszeichen) aus.
>
> **Warnung (Warning):**
>
> - Erfinde keine Spezifikationen, die nicht im Kontext angegeben wurden. Fokussiere dich strikt auf die genannten Features, um falsche Versprechungen (Halluzinationen) zu vermeiden.
...
```text
**Kampagnen-Motto:** "Gedacht. Getan. Die Kraft der Galaxy AI."

**3D-Billboard Konzept (10 Sekunden):**
- [Sek 0-3] Ein gigantischer, glühender Exynos 2600 Chip schwebt scheinbar aus dem LED-Bildschirm heraus, direkt über die Köpfe der Zuschauer am Times Square.
- [Sek 3-7] Der Chip implodiert lautlos zu einem leuchtenden Energiefunken, der blitzschnell in das elegante Titan-Gehäuse des Galaxy S26 schießt.
- [Sek 7-10] Das Smartphone dreht sich rasant, das Display leuchtet auf und zeigt das Motto. Die Buchstaben scheinen in 3D greifbar in der Luft zu stehen.

**Instagram Reel Voiceover:**
"Du siehst ein Smartphone. Aber tief im Inneren schlägt das Herz eines Monsters. Der Exynos 2600 verwandelt jeden Gedanken in Millisekunden in Realität. Erlebe die Evolution der Galaxy AI."
```
