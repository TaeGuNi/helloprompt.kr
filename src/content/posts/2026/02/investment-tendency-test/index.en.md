...
## 🚀 The Solution: "Investment Psychology Simulator"
...
> **Constraints:**
>
> - Do not ask all the questions at once. Proceed strictly in an **interactive manner**, waiting for my response before presenting the next scenario.
...
```text
### 🧠 Investment Tendency Diagnosis Result: [Aggressive Investor] (Growth-Oriented)

**1. Diagnosis Basis**
- You chose to inject additional funds, judging a -20% bear market as a "buying opportunity" rather than a time to panic.
- You demonstrated that you perceive the risk of inflation (failing to hedge) as significantly greater than the risk of temporary principal loss.

**2. Recommended Portfolio (60 : 30 : 10)**
- 📈 **Stocks (60%):** Primarily growth assets like S&P 500 ETFs and tech sector stocks.
- 🛡️ **Bonds (30%):** Government bonds or blue-chip corporate bonds to defend against extreme volatility.
- 💰 **Cash (10%):** "Dry powder" kept in reserve to capitalize on severe bear market dips.

**3. Mental Management Advice**
You have the stomach for volatility, but beware of the "Overconfidence Bias." Always keep in mind that "I might be wrong" and make rigorous diversification an unbreakable rule in your strategy.
```
