...
- **🤖 Empfohlene Modelle:** Gemini 2.5 Pro, Claude 3.5 Sonnet (Large-Context-Modelle)
...
Perfekt für schnelle, übergreifende Analysen extrem langer Texte oder kompletter Repositories.

> **Rolle:** Du bist ein Elite-Datenanalyst und Systemarchitekt.
> **Aufgabe:** Analysiere die beigefügten `[Art der angehängten Daten, z.B. 50 Dokumente oder die gesamte Codebasis]`. Fasse die wichtigsten Kernpunkte zusammen und identifiziere alle systemkritischen Abhängigkeiten.

### 🥇 Pro Version (Expertenform)

Für komplexe Synthesen und tiefgreifende Analysen ohne jeglichen Informationsverlust.

> **Rolle (Role):** Du bist ein Lead Principal Engineer und forensischer Datenanalyst, der mit außergewöhnlicher Präzision arbeitet.
>
> **Kontext (Context):**
>
...
> **Aufgabe (Task):**
>
> 1. Scanne den gesamten Kontext und erstelle eine fundierte High-Level-Architekturübersicht.
> 2. Identifiziere exakt, wo veraltete API-Aufrufe (`[Name der veralteten API]`) verwendet werden. Nenne die genauen Dateipfade und Zeilennummern.
> 3. Extrahiere alle versteckten Abhängigkeiten, die bei einer Migration auf `[Name des neuen Systems]` zu Problemen führen könnten.
>
> **Einschränkungen (Constraints):**
>
> - Formatiere die Ausgabe zwingend als Markdown-Tabelle mit den Spalten: Dateipfad, Risiko-Level, Beschreibung, Lösungsvorschlag.
> - Ignoriere üblichen Boilerplate-Code und fokussiere dich ausschließlich auf die Kernlogik.
>
> **Warnung (Warning):**
>
> - Erfinde unter keinen Umständen Dateinamen oder Code-Snippets. Sollte eine Information im riesigen Kontext fehlen, antworte explizit mit "Nicht im Kontext gefunden". (Strikte Vermeidung von Halluzinationen)
...
```text
(Aufbau einer RAG-Pipeline, Chunken von Code, stundenlanges Indexieren)
...
```text
(Das gesamte Projekt-Repository wird einfach in den Prompt geladen)
Ergebnis:
...
Die Zeit künstlicher Token-Limits ist endgültig vorbei. Mit Kontextfenstern im zweistelligen Millionenbereich halten wir Werkzeuge in den Händen, die die gesamte Komplexität riesiger Unternehmensnetzwerke auf einen einzigen Blick erfassen.

Laden Sie Ihre Daten hoch und beginnen Sie, in völlig neuen Dimensionen zu denken! 🚀
