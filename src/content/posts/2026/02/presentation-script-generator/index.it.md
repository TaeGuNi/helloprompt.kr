...
## 🚀 La Soluzione: Il tuo "Speechwriter" Personale
...
```text
Slide 1: Quota di mercato calata del 5% nel Q1.
Slide 2: Cause principali: nuovi competitor e ritardi nella supply chain.
(Genera uno script per favore)
```

### ✅ Dopo (L'Output del Prompt Pro)

```text
**[Slide 1: Quota di Mercato Q1]**

"Buongiorno a tutti. Se diamo uno sguardo a questo grafico, noterete subito un dato che richiede la nostra attenzione: nel primo trimestre, la nostra quota di mercato ha registrato una flessione del 5%. [Pausa breve, guarda il pubblico] È un numero che non ci fa piacere vedere, certo. Ma la vera domanda non è *quanto* abbiamo perso, ma *perché*. E la risposta a questa domanda ci porta direttamente alla slide successiva..."

**[Slide 2: Cause Principali]**

"...Infatti, analizzando a fondo la situazione, sono emersi due fattori critici che..."
```
