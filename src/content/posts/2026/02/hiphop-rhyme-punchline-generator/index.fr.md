...
- **🤖 Modèle recommandé :** Claude 3.5 Sonnet (excellent pour la créativité littéraire), ChatGPT Plus
...
## 🚀 La Solution : « Le Carnet de Rimes du MC IA »
...
> **Contexte (Context) :**
>
> - Fond sonore : J'écris un couplet sur un beat de style `[Boom Bap classique / Drill sombre / Trap énergique]`.
> - Thème : `[L'ambition, la rue, la réussite, la trahison, etc.]`.
>
> **Requête (Task) :**
>
> 1. Rédige un couplet de rap de 8 mesures en te concentrant sur les **Sonorités Cibles** indiquées ci-dessous.
> 2. Ne te contente pas d'aligner des rimes pauvres : le propos doit être fluide, percutant, et le message profond (utilise des rimes multisyllabiques si possible).
> 3. Intègre au moins 1 **Punchline** (avec un double sens ou une métaphore filée) qui forcera le respect de l'auditeur.
>
> **Variables d'Entrée :**
>
...
>
> - Mélange le français et quelques expressions anglaises (franglais) dans un ratio naturel de 80/20.
> - Utilise un vocabulaire urbain et des figures de style (allitérations, métaphores) pour conserver l'authenticité Hip-Hop.
> - Présente le résultat sous forme de texte clair, en mettant les mots qui riment en **gras**.
>
> **Attention (Warning) :**
>
...
> "J'arrive en furtif, j'étudie chaque **détail** /
> Ils parlent de sommet mais fuient le **travail** /
> Mon flow est tranchant, c'est l'heure de l'en**taille** /
> J'vise l'or du podium, fuck la médaille de **paille**. /
>
> Toujours sur mes gardes, j'exploite chaque **faille** /
> Le game est un zoo, j'suis le roi du **bétail**."
>
> _(Punchline : "fuck la médaille de paille" - Jeu de mots sur l'illusion de la réussite facile. Le texte offre des rimes riches et une vraie attitude Hip-Hop)_

---

## 🎯 Conclusion

Fini le syndrome de la page blanche face à votre micro ou votre carnet. Avec ce prompt, vous possédez un dictionnaire de rimes intelligent et un partenaire d'écriture infatigable disponible 24h/24.

Chargez l'instru, ajustez votre flow, et allez lâcher le feu en cabine ! 🎤🔥
