...
>
> - Gehe von einem durchschnittlichen Catering-Preis von 100 Euro pro Person aus.
> - Verwende realistische, aktuelle Marktpreise für Deutschland und setze die Kosten auf keinen Fall zu niedrig an.
> - Die Ausgabe muss als übersichtliche Markdown-Tabelle (Table) erfolgen, die ich direkt in Excel kopieren kann.
>
> **Warnung (Warning):**
>
...
```text
Ist eine Hochzeit für 30.000 Euro möglich? Mach ein Budget.
```

### ✅ Nachher (Ergebnis)

```text
### 👰‍♀️ Hochzeitsbudget-Planung: 30.000 Euro (80 Gäste)
