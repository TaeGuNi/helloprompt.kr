...
Für maximale Kontrolle und chirurgische Präzision bei der Kombination verschiedenster Medienformate.
...
> - Ziel: `[Erstelle den Code für den markierten Bereich / Erkläre das Kernkonzept bei Minute 2:15]`.
>
> **Aufgabe (Task):**
>
> 1. Analysiere das angehängte Medium absolut präzise.
> 2. Achte explizit auf die visuellen Hervorhebungen (z. B. rote Kästen) oder den akustischen Tonfall.
> 3. `[Spezifische Anweisung: z. B. Generiere React-Komponenten ausschließlich für den rot markierten Bereich]`.
> 4. `[Variablen]`-Bereiche wie Farb-Codes übernimmst du 1:1 aus der Vorlage.
>
> **Einschränkungen (Constraints):**
>
> - Ausgabeformat: `[Markdown-Tabelle / JSON / sauberer Code-Block]`.
> - Ignoriere strikt alle Elemente außerhalb der roten Markierung oder vor dem definierten Zeitstempel.
>
> **Warnung (Warning):**
>
> - Erfinde keine Informationen. Wenn Details im Bild/Video unklar oder verdeckt sind, weise mich explizit darauf hin. (Absolute Null-Toleranz für Halluzinationen).
...
- **F: Funktioniert das direkte Markieren auf Bildern mit jeder KI zuverlässig?**
  - A: Die besten und fehlerfreiesten Ergebnisse erzielen Sie mit aktuellen multimodalen Modellen wie Gemini 2.5 Pro oder GPT-4o. Ältere Modelle könnten rote Markierungen fälschlicherweise als Teil des eigentlichen Bildmotivs (beispielsweise als Logo) fehlinterpretieren.

- **F: Versteht die KI tatsächlich den Tonfall meiner Stimme?**
...
Multimodales Prompting markiert den definitiven evolutionären Sprung von der starren Kommandozeile hin zu einer fließenden, intuitiven Interaktion. Nutzen Sie Bilder, Videos und Ihre eigene Stimme als hochpräzise Werkzeuge, um Ihre Gedanken direkt und ohne jeglichen Informationsverlust in die Maschine zu übertragen.
